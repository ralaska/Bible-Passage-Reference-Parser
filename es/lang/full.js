...
var bcv_regexps = class {
  constructor() {
    ...
    this.translations = [/(?:N(?:A(?:BRE|SB)|IV|LT)|HCSB|(?:N(?:IR|KJ)|N?RS|AS|E[RS]|KJ)V|TNIV|NA[BS]|AMP|CE[BV]|LXX|MSG)\b/gi];
    ...
    this.all_books = [
      ...
      },
      {
        osis: ["PrMan"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}]))(Man\s*ru|(?:Orazione\s*di\s*Manasse\s*Re\s*di\s*Giuda|Rug[aă]ciunea\s*(?:rege)?lui\s*Manase|Ang\s*Panalangin\s*ni\s*Manases|The\s*Pr(?:ayer(?:s\s*(?:of\s*)?Manasseh|\s*(?:of\s*)?Manasseh)|\s*(?:of\s*)?Manasseh)|(?:Oratio\s*(?:regis\s*)?Manassa|(?:Doa\s*)?Manasy)e|(?:La\s*Oraci[oó]n\s*de\s*Manas[eé]|Oraci[oó]n\s*de\s*Manas[eé]|Prece\s*de\s*Manass[eé])s|Panalangin\s*ni\s*Manases|М(?:олитва(?:та\s*на\s*Манасия|\s*Манас(?:ијина|сии))|анасия|\.?\s*Ман)|La\s*Pri[eè]re\s*de\s*Manass[eé]|(?:(?:Preghiera\s*di|Modlitbu|Bæn)|Gebet\s*des)\s*Manasse|Orazione\s*di\s*Manasse|M(?:anas(?:esova\s*modlitb|s(?:e\s*im[aá]ds[aá]g|é\s*im[aá]ds[aá]g|ze\s*im[aá]j))|odlitwa\s*Manasses)a|Prayer(?:s\s*(?:of\s*)?Manasseh|\s*(?:of\s*)?Manasseh)|Dalangin\s*ni\s*Manases|(?:Manasse(?:n\s*rukoukse|s(?:\s*(?:b(?:øn|[oö])|Bø)|’\s*b[oö])|\s*b[oö])|BM)n|Pri[eè]re\s*de\s*Manass[eé]|Πρ(?:οσευχ[ήη]\s*Μανασσ[ήη]|\s*Μαν)|Dasal\s*ni\s*Manases|Geb(?:et\s*Manasses|\s*Man)|Pr\s*of\s*Manasseh|Gebet\s*Manasse|Pr\s*Manass(?:eh|é)|Pr\.\s*Manass[eé]|Pr(?:\s*Man(?:asse)?|\.\s*Man)|תפילת\s*מנשה|صلاة\s*منسى|Man(?:ass?e)?|Doa\s*Man|Or\.?\s*Man|《PrMan》|マナセの(?:いのり|祈[り禱])|므나쎄의\s*기도|《PrMan|DoaMan|PrMan》|PrMan))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Acts"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:M(?:ga\s*Gawa\s*ng\s*mga\s*Alagad|atendo\s*ya\s*Mitume)|کارهای\s*رسولان\s*الهی|رسولوں\s*کے\s*اعمال|Dz\s*Ap)|(?:Mabuting\s*Balita\s*ayon\s*sa\s*Espiritu\s*Santo|Mabuting\s*Balita\s*ng\s*Espiritu\s*Santo|(?:Handelingen\s*(?:van\s*de|der)\s*apostele|A(?:ma(?:(?:al(?:\s*(?:e\s*)?|-?e-?)Rusule|l\s*e\s*Rusule)|l-?e-?Rusule)|['’]mal(?:\s*e\s*|-?e-?)Rusule)e|Karhaye\s*R(?:asoo|usu)la|A(?:ma(?:(?:al(?:\s*(?:e\s*)?|-?e-?)Rusula|l\s*e\s*Rusula)|l-?e-?Rusula)|['’]mal(?:\s*e\s*|-?e-?)Rusula)|Mga\s*Gawai)n|ପ୍ରେରିତମାନଙ୍କ\s*କାର୍ଯ୍ୟର\s*ବିବରଣ|Ebanghelyo\s*ng\s*Espiritu\s*Santo|Los\s*Hechos\s*de\s*los\s*Ap[oó]stoles|Dijannja\s*svjaty[hȟ]\s*apostoliv|Д(?:е(?:яния(?:\s*на\s*(?:светите\s*Апостоли|апостолите)|та\s*на\s*апостолите)|ла\s*(?:(?:на\s*светите\s*апостоли|Апостолска)|на\s*апостолите))|і(?:яння\s*Святих\s*А|[ії]\s*(?:святих\s*а|А))постолів|\.?\s*А|ап)|A(?:z\s*apostolok\s*cselekedetei|postolok\s*cselekedetei|(?:tti\s*degli\s*Apostol|pp[oō]stalar\s*Pa[nṇ])i|ct(?:sss|a)|ma(?:ale|l[ei])|['’]male|p(?:\.(?:\s*t|[Gt])|\s*t|[Ggt]))|(?:Mga\s*Gawa\s*ng\s*mga\s*Apostole|Atos\s*dos\s*Ap[oó]stolo)s|اعمال\s*رسولان\s*در\s*کتاب\s*مقدس|(?:کار(?:های\s*ر(?:سول(?:ا(?:ن‌(?:نامه‌گ?ی‌|هات‌)|[-‌])|ی‌)|َسولا?‌)ه|های\s*رسول‌(?:نامه‌)?ه|نامه\s*رسول‌ه)|اعما?له)ا|(?:The\s*)?Acts\s*of\s*the\s*Apostles|(?:ک(?:ار(?:های\s*رسول(?:ان‌نامه‌(?:هات|گ)ا|یا)|نامه\s*رسولا|\s*رسولا)|تاب\s*(?:کارهای\s*رسول[ای]|اعمال\s*رسول[ای]))|اعمال\s*(?:(?:ال)?رسولی|رَسول[ای]))ن|Mga\s*Gawa(?:\s*ng\s*mga\s*Apostol)?|அப்போஸ்தலருடைய\s*நடபடிகள்|Hechos\s*de\s*los\s*Ap[oó]stoles|رساله\s*اعمال\s*رسولان\s*مقدس|کار(?:های\s*ر(?:سول(?:ا(?:ن(?:‌(?:نامه‌هات?|هات?))?)?|‌نامه|ی)?|َسولان?)?|نامه\s*ر(?:سول)?|\s*ر(?:سول)?)|(?:Buhat\s*sa\s*mga|Gawa\s*ng)\s*Apostoles|(?:کارهای\s*رسولان‌(?:نامه|های)‌ش|اعمال\s*پیام‌آور)ان|Dziejach\s*Apostolskich|Apostlenes\s*(?:gj|G)erninger|ک(?:ارهای\s*ر(?:سول(?:ان‌نامه‌اش|‌نامه‌ا?ی|ین)|َسول(?:ان‌نامه|ی))|\s*ر)|Πρ(?:[άα]ξεις\s*των\s*Αποστ[οό]λων|ξ)|(?:Apost(?:lenes-?gjerning|elg(?:jerningen|eschicht))|Dzieje\s*Apostolski)e|प्र(?:े(?:षितांचीं?\s*कृत्यें|रित(?:ों\s*के\s*कामों|हरूका\s*काम))|\.\s*?क|\s*?क)|(?:ک(?:تاب\s*(?:پیام‌های|مقدس)|ار(?:های\s*اله|نامه‌ها)ی)|اعمال\s*مقدس)\s*رسولان|प्रे(?:षितांचीं\s*कृत्ये|रित(?:ों\s*के\s*काम)?)|Fapte(?:le)?\s*Apostolilor|(?:Falimaha\s*Rasuullad|Apostlag[aä]rningarn|Djela\s*apostolsk)a|pre(?:[sš]it[aā][mṃ]c[iī][mṃ]\s*kr̥tye[mṃ]|rithar[uū]k[aā]\s*k[aā]m)|(?:Gawa\s*ng\s*mga\s*Aposto|(?:Lelakone|Kis(?:ah)?)\s*Para\s*Rasu|Kisah\s*Rasul-?rasu|Karha(?:(?:\s*e\s*Raso|y\s*R[au]so)|-?e-?Raso)o|A['’]maal(?:\s*e\s*|-?e-?)Rusu|Para\s*Rasu|A(?:z\s*ApC|p(?:\.\s*|\s*?)C)se)l|رساله\s*اعمال\s*رسولان|K(?:arhay(?:\s*R(?:asulan(?:-?ha|h)|usulh)a|e\s*Ras(?:ulan|ool)ha)|isR)|Veprat\s*e\s*[Aa]postujve|ก(?:ิจการ(?:​ของ​|ของ)อัครทูต|จ)|தி(?:ருத்தூதர்\s*பணிகள்|ப)|rasūl(?:āṃ\s*de\s*kartabb|ōṅ\s*ke\s*aʿmāl)|داستان\s*رسولان\s*مقدس|Skutky\s*apo[sš]tol(?:sk[eé]|ov|[uüů])|C(?:ông\s*(?:vụ\s*(?:các\s*Sứ|Tông)\s*đồ|Vụ)|selekedetek)|Actes\s*des\s*Ap[oô]tres|(?:(?:Ang\s*Mga\s*)?Binuhat|Karha(?:(?:y(?:\s*e\s*R(?:as(?:oo|u)|usu)|-?e-?R(?:as(?:oo|u)|usu))|\s*e\s*Rasu)|-?e-?Rasu)l)an|(?:Actus\s*Apostoloru|Praeriton\s*Ke\s*Ka)m|اعمال\s*رسولان\s*مقدس|(?:(?:رسُولوں\s*کے\s*ا|اَ)|یوحنا\s*کے\s*ا)عمال|K(?:arhay(?:e\s*R(?:asul(?:an)?|usul)|\s*R(?:asulan|usul))|is(?:ah)?)|A(?:postolien\s*te|kd[eè]zap)ot|அப்போஸ்தலர்\s*பணி|سفر\s*أعمال\s*الرسل|ਰਸੂਲਾਂ\s*ਦੇ\s*ਕਰਤੱਬ|کارهای\s*رُسولان|(?:Aksyon\s*ap[oò]t\s*y|Travay\s*ap[oò]t\s*y|M(?:aten)?d)o|A(?:['’]ma(?:l(?:\s*e\s*Rusul|-?e-?Rusul)?|al)|mal\s*e\s*Rusul|mal-?e-?Rusul|postolok|c(?:t(?:ss?|es|us)?)?|maa?l|t(?:os|ti))|اعم(?:الی|ل)\s*رسولان|حکایات\s*رسولان|D(?:z(?:ieje(?:\s*Apost)?)?|j)|اع(?:م(?:ال(?:\s*(?:ر(?:سول(?:ان)?)?|الرسول)|ی)?|ل)?)?|Postulasagan|מעשי\s*השליחים|H(?:and(?:elingen)?|ech?|c)|அப்(?:போ(?:ஸ்தலர்)?)?|أعمال\s*الرسل|ﺍﻋﻤﺎﻝ\s*ﺍﻟﺮﺳﻞ|Los\s*Hechos|G(?:erninger|w)|मसीह-?दूत|Fa(?:p(?:t(?:e(?:le)?)?)?|l)|Д(?:е(?:ла(?:\s*Ап)?|ян(?:ия)?)|і(?:ян(?:ня)?|[ії]))|Πρ[άα]ξ(?:εις)?|ପ୍ରେରିତ|《?宗徒(?:大事錄|行實)》|Sk(?:utky)?|Vep(?:rat)?|Travay|กิจการ|Hechos|《?宗徒(?:大事錄|行實)|a['’]mālī|عم(?:ال(?:ها|ی)|ل(?:ها|ی))|رسولوں|(?:《(?:使徒行[传傳]|徒)|使徒行[传傳]|徒)》|a['’]m(?:āl)?|《(?:使徒行[传傳]|徒)|F(?:\.?\s*Ap|\.?A)|اعملی|Sứ\s*đồ|使徒(?:の働き|言行録|行[伝録]|書)|Gawa|Công|عما?ل|使徒行[传傳]|Teot|사도행전|Bin|H(?:ch|nd)|使徒|사도|徒|행))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Rev"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))(Apo(?:(?:cal(?:ipsa\s*lui\s*Io|ypse\s*de\s*Je)|calipsis\s*ni\s*Ju)|kalipsis\s*ni\s*Ju)an|(?:О(?:(?:(?:ткровение\s*на\s*св\.?\s*Ио|б['’]явлення\s*св(?:\.\s*[ИЙ]|\s*[ИЙ])о)|б['’]явлення\s*(?:св\.?\s*І|І)в)|дкровення\s*Ів)ана\s*Богослова|யோவானுக்கு\s*வெளிப்படுத்தின\s*விசேஷம்|(?:yoh[aā]n[aā]l[aā]\s*ǳʰ[aā]lele\s*p|p)raka[tṭ][iī]kara[nṇ]|(?:Apocal(?:ypsis\s*Ioannis\s*Apostol|isse\s*di\s*Giovann)|J[aá]nos\s*jelen[eé]se|M(?:akasheph|uujinti))i|(?:Ob['’]javlennja\s*Ivana\s*Bohoslov|Apokalipsa\s*[SŚ]wi[eę]tego\s*Jan|Z(?:j(?:avenie\s*(?:Apo[sš]tola\s*J[aá]|sv[aä]t[eé]ho\s*J[aá]|J[aá])n|eveni\s*svat[eé]ho\s*Jan)|bules)|(?:Apokalipsa\s*[sś]w\.|Objawienie\s*[sś]w\.)\s*Jan|(?:Apokalipsa\s*[sś]w\s*|Objawienie\s*[sś]w\s*)Jan|Ks(?:i[eę]g[ai]\s*Objawieni|\.?\s*Objawieni)|(?:Ufunua\s*wa\s*Yoh|Objawienie\s*J)an|Prakashaitavaky|Ilmestyskirj)a|ଯୋହନଙ୍କ\s*ପ୍ରତି\s*ପ୍ରକାଶିତ\s*ବାକ୍ୟ|O(?:p(?:inberun(?:arb[oó]k\s*|\s*)J[oó]hannesar|b)|ffb)|y(?:ū(?:(?:(?:hãnā\s*de\s*prakāš\s*dī\s*potʰī|ḥannā\s*ʿārif\s*kā\s*mukāšafâ)|hannāl[aā][iī]\s*bʰaeko\s*prak[aā][sš])|hannal[aā][iī]\s*bʰaeko\s*prak[aā][sš])|uhann[aā]l[aā][iī]\s*bʰaeko\s*prak[aā][sš])|Ve[lḷ]ippa[tṭ]utti[nṉ]a\s*Vic[eē][tṭ]a[nṅ]ka[lḷ]|ی(?:ُو(?:\s*حنّا\s*عارِف\s*کا\s*مُ|حنا\s*عارف\s*کا\s*م)کاشفہ|و\s*حنا\s*عارف\s*کا\s*مکاشفہ)|य(?:ोहानाला\s*झालेले\s*प्रकटीकरण|ूहन्नालाई\s*भएको\s*प्रकाश)|வெளிப்படுத்தின\s*விசேடங்கள்|ਯੂਹੰਨਾ\s*ਦੇ\s*ਪਰਕਾਸ਼\s*ਦੀ\s*ਪੋਥੀ|(?:Openbaring\s*van\s*Johanne|Johanne(?:ksen\s*ilmesty|s\s*apokalyp)|Apo[ck]alipsi)s|(?:Apocalipse\s*de\s*(?:S[aã]o\s*Jo[aã]|Jo[aã])|Otkrivenje\s*Ivanov|Zjeven[ií]\s*Janov)o|(?:Johannes\s*Uppenbarels|Rivelazion)e|О(?:ткр(?:ове(?:ние(?:то\s*на\s*[ИЙ]оан|\s*на\s*[ИЙ]оан)|ње\s*Јованово)|ивење\s*Јованово)|дкриттє)|(?:Joh(?:annes['’]\s*(?:[AÅ]b|[aå]p)enbarin|s(?:\.\s*[AÅ]|\s*[AÅ])benbarin)|Offenbarun)g|Ap(?:o(?:c(?:al(?:yps(?:is(?:\s*Ioannis)?)?|i[ps]se))?|k(?:alipsa?)?)?)?|(?:(?:Johannesapokalyps|Abenbaringsbog|Aabenbaring)e|Uppenbarelseboke|Op(?:inberunarb[oó]ki|enbaringe)|Pa(?:hayag\s*kay\s*Ju|medar)a|Apenbaring(?:sbok)?e|Å(?:benbaring(?:sbog)?e|penbaring(?:sbok)?e)|Abenbaringe|Apokalypse|Re[bv]elasyo)n|K(?:hải\s*(?:Huyền\s*của\s*John|thị)|s(?:i[eę]g[ai]\s*Apokalipsy|\.?\s*Apokalipsy)|niha\s*Zjeven[ií]|itab\s*Wahyu)|Αποκ(?:άλυψ(?:ις\s*Ιω[άα]ννου|η)|αλ(?:υψ(?:(?:ις\s*Ιω[άα]ννου|η)|εις)|ύψεις))|yūh(?:ãnā\s*de\s*prakāš|annā)|Ufunuo\s*wa\s*Yohan[ae]|प्र(?:काशित(?:-?वाक्‍|\s*?वाक्)य|\.?\s*व)|Відкриття\s*Івана|Ve[lḷ]ippa[tṭ]utti[nṉ]a|தி(?:ருவெளிப்பாடு|வெ)|El\s*Apocalipsis|ਪਰਕਾਸ਼\s*ਦੀ\s*ਪੋਥੀ|Apokalipszis|Апок(?:(?:а́|[aá])лі|ал[iíиі])псис|R(?:ev(?:e?|[ao])lations|v)|m(?:ak(?:(?:(?:(?:(?:ashefi(?:ah|[ei])|(?:(?:(?:(?:a(?:(?:aa|h)s|sh)h|hsa)fe|ash(?:fe[ai]|af[io]|e(?:ef|f[eo]))|shaafe)|ashaafi)|ashefah))|ashfeha)|aash(?:f(?:e(?:hi|vo|a)|a)|efa))|ashafeh)|shaf(?:ah|e))|uk(?:a(?:(?:sh(?:(?:ef(?:i(?:ah|[ei])|ah|e)|a(?:afi|fo)|fea)|feha)|ash(?:f(?:e(?:hi|vo|a)|a)|efa))|shafeh)|shaf(?:ah|e)))|O(?:p(?:enb(?:aring)?)?|bj(?:awienie)?|tk(?:rivenje)?)|R(?:ev(?:elation|[ao]lation|lation|el)?|iv)|Apenbaring|Å(?:p(?:enbaring)?|b)|О(?:б(?:['’]явлення)?|тк(?:р(?:овение|ивење)?)?)|Khải(?:\s*Huyền)?|m(?:aka(?:sh(?:efia?|(?:efa|fe))|ashfeh)|uka(?:sh(?:ef(?:ia?|a)|fe)|ashfeh))|Ap(?:o(?:cal(?:ypse|ipsa)|kalypsa)|[ck])|Maka(?:ashfa[ah]|ashf[ei]y|shef(?:a[ah]|e[hiy]|iy|y))|رؤيا\s*يوحنا|חזון\s*יוחנן|ﻳﻮﺣﻨﺎ\s*ﺭﺅﻳﺎ|M(?:aka(?:ashf(?:a?|[ei])|shef(?:a|e|i)?)|uuj)|Jelen[eé]sek|M(?:ikashe|ekaash)fe|Gipadayag|प्रकटीकरण|Z(?:j(?:av(?:enie)?|even[ií])?|bu?)|Ilm(?:estys)?|الرؤيــا|Pah(?:ayag)?|vāhyūnn|م(?:ک(?:اشف(?:ات|ةٔ|ه[اهؤی]|یه|[ىہ])|شفه)|ک(?:اشفي|شفا)ه|كاشفه)|הה?תגלות|《?若望默示錄》|ヨハネの[默黙]示録|مُکاشفہ|U(?:f(?:u(?:nuo)?)?|pp)|vāh(?:y(?:ūn?)?)?|مک(?:ا(?:ش(?:ف(?:ا|ة|ه|ی)?)?)?|ش)|प्रकाश|《?若望默示錄|ว(?:ิวรณ์|ว)|요한(?:\s*[계묵]시록|[계묵]시록)|Wahyu|《?启示录》|《?啟示錄》|(?:《[啓默]|[啓默])示錄》|Wahy?|Απ(?:οκ)?|வெளி|《?启示录|《?啟示錄|(?:《[啓默]|[啓默])示錄|Jel|Zjv|Why|《[启啟]》|᾿Απ|黙示録|رؤ|《[启啟]|启》|啟》|묵시|启|啟|계))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["PrAzar"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}]))((?:(?:(?:Ang\s*)?Panalangin\s*ni\s*Azari|Salmo\s*de\s*Azari|Azarí)as|The\s*Pr(?:ayers?\s*of\s*Azariah|\s*of\s*Azariah)|תפילת\s*עזריה\s*בתוך\s*הכבשן|The\s*Pr(?:ayers?\s*of\s*Azaria|\s*of\s*Azaria)|Rug[aă]ciunea\s*lui\s*Azaria|М(?:олитва(?:та\s*на\s*Азария|\s*Азар(?:і[ії]|ия))|\.?\s*Аза)|La\s*Pri[eè]re\s*d['’]Azaria[hs]|(?:Az(?:ar(?:(?:(?:j(?:a[sš]ova\s*modlitb|á[sš]ova\s*modlitb)|y)|ias\s*im[aá](?:ds[aá]g|j))|iás\s*im[aá](?:ds[aá]g|j))|ári[aá]s\s*im[aá](?:ds[aá]g|j))|Modlitw[aą]\s*Azariasz|Gebed\s*van\s*Azarj|Gebet\s*des\s*Asarj|Pie[sś][nń]\s*Azariasz|Doa\s*Azary|Bæn\s*Asarj)a|Preghiera\s*di\s*Azaria|Prayers?\s*of\s*Azariah|Oraci[oó]n\s*de\s*Azar[ií]as|C[aá]ntico\s*de\s*Azar[ií]as|Prayers?\s*of\s*Azaria|Πρ(?:οσευχ[ήη]\s*Αζαρ[ίι]ου|\s*Αζαρ)|Pri[eè]re\s*d['’]Azaria[hs]|Oratio\s*Azariae|(?:Asarjan\s*rukou|Geb\s*A)s|Pr\s*of\s*Azariah|Pr\s*of\s*Azaria|A(?:sar(?:ias’\s*b[oö]n|jas(?:\s*b(?:øn|[oö])n|’\s*b[oö]n)|ias\s*b[oö]n|\s*ru)|zarjas\s*[Bb]øn|zariah)|תפילת\s*עזריה|صلاة\s*عزريا|Doa\s*Az(?:ar)?|[OP]r\.\s*Azar|Sal\s*Azar|《PrAzar》|Azarias?|《PrAzar|Or\s*Azar|Pr\s*Azar|PrAzar》|ア[サザ]ルヤの祈り|PrAzar|அசரியா|Or\s*Az|DoaAz|PrAzr))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["SgThree"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Kolmen\s*(?:nuoren\s*miehen\s*ollessa\s*tulisessa\s*p[aä]tsiss[aä]|miehen\s*kiitosvirsi\s*tulessa)|Lobgesang\s*der\s*drei\s*jungen\s*M[aä]nner\s*im\s*Feuerofen|De(?:r\s*Gesang\s*der\s*Drei\s*M[aä]nner\s*im\s*feurigen\s*Ofen|\s*(?:tre\s*mennenes\s*sang\s*føyer|tre\s*m[aä]nnens\s*lovs[aå]ng|tre\s*mænds\s*lovsang|Tre\s*Mænds\s*Lovsang|tre\s*menns\s*sang))|(?:Cantico\s*dei\s*tre\s*giovani\s*nella\s*fornac|S(?:on|n?)g\s*Thre)e|El\s*(?:Canto\s*de\s*los\s*(?:Tres\s*J[oó]venes\s*(?:Hebre|Jud[ií])os|3\s*J[oó]venes\s*(?:Hebre|Jud[ií])os)|Himno\s*de\s*los\s*(?:Tres\s*J[oó]venes\s*(?:Hebre|Jud[ií])os|3\s*J[oó]venes\s*(?:Hebre|Jud[ií])os))|(?:The\s*Song\s*of\s*(?:the\s*(?:Three\s*(?:Holy\s*Childr|Young\s*M)|3\s*(?:Holy\s*Childr|Young\s*M))|Three\s*(?:Holy\s*Childr|Young\s*M)|3\s*(?:Holy\s*Childr|Young\s*M))|Song\s*of\s*(?:the\s*(?:Three\s*(?:Holy\s*Childr|Young\s*M)|3\s*(?:Holy\s*Childr|Young\s*M))|Three\s*(?:Holy\s*Childr|Young\s*M)|3\s*(?:Holy\s*Childr|Young\s*M))|Lied\s*van\s*de\s*drie\s*jongemann)en|Gezang\s*der\s*drie\s*mannen\s*in\s*het\s*vuur|(?:Awit\s*ng\s*(?:Tatlong\s*Banal\s*na|3)|Tatlong)\s*Kabataan|(?:Canto\s*de\s*los\s*(?:Tres|3)\s*J[oó]venes\s*|Himno\s*de\s*los\s*3\s*J[oó]venes\s*)(?:Hebre|Jud[ií])os|Lobgesang\s*der\s*drei\s*jungen\s*M[aä]nner|(?:Traja\s*ml[aá]denci\s*v\s*rozp[aá]lenej|T(?:ri\s*mu[zž]i\s*v\s*rozp[aá]len[eé]|ři\s*mu[zž]i\s*v\s*rozp[aá]len[eé]))\s*peci|Himno\s*de\s*los\s*Tres\s*J[oó]venes\s*Jud[ií]os|Aw(?:it\s*ng\s*Tatlong\s*Kabataang\s*Banal|\s*ng\s*3\s*Kab)|P(?:iese[nň]\s*ml[aá]dencov\s*v\s*ohnivej\s*peci|ise[nň]\s*ml[aá]denc[uů]\s*v\s*ho[rř][ií]c[ií]\s*peci|íse[nň]\s*ml[aá]denc[uů]\s*v\s*ho[rř][ií]c[ií]\s*peci|ie(?:s(?:ni[aą]|ń)\s*trzech\s*młodzie[nń]c[oó]w|ś(?:(?:ni[aą]|ń)\s*trzech\s*młodzie[nń]c[oó]w|n\s*trzech\s*młodzie[nń]c[oó]w)|sn\s*trzech\s*młodzie[nń]c[oó]w))|Благодарственная\s*песнь\s*отроков|(?:Lofs[oö]ngur\s*ungmennanna\s*þriggj|Lagu\s*Pujian\s*Ketiga\s*Pemud|Awit\s*ng\s*Tatlong\s*Binat|Lagu\s*3\s*Pemud|Lagu\s*Pemud|Tiga\s*Pemud|3\s*Pemud)a|Lobgesang\s*der\s*3\s*jungen\s*M[aä]nner|(?:T(?:he\s*Song\s*of\s*(?:the\s*(?:Three\s*(?:Youth|Jew)|3\s*(?:Youth|Jew))|Three\s*(?:Youth|Jew)|3\s*(?:Youth|Jew))|res\s*J[oó]vene)|C(?:anti(?:que\s*des\s*(?:Trois|3)\s*Enfant|co\s*dos\s*(?:Tr[eê]s\s*Joven|3\s*Joven))|ântico\s*dos\s*(?:Tr[eê]s\s*Joven|3\s*Joven))|Song\s*of\s*(?:the\s*(?:Three\s*(?:Youth|Jew)|3\s*(?:Youth|Jew))|Three\s*(?:Youth|Jew)|3\s*(?:Youth|Jew))|3\s*J[oó]vene)s|(?:Молитва\s*святых\s*тре|Песнь\s*тр[её])х\s*отроков|П(?:есента\s*на\s*тримата\s*младежи|\.?\s*Мл)|(?:(?:C[aâ]ntarea\s*celor\s*trei\s*t|3\s*t)iner|Cantico\s*dei\s*tre\s*fanciull|C[aâ]ntarea\s*celor\s*trei\s*evre|Gesang\s*der\s*Dre|Trei\s*tiner)i|Kolmen\s*(?:miehen(?:\s*kiitosvirsi)?|nuoren\s*miehen)|Canto\s*de\s*los\s*(?:Tres|3)\s*J[oó]venes|Himno\s*de\s*los\s*(?:Tres\s*J[oó]venes|3\s*J[oó]venes)|Awit\s*ng\s*Tatlong\s*Kabataan|H(?:[aá]rom\s*fiatalember\s*[eé]neke|ymnus\s*trium\s*puerorum)|שירת\s*שלושת\s*הנערים\s*בכבשן|Wimbo\s*wa\s*Vijana\s*Watatu|[ΎΥ]μνος\s*των\s*Τρι[ωώ]ν\s*Πα[ίι]δων|أنشودة\s*الأطفال\s*الثلاثة|இளைஞர்\s*மூவரின்\s*பாடல்|Der\s*Gesang\s*der\s*Drei|Пісня\s*трьох\s*отроків|S(?:\.\s*(?:of\s*(?:Th(?:ree(?:\.\s*(?:Ch|Y)|\s*(?:Ch|Y))|\.\s*(?:Ch|Y)|\s*(?:Ch|Y))|3(?:\.\s*(?:Ch|Y)|\s*(?:Ch|Y)))|Th(?:ree(?:\.\s*(?:Ch|Y)|\s*(?:Ch|Y))|\.\s*(?:Ch|Y)|\s*(?:Ch|Y))|3(?:\.\s*(?:Ch|Y)|\s*(?:Ch|Y)))|\s*(?:of\s*(?:Th(?:ree(?:\.\s*(?:Ch|Y)|\s*(?:Ch|Y))|\.\s*(?:Ch|Y)|\s*(?:Ch|Y))|3(?:\.\s*(?:Ch|Y)|\s*(?:Ch|Y)))|Th(?:ree(?:\.\s*(?:Ch|Y)|\s*(?:Ch|Y))|\.\s*(?:Ch|Y)|\s*(?:Ch|Y))|3(?:\.\s*(?:Ch|Y)|\s*(?:Ch|Y))))|《SgThree》|《SgThree|SgThree》|三(?:人の若者の賛|童兒の)歌|SgThree|C(?:t\s*3\s*(?:J[oó]|E)|3J)|Sg\s*Thr|L(?:agPuj|3J)))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Pet"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(دوم\s*پ[تط]رس\s*مقدس|(?:2-?(?:ге|а)\.\s*(?:соборне\s*послання\s*(?:св\.?\s*апостола\s*Петра|(?:апостола\s*)?Петра)|послання\s*апостола\s*Петра|послання\s*Петра|Петр(?:ово|а))|Друг(?:а\s*(?:соборне\s*послання\s*(?:св\.?\s*апостола\s*Петра|(?:апостола\s*)?Петра)|(?:послання\s*апостола\s*Петра|(?:(?:посланица\s*Петрова|Петр(?:ов[ао]|а))|послання\s*Петра)))|е\s*(?:соборне\s*послання\s*(?:св\.?\s*апостола\s*Петра|(?:апостола\s*)?Петра)|послання\s*апостола\s*Петра|послання\s*Петра|Петр(?:ово|а)))|(?:2(?:-?е\.?\s*с|\.?\s*с)|II\.?\s*с)оборне\s*послання\s*(?:св\.?\s*апостола\s*Петра|(?:апостола\s*)?Петра)|2-?(?:ге|а)\s*(?:соборне\s*послання\s*(?:св\.?\s*апостола\s*Петра|(?:апостола\s*)?Петра)|послання\s*апостола\s*Петра|послання\s*Петра|Петр(?:ово|а))|(?:Второ\s*съборно\s*послание\s*на\s*св\.?\s*ап\.|2(?:-?е\.?\s*послание|(?:-?я|[ея])\.?\s*послание))\s*Петра|Второ\s*съборно\s*послание\s*на\s*св\.?\s*ап\s*Петра|P(?:eturu\s*E[lḻ]utiya\s*Ira[nṇ][tṭ][aā]vatu\s*Nirupam|ēturu\s*E[lḻ]utiya\s*Ira[nṇ][tṭ][aā]vatu\s*Nirupam)|பேதுரு\s*(?:எழுதிய\s*இரண்டா(?:ம்\s*(?:திருமுக|கடித)|வது\s*நிருப)ம்|இரண்டாம்\s*திருமுகம்)|Втор(?:(?:(?:а\s*послание\s*на\s*апостол\s*Пета|а\s*Пет[аъ])|а\s*писмо\s*од\s*апостол\s*Пета)р|о\s*(?:п(?:ослание\s*на\s*(?:апостол\s*Пета|Петъ)|исмо\s*од\s*апостол\s*Пета)р|Пет[аъ]р))|(?:Dru(?:he\s*poslannja\s*apostola\s*Pe|g(?:a\s*List\s*(?:[sś]w\.?\s*Pio|Pio)|i\s*List\s*(?:[sś]w\.?\s*Pio|Pio)))|(?:II\.?\s*L|2\.?\s*L)ist\s*(?:[sś]w\.?\s*Pio|Pio))tra|(?:II\.?\s*послание\s*н|2\.?\s*послание\s*н)а\s*апостол\s*Петар|(?:2(?:-?е\.?\s*посланн|\.?\s*посланн)|II\.?\s*посланн)я\s*апостола\s*Петра|א(?:גרתו\s*השנייה\s*של\s*פטרוס\s*השליח|יגרת\s*פטרוס\s*השנייה)|(?:S(?:[ií]ðara\s*almenna\s*br[eé]f\s*P[eé]tur|econdPetro)|Do(?:vom(?:\s*[Pp]at(?:ari|ru)|P(?:atari|(?:etr[aou]|atr[ou]))|pat(?:ari|ru))|\s*?pat(?:ari|ru)|P(?:atr[ao]|etr[aou]))|Tweede\s*Petru|2(?:(?:(?:\.\s*Patara|\s*(?:Patar[ai]|patra))|\s*Patru)|Pat(?:ari|ru))|(?:II\.?\s*Butr|2\.?\s*Butr)o|(?:2(?:e\.?\s*Pe|p)|۲p)tru|2ndPetro|DoPtru)s|(?:II\.?\s*пи|2\.?\s*пи)смо\s*од\s*апостол\s*Петар|(?:Second(?:(?:a\s*lettera\s*di|o)|a)\s*Pi|2°\.?\s*Pi)etro|(?:رسالة\s*القديس\s*)?بطرس\s*الثانية|(?:Druga\s*Petrova\s*[Pp]oslanic|(?:II\.?\s*Petrova\s*P|2\.?\s*Petrova\s*P)oslanic)a|p(?:a(?:ṭras\s*kā\s*dūsrā\s*ʿām\s*ḫaṭ|tr(?:usko\s*dostro\s*patra|as\s*dī\s*dūjī\s*pattrī))|etr[aā]ce[mṃ]\s*dusre\s*patra)|Waraka\s*wa\s*Pili\s*wa\s*Petro|Barua\s*ya\s*Pili\s*ya\s*Petro|प(?:(?:त्रुसको\s*दोस्(?:त्)?रो|ौलाचें\s*दुसरे)|ेत्राचें\s*दुसरे)\s*पत्र|Toinen\s*Pietarin\s*kirje|(?:(?:II\.?\s*посланиц|2\.?\s*посланиц)а\s*Петров|2(?:(?:-?е\.?\s*Петру|\.?\s*Петру)с|(?:-?я|[ея])\.?\s*Петрус))а|پطرس\s*کا\s*دوسرا\s*عام\s*خط|ପିତରଙ୍କ\s*ଦ୍ୱିତୀୟ\s*ପତ୍ର|دو(?:م(?:(?:(?:\s*پ(?:(?:ترس‌نامه‌هات|ترس‌نامه‌[شگ])ان|طرس(?:‌(?:نامه‌(?:گ(?:ی‌ها|ان)|ی‌ها|هات|شان|ا[شی])|ها)|(?:ی[-‌]|-?)ها|[ئاهى])|ترس(?:‌نامه‌ی‌|(?:ی[-‌]|-?))ها|ترس(?:‌نامه‌ا[شی]|\s*رسول)|ترس‌ها)|پتر)|\s*پطرسس(?:اه|[ئهىی]))|پطرس(?:س(?:اه|[ئهىی])|[ئاهىی]))|\s*پطر(?:س(?:س(?:اه|[ئهىی])|[ئاهىی])|ص[ئاسهىی])|م\s*?پطرص[ئاسهىی]|پطر(?:س(?:س(?:اه|[ئهىی])|[ئاهىی])|ص[ئاسهىی]))|(?:(?:2(?:-?е\.?\s*посланн|\.?\s*посланн)|II\.?\s*посланн)я\s*П|2\.?\s*послание\s*П)етра|ਪਤਰਸ\s*ਦੀ\s*ਦੂਜੀ\s*ਪੱਤ੍ਰੀ|(?:Druh(?:[aá]\s*(?:kniha\s*Petro|list\s*Petr[uů]|Petr[uů])|[yý]\s*(?:list\s*Petr[ouů]|Petr[uů]))|(?:II\.?\s*l|2\.?\s*l)ist\s*Petr[uů]|2\s*k\.\s*Petro|II\.?\s*Petrů|2\s*k\s*Petro|2\.?\s*Petrů)v|And(?:r(?:a\s*Petrusbrevet|e\s*Petersbrev)|e[nt]\s*Petersbrev)|(?:II\.?\s*Pieta|2\.?\s*Pieta)rin\s*kirje|رسالة\s*بطرس\s*الثانية|دومین\s*نامه\s*به\s*پترس|دو(?:م(?:(?:(?:(?:\s*پ(?:ترس(?:(?:(?:‌نامه(?:‌هات?)?)?|ی)|‌نامه‌ی)|طرس(?:‌نامه(?:‌(?:ها|ی))?|ی)?)|پ(?:طر?|ت))|\s*پطرسسا?)|پطرس(?:سا?)?)|\s*?پطرص)|\s*پطر(?:س(?:سا?)?|ص)|پطر(?:س(?:سا?)?|ص))|S(?:[ií]ðara\s*P[eé]tursbr[eé]f|econd\s*P(?:(?:ete|t)r|et?r))|(?:Peters\s*Andet\s*B|Pet(?:rus\s*andra|ers\s*andre)\s*b)rev|(?:Druh[yý]\s*Petrov\s*lis|2(?:(?:\s*[ei]\.?\s*Pj|\s*Pj)|\.\s*Pj)etri|dovvomp)t|Epistula\s*(?:II\s*Petri|Petri\s*II)|(?:Segund(?:o\s*(?:San\s*)?Ped|a\s*Ped)|(?:Ikalawang|2a\.)\s*Ped|2(?:\.[oº]|[oº])\.\s*(?:San\s*)?Ped|(?:II\.?\s*S|2\.?\s*S)an\s*Ped|2(?:\.[oº]|[oº])\s*(?:San\s*)?Ped|II\.?\s*Ped|2\.\s*Ped|2a\s*Ped)ro|(?:Deuxi[eè]mes?\s*Pierr|(?:2(?:(?:eme|de?)|ème)\.\s*Pier|(?:2(?:(?:eme|de?)|ème)\s*Pier|(?:(?:II\.?\s*Pier|2\.?\s*Pier)|2e\.?\s*Pier)))r)e|درس‌های\s*پ[تط]رس\s*دوم|T(?:oinen\s*Pietarin|weede\s*Petr?)|2\.?\s*Petrusbrevet|پندهای\s*پترس\s*دوم|D(?:o(?:vom(?:\s*[Pp](?:atrissi|eters)|P(?:atrissi|eters)|p(?:atrissi|eters))|\s*?p(?:atrissi|eters)|Peters)|o(?:vom(?:\s*[Pp]atras|[Pp]atras)|\s*?patras)a|ru(?:h(?:[yý]\s*P(?:etrova|t)|[aá]\s*Pt)|h[aá]\s*Petrova|g[ai]\s*Piotra)|ezy[eè]m\s*P[iy][eè])|(?:(?:رسال|نام)ه\s*دوم\s*پ[تط]|(?:پیام\s*دوم\s*|(?:(?:دوم[-۔]|2(?:\.[-۔]|۔)|۲[-۔])|2-?))پط|کتاب\s*دوم\s*پ[تط])رس|فرمان\s*دوم\s*پترس|موعظه\s*پترس\s*دوم|D(?:o(?:(?:vom(?:\s*[Pp](?:atriss?|eter)|P(?:atriss?|et(?:er)?)|p(?:atriss?|eter))|\s*?p(?:atriss?|eter)|Pet(?:er)?)|(?:vom(?:\s*[Pp]atras|[Pp]atras)|\s*?patras))|ru(?:g(?:a\s*P(?:etrova|iotr)|i\s*Piotr)|h(?:(?:[yý]\s*P(?:etr(?:ov)?)?|[aá]\s*P(?:etr)?)|[aá]\s*Petrov)))|2\.?\s*Petersbrev|M[aá]sodik\s*P[eé]ter|Butros\s*Labaad|dovvom\s*petrus|Zweite\s*Petrus|(?:Втор[ао]\s*Петро|2-?е\.?\s*Петро)во|پیام\s*پترس\s*دوم|ଦ୍ୱିତୀୟ\s*ପିତରଙ|And(?:re\s*Pet(?:ers?)?|en\s*Pet(?:er)?)|(?:II\.?\s*Pieta|2\.?\s*Pieta)rin|II(?:\.\s*(?:P(?:h(?:(?:i(?:-?e|a)-?|i-?)rơ|ê(?:-?rơ|rô))|e(?:tr(?:u[sv]|i)|r)|iè)|Петра)|\s*(?:P(?:h(?:(?:i(?:-?e|a)-?|i-?)rơ|ê(?:-?rơ|rô))|e(?:tr(?:u[sv]|i)|r)|iè)|Петра))|رسالة\s*بطرس\s*2|השנייה\s*פטרוס|II(?:\.\s*(?:P(?:e(?:t(?:r(?:o(?:va?)?|u)?)?)?|hia|ie|ét)?|Петр?|But)|\s*(?:P(?:e(?:t(?:r(?:o(?:va?)?|u)?)?)?|hia|ie|ét)?|Петр?|But))|Second\s*P(?:ete|et?|t)?|M[aá]sodik\s*P[eé]t|2(?:(?:\s*(?:(?:(?:(?:(?:पेत्राचें|petr[aā]ce[mṃ]|P(?:eturu|ēturu|er|iè|d)|பேதுரு|ਪਤਰਸ|ปต)|Petr(?:uv|i))|Петра)|पत(?:्रुसको|रस))|เปโตร)|\.\s*(?:पत(?:्रुसको|रस)|Pe(?:tr(?:uv|i)|r)|Петра|เปโตร|پطرس)|-?е\.?\s*Петра|(?:-?я|[ея])\.?\s*Петра|베드)|\.\s*Piè)|2\.?\s*Ph(?:(?:i(?:-?e|a)-?|i-?)rơ|ê(?:-?rơ|rô))|(?:SecondPete|II\.?\s*Péte|2\.?\s*Péte|DovomPt|2ndPete)r|(?:II\.?\s*Петро|2\.?\s*Петро)в[ао]|2(?:-?е\.?\s*Пети|(?:-?я|[ея])\.?\s*Пети|\.?\s*Пети)ра|(?:2(?:(?:\.\s*patrusk|\s*(?:patrusk|Pietr))|\.\s*Pietr)|II\.?\s*Pietr|Pili\s*Petr|2\s*Pedr)o|2\s*இராயப்பர்|2\.?\s*Petro(?:va?)?|Втор(?:а\s*Петр?|о\s*Петр?)|2\s*Patrissi|(?:II\.?\s*Pio|2\.?\s*Pio)tra|2nd\.?\s*P(?:(?:ete|t)r|et?r)|(?:II\.?\s*Pétr|2\.?\s*Pétr)us|베드로(?:의\s*둘째\s*서간|[2후]서)|دومین\s*پترس|2(?:\.\s*(?:P(?:e(?:t(?:r(?:us?)?|e)?)?)?|पत(?:्रुस|र)|Петр?)|\s*Petr(?:us?)?|\s*पत(?:्रुस|र)|\s*(?:पेत्र|P(?:i(?:et?)?|et?|je?)?|பேது)|\s*Pete|\s*Петр?|Pet|پ)|2\s*Patriss?|(?:II\.?\s*Pio|2\.?\s*Pio)tr|2nd\.?\s*P(?:ete|et?|t)?|2\.?\s*Peters?|2Patrissi|2\s*?Patrasa|(?:II(?:\.\s*P(?:ete|t)|\s*P(?:ete|t))|2\.?\s*Pt)r|Β['ʹʹ΄’]\s*Π[έε]τρου|(?:(?:[2۲]\s*|۲)|2)پطرس(?:س(?:اه|[ئهىی])|[ئاهىی])|[ヘペ](?:トロ(?:の第二の手紙|(?:の手紙二|\s*2))|テロの(?:第二の手紙|後の書|手紙Ⅱ))|Π[έε]τρου\s*Β['ʹʹ΄’]|(?:II(?:\.\s*Пет[аъ]|\s*Пет[аъ])|2(?:\.\s*Пет[аъ]|\s*Пет[аъ]))р|(?:دوم|(?:2\.?|۲))\s*پطر\s*س|2Patriss?|2\s*?Patras|Pili\s*Pet|II(?:\.\s*P(?:ete|t)|\s*P(?:ete|t))|(?:2(?:e\.?\s*Pe|p)|۲p)tr?|(?:(?:[2۲]\s*|۲)|2)پطرس(?:سا?)?|Petr[io]\s*II|2\.?\s*ପିତରଙ|2\.?\s*Phia|Β['ʹʹ΄’]\s*Π[έε](?:τρ?)?|2Peters|(?:II\.?\s*Py|2\.?\s*Py)[eè]|(?:(?:[2۲]\s*|۲)|2)پطرص[ئاسهىی]|《?伯多祿後書》|2\.\s*Pie|2\.?\s*Pét|2\.?\s*But|2Peter|(?:(?:[2۲]\s*|۲)|2)پطرص|《?伯多祿後書|(?:《彼(?:得后书|[后後])|《?撇特爾後|彼(?:得后书|[后後]))》|《?彼得後書》|2\s*Ped|2\.?\s*Pt|DoPtr|《彼(?:得后书|[后後])|《?撇特爾後|《?彼得後書|Ⅱ\s*[ヘペ]テロ|۲پطر|2پطر?|彼(?:得后书|[后後])|[2۲]پتر|二[ヘペ]トロ|2\s*?بط|[2۲]پت|۲پ|벧후))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Pet"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(اول\s*پ(?:ترس\s*(?:رسول|مقدس)|طرس\s*مقدس)|(?:1-?(?:ше|а)\.\s*(?:соборне\s*послання\s*(?:св\.?\s*апостола\s*Петра|(?:апостола\s*)?Петра)|послання\s*апостола\s*Петра|послання\s*Петра|Петр(?:ово|а))|П(?:ерш[ае]\s*(?:соборне\s*послання\s*(?:св\.?\s*апостола\s*Петра|(?:апостола\s*)?Петра)|послання\s*апостола\s*Петра|послання\s*Петра|Петр(?:ово|а))|ърво\s*съборно\s*послание\s*на\s*св\.?\s*ап\.\s*Петра|ърво\s*съборно\s*послание\s*на\s*св\.?\s*ап\s*Петра|рв(?:а\s*(?:послание\s*на\s*апостол\s*Петар|(?:писмо\s*од\s*апостол\s*Петар|Пет(?:ров[ао]|ар)))|о\s*(?:п(?:ослание\s*на|исмо\s*од)\s*апостол\s*Петар|Петар))|ърв(?:о\s*(?:послание\s*на\s*)?Петъ|а\s*Петъ)р|рва\s*посланица\s*Петрова|(?:ърв[ао]\s*Петро|рво\s*Петро)во)|(?:1(?:-?е\.?\s*с|\.?\s*с)|I\.?\s*с)оборне\s*послання\s*(?:св\.?\s*апостола\s*Петра|(?:апостола\s*)?Петра)|1-?(?:ше|а)\s*(?:соборне\s*послання\s*(?:св\.?\s*апостола\s*Петра|(?:апостола\s*)?Петра)|послання\s*апостола\s*Петра|послання\s*Петра|Петр(?:ово|а))|P(?:eturu\s*E[lḻ]utiya\s*Mutal[aā]vatu\s*Nirupam|ēturu\s*E[lḻ]utiya\s*Mutal[aā]vatu\s*Nirupam|r(?:emye\s*P[iy][eè]|vn[ií]\s*Pt))|(?:P(?:er[sš]e\s*poslannja\s*apostola\s*Pe|ierwsz[aey]\s*List\s*(?:[sś]w\.?\s*Pio|Pio))|(?:1\.?\s*L|I\.?\s*L)ist\s*(?:[sś]w\.?\s*Pio|Pio))tra|பேதுரு\s*(?:எழுதிய\s*முதல(?:ா(?:வது\s*நிருப|ம்\s*கடித)|்\s*திருமுக)ம்|முதல்\s*திருமுகம்)|1\.?\s*послание\s*на\s*апостол\s*Петар|I\.?\s*послание\s*на\s*апостол\s*Петар|(?:1(?:-?е\.?\s*посланн|\.?\s*посланн)|I\.?\s*посланн)я\s*апостола\s*Петра|א(?:גרתו\s*הראשונה\s*של\s*פטרוס\s*השליח|יגרת\s*פטרוס\s*הראשונה)|אגרתו\s*הראשונה\s*של\s*פטרוס\s*השלי|E(?:nsimm[aä]inen\s*Pietarin\s*kirje|pistula\s*(?:I\s*Petri|Petri\s*I)|erste\s*Petrus|rste\s*Petrus|ls[oő]\s*P[eé]ter)|(?:Fyrra\s*almenna\s*br[eé]f\s*P[eé]tur|Avval(?:\s*[Pp]at(?:ari|ru)|P(?:atari|(?:etru|atr[ou]))|pat(?:ari|ru))|Yek\s*?pat(?:ari|ru)|1(?:(?:\.\s*Patara|\s*(?:Patar[ai]|patra))|stPetro)|1e\.\s*Petru|1\.?\s*Butro|I\.?\s*Butro|YekPetr[ou]|1e\s*Petru|1\s*Patru|1Pat(?:ari|ru)|[1۱]ptru)s|(?:1\.?\s*пи|I\.?\s*пи)смо\s*од\s*апостол\s*Петар|Waraka\s*wa\s*Kwanza\s*wa\s*Petro|رسالة\s*(?:القديس\s*بطرس\s*الأولى|بطرس\s*(?:الأولى|1))|Barua\s*ya\s*Kwanza\s*ya\s*Petro|p(?:a(?:(?:tras\s*dī\s*pahilī\s*pattrī|ṭras\s*kā\s*pahlā\s*ʿām\s*ḫaṭ)|trusko\s*pahilo\s*patra)|etr[aā]ce[mṃ]\s*pahile\s*patra)|(?:Prim(?:(?:a\s*lettera\s*di|o)|a)\s*Pi|1°\.?\s*Pi)etro|(?:Prv(?:a\s*Petrova\s*[Pp]oslanic|n[ií]\s*Petrov)|(?:1\.?\s*Petrova\s*P|I\.?\s*Petrova\s*P)oslanic)a|E(?:nsimm[aä]inen\s*Pietarin|erste\s*Petr?|ls[oő]\s*P[eé]t)|(?:1\.?\s*посланица\s*Петров|I\.?\s*посланица\s*Петров|1(?:(?:-?е\.?\s*Петру|\.?\s*Петру)с|(?:-?я|[ея])\.?\s*Петрус))а|پطر(?:\s*س\s*کاپہلا\s*عا\s*|س\s*کا\s*پہلا\s*عا)م\s*خط|प(?:ेत्राचें?\s*पहिले\s*पत्र|त्रुसको\s*पहिलो\s*पत्र)|ਪਤਰਸ\s*ਦੀ\s*ਪਹਿਲੀ\s*ਪੱਤ੍ਰੀ|(?:F[oö]rsta\s*Petrusbreve|Prv[yý]\s*Petrov\s*lis|1\.?\s*Petrusbreve|1(?:(?:\s*[ei]\.?\s*Pj|\s*Pj)|\.\s*Pj)etri)t|او(?:ل(?:\s*پ(?:(?:ترس‌نامه‌هات|ترس‌نامه‌[شگ])ان|طرس(?:‌(?:نامه‌(?:گ(?:ی‌ها|ان)|ی‌ها|هات|شان|ا[شی])|ها)|(?:ی[-‌]|-?)ها|[ئاهى])|ترس(?:‌نامه‌ی‌|(?:ی[-‌]|-?))ها|ترس‌نامه‌ا[شی]|ترس‌ها)|پتر)|ّل\s*پطرس)|(?:(?:1(?:-?е\.?\s*посланн|\.?\s*посланн)|I\.?\s*посланн)я\s*П|1\.?\s*послание\s*П)етра|1(?:-?е\.?\s*послание|(?:-?я|[ея])\.?\s*послание)\s*Петра|Pet(?:ers\s*(?:(?:Første|1\.?)\s*B|første\s*b)|rus\s*f[oö]rsta\s*b)rev|اولین\s*نامه\s*به\s*پترس|ପ(?:ିତରଙ୍କ\s*ପ୍ରଥମ\s*ପତ୍ର|୍ରଥମ\s*ପିତରଙ)|اول(?:\s*پ(?:ترس(?:(?:(?:‌نامه(?:‌هات?)?)?|ی)|‌نامه‌ی)|طرس(?:‌نامه(?:‌(?:ها|ی))?|ی)?)|پ(?:طر?|ت))|(?:Prv(?:n[ií]\s*(?:list\s*Petr[uů]|Petr[uů])|[aá]\s*kniha\s*Petro|[yý]\s*list\s*Petro|á\s*Petro)|(?:1\.?\s*l|I\.?\s*l)ist\s*Petr[uů]|1\s*k\.\s*Petro|1\s*k\s*Petro|1\.?\s*Petrů|I\.?\s*Petrů)v|F(?:ørste\s*Petersbrev|yrra\s*P[eé]tursbr[eé]f|irst\s*P(?:(?:ete|t)r|et?r))|(?:1\.?\s*Pieta|I\.?\s*Pieta)rin\s*kirje|(?:(?:Prime(?:ro?\s*San|ir[ao])|1(?:\.[oº]|[oº])\.\s*San|1(?:\.[oº]|[oº])\s*San|(?:1\.?\s*S|I\.?\s*S)an|1a\.)\s*Ped|(?:Primero?\s*P|(?:1(?:\.[oº]|[oº])\.\s*|1(?:\.[oº]|[oº])\s*)P)ed|Una(?:ng)?\s*Ped|1\.\s*Ped|I\.?\s*Ped|1a\s*Ped)ro|(?:Premi(?:eres?\s*Pierr|ères?\s*Pierr|ers?\s*Pierr)|(?:1(?:(?:ere?|re)|ère)\.\s*Pier|(?:1(?:(?:ere?|re)|ère)\s*Pier|(?:1\.?\s*Pier|I\.?\s*Pier)))r)e|درس‌های\s*پ[تط]رس\s*اول|(?:Pierwsz[aey]\s*Piotr|(?:1\.?\s*Pio|I\.?\s*Pio)tr)a|(?:پ(?:ندهای|یام)|موعظه)\s*پترس\s*اول|Pierwsz[aey]\s*Piotr|Avval(?:\s*[Pp](?:atr(?:issi|asa)|eters)|Patrissi|p(?:atr(?:issi|asa)|eters)|P(?:atrasa|eters)|Petr[ao]si)|(?:(?:رسال|نام)ه\s*اول\s*پ[تط]|(?:پیام\s*اول\s*|(?:(?:اوّل[-۔]|1(?:\.[-۔]|۔)|۱[-۔])|1-?))پط|کتاب\s*اول\s*پ[تط])رس|فرمان\s*اول\s*پترس|F(?:ørste\s*Pet(?:ers?)?|irst\s*P(?:ete|et?|t)?)|Avval(?:\s*[Pp](?:atr(?:iss?|as)|eter)|P(?:atriss?|(?:(?:atras|et(?:er)?)|etr[ao]s))|p(?:atr(?:iss?|as)|eter))|1\.?\s*Petersbrev|Butros\s*Kowaad|הראשונה\s*פטרוס|P(?:rv(?:a\s*Petrova?|[yý]\s*Petrov|n[ií]\s*P(?:etr)?)|eter)|Yek\s*?p(?:atr(?:issi|asa)|eters)|avval\s*petrus|1-?е\.?\s*Петрово|(?:Kwanza\s*Petr|1(?:(?:\.\s*patrusk|\s*(?:patrusk|Pietr))|\.\s*Pietr)|I\.?\s*Pietr|1\s*Pedr)o|Yek\s*?p(?:atr(?:iss?|as)|eter)|(?:1\.?\s*Pieta|I\.?\s*Pieta)rin|1(?:(?:\s*(?:(?:(?:(?:(?:पेत्राचें|petr[aā]ce[mṃ]|P(?:eturu|ēturu|er|iè|d)|பேதுரு|ਪਤਰਸ|ปต)|Petr(?:uv|i))|Петра)|पत(?:्रुसको|रस))|เปโตร)|\.\s*(?:पत(?:्रुसको|रस)|Pe(?:tr(?:uv|i)|r)|Петра|เปโตร)|-?е\.?\s*Петра|(?:-?я|[ея])\.?\s*Петра|베드)|\.\s*Piè)|1\.?\s*Ph(?:(?:i(?:-?e|a)-?|i-?)rơ|ê(?:-?rơ|rô))|I(?:\.\s*(?:P(?:h(?:(?:i(?:-?e|a)-?|i-?)rơ|ê(?:-?rơ|rô))|e(?:tr(?:u[sv]|i)|r)|iè)|Петра)|\s*(?:P(?:h(?:(?:i(?:-?e|a)-?|i-?)rơ|ê(?:-?rơ|rô))|e(?:tr(?:u[sv]|i)|r)|iè)|Петра))|اول\s*پطرسس(?:اه|[ئهىی])|1(?:-?е\.?\s*Пети|(?:-?я|[ея])\.?\s*Пети|\.?\s*Пети)ра|بطرس\s*الأولى|1\s*இராயப்பர்|1\.?\s*Petro(?:va?)?|I(?:\.\s*(?:P(?:e(?:t(?:r(?:o(?:va?)?|u)?)?)?|hia|ie|ét)?|Петр?|But)|\s*(?:P(?:e(?:t(?:r(?:o(?:va?)?|u)?)?)?|hia|ie|ét)?|Петр?|But))|Kwanza\s*Pet|اول\s*پطرسسا?|Първ(?:а\s*Петр?|о\s*Петр?)|1st\.\s*P(?:(?:ete|t)r|et?r)|YekPetrasi|1\s*Patr(?:issi|asa)|(?:اول|(?:(?:[1۱]\s*|۱)|1))پطرس(?:س(?:اه|[ئهىی])|[ئاهىی])|یک(?:\s*پطر(?:س(?:س(?:اه|[ئهىی])|[ئاهىی])|ص[ئاسهىی])|پطر(?:س(?:س(?:اه|[ئهىی])|[ئاهىی])|ص[ئاسهىی]))|베드로(?:의\s*첫째\s*서간|[1전]서)|(?:1\.?\s*Петро|I\.?\s*Петро)в[ао]|(?:اوّل|(?:1\.|[1۱]))\s*پطر\s*س|اولین\s*پترس|1(?:\.\s*(?:P(?:e(?:t(?:r(?:us?)?|e)?)?)?|पत(?:्रुस|र)|Петр?)|\s*Petr(?:us?)?|\s*पत(?:्रुस|र)|\s*(?:पेत्र|P(?:i(?:et?)?|et?|je?)?|பேது)|\s*Pete|\s*Петр?|Pet|پ)|1st\.\s*P(?:ete|et?|t)?|1\.?\s*Peters?|YekPetras|1\s*Patr(?:iss?|as)|(?:اول|(?:(?:[1۱]\s*|۱)|1))پطرس(?:سا?)?|یک(?:\s*پطر(?:س(?:سا?)?|ص)|پطر(?:س(?:سا?)?|ص))|1st\s*P(?:(?:ete|t)r|et?r)|(?:Yek|1)Peters|1Patr(?:issi|asa)|(?:1\.?\s*Pétr|I\.?\s*Pétr)us|Α['ʹʹ΄’]\s*Π[έε]τρου|[ヘペ](?:トロ(?:の第一の手紙|(?:の手紙一|\s*1))|テロの(?:第一の手紙|前の書|手紙Ⅰ))|(?:اول\s*?پطرص|(?:(?:[1۱]\s*|۱)|1)پطرص)[ئاسهىی]|Π[έε]τρου\s*Α['ʹʹ΄’]|1st\s*P(?:ete|et?|t)?|(?:Yek|1)Peter|(?:1\.?\s*Pio|I\.?\s*Pio)tr|1Patr(?:iss?|as)|1e\.\s*Petr?|اول\s*?پطرص|(?:I(?:\.\s*P(?:ete|t)|\s*P(?:ete|t))|1\.?\s*Pt)r|(?:(?:1stPe|1\.?\s*Pé)te|I\.?\s*Péte|AvvalPt|YekPt)r|(?:1(?:\.\s*Пет[аъ]|\s*Пет[аъ])|I(?:\.\s*Пет[аъ]|\s*Пет[аъ]))р|1\.?\s*ପିତରଙ|1\.?\s*Phia|I(?:\.\s*P(?:ete|t)|\s*P(?:ete|t))|1e\s*Petr?|Α['ʹʹ΄’]\s*Π[έε](?:τρ?)?|avvalpt|Petr[io]\s*I|1\.\s*پطرس|《?伯多祿前書》|1\.\s*Pie|1\.?\s*Pét|1\.?\s*But|YekPet|(?:(?:[1۱]\s*|۱)|1)پطرص|《?伯多祿前書|(?:1\.?\s*Py|I\.?\s*Py)[eè]|(?:《彼(?:得前[书書]|前)|《?撇特爾前|彼(?:得前[书書]|前))》|1\.?\s*Pt|1\s*Ped|《彼(?:得前[书書]|前)|《?撇特爾前|Ⅰ\s*[ヘペ]テロ|[1۱]ptr?|۱پطر|1پطر?|彼(?:得前[书書]|前)|[1۱]پتر|一[ヘペ]トロ|1\s*?بط|[1۱]پت|۱پ|벧전))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Rom"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:П(?:исмо\s*од\s*апостол\s*Павле\s*до\s*христијаните\s*во\s*Рим|ослан(?:(?:ня\s*(?:св\.?\s*апостола\s*Павла\s*до\s*римлян|(?:апостола\s*Павла\s*)?до\s*римлян)|и(?:е\s*(?:на\s*св(?:\.\s*ап\.?\s*Павла\s*до\s*Римляни|\s*ап\.?\s*Павла\s*до\s*Римляни)|към\s*римляните)|ца\s*Римљанима))|ие\s*к\s*Римлянам))|P(?:oslan(?:nja\s*apostola\s*Pavla\s*do\s*rymljan|ica\s*Rimljanima)|a(?:vlova\s*poslanica\s*Rimljanima|ulus(?:'\s*Brev\s*til\s*Romerne|’\s*(?:Brev\s*til\s*R|brev\s*til\s*r)omerne)))|رسالة\s*بولس\s*الرسول\s*إلى\s*أهل\s*رومية|ரோம(?:ாபுரியாருக்கு\s*எழுதிய\s*கடிதம|ர)்|ر(?:وم(?:ی(?:و(?:ں\s*کے\s*نام\s*(?:پولس\s*رسول\s*)?کا\s*خط|ن(?:ی?ان|ها|ن))|ان(?:ی?ان|ها|ن))|ي(?:ان[هی]|ون[هی]))|سالة\s*روما|ُومِیوں)|உரோம(?:ையருக்கு\s*எழுதிய\s*திருமுக|ருக்கு\s*எழுதிய\s*நிருப)ம்|א(?:גרת\s*פולוס\s*השליח\s*אל-?הרומי|ל\s*הרומא)ים|Ur[oō]marukku\s*E[lḻ]utiya\s*Nirupam|(?:List\s*(?:[sś]w\.?\s*Pawła\s*do\s*Rzymi|do\s*Rzymi)|R(?:oomiy|o(?:ome|my)|zymi|umiy))an|(?:Br[eé]f\s*P[aá]ls\s*til\s*R[oó]mverj|rom(?:īhar[uū]l[aā][iī]\s*patr|ihar[uū]l[aā][iī]\s*patr|kar[aā][mṃ]s\s*patr)|Rôm)a|रोमीहरूलाई\s*पावलको\s*पत्र|r(?:ōmiyōṅ\s*ke\s*nām\s*kā\s*ḫaṭ|omīāṃ\s*nū̃\s*pattrī|ūm(?:iān)?ī)|الرسالة\s*إلى\s*أهل\s*رومية|पौलाचे\s*रोमकरांस\s*पत्र|Epistula\s*ad\s*Romanos|Sulat\s*sa\s*mga\s*Romano|(?:Kirje\s*roomalaisill|Ro(?:(?:omalaiskirj|m(?:ak[eë]v|ern))|omalaisill))e|ରୋମୀୟଙ୍କ\s*ପ୍ରତି\s*ପତ୍ର|(?:(?:(?:Layang\s*Paulus\s*|Taga-?\s*)R|Mga\s*Taga(?:-?\s*?R|\s*R))o|War(?:aka\s*kwa\s*War)?o|Barua\s*kwa\s*Waro|Rô-?)ma|Lettera\s*ai\s*Romani|War(?:aka\s*kwa\s*War)?umi|ਰੋਮੀਆਂ\s*ਨੂੰ\s*ਪੱਤ੍ਰੀ|האיגרת\s*אל\s*הרומאים|रोमीहरूलाई\s*पत्र|R(?:omverjabr[eé]fið|óm(?:verjabr[eé]fið|aiakhoz)|o(?:m(?:e(?:inenbrief|rbrevet|n)|arbrevet|an(?:os|[is])|s)|s)|omaiakhoz|oemer|ömer|mn?s)|로마(?:\s*신자들에게\s*보낸\s*서간|서)|Προς\s*Ρωμα[ίι]ους|रोमकरांस\s*पत्र|(?:List\s*(?:R(?:iman[ouů]|íman[uů])|Ř[ií]man[uů])|R(?:(?:imsky|ímsky|ò)|iman[ouů])|(?:Ríma|Ř[ií]ma)n[uů])m|r(?:om(?:īhar[uū]l[aā][iī]|ihar[uū]l[aā][iī]|kar[aā][mṃ]s|īāṃ)|ūm(?:iān)?)|Ur[oō]marukku|रोम(?:ी(?:हरूलाई)?|करांस|ियो)|ਰੋਮੀਆਂ(?:\s*ਨੂੰ)?|ロ(?:ーマ(?:の信徒への手紙|人への手紙|書)|マ人への書)|ad\s*Romanos|Rimljanima|אל\s*הרומיים|(?:К\s*)?Римлянам|אל\s*הרומים|До\s*римлян|Римјаните|римляните|Римљанима|R(?:o(?:m(?:e(?:inen|r)|a(?:no?)?)?|oma?)?|z(?:ym)?|óma?|mn?|im|um|ím|öm)|ରୋମୀୟଙ୍କ|உரோமையர்|रोम(?:कंरास|ियों)|Ρωμα[ίι]ους|رو(?:م(?:ی(?:ان(?:ه|ی)?|و(?:ن(?:ه|ی)?|ں))?|يان)?)?|Рим(?:јани|л(?:ян)?)?|Римляни|R(?:o(?:ma(?:nd|in)|amn)|pman)s|R(?:o(?:m(?:i(?:yo|[au])|as)|omi[au])|umi[au])n|《(?:羅(?:爾瑪書|(?:馬書)?)》|罗(?:马书)?》)|《(?:羅(?:爾瑪書|馬書)?|罗(?:马书)?)|ローマ(?:人へ)?|La-?mã|羅(?:爾瑪書|(?:馬書)?)》|ﺭﻭﻣﻴﺔ|羅(?:爾瑪書|馬書)?|罗马书》|Ř(?:[ií]m)?|Ρωμ|罗马书|உரோ|῾Ρω|โรม|로마|罗》|รม|罗|롬))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Song"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:Песнь\s*Сул(?:а[ий]мона|е[ий]мана)|Tình\s*ca|Kid\s*Ag)|(?:Книга\s*П(?:есен\s*на\s*Песните,\s*от|існі\s*Пісень)\s*Соломона|Пісня\s*над\s*піснями\s*Соломона|E(?:l\s*Cantar\s*de\s*los\s*Cantares|nekek\s*[eé]neke)|சாலொமோனின்\s*உன்னதப்பாட்டு|Cantare?\s*de\s*los\s*Cantares|Cantique\s*des\s*[Cc]antiques|T(?:he\s*Song(?:s\s*of\s*S(?:o(?:lom[ao]ns|ngs)|alom[ao]ns)|\s*of\s*S(?:o(?:lom[ao]ns|ngs)|alom[ao]ns))|ình)|(?:(?:Syirul-?asyar\s*Sulaim|H(?:oga\s*vis|öga\s*[Vv]is))a|C(?:[aâ]ntarea\s*lui\s*So|hante\s*Sa)lomo|Gabaygii\s*Sulaymaa|Lj[oó]ðalj[oó]ði|Hø[jy]sange)n|(?:C(?:anticos?\s*dos\s*C[aâ]ntic|ântico(?:s\s*dos\s*C[aâ]ntic|\s*dos\s*C[aâ]ntic))o|Ho(?:he(?:lied\s*Salomoni|slied\s*Salomo)|j))s|Песнь\s*песне[ий]\s*Соломона|The\s*Song(?:s\s*of\s*S(?:o(?:lom[ao]n|ng)|alom[ao]n)|\s*of\s*S(?:o(?:lom[ao]n|ng)|alom[ao]n))|(?:Ghaz(?:al(?:\s*Ghazal-?(?:Ha-?Ha|h)|(?:\s*Ghazal[\s*’]|Ghazal[\s*-])h|-?Ghazal(?:[-’])?h|GhazalHa)|l[\s*-]Ghazal-?h|l(?:Ghazal-?[Hh]|-?Ghazalh))|Ve[lľ]piese[nň]\s*[SŠ]alam[uú]nov|P(?:jesma\s*nad\s*pjesmam|i\s*bèl\s*Chante\s*)|P(?:ise[nň]\s*[SŠ]alamou|íse[nň]\s*[SŠ]alamou)nov|Piese[nň]\s*[SŠ]alam[uú]nov|Wimbo\s*(?:Ulio\s*)?Bor|Pie(?:s[nń]\s*Salomo|ś[nń]\s*Salomo)n|g[iī]tratn)a|(?:s(?:ulem[aā]nko\s*[sš]re[sṣ][tṭ]ʰag[iī]|alemān\s*dā\s*gī)|A(?:ng\s*Awit\s*ng|wit\s*(?:sa|ng))\s*mga\s*Awi|Reshthagee|Cn)t|स(?:ुलेमानको\s*श्रेष्ठ|्रेस्ट\s*)गीत|C(?:ant(?:i(?:cum\s*[Cc]anticorum|ques)|\.\s*Cantic|\s*Cantic|ari)|antarea\s*cantarilor|antarea\s*C[aâ]nt[aă]rilor|ântar(?:ea\s*C[aâ]nt[aă]rilor|i)|t)|C(?:ant(?:ico\s*dei\s*[Cc]antic|ăr)|ântăr)i|P(?:i(?:snja\s*nad\s*pisnjamy|e(?:s[nń]\s*nad\s*Pie[sś]niami|ś[nń]\s*nad\s*Pie[sś]niami))|iese[nň]\s*piesn[ií]|ise[nň]\s*p[ií]sn[ií]|íse[nň]\s*p[ií]sn[ií]|NP|Š)|C(?:ant(?:(?:ares\s*de\s*Salom[aã]|ico\s*de\s*Salom[aã])|ico\s*Superlativ)|ântico\s*(?:Superlativ|de\s*Salom[aã]))o|غ(?:(?:زل(?:\s*غزل‌ها‌ها‌ها‌|\s*غزل(?:‌ها(?:‌ها)?-?|\s*ها[-‌]|ۀ\s*|-?)|غ(?:زل-?ها‌|\s*غزل[-‌])|غزل‌ها‌|‌(?:ها(?:‌ها‌|-?)|غزل‌)|ۀ\s*غزلۀ[\s*-‌]|-?غزل‌|ـغزل[ـ‌]|ها‌|ه‌)|-?)ها|زل(?:\s*(?:غزل(?:ــ?هاا|\s*?هاا|‌هاا)|سلیمان)|ُ\s*الغزلات|(?:غزل(?:ــ|\s*)|غزل-?)هاا|\s*الغزلات|یات)|زل(?:\s*غزل‌هاه|غ(?:\s*غ)?زله|ۀ\s*غزله|‌هاه|-?ه)ا)|П(?:ес(?:на(?:та)?\s*над\s*песните|(?:(?:ната\s*на\s*Соломо|\s*на\s*пес)|\.\s*на\s*пес)н|ен\s*на\s*песните)|есни\s*Песне[ий]|існ(?:я\s*Пісне[ий]|і\s*Пісень)|\.?\s*П|нп)|A(?:ng\s*Awit\s*ni\s*S[ao]lom[oó]n|wit\s*ni\s*S[ao]lom[oó]n|\.?\s*ng\s*A|w\s*ni\s*S)|(?:Cantico\s*di\s*Salomon|Kantiku\s*i\s*Kantik[eë]v)e|Musthikaning\s*Kidung|П(?:існ(?:я\s*над\s*піснями)?|ес(?:нь?)?)|Ghaz(?:al(?:\s*Ghazalha|Ghazalh)aa|l(?:\s*Ghazalha|Ghazalh)aa)|Songs\s*of\s*S(?:o(?:lom[ao]ns|ngs)|alom[ao]ns)|Песма\s*(?:над\s*песмам|Соломонов)а|G(?:haz(?:al(?:\s*Ghazalhaa?|Ghazalha)|l(?:\s*Ghazalhaa?|Ghazalha))|ab(?:aygii)?)|غز(?:ل(?:\s*غزل‌ها‌ها‌ها|\s*(?:غزل(?:‌ها(?:‌ها)?|ــ?ها|\s*?ها)|س(?:لی)?)|غزل(?:ــ|\s*)ها|غ(?:زل(?:-?ها)?)?|‌ها(?:‌ها)?|ها|ی))?|Songs\s*of\s*S(?:o(?:lom[ao]n|ng)|alom[ao]n)|K(?:anti(?:d\s*de\s*Kantik|k(?:ul)?o)|idA)|Song\s*of\s*S(?:o(?:lom[ao]ns|ngs)|alom[ao]ns)|Salomo(?:ns\s*Høj|s\s*(?:Høi|høy))sang|ġazalu\s*l-?ġazalāt|سفر\s*نشيد\s*الأنشاد|Song\s*of\s*S(?:o(?:lom[ao]n|ng)|alom[ao]n)|இனிமைமிகு\s*பாடல்|(?:Laulujen\s*laul|Korkea\s*veis)u|உன்னத\s*சங்கீதம்|Salamon\s*[eé]neke|Црковни\s*химни|نشيد\s*الأناشيد|ਸਲੇਮਾਨ\s*ਦਾ\s*ਗੀਤ|உன்னதப்பாட்டு|Énekek\s*[eé]neke|U[nṉ][nṉ]atapp[aā][tṭ][tṭ]u|Kidung\s*Agung|[ΆΑ]σμα\s*Ασμ[άα]των|உன்னத\s*பாட்டு|เพลง(?:ซา|โซ)โลมอน|H(?:o(?:hes\s*Lied|oglied|ga(?:\s*V|v))|ögav|ld)|שיר(?:\s*השירים|י\s*שלמה)|ﻧﺸﻴﺪ\s*ﺍﻷﻧﺸﺎ|श्रेष्ठगीत|H(?:o(?:hes?lied|ogl)|oga\s*v|öga(?:\s*V)?|ø[jy]s|l)|Ve[lľ]p(?:iese[nň])?|C(?:an(?:(?:t(?:ares|i(?:que|co))?)?|ticos)|ânt(?:icos)?|hante)|श्रेष्ठ|L(?:aul\.?\s*l|jl)|Diễm\s*ca|गीतरत्न|P(?:i(?:es(?:e[nň])?|s)|ise[nň]|ís(?:e[nň])?|j)|K(?:id(?:ung)?|ant)|shīr(?:āy|i)|S\s*of\s*S|Nhã\s*ca|ପରମଗୀତ|shīrā?|So(?:ng?)?|உன்ன|Sn?gs|《?雅歌》|諸歌の歌|Wim|Sn?g|《?雅歌|So?S|Pnp|V[lľ]p|《歌》|இபா|พซม|Én|نش|《歌|아가|Ἆσ|歌》|아))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Prov"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))(امثالا-?ها-?ها|امث(?:الا-?ها|ل\s*ل)|(?:Книга\s*(?:При(?:повісте[ий]\s*Соломонови|казок\s*Соломонови)х|притче[ий]\s*Соломоновых|Притчи\s*Соломонови)|(?:Ks(?:i[eę]g[ai]\s*Przypowie[sś]ci\s*Salomon|\.\s*Przypowie[sś]ci\s*Salomon|\s*Przypowie[sś]ci\s*Salomon)|P(?:r[ií]slovi\s*[SŠ]alomounov|r[ií]sloví\s*[SŠ]alomounov|ř[ií]slov[ií]\s*[SŠ]alomounov)|Sananlaskujen\s*kirj|hikmā(?:-?la|(?:ha|[ty]))-?h|Am(?:th(?:al(?:[ae]-?ha|-?h)|āle-?h)|sale-?ha)|hikmata-?h)a|Przypowie[sś]ci\s*Salomonowych|Приповісте[ий]\s*соломонових|(?:(?:(?:P(?:roverb|ild)ele\s*lui\s*Solom|Panultih)|Mga\s*Panultih)o|Ordspr[aå]ksboke|Châm\s*ngô|Spreuke)n|(?:Surat\s*Amsal\s*Sulaim|(?:Mga\s*)?Kawika|Neetivach)an|hi(?:topade[sš]ko\s*pustak|kmāya)|Li(?:ber\s*Proverbiorum|v\s*Pwov[eè]b\s*yo)|हितोपदेशको\s*पुस्तक|Притчи\s*Соломонови|Ordsprogenes\s*Bog|S(?:a(?:lomos\s*Ordsprog|nanlaskut)|prichw[oö]rter)|(?:Salomos\s*Ordspr[aå]|P[eé]ldabesz[eé]de)k|При(?:че\s*Солом[оу]нове|тчі\s*Соломона|пові(?:док|сті)|казок)|Мудрые\s*изречения|K(?:s(?:i[eę]g[ai]\s*Przysł[oó]w|\.\s*Przysł[oó]w|\s*Przysł[oó]w)|niha\s*pr[ií]slov[ií]|\.\s*pr[ií]slov[ií]|\s*pr[ií]slov[ií])|Wulang\s*Bebasan|S(?:ananl(?:askujen)?|pr)|M(?:(?:aahmaahyadi|ithal)|ethal)i|(?:Orðskviðirni|Iz)r|Fjal[eë]t\s*e\s*urta|ام(?:ث(?:(?:(?:ال(?:(?:ا-?ها‌|يات-?|-?)|ی[-‌])|لا(?:ت(?:-?ها|يه)[-‌]|يي[-‌]|-?)|ال(?:‌[تم]ان|شان)-?|ل(?:ات)?ی‌|ی(?:ات-?|ه‌))ه|ل(?:ا(?:ت‌?ه|ه)|هم)|الهاه|ـال(?:ا?|[-‌])ه|الاه|یاه)ا|ال(?:(?:‌هایی|ي(?:اتي|ت)|ا(?:ءِ|[تً])|هم|ل)|مان)|ل(?:ا(?:ت(?:‌ت|ش)ان|ء[لِ]|ل)|يت|ل)|الـيت|ـلات|َ(?:الا|لي)|يل[اي]|یت)|صل)|(?:Mudre\s*izrek|Ordspr[aå]ken|Poslovic|Spr(?:(?:ue|ü)|u)ch)e|பழமொழி\s*ஆகமம்|Ords(?:p(?:rogene)?)?|hi(?:topade[sš]ko|km(?:ā(?:-?la|ha|t)?)?)|Пр(?:и(?:повісте[ий]|т(?:ч(?:и|і)?)?))?|P(?:(?:robver|(?:rov(?:ér|e)|rober))bio|or?verbio)s|N[iī]timo[lḻ]ika[lḷ]|नीति(?:सूत्रें|(?:\s*व|[बव])चन)|سفر\s*الأمثال|நீதிமொழிகள்|P(?:r(?:o(?:v(?:erb(?:e(?:le)?|i)?)?)?|(?:overbi|vb)o|everb(?:io)?|[ií]s(?:lovi)?|verb(?:io)?|z(?:yp?)?|vb?)?|r[ií]sloví|ř(?:[ií]s(?:lov[ií])?)?|[eé]ld|w)|नीति(?:सूत्रे)?|हितोपदेश(?:को)?|P(?:r(?:(?:overbi|vb)os|everb(?:io)?s|overb(?:e?s|ia)|[ií]slovia|verb(?:io)?s|vbs)|robverbs|roberbs|or?verbs|rovebs|wov[eè]b|v)|Prypovisti|ام(?:ث(?:ا(?:ل(?:‌های?|ي(?:ات)?|ا)?)?|ل(?:ا(?:ت(?:-?ها|يه)|تي?|يي|ء)?|ه|ي)?|ال(?:‌[تم]ان|شان)|ل(?:ات)?ی|الها|ـالا?|الی|ی(?:ات?|ه))?)?|Π(?:αροιμ[ίι](?:αι|ες)|ρμ)|n[iī]tis[uū]tre|П(?:ословиц|риказк)и|O(?:roverbs|kv)|Am(?:\s*(?:thal[es]|sale)|th(?:al(?:eh|ah|[lsā])|āl[aiī])|’(?:sālah|thāl[ai])|sālah|sāl[iī])|a(?:['’]mthāli|ms̱?āl)|Hikm(?:at(?:ah|ā)|ālā)|kahāutāṃ|ହିତୋପଦେଶ|Am(?:\s*(?:th|s)al|thale?|’sāla|sāla|sal)|a['’]mthāl?|箴(?:言(?:\s*知恵の泉|》)|》)|(?:Am(?:th(?:a[ae]|e)|saa)|Sn)l|ส(?:ุภาษิต|ภษ)|الأمثال|ਕਹਾਉ(?:ਂਤਾ|ਤਾਂ)|Изрек[еи]|פתגמים|(?:ام(?:ث(?:اا|آ)|صا)|مث)ل|(?:اَ|أ)مثال|משלים|ﺃﻣﺜﺎﻝ|M(?:aah|ith|eth|it)|Châm|Мудр|משלי|நீதி|格言の書|《箴言?》|நீமொ|Kaw|《箴言?|箴言?|잠언|格|잠))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Wis"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}]))((?:Cartea\s*[iî]n[tţ]elepciunii\s*lui\s*Solomon|Книга\s*(?:Прем(?:ъдрост\s*Соломонов|удрості\s*Соломон)а|Мудрост\s*Соломонова|на\s*мъдростта|Мудрости)|(?:Ang\s*Karunungan\s*ni\s*S[ao]lom[oó]|Karunungan\s*ni\s*S[ao]lom[oó]|Khôn\s*Ngoa|S[ao]lomó)n|[IÎ]n[tț]elepciunea\s*lui\s*Solomon|Прем(?:удорсти\s*Соломонове|ъдрост\s*на\s*Соломон|\s*Сол)|De\s*wijsheid\s*van\s*Salomo|Het\s*boek\s*der\s*wijsheid|(?:The\s*Wis(?:d?om|d?)\s*of|(?:Wis(?:d(?:om)?\s*|\s*)|Wisom\s*)of)\s*Solomon|Премъдрост\s*Соломонова|(?:M(?:oudrost\s*[SŠ]alomounov|[aą]dro[sś][cć]\s*Salomon)|Sabidur[ií])a|Sa(?:pienza\s*di\s*Salomon|lamon\s*b[oö]lcsess[eé]g)e|Cartea\s*[IÎ]n[tț]elepciunii|Sabedoria\s*de\s*Salom[aã]o|K(?:ebij(?:aksanaan)?\s*|awicaksanan\s*)Salomo|Премудр(?:ости|ість)\s*Соломона|S(?:a(?:pientia\s*Salomoni|lomon\s*viisau)|peki\s*Sal[oó]mon)s|Мудрости\s*Соломонове|Wijsheid\s*van\s*Salomo|(?:Hekima\s*ya\s*Solomon|K(?:s(?:i[eę]g[ai]\s*M[aą]dro[sś]c|\.\s*M[aą]dro[sś]c|\s*M[aą]dro[sś]c)|n(?:iha\s*Mo|jiga\s*M)udrost))i|Sagesse\s*de\s*Salomon|Weisheit\s*Salomos|Σοφ[ίι]α\s*Σ(?:ολομ[ωώ]ντος|αλωμ[ωώ]ντος)|Liber\s*Sapientiae|Kniha\s*moudrost[ií]|Vi(?:isauden\s*kirja|s(?:domm|het)ens\s*bok)|சாலமோனின்\s*ஞானம்|S(?:alomos\s*(?:Visdom|vishet)|Sal|b)|Visdommens\s*Bog|K(?:eb(?:ijaksanaan)?|a(?:wicaksanan|r(?:unungan)?))|Hikmat\s*Salomo|حكمة\s*سليمان|Прем(?:ъдрост)?|B[oö]lcsess[eé]g|سفر\s*الحكمة|Sa(?:b(?:edoria)?|p(?:ien(?:t(?:ia)?|za))?|gesse|lomon)|Vi(?:s(?:d(?:ommen)?|h(?:eten)?)|is)|Σοφ(?:[ίι]α(?:\s*Σολ)?)?|חכמת\s*שלמה|M(?:oudrost|ud(?:rost|r?)|úd(?:rost)?|[aą]dr)|W(?:i(?:jsheid|s(?:d(?:om)?)?)|eish(?:eit)?)|Муд(?:рости)?|M(?:udros(?:ti|ť)|údros(?:ti|ť)|dr)|ソロモンの(?:知恵書|智慧)|ஞானாகமம்|ปรีชาญาณ|Hek(?:ima)?|الحكمة|B[oö]lcs|《智慧篇》|《智慧篇|சாஞா|智慧篇》|知恵の書|智慧篇|지혜서|知恵?|حك|지혜))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Joel"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:ଯୋୟେଲ\s*ଭବିଷ୍ୟ‌ଦ୍‌ବକ୍ତାଙ୍କ\s*ପୁସ୍ତକ|Книга\s*(?:на\s*пророк\s*Иоиля?|пророка\s*(?:Ио(?:иля|іла)|Йоіла)|[ИЙ]оіла)|Pro(?:roctwo\s*Ioelowe|phetia\s*Ioel)|योएलको\s*पुस्तक|Joelin\s*kirja|Ks(?:i[eę]g[ai]\s*Joe|\.?\s*Joe)la|Liv\s*Jow[eè]l\s*la|J(?:o(?:el(?:s\s*(?:Bog|bok)|a)|ël)|l)|سفر\s*يوئيل|یو(?:ئ(?:ی(?:یل(?:یہ|[ـلهہ])|ل(?:ی[هہی]|[ـلهہ])|ئل[لی])|ئی(?:یلـ|ل[ـلهی])|ل)|وئیلل)|یو(?:ئ(?:ی(?:یلی?|لی?|ئل)|ئیی?ل)?|وئیل)|(?:Y(?:o(?:o(?:['’]e[ei]|e[ai]|i)|ei|ë)|uoi|ov[eē]|ōv[eē])|Yoo['’]i[ei]|J(?:o(?:e[ai]|w[eè]|[iéï])|ó[eé])|yōʾī|Io[ei])l|ی(?:و(?:(?:وئی)?ی|ای)|ُوای)ل|Jo(?:e(?:l(?:in?)?)?|ë)|Y(?:oo(?:['’]e|e?)l|l)|Giô-?ên|yū['’]īli|யோவேல்|(?:Yoo?a|Jo['a’]|yo)el|(?:Gioe|Yo)le|yū['’]īl|ଯୋୟେଲ|Yoeli|Иоил[ья]|Иоі(?:ла|н)|Йо(?:і(?:ла|н)|ил|ї[лн])|(?:《?岳厄爾|《?約珥書|《?珥)》|《?约[珥饵]书》|โยเอล|よえるしょ|يوئيل|Gioe|Yoel|Иоил|Иоіл|Йоіл|《?岳厄爾|《?約珥書|《?约[珥饵]书|योएल|யோவே|(?:Ιω[ήη]|Ἰ)λ|Јои[лљ]|Јоел|Иої[лн]|יואל|ヨエル書|[ਜਯ]ੋਏਲ|Yoe|ヨエル|يوء|요엘서|ยอล|요엘|《?珥|Ιλ|욜))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["GkEsth"],
        testament: "a",
      ...
      },
      {
        osis: ["Jonah"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))(یونسی-?ها-?ها|(?:ଯୂନସ\s*ଭବିଷ୍ୟ‌ଦ୍‌ବକ୍ତାଙ୍କ\s*ପୁସ୍ତକ|حضرت\s*یونس\s*علیه\s*السلام|Книга\s*(?:на\s*пророк\s*Иона|пророка\s*(?:Ион[иы]|Йони))|Pro(?:roctwo\s*Ionaszow|phetia\s*Iona)e|(?:د(?:استان\s*پیامبر|عای)|حکایت|سوره|پیام|کتاب|قصه)\s*یونس|ی(?:ونس(?:\s*(?:در\s*شکم|و)\s*ماه|‌نامه‌ها‌|ی‌نامه‌ا)ی|(?:(?:ون(?:س‌(?:نامه‌گ|ا)ی|وس)‌|ونس(?:‌نامه(?:‌ی‌|-?)|ی‌(?:ها|ای)‌|-?ها-?))ه|ونس(?:ی(?:‌نامه‌|-?)ه|\s*در\s*نینو|‌ها‌ه))ا|ُون(?:(?:َس(?:‌نامه‌|-?)|َس‌)ها|[وُ]س(?:‌(?:نامه‌(?:ای|ها)|ها)|-?ها)|ا[سہ]|س)|و(?:ن(?:س(?:‌(?:ها(?:ی‌نامه|‌ی)|نامه‌(?:هات|یش|ا[شی])|یه|ات)|ی‌نامه‌ی|یه?-?نامه|\s*پیامبر|[ـهہ])|سسی|اسی|یس|[شص])|ونی?س))|ماجرای\s*(?:حضرت\s*)?یونس|(?:Ks(?:i[eę]g[ai]\s*Jonasz|\.?\s*Jonasz)|Jo(?:onan\s*kirj|nasz)|Gi(?:ô-?|o)n)a|योनाको\s*पुस्तक|(?:یونس(?:‌نامه‌گ|ی)ا|يونا)ن|یونس(?:ی‌های‌ش|‌(?:نامه|های)‌ش)ان|ی(?:ون(?:(?:س(?:‌(?:نامه(?:‌(?:ها|ی))?|های?|ی)|ی(?:‌(?:نامه|ها))?|-?ها)?|سس|اس)?|(?:س‌(?:نامه‌گ|ا)ی|وس))|ُون(?:َس(?:‌نامه)?|[وُ]س(?:‌نامه)?))|Liv\s*Jonas\s*la|داستان\s*یونس|(?:حکای|نج)ات\s*یونس|J(?:o(?:n(?:(?:a(?:s(?:['’]\s*Bog|s(?:eh|i)|[ei])|s?\s*bok|š)|á[hsš])|asse-?[iy])|onas(?:se-?[iy]|e)|unasi)|n[hs])|يونس(?:(?:-?ها-?|ي(?:ه-?|‌))|‌ها‌)ها|حضرت\s*یونس|(?:Jo(?:onas|na)sa|Y[ou]nasa)h|يونس-?نامه|سفر\s*يونان|Y(?:o(?:un(?:asse|us[is])|onus[is]|n(?:ass|isi|ā)|nus[is])|un(?:ass|us[eis])|n)|Y(?:o(?:(?:onu|na)|una)s-?|unus-?)[iy]|(?:Jouniss|Y[ou]nes)e|Y(?:o(?:un(?:ass?|us)|on(?:us)?|nus|na?)|un[au]s)|J(?:o(?:n(?:a(?:s(?:se?)?)?|á)?|ona(?:ss?|n)?|un[ai]s)|ón)|يونس-?ها|يونس‌ها|Y(?:o(?:oni|un[ei])|uni)si|(?:Yoon[ae]s|Jon(?:ah|is))s|(?:Yoonos|J(?:ooni|ón[aá]))s|یو(?:ون(?:یی|[او])|ن(?:ی[ای]|ُ))س|Y(?:o(?:oni|un[ei])|uni)s|Yoon[ae]s|يونسيه|โยนาห์|Jon(?:ah|is)|يون(?:سي?)?|Ionas|y(?:ūn(?:as|āh)|on[aā])|Ι(?:ων[άα]ς|ν)|يونسّ|(?:《?約(?:拿書|納)|《?拿)》|《?约拿书》|ਯੂਨਾਹ|Iona|《?約(?:拿書|納)|《?约拿书|योना|ଯୂନସ|Y(?:oṉ|ō[nṉ])[aā]|Ион[аиы]|Йон[аи]|ヨナ(?:しょ|書)|Юнус|יונה|யோனா|Јона|Gio|Ион|Йон|요나서|ยนา|ヨナ|요나|《?拿|Ἰν|욘))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Nah"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:Na(?:h-?o?um|-?h[uâ]m)|نا(?:\s*حُو|حو-?)م)|(?:ନାହୂମ\s*ଭବିଷ୍ୟ‌ଦ୍‌ବକ୍ତାଙ୍କ\s*ପୁସ୍ତକ|Книга\s*(?:на\s*пророк\s*Наума?|пророка\s*Наума)|Pro(?:roctwo\s*Nahumowe|phetia\s*Nahum)|Liv\s*Nawoum\s*lan|Nahumin\s*kirja|Ks(?:i[eę]g[ai]\s*Nahuma|\.?\s*Nahuma)|नहूमको\s*पुस्तक|ن(?:اح(?:وم(?:‌ها‌ها|ی(?:ی(?:یه|[ءئه])|ائ[هہ]|ئی|ہ[ئاه]|[ءةهۂ])|ا-?ها|ائ[هہ]|وو|ئی|ہ[ئاه]|[ءةـهۂ])|م)|حوم)|N(?:a(?:h(?:um(?:s\s*(?:Bog|bok)|[au])|om|úm)|wou[mn]|ahom|ch)|h)|سفر\s*ناحوم|ن(?:ا(?:ح(?:و(?:م(?:‌ها|ی(?:ئ|ہ|ی)?|ا|و|ئ|ہ)?)?)?)?|حو)|N(?:a(?:h(?:u(?:m(?:in?)?)?|ú)?|w|x)?|áh)|(?:N(?:a(?:aho?u|h(?:uu|o[ou])|u)|áhu)|N[aā]k[uū]|n(?:ah[uū]|āḥū))m|Nahumme|nāhūmi|நாகூம்|Naxuum|ناحووم|ناحُوم|nāhūm?|ନାହୂମ|Ναο[υύ]μ|น(?:าฮู|ฮ)ม|ナホム(?:しょ|書)|《?那(?:鴻[书書]|鸿书)》|Наума?|《?那(?:鴻[书書]|鸿书)|नहूम|நாகூ|נחום|(?:《?納鴻|《[鴻鸿]|[鴻鸿])》|ਨਹੂਮ|ナホム|《?納鴻|나훔서|나훔?|Να|《[鴻鸿]|[鴻鸿]))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(Første\s*Johannes'\s*Brev|(?:П(?:(?:ърво\s*съборно\s*послание\s*на\s*св(?:\.\s*ап\.?\s*Иоана\s*Богослов|\s*ап\.?\s*Иоана\s*Богослов)|рва\s*посланица\s*Јованов)а|ерш[ае]\s*(?:соборне\s*послання\s*св\.?\s*апостола\s*Іоанна|(?:послання\s*апостола\s*|(?:Послання\s*)?)Івана|[ИЙ]оаново|Іоанна)|рв(?:а\s*п(?:ослание\s*на|исмо\s*од)\s*апостол\s*Јов|о\s*п(?:ослание\s*на|исмо\s*од)\s*апостол\s*Јов)ан|ърво\s*послание\s*на\s*[ИЙ]оан|рва\s*Јованов[ао]|(?:рво\s*Јовано|ърв(?:а\s*[ИЙ]оано|о\s*[ИЙ]оано))во)|1-?(?:ше|а)\.\s*(?:соборне\s*послання\s*св\.?\s*апостола\s*Іоанна|(?:послання\s*апостола\s*|(?:Послання\s*)?)Івана|[ИЙ]оаново|Іоанна)|(?:1(?:-?е\.?\s*с|\.?\s*с)|I\.?\s*с)оборне\s*послання\s*св\.?\s*апостола\s*Іоанна|1-?(?:ше|а)\s*(?:соборне\s*послання\s*св\.?\s*апостола\s*Іоанна|(?:послання\s*апостола\s*|(?:Послання\s*)?)Івана|[ИЙ]оаново|Іоанна)|(?:Fyrsta\s*br[eé]f\s*J[oó]hannesar\s*hið\s*almenn|(?:P(?:er[sš]e\s*poslannja\s*apostola\s*Iva|ierwsz[aey]\s*(?:List\s*(?:[sś]w\.?\s*J|J)|J)a)|(?:1\.?\s*L|I\.?\s*L)ist\s*(?:[sś]w\.?\s*J|J)a)n|Prv(?:a\s*Ivanova\s*[Pp]oslanic|n[ií]\s*Janov)|(?:1\.?\s*Ivanova\s*P|I\.?\s*Ivanova\s*P)oslanic|Avval\s*Yoohann|(?:AvvalY|Yek\s*?Y|۱\s*?Y)oohann|اول\s*?Yoohann|1\.?\s*Yooxana|I\.?\s*Yooxana|1\.\s*Yoohann|1\s*Yoohann|1Yoohann|1\s*Yahy)a|Y(?:o(?:va[nṉ]\s*E[lḻ]utiya\s*Mutal[aā]vatu\s*Nirupam|(?:oxanaa\s*Kowaad|hane\s*I))|ōva[nṉ]\s*E[lḻ]utiya\s*Mutal[aā]vatu\s*Nirupam)|(?:Ensimm[aä]inen\s*Johanneksen\s*kirj|(?:1\.?\s*Johannek|I\.?\s*Johannek)sen\s*kirj)e|யோவ(?:ான்\s*(?:எழுதிய\s*முதல(?:்\s*திருமுக|ாம்\s*கடித)|முதல்\s*திருமுக)|ன்\s*எழுதிய\s*முதலாவது\s*நிருப)ம்|(?:(?:1\.?\s*послание\s*на|(?:1\.?\s*пи|I\.?\s*пи)смо\s*од)|I\.?\s*послание\s*на)\s*апостол\s*Јован|(?:(?:1(?:-?е\.?\s*посланн|\.?\s*посланн)|I\.?\s*посланн)я\s*апостола\s*Ів|(?:(?:1(?:-?е\.?\s*П|\.?\s*П)|I\.?\s*П)ослання\s*Ів|(?:(?:1(?:-?е\.?\s*Иох|(?:-?я|[ея])\.?\s*Иох|\.?\s*Иох)|(?:1(?:-?е\.?\s*І|\.\s*І)|I\.?\s*І)в)|1\s*Ів)))ана|א(?:גרתו\s*הראשונה\s*של\s*יוחנן\s*השליח|יגרת\s*יוחנן\s*הראשונה)|אגרתו\s*הראשונה\s*של\s*יוחנן\s*השלי|Waraka\s*wa\s*Kwanza\s*wa\s*Yohane|Prim(?:(?:a\s*lettera\s*di|o)\s*Giovanni|a\s*Giovanni|eir[ao]\s*Jo[aã]o)|(?:رسالة\s*القديس\s*)?يوحنا\s*الأولى|Barua\s*ya\s*Kwanza\s*ya\s*Yohane|y(?:ū(?:ḥannā\s*kā\s*pahlā\s*ʿām\s*ḫaṭ|h(?:ãnā\s*dī\s*pahilī\s*pattrī|ann[aā]ko\s*pahilo\s*patra))|oh[aā]n[aā]ce[mṃ]\s*pahile\s*patra|uhann[aā]ko\s*pahilo\s*patra)|E(?:nsimm[aä]inen\s*Johanneksen|erste\s*Joh)|F(?:yrsta\s*br[eé]f\s*J[oó]hannesar|ørste\s*Joh(?:annes)?|irst\s*J(?:oh?|h))|ی(?:ُوحنّا\s*کا\s*پہلا\s*عام\s*خط|وحنّا\s*کا\s*پہلا\s*عام\s*خط|وحنا\s*کا\s*پہلا\s*عام\s*خط|ک(?:\s*یو[حه]ن(?:ا(?:ءه|[ته])|[آةهىی])|یو[حه]ن(?:ا(?:ءه|[ته])|[آةهىی])))|ਯੂਹੰਨਾ\s*ਦੀ\s*ਪਹਿਲੀ\s*ਪੱਤ੍ਰੀ|Johannes(?:’\s*første\s*b|\s*f[oö]rsta\s*b)rev|(?:Johannes(?:'\s*(?:Første|1\.)|’\s*(?:Første|1\.))|1(?:\.\s*Johannes['’]|\s*Johannes['’]))\s*Brev|F(?:ørste\s*Johannes(?:’\s*B|b)rev|yrsta\s*J[oó]hannesarbr[eé]f|[oö]rsta\s*Johannesbrevet|irst\s*J(?:oh[mn]|h?n))|(?:(?:1\.?\s*посланиц|I\.?\s*посланиц)а\s*Јованов|1(?:-?е\.?\s*Иоанн|\.?\s*Иоанн))а|1(?:(?:-?е\.?\s*послани|\.?\s*послани)е\s*И|(?:-?я|[ея])\.?\s*послание\s*И)оанна|य(?:ूहन्नाको\s*पहिलो|ोहानाचें\s*पहिले)\s*पत्र|E(?:pistula\s*I\s*Ioannis|(?:erste\s*Johanne|rste\s*Johanne|ls[oő]\s*J[aá]no)s|ls[oő]\s*Jn)|(?:(?:Epistula\s*)?Ioannis|J[aá]nos)\s*I|رسالة\s*يوحنا\s*الأولى|ଯୋହନଙ୍କ\s*ପ୍ରଥମ\s*ପତ୍ର|(?:1(?:\.\s*(?:Johannesbreve|Gjoni)|\s*(?:Johannesbreve|Gjoni)|\s*[ei]\.?\s*Gjoni)|Prv[yý]\s*J[aá]nov\s*lis)t|(?:Mutal[aā]vatu\s*யோவான|முதலாவது\s*யோவான|1(?:\s*(?:அருளப்பர|யோவான)|\.\s*யோவான))்|(?:Prv(?:n[ií]\s*(?:list\s*Jan[uů]|Jan[uů])|[aá]\s*kniha\s*J[aá]no|[yý]\s*list\s*J[aá]no|[aá]\s*J[aá]no)|(?:1\.?\s*l|I\.?\s*l)ist\s*Jan[uů]|1\s*k\.\s*J[aá]no|1\s*k\s*J[aá]no|1\.?\s*Jan[uů]|I(?:\.\s*Jan[uů]|\s*Jan[uů]))v|Johannes['’]\s*1\s*Brev|(?:Primer(?:o\s*(?:San\s*J[au][au]|J[au][au])|\s*(?:San\s*J[au][au]|J[au][au]))|(?:Prem(?:i(?:eres?\s*Je|ères?\s*Je|ers?\s*Je)|ye\s*J)|1\.?\s*Yokan|I(?:\.\s*(?:Yokan|Je)|\s*(?:Yokan|Je))|1(?:(?:ere?|re)|ère)\.\s*Je|1(?:(?:ere?|re)|ère)\s*Je|1\.?\s*Je)a|1(?:\.[oº]|º)\.\s*(?:San\s*J[au][au]|J[au][au])|(?:1(?:o\.?\s*S|\.?\s*S)|I\.?\s*S)an\s*J[au][au]|1(?:\.[oº]|º)\s*(?:San\s*J[au][au]|J[au][au])|First\s*J(?:h[ho]|oo)|Una(?:ng)?\s*Jua|1st\.\s*J(?:h[ho]|oo)|1\.?\s*Gioa|I(?:\.\s*(?:Gioa|J(?:oo|a[au]))|\s*(?:Gioa|J(?:oo|a[au])))|(?:1(?:o(?:\.\s*J[au]|\s*J[au])|\.?\s*Ju)|I\.?\s*Ju)[au]|1st\s*J(?:h[ho]|oo)|1(?:\.\s*Joo|\s*(?:Joo|Yh))|1\.?\s*Ja[au]|(?:1\.?\s*Jh|I\.?\s*Jh)[ho])n|1(?:\.\s*(?:J(?:o(?:h(?:annes(?:brev)?)?)?)?|यूहन्ना|Иоан)|\s*(?:(?:(?:J(?:o(?:h(?:annes(?:brev)?)?)?)?|(?:योहान|யோ(?:வா)?|Yoh|Gj|Iv|Ів))|Иоан)|यूहन्ना)|Yoh)|Avval\s*Y(?:o(?:ohanaah|han[an]ah)|uhan[an]ah)|(?:1\.?\s*Johannek|I\.?\s*Johannek)sen|(?:AvvalY|Yek\s*?Y|۱\s*?Y)(?:o(?:ohanaah|han[an]ah)|uhan[an]ah)|Avval\s*Y(?:o(?:ohana|hann?a)|uhann?a)|avval\s*yohannā|Kwanza\s*Yohan[ae]|او(?:ل(?:\s*Y(?:o(?:ohanaah|han[an]ah)|uhan[an]ah)|Y(?:o(?:ohanaah|han[an]ah)|uhan[an]ah))|ّل(?:(?:\s*یُوحنّ|(?:\s*یوحنّ|۔یوحن))|-?یُوحنّ)ا)|(?:Avval\s*?|اول\s*)یو[حه]ن(?:ا(?:ءه|[ته])|[آةهىی])|رسالة\s*يوحنا\s*1|הראשונה\s*יוחנן|Prv(?:a\s*Ivanova|[yý]\s*J[aá]nov|n[ií]\s*J(?:an)?)|(?:AvvalY|Yek\s*?Y|۱\s*?Y)(?:o(?:ohana|hann?a)|uhann?a)|(?:Avval\s*?|اول\s*)یو[حه]ناء?|1(?:\.\s*(?:य(?:ूहन्नाको|ुहत्रा)|ยอห์น|J(?:oh[mn]|n))|\s*(?:(?:(?:(?:(?:yoh[aā]n[aā]ce[mṃ]|योहानाच|ਯੂਹੰਨਾ|Y(?:ova[nṉ]|ōva[nṉ])|Gv|In|Јн|Ин|Йн|يو|ยน)|J(?:oh[mn]|n))|ยอห์น)|युहत्रा)|यूहन्नाको)|요한)|1e\.?\s*Johannes|(?:1(?:\.\s*(?:y[uū]hann[aā]k|Jo[aã])|\s*(?:(?:yūhann[aā]k|Jo[aã])|yuhann[aā]k))|I(?:\.\s*Jo[aã]|\s*Jo[aã])|avvly)o|1°\.\s*Giovanni|(?:1(?:(?:-?е\.?\s*Иоано|\.?\s*Иоано)|\s*Йоано)|(?:1\.\s*Й|I(?:\.\s*[ИЙ]|\s*[ИЙ]))оано)во|1-?е\.?\s*Йоаново|اول(?:\s*Y(?:o(?:ohana|hann?a)|uhann?a)|Y(?:o(?:ohana|hann?a)|uhann?a)|یو)|I(?:\.\s*(?:J(?:oh(?:annes|[mn])|an(?:o(?:va|s)|a)|áno[sv]|n)|Yohan(?:es|a)|Giăng|In)|\s*(?:J(?:oh(?:annes|[mn])|an(?:o(?:va|s)|a)|áno[sv]|n)|Yohan(?:es|a)|Giăng|In))|(?:1\.?\s*Giov|I\.?\s*Giov)anni|1°\s*Giovanni|(?:First\s*Jo?p|1st\.\s*Jo?p|1st\s*Jo?p|1(?:\.\s*Jo?p|\s*Jo?p)|I(?:\.\s*Jo?p|\s*Jo?p))hn|(?:1\s*Yoo?|1Yoo)hanaah|(?:1\.\s*Ј|I\.?\s*Ј)ованов[ао]|1(?:-?я|[ея])\.?\s*Иоанна|(?:(?:1(?:-?е\.?\s*І|\.\s*І)|I\.?\s*І)|1\s*І)оанна|ପ୍ରଥମ\s*ଯୋହନଙ|1\.\s*I(?:vanova|oan)|I(?:\.\s*(?:I(?:vanova|oan)|Yo(?:h(?:ane)?|ox)|J(?:an(?:ov)?|oh?)?|Gi)|\s*(?:I(?:vanova|oan)|Yo(?:h(?:ane)?|ox)|J(?:an(?:ov)?|oh?)?|Gi))|Kwanza\s*Yoh|П(?:рв[ао]\s*Јован|ърв(?:а\s*[ИЙ]оан|о\s*[ИЙ]оан))|1\.\s*Yohan(?:es|a)|(?:1\.?\s*Ioann|I\.?\s*Ioann)is|(?:First\s*Jon|1st\.\s*Jon|1st\s*Jon|1(?:\.\s*J(?:on|ó)|\s*J(?:on|ó))|I(?:\.\s*J(?:on|ó)|\s*J(?:on|ó)))h|1\s*Yohannah|1\s*?Yuhan[an]ah|(?:1\.|[1۱])\s*یُوحنّا|(?:1\.|۱)-?یُوحنّا|(?:اولیو[حه]|1\s*?یوه|۱\s*?یوه)ن(?:ا(?:ءه|[ته])|[آةهىی])|Ιω[άα]ννου\s*Α['ʹʹ΄’]|1\s*Јованов[ао]|ﻳﻮﺣﻨﺎ\s*ﺍﻻﻭﻝ|1\s*Ivanova|1\.\s*Yoh(?:ane)?|(?:1\s*Yoo?|1Yoo)hana|1\s*Yohanna|1\s*?Yuhann?a|(?:اولیو[حه]|1\s*?یوه|۱\s*?یوه)ناء?|یک(?:\s*یو[حه]ناء?|یو[حه]ناء?)|1\.?\s*Jan(?:o(?:va|s)|a)|1\s*Yohanes|요(?:한(?:의\s*첫째\s*서간|[1일]서)|일)|1st\.\s*J(?:oh[mn]|h?n)|Α['ʹʹ΄’]\s*(?:Ιω[άα]ννη|᾿Ιω)|AvvalJohn|1Yohan[an]ah|1\.\s*یوحنّا|1-?یُوحنّا|(?:1\s*?یوحنا|۱\s*?یوحنا)(?:ءه|[ته])|ヨハネの(?:第一の(?:手紙|書)|手紙[Ⅰ一])|1\.?\s*Jan(?:ov)?|1\s*Yohane|1st\.\s*J(?:oh?|h)|1Yohann?a|(?:1\s*?یوحنا|۱\s*?یوحنا)ء?|(?:1\.\s*Ј|I\.?\s*Ј)ован|1\.?\s*Jáno[sv]|1\.?\s*Giăng|1\s*yūhãnā|1o\.?\s*Jo[aã]o|1a\.\s*Jo[aã]o|1st\s*J(?:oh[mn]|h?n)|(?:[1۱]\s*یوحنّ|(?:1\.?۔|۱۔)یوحن)ا|1\.?\s*ଯୋହନଙ|1\.?\s*Yoox|1e\.\s*Joh|1st\s*J(?:oh?|h)|1\s*Јован|(?:1\.\s*Й|I(?:\.\s*[ИЙ]|\s*[ИЙ]))оан|1\s*یوحن[آةهىی]|۱(?:\s*یوحن[آةهىی]|یوحن[آةهىی]|yohn)|1a\s*Jo[aã]o|1\s*Ioan|1e\s*Joh|1\s*Йоан|1یوحن[آةهىی]|(?:1\.?\s*Jh|I\.?\s*Jh)n|(?:《(?:约(?:翰[一壹]书|壹)|約壹)|《?伊望第一|约(?:翰[一壹]书|壹)|約壹)》|(?:《約翰[一壹]|約翰[一壹])書》|《?若望一書》|1\.?\s*Gi|1یو(?:حن?)?|۱(?:یو(?:حن?)?|yoh?)|1\.?\s*Jh|I\.?\s*Jh|Α['ʹʹ΄’]\s*Ιω|《(?:约(?:翰[一壹]书|壹)|約壹)|《?伊望第一|(?:《約翰[一壹]|約翰[一壹])書|《?若望一書|1\.\s*In|1yohn|1John|Ⅰ\s*ヨハネ|1yoh?|约(?:翰[一壹]书|壹)|一ヨハネ|約壹))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:(?:Второ\s*съборно\s*послание\s*на\s*св(?:\.\s*ап\.?\s*Иоана\s*Богосл|\s*ап\.?\s*Иоана\s*Богосл)ов|2-?(?:ге|а)\.\s*(?:соборне\s*послання\s*св\.?\s*апостола\s*Іоанн|(?:(?:послання\s*апостола\s*|(?:Послання\s*)?)Іва|Іоан)н)|Друг(?:а\s*соборне\s*послання\s*св\.?\s*апостола\s*Іоанн|е\s*(?:соборне\s*послання\s*св\.?\s*апостола\s*Іоанн|(?:(?:послання\s*апостола\s*|(?:Послання\s*)?)Іва|Іоан)н)|(?:а\s*послання\s*апостола\s*|а\s*(?:Послання\s*)?)Іван|а\s*(?:посланица\s*)?Јованов|а\s*Іоанн)|(?:2(?:-?е\.?\s*с|\.?\s*с)|II\.?\s*с)оборне\s*послання\s*св\.?\s*апостола\s*Іоанн|2-?(?:ге|а)\s*(?:соборне\s*послання\s*св\.?\s*апостола\s*Іоанн|(?:(?:послання\s*апостола\s*|(?:Послання\s*)?)Іва|Іоан)н)|(?:(?:2(?:-?е\.?\s*посланн|\.?\s*посланн)|II\.?\s*посланн)я\s*апостола\s*Ів|(?:(?:2(?:-?е\.?\s*П|\.?\s*П)|II\.?\s*П)ослання\s*Ів|(?:(?:2(?:-?е\.?\s*Иох|(?:-?я|[ея])\.?\s*Иох|\.?\s*Иох)|(?:2(?:-?е\.?\s*І|\.\s*І)|II\.?\s*І)в)|2\s*Ів)))ан|(?:II\.?\s*посланиц|2\.?\s*посланиц)а\s*Јованов|2(?:(?:-?е\.?\s*послани|\.?\s*послани)е\s*И|(?:-?я|[ея])\.?\s*послание\s*И)оанн|2(?:-?е\.?\s*Иоанн|\.?\s*Иоанн)|2(?:-?я|[ея])\.?\s*Иоанн|(?:(?:2(?:-?е\.?\s*І|\.\s*І)|II\.?\s*І)|2\s*І)оанн)а|Y(?:o(?:va[nṉ]\s*E[lḻ]utiya\s*Ira[nṇ][tṭ][aā]vatu\s*Nirupam|oxanaa\s*Labaad)|ōva[nṉ]\s*E[lḻ]utiya\s*Ira[nṇ][tṭ][aā]vatu\s*Nirupam)|யோவ(?:ான்\s*(?:எழுதிய\s*இரண்டாம்\s*(?:திருமுக|கடித)|இரண்டாம்\s*திருமுக)|ன்\s*எழுதிய\s*இரண்டாவது\s*நிருப)ம்|Втор(?:а\s*п(?:ослание\s*на|исмо\s*од)\s*апостол\s*Јован|о\s*п(?:(?:ослание\s*на\s*апостол\s*Јов|ослание\s*на\s*[ИЙ]о)|исмо\s*од\s*апостол\s*Јов)ан)|(?:Dru(?:he\s*poslannja\s*apostola\s*Ivan|g(?:a\s*(?:(?:Ivanova\s*[Pp]oslanic|Jan)|List\s*(?:[sś]w\.?\s*Jan|Jan))|i\s*(?:List\s*(?:[sś]w\.?\s*Jan|Jan)|Jan)))|(?:II\.?\s*Ivanova\s*P|2\.?\s*Ivanova\s*P)oslanic|(?:II\.?\s*L|2\.?\s*L)ist\s*(?:[sś]w\.?\s*Jan|Jan)|(?:Do(?:vom\s*?Y|\s*?Y)|۲Y)oohann|II\.?\s*Yooxana|دوم\s*?Yoohann|2\.?\s*Yooxana|2\.\s*Yoohann|2\s*Yoohann|۲\s*Yoohann|2Yoohann|2\s*Yahy)a|(?:II\.?\s*послание\s*н|2\.?\s*послание\s*н)а\s*апостол\s*Јован|Se(?:cond(?:(?:a\s*lettera\s*di|o)\s*Giovanni|a\s*Giovanni|\s*J(?:oh[mn]|h?n))|gund(?:o\s*(?:San\s*J[au][au]n|Jo[aã]o|J[au][au]n)|a\s*Jo[aã]o)|cond\s*J(?:o?ph|h[ho]|oo)n)|א(?:גרתו\s*השנייה\s*של\s*יוחנן\s*השליח|יגרת\s*יוחנן\s*השנייה)|(?:II\.?\s*пи|2\.?\s*пи)смо\s*од\s*апостол\s*Јован|(?:رسالة\s*القديس\s*)?يوحنا\s*الثانية|y(?:ū(?:ḥannā\s*kā\s*dūsrā\s*ʿām\s*ḫaṭ|h(?:ann[aā]ko\s*dostro\s*patra|ãnā\s*dī\s*dūjī\s*pattrī))|uhann[aā]ko\s*dostro\s*patra|oh[aā]n[aā]ce[mṃ]\s*dusre\s*patra)|(?:Toinen\s*Johannek|(?:II\.?\s*Johannek|2\.?\s*Johannek))sen\s*kirje|Waraka\s*wa\s*Pili\s*wa\s*Yohane|Barua\s*ya\s*Pili\s*ya\s*Yohane|ی(?:ُوحنّا\s*کا\s*دوسرا\s*عام|وحن(?:ا\s*کا\s*دوسرا\s*عام|ّا\s*کا\s*دوسرا))\s*خط|य(?:ूहन्नाको\s*दोस्(?:त्)?रो\s*पत्र|ोहानाचें\s*दुसरे\s*पत्र)|An(?:nað\s*(?:br[eé]f\s*J[oó]hannesar|J[oó]hannesarbr[eé]f)|d(?:e(?:n\s*Johannes(?:['’]\s*B|b)|t\s*Johannesb)rev|ra\s*Johannesbrevet))|ਯੂਹੰਨਾ\s*ਦੀ\s*ਦੂਜੀ\s*ਪੱਤ੍ਰੀ|(?:Johannes['’]\s*Andet|2(?:\.\s*Johannes['’]|\s*Johannes['’]))\s*Brev|Johannes(?:’\s*andre|\s*andra)\s*brev|ଯୋହନଙ୍କ\s*ଦ୍ୱିତୀୟ\s*ପତ୍ର|Epistula\s*I(?:I\s*Ioannis|oannis\s*II)|رسالة\s*يوحنا\s*الثانية|T(?:oinen\s*Joh(?:anneksen)?|weede\s*Joh)|(?:Druh(?:[aá]\s*(?:kniha\s*J[aá]|Já)no|[aá]\s*(?:list\s*Jan[uů]|Jan[uů])|[yý]\s*(?:list\s*J(?:an[ouů]|áno)|Jan[uů]))|(?:II\.?\s*l|2\.?\s*l)ist\s*Jan[uů]|2\s*k(?:\.\s*J[aá]|\s*J[aá])no|II(?:\.\s*Jan[uů]|\s*Jan[uů])|2\.?\s*Jan[uů])v|(?:2(?:\.\s*(?:Johannesbreve|Gjoni)|\s*(?:Johannesbreve|Gjoni)|\s*[ei]\.?\s*Gjoni)|Druh[yý]\s*J[aá]nov\s*lis)t|Послання\s*до\s*Тита|2(?:\.\s*(?:J(?:o(?:h(?:annes(?:brev)?)?)?)?|यूहन्ना|Иоан)|\s*(?:(?:(?:J(?:o(?:h(?:annes(?:brev)?)?)?)?|(?:योहान|யோ(?:வா)?|Yoh|Gj|Iv|Ів))|Иоан)|यूहन्ना)|Yoh)|(?:II\.?\s*Johannek|2\.?\s*Johannek)sen|(?:Do(?:vom\s*?Y|\s*?Y)|۲Y)(?:o(?:ohanaah|han[an]ah)|uhan[an]ah)|(?:(?:Tweede\s*Jo|(?:Andre\s*Jo|2e\.?\s*Jo))hanne|Zweite\s*Johanne|M[aá]sodik\s*J[aá]no)s|Anden\s*Joh(?:annes)?|dovvom\s*yohannā|(?:(?:I(?:kalawang\s*Ju|I(?:\.\s*(?:Yokan|Je)|\s*(?:Yokan|Je)))|2\.?\s*Yokan|2(?:e\.?\s*Je|\.?\s*Je))a|De(?:uxi[eè]mes?\s*Jea|zy[eè]m\s*Ja)|2(?:(?:eme|de?)|ème)\.\s*Jea|2nd\.?\s*J(?:o?ph|h[ho]|oo)|II(?:\.\s*(?:Gioa|J(?:oo|a[au]))|\s*(?:Gioa|J(?:oo|a[au])))|2(?:(?:eme|de?)|ème)\s*Jea|(?:II(?:\.\s*Jo?p|\s*Jo?p)|DovomJo|2(?:\.\s*Jo?p|\s*Jo?p)|2Jo)h|2\.?\s*Gioa|(?:II\.?\s*Jh|2\.?\s*Jh)[ho]|2(?:\.\s*Joo|\s*(?:Joo|Yh))|2\.?\s*Ja[au])n|(?:Втор(?:(?:а\s*Јов|а\s*[ИЙ]о)ано|о\s*(?:Јов|[ИЙ]о)ано)|2(?:-?е\.?\s*Иоано|\.?\s*Иоано)|(?:(?:II(?:\.\s*[ИЙ]|\s*[ИЙ])|2\.\s*Й)|2\s*Й)оано)во|Dru(?:ga\s*Ivanova|h(?:[aá]\s*J(?:an(?:ov)?)?|[yý]\s*J(?:an(?:ov)?|ánov)?))|(?:Do(?:vom\s*?Y|\s*?Y)|۲Y)(?:o(?:ohana|hann?a)|uhann?a)|(?:2(?:(?:\.[oº]|º)\.?\s*S|\.?\s*S)|II\.?\s*S)an\s*J[au][au]n|Dovom\s*?یو[حه]ن(?:ا(?:ءه|[ته])|[آةهىی])|دو(?:م(?:(?:\s*(?:Y(?:o(?:ohanaah|han[an]ah)|uhan[an]ah)|یوحن[آةهىی])|Y(?:o(?:ohanaah|han[an]ah)|uhan[an]ah)|\s*یُوحنّا|-?یُوحنّا|(?:\s*یوحنّ|۔یوحن)ا)|\s*یوحنا(?:ءه|[ته]))|م(?:\s*یوه|یو[حه])ن(?:ا(?:ءه|[ته])|[آةهىی])|\s*یو[حه]ن(?:ا(?:ءه|[ته])|[آةهىی])|یو[حه]ن(?:ا(?:ءه|[ته])|[آةهىی]))|2-?(?:ге|а)\.\s*[ИЙ]оаново|Друг(?:а\s*[ИЙ]оаново|е\s*[ИЙ]оаново)|رسالة\s*يوحنا\s*2|ଦ୍ୱିତୀୟ\s*ଯୋହନଙ|Dovom\s*?یو[حه]ناء?|2(?:\.\s*(?:य(?:ूहन्नाको|ुहत्रा)|ยอห์น|J(?:oh[mn]|n))|\s*(?:(?:(?:(?:(?:yoh[aā]n[aā]ce[mṃ]|योहानाच|ਯੂਹੰਨਾ|Y(?:ova[nṉ]|ōva[nṉ])|Gv|In|Јн|Ин|Йн|يو|ยน)|J(?:oh[mn]|n))|ยอห์น)|युहत्रा)|यूहन्नाको)|요한)|II(?:\.\s*(?:J(?:oh(?:annes|[mn])|an(?:os|a)|áno[sv]|n)|Јованов[ао]|Yohan(?:es|a)|Giăng|In)|\s*(?:J(?:oh(?:annes|[mn])|an(?:os|a)|áno[sv]|n)|Јованов[ао]|Yohan(?:es|a)|Giăng|In))|Druh(?:[aá]|[yý])\s*Janova|(?:II\.?\s*Giov|2\.?\s*Giov)anni|2°\.\s*Giovanni|(?:2(?:\.\s*(?:y[uū]hann[aā]k|Jo[aã])|\s*(?:(?:yūhann[aā]k|Jo[aã])|yuhann[aā]k))|II(?:\.\s*Jo[aã]|\s*Jo[aã])|dovvomy)o|2o\.\s*(?:San\s*J[au][au]n|Jo[aã]o|J[au][au]n)|2-?е\.?\s*Йоаново|2-?(?:ге|а)\s*[ИЙ]оаново|השנייה\s*יוחנן|II(?:\.\s*(?:I(?:vanova|oan)|Yo(?:h(?:ane)?|ox)|Јован|J(?:oh?|an)?|Gi)|\s*(?:I(?:vanova|oan)|Yo(?:h(?:ane)?|ox)|Јован|J(?:oh?|an)?|Gi))|دو(?:م(?:(?:\s*Y(?:o(?:ohana|hann?a)|uhann?a)|Y(?:o(?:ohana|hann?a)|uhann?a)|یو)|\s*یوحناء?)|م(?:\s*یوه|یو[حه])ناء?|\s*یو[حه]ناء?|یو[حه]ناء?)|Втор(?:(?:а\s*Јов|а\s*[ИЙ]о)ан|о\s*(?:Јов|[ИЙ]о)ан)|2\.\s*Јованов[ао]|Pili\s*Yohan[ae]|2°\s*Giovanni|2o\s*(?:San\s*J[au][au]n|Jo[aã]o|J[au][au]n)|(?:Second\s*Jon|2nd\.?\s*Jon|II(?:\.\s*J(?:on|ó)|\s*J(?:on|ó))|2(?:\.\s*J(?:on|ó)|\s*J(?:on|ó)))h|(?:2\s*Yoo?|2Yoo)hanaah|۲\s*(?:Y(?:o(?:ohanaah|han[an]ah)|uhan[an]ah)|یوحن[آةهىی])|(?:II\.?\s*Ioann|2\.?\s*Ioann)is|2\s*(?:அருளப்பர|யோவான)்|2\.\s*I(?:vanova|oan)|Second\s*J(?:oh?|h)|2\.\s*Yohan(?:es|a)|2\s*Јованов[ао]|(?:II\.?\s*Janov|2\.?\s*Janov)a|M[aá]sodik\s*Jn|2\s*Yohannah|2\s*?Yuhan[an]ah|(?:2\.?|۲)\s*یُوحنّا|(?:2\.|۲)-?یُوحنّا|Ιω[άα]ννου\s*Β['ʹʹ΄’]|Ioannis\s*II|2\s*Ivanova|2\.\s*Yoh(?:ane)?|II\.?\s*Janov|Andre\s*Joh|(?:2\s*Yoo?|2Yoo)hana|2\s*Yohanna|2\s*?Yuhann?a|۲\s*Y(?:o(?:ohana|hann?a)|uhann?a)|2\s*Yohanes|요(?:한(?:의\s*둘째\s*서간|[2이]서)|이)|Β['ʹʹ΄’]\s*(?:Ιω[άα]ννη|᾿Ιω)|2nd\.?\s*J(?:oh[mn]|h?n)|2(?:\.[oº]|º)\.?\s*J[au][au]n|2Yohan[an]ah|2\.\s*یوحنّا|2-?یُوحنّا|(?:(?:2\s*|[2۲])|۲\s*)یوحنا(?:ءه|[ته])|(?:(?:2\s*|[2۲])|۲\s*)یوهن(?:ا(?:ءه|[ته])|[آةهىی])|Yohane\s*II|ヨハネの(?:第二の(?:手紙|書)|手紙[Ⅱ二])|2\s*Yohane|2\.\s*Јован|2\.?\s*Janov|Pili\s*Yoh|2nd\.?\s*J(?:oh?|h)|2Yohann?a|(?:(?:2\s*|[2۲])|۲\s*)یوحناء?|(?:(?:2\s*|[2۲])|۲\s*)یوهناء?|(?:(?:II(?:\.\s*[ИЙ]|\s*[ИЙ])|2\.\s*Й)|2\s*Й)оан|2\.?\s*Jan(?:os|a)|2\.?\s*Jáno[sv]|2\.?\s*Giăng|2\s*yūhãnā|2a\.?\s*Jo[aã]o|(?:II\.?\s*Ju|2\.?\s*Ju)[au]n|(?:[2۲]\s*یوحنّ|(?:2\.?۔|۲۔)یوحن)ا|J[aá]nos\s*II|2\.?\s*ଯୋହନଙ|2\.?\s*Yoox|2\s*Јован|2e\.?\s*Joh|(?:II\.?\s*Jh|2\.?\s*Jh)n|2\s*یوحن[آةهىی]|2\.?\s*Jan|2\s*Ioan|II\.?\s*Jh|2یوحن[آةهىی]|۲(?:یوحن[آةهىی]|yohn)|(?:《(?:约(?:翰[二贰]书|贰)|約[貳贰])|《?伊望第二|约(?:翰[二贰]书|贰)|約[貳贰])》|(?:《約翰[二貳]|約翰[二貳])書》|《?若望二書》|2\.?\s*Gi|2یو(?:حن?)?|۲(?:یو(?:حن?)?|yoh?)|Β['ʹʹ΄’]\s*Ιω|2\.?\s*Jh|《(?:约(?:翰[二贰]书|贰)|約[貳贰])|《?伊望第二|(?:《約翰[二貳]|約翰[二貳])書|《?若望二書|2\.\s*In|2yohn|Ⅱ\s*ヨハネ|2yoh?|约(?:翰[二贰]书|贰)|二ヨハネ|約[貳贰]))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["3John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Тре(?:то\s*съборно\s*послание\s*на\s*св(?:\.\s*ап\.?\s*Иоана\s*Богосл|\s*ап\.?\s*Иоана\s*Богосл)ова|т[яє]\s*(?:соборне\s*послання\s*св\.?\s*апостола\s*Іоанн|(?:(?:послання\s*апостола\s*|(?:Послання\s*)?)Іва|Іоан)н)а|т(?:а\s*п(?:ослание\s*на|исмо\s*од)\s*апостол\s*Јован|о\s*п(?:(?:ослание\s*на\s*апостол\s*Јов|ослание\s*на\s*[ИЙ]о)|исмо\s*од\s*апостол\s*Јов)ан|(?:(?:а\s*Јов|а\s*[ИЙ]о)ано|о\s*(?:Јов|[ИЙ]о)ано)во|[яє]\s*[ИЙ]оаново)|ћ(?:ом\s*(?:посланица\s*)?Јованова|а\s*(?:посланица\s*)?Јованова))|(?:3-?(?:тє|а)\.\s*(?:соборне\s*послання\s*св\.?\s*апостола\s*Іоанн|(?:(?:послання\s*апостола\s*|(?:Послання\s*)?)Іва|Іоан)н)|(?:3(?:-?е\.?\s*с|\.?\s*с)|III\.?\s*с)оборне\s*послання\s*св\.?\s*апостола\s*Іоанн|3-?(?:тє|а)\s*(?:соборне\s*послання\s*св\.?\s*апостола\s*Іоанн|(?:(?:послання\s*апостола\s*|(?:Послання\s*)?)Іва|Іоан)н)|(?:(?:3(?:-?е\.?\s*посланн|\.?\s*посланн)|III\.?\s*посланн)я\s*апостола\s*Ів|(?:(?:3(?:-?е\.?\s*П|\.?\s*П)|III\.?\s*П)ослання\s*Ів|(?:(?:3(?:-?е\.?\s*Иох|(?:-?я|[ея])\.?\s*Иох|\.?\s*Иох)|(?:3(?:-?е\.?\s*І|\.\s*І)|III\.?\s*І)в)|3\s*Ів)))ан|3(?:(?:-?е\.?\s*послани|\.?\s*послани)е\s*И|(?:-?я|[ея])\.?\s*послание\s*И)оанн|3(?:-?е\.?\s*Иоанн|\.?\s*Иоанн)|3(?:-?я|[ея])\.?\s*Иоанн|(?:(?:3(?:-?е\.?\s*І|\.\s*І)|III\.?\s*І)|3\s*І)оанн)а|யோவ(?:ான்\s*(?:எழுதிய\s*ம(?:ுன்றாம்\s*திருமுக|ூன்றாம்\s*கடித)|மூன்றாம்\s*திருமுக)|ன்\s*எழுதிய\s*மூன்றாவது\s*நிருப)ம்|Y(?:o(?:va[nṉ]\s*E[lḻ]utiya\s*M[uū][nṉ][rṛ][aā]vatu\s*Nirupam|oxanaa\s*Saddexaad)|ōva[nṉ]\s*E[lḻ]utiya\s*M[uū][nṉ][rṛ][aā]vatu\s*Nirupam)|(?:T(?:r(?:e(?:tje\s*poslannja\s*apostola\s*Ivan|[cæć]a\s*Ivanova\s*[Pp]oslanic)|zeci(?:a\s*(?:List\s*(?:[sś]w\.?\s*Jan|Jan)|Jan)|\s*(?:List\s*(?:[sś]w\.?\s*Jan|Jan)|Jan)))|řet[ií]\s*Janov)|(?:III\.?\s*Ivanova\s*P|3\.?\s*Ivanova\s*P)oslanic|(?:III\.?\s*L|3\.?\s*L)ist\s*(?:[sś]w\.?\s*Jan|Jan)|Se(?:vom\s*?Yoohann|h\s*?Yoohann|\s*?Yoohann)|III\.?\s*Yooxana|3\.?\s*Yooxana|3\.\s*Yoohann|3\s*Yoohann|۳\s*?Yoohann|3Yoohann|3\s*Yahy)a|(?:III\.?\s*послание\s*н|3\.?\s*послание\s*н)а\s*апостол\s*Јован|א(?:גרתו\s*השלישית\s*של\s*יוחנן\s*השליח|יגרת\s*יוחנן\s*השלישית)|אגרתו\s*השלישית\s*של\s*יוחנן\s*השלי|(?:III\.?\s*пи|3\.?\s*пи)смо\s*од\s*апостол\s*Јован|(?:رسالة\s*القديس\s*)?يوحنا\s*الثالثة|T(?:er(?:z(?:(?:a\s*lettera\s*di|o)|a)\s*Giovanni|cer(?:o\s*(?:San\s*J[au][au]n|J[au][au]n)|\s*(?:San\s*J[au][au]n|J[au][au]n)))|re(?:dje\s*Johannesbrevet|t(?:i\s*J[aá]nov\s*lis|í\s*J[aá]nov\s*lis)t|t[ií]\s*Janova)|(?:roisi[eè]mes?\s*Jea|hird\s*J(?:o?ph|h[ho]|oo))n|atu\s*Yohan[ae]|hird\s*J(?:oh[mn]|h?n))|y(?:ū(?:ḥannā\s*kā\s*tīsrā\s*ʿām\s*ḫaṭ|h(?:ann[aā]ko\s*testro\s*patra|ãnā\s*dī\s*tījī\s*pattrī))|uhann[aā]ko\s*testro\s*patra|oh[aā]n[aā]ce[mṃ]\s*tisre\s*patra)|(?:Kolmas\s*Johannek|(?:III\.?\s*Johannek|3\.?\s*Johannek))sen\s*kirje|Waraka\s*wa\s*Tatu\s*wa\s*Yohane|(?:III\.?\s*посланиц|3\.?\s*посланиц)а\s*Јованова|Barua\s*ya\s*Tatu\s*ya\s*Yohane|ی(?:ُوحنّا\s*کا\s*تیسرا\s*عام|(?:وحنا\s*کا\s*تیسرا\s*عام|(?:وحنّا\s*کا\s*(?:تیسرا|3\.|۳)|وحنّا\s*کا\s*3)))\s*خط|य(?:ूहन्नाको\s*तेस्(?:त्)?रो\s*पत्र|ोहानाचें\s*तिसरे\s*पत्र)|Þriðja\s*(?:br[eé]f\s*J[oó]hannesar|J[oó]hannesarbr[eé]f)|(?:Tredje\s*Johannes['’]|3\.?\s*Johannes['’])\s*Brev|Johannes(?:(?:(?:(?:'\s*Tredje|'\s*3\.?)\s*B|’\s*(?:Tredje|3\.?)\s*B)|’\s*tredje\s*b)|\s*tredje\s*b)rev|ਯੂਹੰਨਾ\s*ਦੀ\s*ਤੀਜੀ\s*ਪੱਤ੍ਰੀ|Epistula\s*I(?:II\s*Ioannis|oannis\s*III)|T(?:re(?:dje\s*Joh(?:annes(?:brev)?)?|[cæć]a\s*Ivanova|t(?:i\s*J(?:an(?:ov)?|ánov)?|í\s*J(?:an(?:ov)?|ánov)?))|hird\s*J(?:oh?|h)|řet[ií]\s*J(?:an)?|atu\s*Yoh)|رسالة\s*يوحنا\s*الثالثة|Kolmas\s*Johanneksen|3(?:e\.?\s*Johannesbreve|(?:(?:\s*[ei]\.?\s*Gj|\s*Gj)|\.\s*Gj)oni)t|(?:T(?:ret(?:i(?:a\s*(?:kniha\s*J[aá]no|J[aá]no)|\s*Jan[uů])|í\s*Jan[uů])|ret[ií]\s*list\s*Jan[uů]|řet[ií]\s*(?:list\s*Jan[uů]|Jan[uů]))|(?:III\.?\s*l|3\.?\s*l)ist\s*Jan[uů]|III(?:\.\s*Jan[uů]|\s*Jan[uů])|3\s*k\.\s*J[aá]no|3\s*k\s*J[aá]no|3\.?\s*Jan[uů])v|ଯୋହନଙ୍କ\s*ତୃତୀୟ\s*ପତ୍ର|3\.?\s*Johannesbrevet|(?:III\.?\s*Johannek|3\.?\s*Johannek)sen|(?:M[uū][nṉ][rṛ][aā]vatu\s*யோவான|ம(?:ூன்றாவது|ுன்றாம்)\s*யோவான|3(?:\s*(?:அருளப்பர|யோவான)|\.\s*யோவான))்|3\.?\s*Johannes(?:brev)?|Se(?:vom(?:\s*Y(?:o(?:ohanaah|han[an]ah)|uhan[an]ah)|Y(?:o(?:ohanaah|han[an]ah)|uhan[an]ah))|h(?:\s*Y(?:o(?:ohanaah|han[an]ah)|uhan[an]ah)|Y(?:o(?:ohanaah|han[an]ah)|uhan[an]ah))|\s*Y(?:o(?:ohanaah|han[an]ah)|uhan[an]ah)|Y(?:o(?:ohanaah|han[an]ah)|uhan[an]ah))|(?:D(?:ritt|erd)e\s*Johanne|Harmadik\s*J[aá]no)s|sevvom(?:\s*yohannā|yo)|Se(?:vom(?:\s*Y(?:o(?:ohana|hann?a)|uhann?a)|Y(?:o(?:ohana|hann?a)|uhann?a))|h(?:\s*Y(?:o(?:ohana|hann?a)|uhann?a)|Y(?:o(?:ohana|hann?a)|uhann?a))|\s*Y(?:o(?:ohana|hann?a)|uhann?a)|Y(?:o(?:ohana|hann?a)|uhann?a))|III(?:\.\s*(?:J(?:oh(?:annes|[mn])|an(?:o(?:va|s)|a)|áno[sv]|n)|Јованов[ао]|Yohan(?:es|a)|Giăng|In)|\s*(?:J(?:oh(?:annes|[mn])|an(?:o(?:va|s)|a)|áno[sv]|n)|Јованов[ао]|Yohan(?:es|a)|Giăng|In))|(?:(?:I(?:katlong\s*Ju|II(?:\.\s*(?:Yokan|Je)|\s*(?:Yokan|Je)))|3\.?\s*Yokan|3(?:e\.?\s*Je|\.?\s*Je))a|III(?:\.\s*(?:Gioa|J(?:oo|a[au]))|\s*(?:Gioa|J(?:oo|a[au])))|3[eè]me\.\s*Jea|(?:III(?:\.\s*Jo?p|\s*Jo?p)|3(?:\.\s*Jo?p|\s*Jo?p|Jo))h|3rd\.\s*J(?:o?ph|h[ho]|oo)|3[eè]me\s*Jea|(?:III\.?\s*Jh|3\.?\s*Jh)[ho]|3rd\s*J(?:o?ph|h[ho]|oo)|3\.?\s*Gioa|3(?:\.\s*Joo|\s*(?:Joo|Yh))|3\.?\s*Ja[au])n|(?:III\.?\s*S|3(?:o\.?\s*S|\.?\s*S))an\s*J[au][au]n|3(?:\.[oº]|º)\.\s*(?:San\s*J[au][au]n|J[au][au]n)|(?:III\.?\s*Giov|3\.?\s*Giov)anni|(?:Terceir[ao]\s*Jo[aã]|3(?:\.\s*(?:y[uū]hann[aā]k|Jo[aã])|\s*(?:(?:yūhann[aā]k|Jo[aã])|yuhann[aā]k))|III(?:\.\s*Jo[aã]|\s*Jo[aã])|3o\.?\s*Jo[aã]|3a\.\s*Jo[aã]|3a\s*Jo[aã])o|3-?(?:тє|а)\.\s*[ИЙ]оаново|تیسرا(?:(?:\s*یُوحنّ|(?:\s*یوحنّ|۔یوحن))|-?یُوحنّ)ا|رسالة\s*يوحنا\s*3|השלישית\s*יוחנן|3(?:(?:(?:e(?:\.\s*Joh(?:annes)?|\s*Joh(?:annes)?)|\.\s*(?:यूहन्ना|Иоан|J(?:oh?)?)|\s*(?:यूहन्ना|(?:(?:(?:योहान|யோ(?:வா)?|Yoh|Gj|Iv|Ів)|J(?:oh?)?)|Иоан))|Yoh)|yoh?)|یو(?:حن?)?)|III(?:\.\s*(?:I(?:vanova|oan)|Yo(?:h(?:ane)?|ox)|J(?:an(?:ov)?|oh?)?|Јован|Gi)|\s*(?:I(?:vanova|oan)|Yo(?:h(?:ane)?|ox)|J(?:an(?:ov)?|oh?)?|Јован|Gi))|3(?:(?:(?:(?:\.\s*(?:य(?:ूहन्नाको|ुहत्रा)|ยอห์น|J(?:oh[mn]|n))|\s*(?:(?:(?:(?:(?:yoh[aā]n[aā]ce[mṃ]|योहानाच|ਯੂਹੰਨਾ|Y(?:ova[nṉ]|ōva[nṉ])|Gv|In|Јн|Ин|Йн|يو|ยน)|J(?:oh[mn]|n))|ยอห์น)|युहत्रा)|यूहन्नाको)|요한)|yohn)|یوحن[آةهىی])|\s*یوحن[آةهىی])|3(?:\.[oº]|º)\s*(?:San\s*J[au][au]n|J[au][au]n)|3°\.\s*Giovanni|(?:3(?:-?е\.?\s*Иоано|\.?\s*Иоано)|(?:(?:III(?:\.\s*[ИЙ]|\s*[ИЙ])|3\.\s*Й)|3\s*Й)оано)во|3-?е\.?\s*Йоаново|3-?(?:тє|а)\s*[ИЙ]оаново|(?:III\.?\s*Ioann|3\.?\s*Ioann)is|Трет(?:(?:а\s*Јов|а\s*[ИЙ]о)ан|о\s*(?:Јов|[ИЙ]о)ан)|3\.\s*Јованов[ао]|3°\s*Giovanni|(?:3\s*Yoo?|3Yoo)hanaah|۳\s*?Y(?:o(?:ohanaah|han[an]ah)|uhan[an]ah)|س(?:وم\s*یو[حه]ن(?:ا(?:ءه|[ته])|[آةهىی])|ومیو[حه]ن(?:ا(?:ءه|[ته])|[آةهىی])|ه(?:\s*یو[حه]ن(?:ا(?:ءه|[ته])|[آةهىی])|یو[حه]ن(?:ا(?:ءه|[ته])|[آةهىی])))|Harmadik\s*Jn|Ioannis\s*III|ତୃତୀୟ\s*ଯୋହନଙ|3\.\s*I(?:vanova|oan)|س(?:وم\s*یو[حه]ناء?|ومیو[حه]ناء?|ه(?:\s*یو[حه]ناء?|یو[حه]ناء?)|ومیو)|3\.\s*Yohan(?:es|a)|3\s*Јованов[ао]|(?:Third\s*Jon|III(?:\.\s*J(?:on|ó)|\s*J(?:on|ó))|3rd\.\s*Jon|3rd\s*Jon|3(?:\.\s*J(?:on|ó)|\s*J(?:on|ó)))h|3\s*Yohannah|3\s*?Yuhan[an]ah|Ιω[άα]ννου\s*Γ['ʹʹ΄’]|Yohane\s*III|(?:3\.|[3۳])\s*یُوحنّا|(?:3\.|۳)-?یُوحنّا|3\s*Ivanova|3\.\s*Yoh(?:ane)?|(?:3\s*Yoo?|3Yoo)hana|3\s*Yohanna|3\s*?Yuhann?a|۳\s*?Y(?:o(?:ohana|hann?a)|uhann?a)|Derde\s*Joh|(?:(?:III(?:\.\s*[ИЙ]|\s*[ИЙ])|3\.\s*Й)|3\s*Й)оан|3\.?\s*Jan(?:o(?:va|s)|a)|3\s*Yohanes|요(?:한(?:의\s*셋째\s*서간|[3삼]서)|삼)|3rd\.\s*J(?:oh[mn]|h?n)|(?:III\.?\s*Ju|3(?:o(?:\.\s*J[au]|\s*J[au])|\.?\s*Ju))[au]n|3Yohan[an]ah|Γ['ʹʹ΄’]\s*(?:Ιω[άα]ννη|᾿Ιω)|(?:3\s*?یوحنا|۳\s*?یوحنا)(?:ءه|[ته])|(?:3\s*?یوه|۳\s*?یوه)ن(?:ا(?:ءه|[ته])|[آةهىی])|J[aá]nos\s*III|ヨハネの(?:第三の(?:手紙|書)|手紙[Ⅲ三])|3\.\s*یوحنّا|3-?یُوحنّا|3\.?\s*Jan(?:ov)?|3\s*Yohane|3\.\s*Јован|3rd\.\s*J(?:oh?|h)|3Yohann?a|(?:3\s*?یوحنا|۳\s*?یوحنا)ء?|(?:3\s*?یوه|۳\s*?یوه)ناء?|3\.?\s*Jáno[sv]|3\.?\s*Giăng|(?:III\.?\s*Jh|3\.?\s*Jh)n|3rd\s*J(?:oh[mn]|h?n)|3\s*yūhãnā|(?:[3۳]\s*یوحنّ|(?:3\.?۔|۳۔)یوحن)ا|3\.?\s*ଯୋହନଙ|3\.?\s*Yoox|3\s*Јован|III\.?\s*Jh|3rd\s*J(?:oh?|h)|۳(?:\s*یوحن[آةهىی]|یوحن[آةهىی]|yohn)|3\s*Ioan|(?:《(?:约(?:翰[三叁]书|[三叁])|約[三叁])|《?伊望第三|约(?:翰[三叁]书|[三叁])|約[三叁])》|(?:《約翰[三參]|約翰[三參])書》|《?若望三書》|۳(?:یو(?:حن?)?|yoh?)|3\.?\s*Gi|3\.?\s*Jh|Γ['ʹʹ΄’]\s*Ιω|《(?:约(?:翰[三叁]书|[三叁])|約[三叁])|《?伊望第三|(?:《約翰[三參]|約翰[三參])書|《?若望三書|3\.\s*In|Ⅲ\s*ヨハネ|约(?:翰[三叁]书|[三叁])|三ヨハネ|約[三叁]))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["John"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:(?:The\s*Gospel\s*(?:according\s*to\s*(?:S(?:aint\s*J(?:o?ph|h[ho]|oo)|t(?:\.\s*J(?:o?ph|h[ho]|oo)|\s*J(?:o?ph|h[ho]|oo)))|J(?:o?ph|h[ho]|oo))|of\s*(?:S(?:aint\s*J(?:o?ph|h[ho]|oo)|t(?:\.\s*J(?:o?ph|h[ho]|oo)|\s*J(?:o?ph|h[ho]|oo)))|J(?:o?ph|h[ho]|oo)))|yoh(?:an[aā]ne\s*lihilele\s*[sŝ]ubʰavartam[aā]|ān[aā]ne\s*lihilele\s*[sŝ]ubʰavartam[aā])|Gospel\s*(?:according\s*to\s*(?:S(?:aint\s*J(?:o?ph|h[ho]|oo)|t(?:\.\s*J(?:o?ph|h[ho]|oo)|\s*J(?:o?ph|h[ho]|oo)))|J(?:o?ph|h[ho]|oo))|of\s*(?:S(?:aint\s*J(?:o?ph|h[ho]|oo)|t(?:\.\s*J(?:o?ph|h[ho]|oo)|\s*J(?:o?ph|h[ho]|oo)))|J(?:o?ph|h[ho]|oo)))|El\s*Evangelio\s*de\s*J[au][au]|Saint\s*J(?:o?ph|h[ho]|oo)|St\.\s*J(?:o?ph|h[ho]|oo)|St\s*J(?:o?ph|h[ho]|oo)|Gioa|Jo?ph|J(?:oo|a[au]|ea)|Ju[au]|Jh[ho])n|The\s*Gospel\s*(?:according\s*to\s*(?:S(?:aint\s*J(?:o(?:h[mn]|nh)|h?n)|t(?:\.\s*J(?:o(?:h[mn]|nh)|h?n)|\s*J(?:o(?:h[mn]|nh)|h?n)))|J(?:o(?:h[mn]|nh)|h?n))|of\s*(?:S(?:aint\s*J(?:o(?:h[mn]|nh)|h?n)|t(?:\.\s*J(?:o(?:h[mn]|nh)|h?n)|\s*J(?:o(?:h[mn]|nh)|h?n)))|J(?:o(?:h[mn]|nh)|h?n)))|The\s*Gospel\s*(?:according\s*to\s*(?:S(?:aint\s*Jo?h|t(?:\.\s*Jo?h|\s*Jo?h))|Jo?h)|of\s*(?:S(?:aint\s*Jo?h|t(?:\.\s*Jo?h|\s*Jo?h))|Jo?h))|Mabuting\s*Balita\s*ayon\s*kay\s*(?:San\s*)?Juan|Gospel\s*(?:according\s*to\s*(?:S(?:aint\s*J(?:o(?:h[mn]|nh)|h?n)|t(?:\.\s*J(?:o(?:h[mn]|nh)|h?n)|\s*J(?:o(?:h[mn]|nh)|h?n)))|J(?:o(?:h[mn]|nh)|h?n))|of\s*(?:S(?:aint\s*J(?:o(?:h[mn]|nh)|h?n)|t(?:\.\s*J(?:o(?:h[mn]|nh)|h?n)|\s*J(?:o(?:h[mn]|nh)|h?n)))|J(?:o(?:h[mn]|nh)|h?n)))|(?:Evankeliumi\s*Johanneksen\s*muka|Yokan|Iv)an|Gospel\s*(?:according\s*to\s*(?:S(?:aint\s*Jo?h|t(?:\.\s*Jo?h|\s*Jo?h))|Jo?h)|of\s*(?:S(?:aint\s*Jo?h|t(?:\.\s*Jo?h|\s*Jo?h))|Jo?h))|य(?:ोहानाने\s*लिहिलेले\s*शुभवर्तमान|ूहन(?:्ना(?:ले\s*लेखे)?को\s*सुसमाचार|ा)|(?:ूहा|हू)न्ना|ुह(?:त्र|न्न)ा)|Ebanghelyo\s*ayon\s*kay\s*(?:San\s*)?Juan|E(?:van(?:geli(?:um\s*secundum\s*Ioannem|e(?:\s*volgens|t\s*etter)\s*Johannes)|gelium\s*podle\s*Jana|jelium\s*Pod[lľ]a\s*J[aá]na|[ðđ]elje\s*po\s*Ivanu)|(?:(?:w(?:angelia\s*w(?:edług\s*[sś]w\.|g\s*[sś]w\.)|\.)\s*|(?:wangelia\s*w(?:edług\s*[sś]w\s*|g\s*[sś]w\s*)|wangelia\s*))|w\s*)Jana)|y(?:uhann[aā]le\s*lekʰeko\s*susm[aā]c[aā]r|ū(?:h(?:ann[aā]le\s*lekʰeko\s*susm[aā]c[aā]r|ãnā\s*dī\s*ĩjīl)|ḥannā\s*kī\s*injīl)|ohannān)|От\s*Иоана\s*свето\s*Евангелие|Еван(?:гелие(?:то\s*според\s*Јов|\s*(?:според\s*Јов|от\s*Йо))ан|ђеље\s*по\s*Јовану)|யோவான்\s*எழுதிய\s*சுவிசேஷம்|(?:Johanneksen\s*evankelium|Y(?:ov[aā][nṉ]\s*Na[rṛ]ceyt|ōv[aā][nṉ]\s*Na[rṛ]ceyt)|Gjon)i|Vangelo\s*di\s*(?:San\s*)?Giovanni|Євангелі(?:я\s*від\s*(?:св\.?\s*І|І)вана|є\s*від\s*(?:св(?:\.\s*[ИЙ]оана|\s*[ИЙ]оана)|Івана))|யோவான்\s*(?:எழுதிய\s*)?நற்செய்தி|(?:Ebanghelyo|Sulat)\s*ni\s*San\s*Juan|Jevanhelije\s*vid\s*Ivana|ଯୋହନ\s*ଲିଖିତ\s*ସୁସମାଗ୍ଭର|Jevanđelje\s*po\s*Ivanu|J(?:ohannis|anovo)\s*evangelium|J[oó]hannesarguðspjall|Јеванђеље\s*по\s*Јовану|(?:Евангелие\s*от\s*|(?:От\s*)?)Иоанна|அருளப்பர்\s*நற்செய்தி|พระวรสารนักบุญจอห์น|Johannesevangeliet|הבשורה\s*על[\s*-]פי\s*יוחנן|Евангелие\s*от\s*Иоан|Ungjilli\s*i\s*Gjonit|Injili\s*ya\s*Yohan[ae]|ی(?:ُوحنّا\s*کی\s*انجیل|و(?:حنا\s*کی\s*انجیل|(?:حن(?:اءه|(?:ا[تهی]|[آةهىی]))|هن(?:ا(?:ءه|[ته])|[آةهىی]))))|ਯੂਹ(?:ੰਨਾ\s*ਦੀ\s*ਇੰਜੀਲ|ਾਂਨਾ)|Injil\s*Yohanes|Κατ[άα]\s*Ιω[άα]ννην|J(?:oh(?:anne(?:ksen|s))?|án|óh)|إنجيل\s*يوحنا|Saint\s*J(?:o(?:h[mn]|nh)|h?n)|y(?:uhann[aā]le|ūh(?:ann[aā]le|ãnā)|oh(?:an[aā]ne|ān[aā]ne|annā))|य(?:ूहन्ना(?:ले)?|ोहान(?:ाने)?)|Saint\s*Jo?h|ヨハネ(?:による福音書|[の傳]福音書|福音書|伝)|(?:Y(?:oo?hana|uhana)a|Jon)h|Від\s*Івана|От\s*Иоана|Y(?:oh(?:annah|(?:ane)?s)|uhannah)|Y(?:oo(?:xana|hann)|ahy)a|St\.\s*J(?:o(?:h[mn]|nh)|h?n)|Giovanni|San\s*Juan|Y(?:o(?:(?:o?hana|(?:h(?:ane)?|ox))|hanna)|uhann?a|ov[aā][nṉ]|ōv[aā][nṉ])|ی(?:ُوحنّا|و(?:ح(?:ناء|(?:نا?)?)|هناء?))|St\.\s*Jo?h|Ιω[άα]ννης|Ioannes|St\s*J(?:o(?:h[mn]|nh)|h?n)|Ew\s*Jan|யோவா(?:ன்)?|St\s*Jo?h|ਯੂਹੰਨਾ|요한\s*?복음서|(?:《[約约]翰|约翰|約翰)福音》|《?若望福音》|요(?:한(?:\s*복음|복음)?)?|(?:《[約约]翰|约翰|約翰)福音|《?若望福音|G(?:iăng|[gv])|J(?:an(?:os|a)|o(?:h[mn]|[aã]o)|ána|n)|И(?:оана|н)|Й(?:оана|н)|János|يوحنا|Иохан|Јован|יוחנן|Івана|ยอห์น|Ioan|Ιω(?:[άα]ν)?|Иоан|Йоан|ଯୋହନ|《?伊望》|G(?:jo|i)|ヨハネ|《?伊望|《[約约]》|Jhn|Ів|يو|《[約约]|Jh|Ін|Јн|Ἰω|ย[นฮ]|约》|約》|约))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Josh"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:Книга\s*(?:на\s*Исус\s*Н(?:авиев|евин)|Иисуса\s*Навина|Ісуса\s*Навина|Иисус\s*Навин|Єгошу[ії])|யோசுவாவின்\s*புத்தகம்|ଯିହୋଶୂୟଙ୍କର(?:\s*ପୁସ୍ତକ)?|Ιησ(?:ο[υύ]ς\s*του\s*Ναυ[ήη]|\s*Ναυ[ήη])|y(?:a(?:ho(?:s[uū]ko\s*pustak|š(?:u(?:ko\s*pustak|ā)|ūko\s*pustak)|saw[aā]|ŝaw[aā])|šūʿ)|ūsh['’](?:ai|ā))|Ks(?:i[eę]g[ai]\s*Jozuego|\.?\s*Jozuego)|यहोश(?:ूको\s*पुस्तक|वा|ु)|(?:J(?:(?:o(?:osuan\s*kirj|shu|usu)|o[sz]uov|ošuov|ózuov)|oushu)|Y(?:ashuuc|o(?:s(?:hu['’]|u)|sh['’]u|wshu)|ushu))a|(?:Ии|І)суса\s*Навина|Li(?:ber\s*Iosue|v\s*Jozye\s*a)|(?:Ии|І)сус\s*Навин|(?:И(?:сус\s*Навие|На)|Ии?с\.\s*На|Ии?с\s*На|І\.?\s*На)в|J(?:o(?:s(?:vas\s*Bog|u[eé])|zu(?:eu|a))|ozsu[eé]|óz(?:su[eé]|ua)|ošua|š)|Josvabogen|I(?:osu(?:a\s*Navi|e)|sus\s*Navyn)|Исус\s*Навин|(?:J(?:os(?:(?:vas\s*bo|uab[oó])|úab[oó])|ós[uú]ab[oó])|Yusa)k|J(?:o(?:(?:s(?:va(?:bog|s)?|ua|h)?|os(?:uan)?|z(?:ue)?)|zs)|óz?s)|y(?:aho(?:s[uū]ko|š[uū]ko)|ūsh['’]a)|(?:Yahosho|Jozueg)o|سفر\s*يشوع|Ιη(?:σ\s*Ναυ)?|यहोशू(?:को)?|G(?:i(?:ô(?:-?su[aê]|s)|osu[eèé])|su[aê])|Y(?:osh(?:uah|a)|usha)|ਯਹੋਸ਼ੁਆ|Y(?:os(?:hua)?|ash)|யோசு(?:வா)?|Y[oō]cuv[aā]|(?:《?約書亞記|《?约书亚记|《[书書]|书)》|《?若蘇厄書》|โยชูวา|Єгошу[ії]|Ios(?:ua)?|《?約書亞記|《?约书亚记|《?若蘇厄書|یو(?:ش(?:ع[عهوی]|ا)|وش[اع])|여호수아기|יהושע|Jozye|ヨシュア記|(?:ی(?:وش[ئهوی]|شو)|يشو)ع|یشُوع|(?:Иешу|Ј[ео]шу)а|Навин|یوشع?|여호(?:수아)?|ヨシュア|G(?:iô|s)|Иеш|Нав|Jsh|ยชว|Js|Єг|يش|《[书書]|Ἰη|書》|书|수))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Esd"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:(?:(?:K(?:itabu\s*cha\s*Kwanza\s*ch|wanz)a\s*Ez|E(?:nsimm[aä]inen|rste)\s*Es|F[oö]rsta\s*Es|Eerste\s*Ez|III\.?\s*Ezd|(?:Unang|1e\.)\s*Ez|Derde\s*Ez|3(?:\.?\s*Ezd|e\.?\s*Ez)|(?:Una|1e)\s*Ez)r|P(?:ierwsz[aey]\s*(?:Ks(?:i[eę]g[ai]\s*Ezdrasz|\.?\s*Ezdrasz)|Ezdrasz)|rv(?:[aá]\s*kniha\s*Ezdr[aá][sš]ov|[yý]\s*(?:list\s*Ezdr[aá][sš]ov|Ezdr[aá][sš]ov)|[aá]\s*Ezdr[aá][sš]ov))|(?:1\.?\s*K|I\.?\s*K)s(?:i[eę]g[ai]\s*Ezdrasz|\.?\s*Ezdrasz)|1\s*k\.\s*Ezdr[aá][sš]ov|1\s*k\s*Ezdr[aá][sš]ov|(?:1\.?\s*Ezdraso|I\.?\s*Ezdraso)v|(?:1\.?\s*Ezdraš|I\.?\s*Ezdraš)ov|(?:1\.?\s*Ezdrá|I\.?\s*Ezdrá)[sš]ov|1\.?\s*Ez(?:drasz|r)|I(?:\.\s*E(?:z(?:drasz|r)|sr)|\s*E(?:z(?:drasz|r)|sr))|Første\s*Esr|III\.?\s*Ezr|3°\.\s*Esdr|3(?:e\.?\s*Esr|\.\s*E[sz]r|\s*E[sz]r)|3°\s*Esdr)a|П(?:ърв(?:(?:а\s*книга\s*на|о)|а)\s*Ездра|рва\s*(?:Је|Е)здрина|ерш[ае]\s*Ездр[аи])|Pr(?:v(?:[aá]\s*kniha\s*Ezdr[aá][sš]|[yý]\s*(?:list\s*Ezdr[aá][sš]|Ezdr[aá][sš])|[aá]\s*Ezdr[aá][sš])|im[ao]\s*Esdra)|Pr(?:emi(?:eres?\s*Esdras|ères?\s*Esdras|ers?\s*Esdras)|ime(?:ir[ao]|ro)\s*Esdras|imer\s*Esdras|im[ao]\s*Esdras|vn[ií]\s*Ezdr[aá][sš]|im[ao]\s*Ésdras)|(?:Første\s*Esdras|(?:1\.?\s*Esdras|3\.?\s*Esdras))bog|T(?:redje\s*Es(?:drasbog|ra)|erz[ao]\s*Esdra)|Liber\s*(?:Esdrae\s*I|I\s*Esdrae)|F(?:ørste\s*Esdras|irst\s*Esdr?)|E(?:sdra(?:s\s*Yunani|\s*greco)|zra\s*Yunani)|(?:(?:Eerste|(?:(?:Unang|1e\.)|(?:Una|1e)))|Derde)\s*Esdras|(?:First\s*Esdra|Els[oő]\s*Ezdr[aá]|1st\.\s*Esdra|1st\s*Esdra)s|1(?:(?:(?:(?:ere|\.[oº]|[aoº])|er)|re)|ère)\.\s*Esdras|إسدراس\s*الأول|1\s*k\.\s*Ezdr[aá][sš]|1(?:(?:\s*(?:(?:எஸ்திராஸ்|Ездра)|Es(?:drae|ra))|\.\s*Es(?:drae|ra))|\.\s*Ездра)|III\.?\s*Esdras|1(?:(?:(?:(?:ere|\.[oº]|[aoº])|er)|re)|ère)\s*Esdras|1-?(?:ше|[ае])\.\s*Ездр[аи]|(?:1\.\s*Ј|I\.?\s*Ј)ездрина|III\.?\s*Esdra|1\s*k\s*Ezdr[aá][sš]|2(?:-?[ея]\.?\s*Ездры|[ея]\.?\s*Ездры|\.?\s*Ездры)|1°\.\s*Esdras|3e\.?\s*Esdras|(?:1°\.\s*É|1\.?\s*É|I\.?\s*É|1°\s*É)sdras|1-?(?:ше|[ае])\s*Ездр[аи]|(?:1\.?\s*Ездрин|I\.?\s*Ездрин)а|1\s*Јездрина|1\.?\s*Ezd(?:ras?)?|I(?:\.\s*(?:E(?:zd(?:ras?)?|sd(?:ra?)?)|Ездри)|\s*(?:E(?:zd(?:ras?)?|sd(?:ra?)?)|Ездри))|1st\.\s*Esdr?|1\.?\s*Esdras|3\.?\s*Esdras|1°\.\s*Esdra|1\.?\s*Ezdraš|I\.?\s*Ezdraš|(?:1\.?\s*Ezdrá|I\.?\s*Ezdrá)[sš]|I(?:\.\s*(?:Esdra[es]|Ездра)|\s*(?:Esdra[es]|Ездра))|Α['ʹʹ΄’]\s*[ΈΕ]σδρας|1°\s*Esdras|[ΈΕ]σδρας\s*Α['ʹʹ΄’]|חזון\s*עזרא|1(?:\.\s*Es(?:d(?:ra?)?|r)?|\s*(?:Es(?:d(?:ra?)?|r)?|(?:Ездр|Јез)))|1\.\s*Ездри|3\.?\s*Esdra|Els[oő]\s*Ezd|1st\s*Esdr?|1°\s*Esdra|Ezdr[aá]s\s*I|1\s*Ездри|Α['ʹʹ΄’]\s*[ΈΕ]σδρ?|에스드라\s*1서|エ[スズ](?:[トド]ラ第一巻|ラ第一書)|《1Esd》|《1Esd|2\s*Езд|1Esd》|1Esd))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Esd"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Kitabu\s*cha\s*Pili\s*cha\s*Ezra|(?:Dru(?:h(?:[aá]\s*kniha\s*Ezdr[aá][sš]ov|[yý]\s*(?:list\s*Ezdr[aá][sš]ov|Ezdr[aá][sš]ov)|[aá]\s*Ezdr[aá][sš]ov)|g[ai]\s*(?:Ks(?:i[eę]g[ai]\s*Ezdrasz|\.?\s*Ezdrasz)|Ezdrasz))|(?:II\.?\s*K|2\.?\s*K)s(?:i[eę]g[ai]\s*Ezdrasz|\.?\s*Ezdrasz)|2\s*k\.\s*Ezdr[aá][sš]ov|(?:II\.?\s*Ezdraso|2\.?\s*Ezdraso)v|(?:II\.?\s*Ezdraš|2\.?\s*Ezdraš)ov|(?:II\.?\s*Ezdrá|2\.?\s*Ezdrá)[sš]ov|2\s*k\s*Ezdr[aá][sš]ov|I(?:I(?:\.\s*E(?:z(?:drasz|r)|sr)|\s*E(?:z(?:drasz|r)|sr))|V\.?\s*Ezr)|2\.?\s*Ez(?:drasz|r)|Fjerde\s*Esr|Andre\s*Esr|4\.?\s*Esr|4\.?\s*Ezr)a|(?:Втор(?:а\s*книга\s*на|о)|III\.)\s*Ездра|Druh(?:[aá]\s*kniha\s*Ezdr[aá][sš]|[yý]\s*(?:list\s*Ezdr[aá][sš]|Ezdr[aá][sš])|[aá]\s*Ezdr[aá][sš])|2-?(?:ге|[ае])\.\s*(?:книга\s*Ездри|Ездр[аи])|Друг(?:а\s*(?:книга\s*Ездри|Ездра)|е\s*(?:книга\s*Ездри|Ездр[аи]))|Fjerde\s*Esdrasbog|(?:(?:(?:(?:Ikalawang|2e\.)|2e)|Tweede)|Vierde)\s*Esdras|Deuxi[eè]mes?\s*Esdras|2-?(?:ге|[ае])\s*(?:книга\s*Ездри|Ездр[аи])|Anden\s*Esdrasbog|Liber\s*(?:Esdrae\s*II|II\s*Esdrae)|(?:II\.?\s*к|2\.?\s*к)нига\s*Ездри|Second[ao]\s*Esdras|(?:M[aá]sodik\s*Ezdr[aá]|(?:Second\s*|2nd\.?\s*)Esdra)s|(?:Second[ao]\s*É|II\.?\s*É|2°\.\s*É|2\.?\s*É|2°\s*É)sdras|(?:Segund[ao]|2(?:(?:eme|(?:(?:\.[oº]|de|[aoº])|d))|ème)\.)\s*Esdras|(?:Друга\s*(?:Је|Е)здрин|(?:(?:II\.?\s*Ј|2\.\s*Ј)е|(?:(?:(?:II\.?\s*Е|2\.\s*Е)|2\s*Е)|2\s*Је))здрин)а|(?:(?:Ikalawang|2e\.)\s*Ez|Quart[ao]\s*Esd|Tweede\s*Ez|Vierde\s*Ez|(?:Toinen|Andra)\s*Es|Fj[aä]rde\s*Es|Zweite\s*Es|IV\.?\s*Ezd|4°\.\s*Esd|4\.?\s*Ezd|4°\s*Esd|2e\s*Ez)ra|Second(?:[ao]\s*Esdra|\s*Esdr?)|إسدراس\s*الثاني|E(?:sdras|zra)\s*Latin|(?:2\.?\s*Esdrasb|4\.?\s*Esdrasb)og|Andre\s*Esdras|עזרא\s*החיצוני|M[aá]sodik\s*Ezd|2\s*k\.\s*Ezdr[aá][sš]|Друга\s*Ездри|2(?:\s*(?:(?:எஸ்திராஸ்|Ездра)|Es(?:drae|ra))|\.\s*Es(?:drae|ra))|2(?:(?:eme|(?:(?:\.[oº]|de|[aoº])|d))|ème)\s*Esdras|Втора\s*Ездра|Трет[ао]\s*Ездра|II(?:\.\s*E(?:zd(?:ras?)?|sd(?:ra?)?)|\s*E(?:zd(?:ras?)?|sd(?:ra?)?))|II\.?\s*Ezdraš|(?:II\.?\s*Ezdrá|2\.?\s*Ezdrá)[sš]|2\s*k\s*Ezdr[aá][sš]|II(?:\.\s*Esdra[es]|\s*Esdra[es])|3(?:-?[ея]\.?\s*Ездры|[ея]\.?\s*Ездры|\.\s*Ездр[аы]|\s*Ездр[аы])|IV\.?\s*Esdras|2°\.\s*Esdras|2(?:\.?\s*Esdras|(?:\.\s*Es(?:d(?:ra?)?|r)?|\s*(?:Es(?:d(?:ra?)?|r)?|(?:Ездр|Јез))))|4(?:\.\s*Esdras?|\s*Esdras?)|2\.?\s*Ezd(?:ras?)?|2nd\.?\s*Esdr?|IV\.?\s*Esdra|2°\.\s*Esdra|2\.?\s*Ezdraš|(?:II\.?\s*Е|2\.\s*Е)здри|2°\s*Esdras|Β['ʹʹ΄’]\s*[ΈΕ]σδρας|Ezdr[aá]s\s*II|[ΈΕ]σδρας\s*Β['ʹʹ΄’]|(?:II\.?\s*Е|2\.\s*Е)здра|III\s*Ездра|Pili\s*Ezra|2°\s*Esdra|Β['ʹʹ΄’]\s*[ΈΕ]σδρ?|2\s*Ездри|에스드라\s*2서|エ[スズ](?:[トド]ラ第二巻|ラ第二書)|3\s*Ездр?|《2Esd》|《2Esd|2Esd》|2Esd))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Isa"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:ଯ(?:ିଶାଇୟ\s*ଭବିଷ୍ୟ‌ଦ୍‌ବକ୍ତାଙ୍କର\s*ପୁସ୍ତକ|[ାୀ]ଶାଇୟ)|ஏசாயா\s*தீர்க்கதரிசியின்\s*புத்தகம்|Книга\s*(?:на\s*пророк\s*Исаия|пророка\s*(?:Исаии|Іса[ії])|Іса[ий][ії])|ya(?:səiy[aā]ko\s*pustak|šəiy[aā]ko\s*pustak|s(?:(?:haayaa|(?:aʿ|ā)yā)h|ay[aā])|ŝay[aā])|(?:Ks(?:i[eę]g[ai]\s*Izajasz|\.?\s*Izajasz)|Jesa(?:jan\s*kirj|i)|E(?:ysheya['’]|sheya['’])|(?:E(?:ysh(?:a(?:['’]i|a)|['’])|sh(?:a(?:['’]i|a)|['’]))|I(?:ysha['’]|sha['’])|Y[eé]sa)y|I(?:za(?:jasz|ij)|-?sa(?:-?gi|i-?)|s(?:a[jy]|ih))|A(?:yshai?y|shai?y))a|य(?:श(?:(?:ैयाको\s*पुस्तक|ायाह)|या)|ेशैया)|Li(?:ber\s*Isaiae|v\s*Ezayi\s*a)|E(?:s(?:a(?:jas['’]\s*Bog|ie)|h(?:a(?:[iy]yah|['’]yaa|yaa)|eyaa))|ysh(?:a(?:[iy]yah|['’]yaa|yaa)|eyaa))|Jesajabok(?:en|a)|(?:Esaias['’]|Jesajas)\s*bok|سفر\s*إشعياء|ya(?:səiy[aā]ko|šəiy[aā]ko)|I(?:yshaiy|s(?:haiy|s))ah|Ishacyaah|E(?:ysha(?:(?:[iy])?|['’])ya|s(?:ha(?:(?:[iy])?|['’])ya|a(?:ias|jas)?))|Is(?:ai(?:a[ai]|s)h|aii(?:[ai])?h|aa(?:[ai](?:[ai])?h|h)|i[ai](?:[ai](?:[ai])?h|h)|a(?:ia?h|h))a|Iy?shayaa|ا(?:شع(?:يا\s*[يی]|یا\s*[يی])|شع[يی]\s*ی|[\s*ِ]شعی|یشی)ا|إشَعْياء|Is(?:ai(?:a[ai]|s)h|aii(?:[ai])?h|aa(?:[ai](?:[ai])?h|h)|i[ai](?:[ai](?:[ai])?h|h)|a(?:ia?h|h))|Iy?shaya|Jes(?:ajan?)?|यश(?:ैया(?:को)?|ा(?:या?)?)|Ezsai[aá]s|É(?:zsai[aá]s|sai[aá]s|saie)|Η(?:ΣΑ(?:Ϊ́|[ΊΙ])ΑΣ|σα[ΐι]ας)|اشع(?:\s*یاه|ي(?:ا[ءئاه]|ى)|ي[هی]ا|ی(?:ا[ءئاه]|[هی]ا|[آى]))|esh['’](?:āyā|a)|ਯਾ?ਸਾਯਾਹ|อ(?:ิสยาห์|สย)|I(?:z(?:ajas)?|s(?:a(?:ia?|ía)?|h)?|-?sa)|ا(?:ش(?:ع(?:\s*یا|يا|ي[هی]|ی(?:ا|[هی])?|ي)?)?|یش)|ଯିଶାଇୟ|I(?:sa(?:i(?:as|e)|ía[hs])|za(?:i[aá][sš]|j(?:aš|á[sš]))|a)|Esaiás|Иса(?:и?ја|и[ия]|я)|ישע(?:יהו|ה)|ی(?:سع|عس)یاہ|(?:《?以(?:賽(?:亞書|亚书)|赛亚书)|《[賽赛]|[賽赛])》|《?依撒意亞》|ﺃﺷﻌﻴﺎء|esh['’]ā|ישעיה|ஏசா(?:யா)?|《?以(?:賽(?:亞書|亚书)|赛亚书)|《?依撒意亞|īshiā|Ec[aā]y[aā]|Ezayi|Ê-?sai|எசாயா|إشعيا|(?:[EI]|É)saïe|ୟିଶାୟ|ୟଶାଇୟ|Ис(?:аи)?|Іса[яії]|이사야서|イ[サザ]ヤ書|Yes|Ezs|É(?:sa?|zs)|īsh|이사야?|ਯਸਾ|எசா|イ[サザ]ヤ|Ησ|Іс|《[賽赛]|Ys|Ἠσ|[賽赛]|사))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Sam"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:சாமுவேலின்\s*இரண்டாம்\s*புத்தகம்|Kitabu\s*cha\s*Pili\s*cha\s*Samueli|ଶାମୁୟେଲଙ୍କ\s*ଦ୍ୱିତୀୟ\s*ପୁସ୍ତକ|And(?:en\s*(?:Kongerigernes\s*B|Samuelsb)og|ra\s*Samuelsboken)|Cartea\s*(?:a\s*doua\s*a\s*Regilor|II\s*a\s*(?:lui\s*Samuel|Regilor))|Drug(?:a\s*(?:knjiga\s*o\s*Samuelu|Ks(?:i[eę]g[ai]\s*Samuela|\.?\s*Samuela))|i\s*Ks(?:i[eę]g[ai]\s*Samuela|\.?\s*Samuela))|(?:D(?:ru(?:g(?:a\s*(?:Samuelo(?:va\s*knjig|w)|Ks(?:i[eę]g[ai]\s*Samuelow|\.?\s*Samuelow))|i\s*(?:Ks(?:i[eę]g[ai]\s*Samuelow|\.?\s*Samuelow)|Samuelow))|h(?:(?:[aá]\s*kniha|[aá])\s*Samuelov|[yý]\s*(?:kniha\s*|(?:list\s*)?)Samuelov))|ezy[eè]m\s*liv\s*Samy[eè]l\s*l)|(?:II\.?\s*Ks|2\.?\s*Ks)(?:i[eę]g[ai]\s*Samuelow|\.?\s*Samuelow)|(?:II\.?\s*k|2\.\s*k)niha\s*Samuelov|2\s*kniha\s*Samuelov|Semuel\s*Yang\s*Kedu|2\s*k\.\s*Samuelov|II(?:\.\s*Samuelo[vw]|\s*Samuelo[vw])|2\s*k\s*Samuelov|2\.?\s*Samuelo[vw])a|Toinen\s*Samuelin\s*kirja|Втор(?:а\s*(?:книга\s*на\s*)?Самуил|а\s*Книга\s*на\s*царете|о\s*(?:Книга\s*на\s*царете|Цар(?:ства|е)|Самуил)|а\s*Цар(?:ства|е))|(?:Втор[ао]\s*книга\s*Самои|(?:II\.?\s*книга\s*Само|2\.?\s*книга\s*Само)и)лова|2-?(?:ге|а)\.\s*(?:книга\s*Саму[ії]лова|Саму[ії]лова)|Друг(?:а\s*книга\s*Саму[ії]лова|е\s*(?:книга\s*Саму[ії]лова|Саму[ії]лова)|(?:(?:а\s*краљевим|а\s*Саму[ії]лов)|а\s*Самуилов)а)|शम(?:ूएलको\s*दोस्रो|ुऐयल\s*की\s*[2२]री)\s*पुस्तक|2\.?\s*Kongerigernes\s*Bog|2-?е\.?\s*книга\s*Саму[ії]лова|2-?(?:ге|а)\s*(?:книга\s*Саму[ії]лова|Саму[ії]лова)|samūel\s*dī\s*dūjī\s*potʰī|II\.?\s*Книга\s*на\s*царете|(?:Втора\s*книга\s*Царст|(?:2(?:-?е(?:\.\s*Саму[ії]|\s*Саму[ії])|\.\s*Саму[ії]|\s*Саму[ії])|II(?:\.\s*Саму[иії]|\s*Саму[иії]))ло|2\.?\s*Самуило)ва|(?:II\.?\s*книга\s*Саму|2\.?\s*книга\s*Саму)[ії]лова|(?:II\.?\s*Ks|2\.?\s*Ks)(?:i[eę]g[ai]\s*Samuela|\.?\s*Samuela)|(?:II\.?\s*Samuelin|2\.?\s*Samuelin)\s*kirja|2\.?\s*Книга\s*на\s*царете|δυτικ[οό]ς\s*Σαμου[ήη]λ\s*Β['ʹʹ΄’]|ਸਮੂਏਲ\s*ਦੀ\s*ਦੂਜੀ\s*ਪੋਥੀ|2(?:-?е\.?\s*Книга\s*Царств|(?:-?я|[ея])(?:\.\s*(?:Книга\s*)?Царств|\s*(?:Книга\s*)?Царств)|(?:\.?\s*Книга\s*Ц|-?е\.?\s*Ц)арств|\s*(?:(?:(?:(?:(?:(?:(?:(?:[ei]\.?\s*Samuelit|ਸਮੂਏਲ)|Samuel(?:sbog|i[st]|[el]))|samūelko)|samuelko)|šam[uū]elko)|शमूएलको)|ซ(?:ามูเอล|มอ))|Самуила)|\.\s*(?:Samuel(?:sbog|i[st]|[el])|[sš]am[uū]elko|शमूएलको|ซ(?:ามูเอล|มอ)|Самуила)|사무)|S(?:[ií]ðari\s*Sam[uú]elsb[oó]k|amuu['’]eel\s*Labaad|econd(?:[ao]\s*Samuele|\s*S(?:amu[ae]l[ls]|ma))|amuelis\s*II|amueli?\s*II|ámuel\s*II)|Liber\s*II\s*Samuelis|سفر\s*صموئيل\s*الثاني|Andre\s*Samuelsbok|(?:Ikalawang|Deuxi[eè]mes|Zweite|2(?:(?:eme|(?:(?:\.[oº]|de|º)|d))|ème)\.)\s*Samuel|ଦ୍ୱିତୀୟ\s*ଶାମୁୟେଲଙ|D(?:ru(?:ga\s*Samuelova|h(?:[aá]\s*S(?:am(?:uel)?)?|[yý]\s*S(?:am(?:uel)?)?))|ovomSam)|T(?:oinen\s*Samuelin|weede\s*Sam)|ଦ୍ୱିତୀୟ\s*ଶାମୁୟେଲ|(?:2\.?\s*Samuelsboke|II\.?\s*Sa-?mu-?ê|2\.?\s*Sa-?mu-?ê)n|(?:Se(?:cond\s*Kingdom|gund[ao]\s*Reino)|(?:2nd\.?\s*Ki|(?:II\.?\s*Ki|2\.?\s*Ki))ngdom|(?:II\.?\s*Rei|2\.?\s*Rei)no|2[ao]\.\s*Reino|2[ao]\s*Reino)s|(?:Deuxi[eè]me\s*|2(?:(?:eme|(?:(?:\.[oº]|de|º)|d))|ème)\s*)Samuel|(?:D(?:o(?:(?:vom(?:\s*[Ss]|s)|s)am(?:ow(?:ey|i)|(?:u['w’]|oe)i|w[ei]i|u[ei])|vomSam(?:ow(?:ey|i)|u[ei])|vomSam(?:u['w’]|oe)i|vomSamw[ei]i|\s*sam(?:ow(?:ey|i)|(?:u['w’]|oe)i|w[ei]i|u[ei]))|ezy[eè]m\s*Samy[eè])|dovvom\s*samu['’]ī|Tweede\s*Samu[eë]|2-?(?:ге|а)\.\s*Samu[iï]|Друг(?:а\s*Samu[iï]|е\s*Samu[iï])|2-?е\.?\s*Samu[iï]|2-?(?:ге|а)\s*Samu[iï]|II(?:\.\s*Samu[iëï]|\s*Samu[iëï])|2\s*?Samow(?:ey|i)|(?:II\.?\s*Samy|2\.?\s*Samy)[eè]|2e\.\s*Samu[eë]|2(?:\s*(?:Sam(?:wei|u[iëï])|C[aā]muv[eē])|\.\s*Samu[iëï])|(?:2(?:\s*Sam(?:u['w’]|wi)|Samu['w’])|2\s*?Samoe)i|2\s*samūʾī|2e\s*Samu[eë]|2Samw[ei]i|2Samu[ei])l|(?:M[aá]sodik\s*S[aá]mu|II(?:\.\s*Samuu['’]e|\s*Samuu['’]e)|Do(?:(?:(?:vom(?:\s*[Ss]|s)|s)|vomS)|\s*s)amou|2(?:\.\s*Shamooa|\s*(?:Shamooa|[sŝ]amuw))|2\.?\s*Samuu['’]e|(?:II\.?\s*Sá|2\.?\s*Sá)mu|2\s*?Samou)el|(?:Segund[ao]\s*S|(?:2[ao]\.\s*|2[ao]\s*)S)amuel|صموئيل\s*الثّاني|الممالك\s*الثاني|2(?:\.\s*(?:S(?:a(?:m(?:uel(?:s(?:bok)?|i)?)?)?)?|Самуил|शमू(?:एल)?)|\s*Samuel(?:s(?:bok)?|i)?|\s*(?:samūel|சாமு|S(?:am?)?|Сам|صم|Ц)|\s*Самуил|\s*शमू(?:एल)?|Sa)|Second\s*S(?:a(?:m(?:u[ae]l)?)?|m)|(?:(?:II\.?\s*кр|2\.?\s*кр)аљевим|2(?:-?е\.?\s*Самуил|(?:-?я|[ея])\.?\s*Самуил))а|صموئيل\s*الثاني|And(?:en\s*Sam(?:uel)?|re\s*Sam(?:uel)?)|II\.?\s*Samuelin|Втор(?:а\s*Цар(?:ств)?|о\s*Цар(?:ств)?)|2-?(?:ге|а)\.\s*Саму[ії]л|Друг(?:а\s*Саму[ії]л|е\s*Саму[ії]л)|II(?:\.\s*(?:Samuel(?:is|[els])|Regnorum)|\s*(?:Samuel(?:is|[els])|Regnorum))|2nd\.?\s*S(?:amu[ae]l[ls]|ma)|(?:Pili\s*Sam[uw]|II\.?\s*Samw|2\.\s*Samw)eli|Βασιλει[ωώ]ν\s*Β['ʹʹ΄’]|दुसरे\s*शमुवेल|II(?:\.\s*S(?:a(?:m(?:ueli?)?)?)?|\s*S(?:a(?:m(?:ueli?)?)?)?)|2nd\.?\s*S(?:a(?:m(?:u[ae]l)?)?|m)|2\.?\s*Samuelin|M[aá]sodik\s*S[aá]m|(?:2(?:-?е(?:\.\s*Саму[ії]|\s*Саму[ії])|\.\s*Саму[ії]|\s*Саму[ії])|II(?:\.\s*Саму[иії]|\s*Саму[иії]))л|2-?(?:ге|а)\s*Саму[ії]л|2\.?\s*Regnorum|دو(?:م?\s*سم(?:و(?:ئ(?:یل[ہی]|ل)|یل)|و(?:ئ(?:یی|ي)|یی|ای)ل|(?:و(?:ئئ|ائ|ء)|ؤ)یل|ئویل)|م(?:-?سموئ|۔سموا)یل|مسم(?:و(?:ئ(?:یل[ہی]|ل)|یل)|و(?:ئ(?:یی|ي)|یی|ای)ل|(?:و(?:ئئ|ائ|ء)|ؤ)یل|ئویل)|سم(?:و(?:ئ(?:یل[ہی]|ل)|یل)|و(?:ئ(?:یی|ي)|یی|ای)ل|(?:و(?:ئئ|ائ|ء)|ؤ)یل|ئویل))|(?:II\.?\s*Samua|2\.?\s*Samua)l[ls]|2°\.\s*Samuele|(?:II\.?\s*Ц|2\.\s*Ц)ар(?:ства|е)|(?:II\.?\s*Regi|2\.?\s*Regi)lor|2\.?\s*ଶାମୁୟେଲଙ|دو(?:م?\s*سموئیل|مس(?:موئیل)?|سموئیل)|(?:II\.?\s*Samua|2\.?\s*Samua)l|(?:II\.?\s*Ц|2\.\s*Ц)ар(?:ств)?|2\.?\s*ଶାମୁୟେଲ|2°\s*Samuele|Β['ʹʹ΄’]\s*Σαμου[ήη]λ|2\s*(?:சாமுவேல|அரசுகள)்|(?:2(?:\.\s*|-?)سموئ|(?:2\.|۲)-?سموئ|(?:2\.?۔|۲۔)سموا|[2۲]سموئئ|[2۲]سموائ|2سم(?:وء|ؤ)|۲سم(?:وء|ؤ))یل|2\s*سم(?:و(?:ئ(?:یل[ہی]|ل)|یل)|و(?:ئ(?:یی|ي)|یی|ای)ل|(?:و(?:ئئ|ائ|ء)|ؤ)یل|ئویل)|۲\s*سم(?:و(?:ئ(?:یل[ہی]|ل)|یل)|و(?:ئ(?:یی|ي)|یی|ای)ل|(?:و(?:ئئ|ائ|ء)|ؤ)یل|ئویل)|2\s*Цар(?:ства|е)|2\s*Samweli|2\.?\s*शामुएल|Pili\s*Sam|2\s*سموئیل|۲\s*سموئیل|2\s*Цар(?:ств)?|[2۲]سموئ(?:یل[ہی]|ل)|(?:2\s*صموئي|[2۲]سموئ(?:یی|ي)|[2۲]سمویی|[2۲]سموای)ل|שמואל\s*ב['’]|2\s*शमुवेल|[2۲]سموئیل|2e\.\s*Sam|(?:II\.?\s*Sá|2\.?\s*Sá)m|שמואל\s*ב|dovvoms|[2۲]سمئویل|(?:II\.?\s*Sm|2\.?\s*Sm)a|《撒(?:(?:慕爾紀)?下》|母耳[記记]下》)|사무엘(?:기(?:\s*하권|하)|\s*?하)|II\.?\s*Sm|《撒(?:(?:慕爾紀)?下|母耳[記记]下)|2e\s*Sam|Β['ʹʹ΄’]\s*Σαμ|[2۲]سمویل|撒(?:(?:慕爾紀)?下》|母耳[記记]下》)|サムエル(?:\s*2|後書|記[Ⅱ下]|下)|列王記第二巻|2\.?\s*Sm|撒(?:(?:慕爾紀)?下|母耳[記记]下)|2سامو|۲(?:سامو|smu)|[2۲]sāmu|Ⅱサムエル|2سمو?|۲(?:سمو?|sm)|2Sam|2smu|2sm|삼하))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Sam"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:K(?:itabu\s*cha\s*Kwanza\s*cha\s*Samu|wanza\s*Sam[uw])eli|சாமுவேலின்\s*முதலாம்\s*புத்தகம்|Ensimm[aä]inen\s*Samuelin\s*kirja|(?:P(?:ierwsz[aey]\s*(?:Ks(?:i[eę]g[ai]\s*Samuelow|\.?\s*Samuelow)|Samuelow)|r(?:v(?:a\s*Samuelova\s*knjig|(?:(?:n[ií]\s*k|a\s*k)|á\s*k)niha\s*Samuelov|[yý]\s*(?:list\s*)?Samuelov|n[ií]\s*Samuelov|á\s*Samuelov)|emye\s*liv\s*Samy[eè]l\s*l))|Semuel\s*Yang\s*Pertam|(?:1\.?\s*Ks|I\.?\s*Ks)(?:i[eę]g[ai]\s*Samuelow|\.?\s*Samuelow)|(?:(?:1\.\s*k|I\.?\s*k)niha|1\s*k(?:niha|\.))\s*Samuelov|1\s*k\s*Samuelov|1\.?\s*Samuelo[vw]|I(?:\.\s*Samuelo[vw]|\s*Samuelo[vw]))a|F(?:ørste\s*(?:Kongerigernes\s*Bog|Samuelsbo[gk])|[oö]rsta\s*Samuelsboken|irst\s*S(?:amu[ae]l[ls]|ma))|P(?:ierwsz[aey]\s*Ks(?:i[eę]g[ai]\s*Samuela|\.?\s*Samuela)|r(?:va\s*knjiga\s*o\s*Samuelu|im[ao]\s*Samuele))|ଶାମୁୟେଲଙ୍କ\s*ପ୍ରଥମ\s*ପୁସ୍ତକ|samūel\s*dī\s*pahilī\s*potʰī|Cartea\s*(?:[iî]nt[aâ]i\s*a\s*Regilor|I\s*a\s*(?:lui\s*Samuel|Regilor))|(?:1-?(?:ше|а)\.\s*книга\s*Саму[ії]|1-?е\.?\s*книга\s*Саму[ії]|1-?(?:ше|а)\s*книга\s*Саму[ії]|(?:1\.?\s*книга\s*Саму|I\.?\s*книга\s*Саму)[ії])лова|П(?:ърв(?:а\s*(?:Книга\s*на\s*царете|Цар(?:ства|е))|о\s*(?:Книга\s*на\s*царете|Цар(?:ства|е)))|ърв(?:а\s*(?:книга\s*на\s*)?С|о\s*С)амуил|ерш[ае]\s*книга\s*Саму[ії]лова|рв(?:(?:а\s*книга\s*Самоилов|а\s*(?:краљевим|Самуилов))а|о\s*(?:книга\s*Самоилова|Самуил))|(?:ърва\s*книга\s*Царст|ерш[ае]\s*Саму[ії]ло)ва)|E(?:nsimm[aä]inen\s*Samuelin|erste\s*Sam|ls[oő]\s*S[aá]m)|1\.?\s*Kongerigernes\s*Bog|शम(?:ूएलको\s*पहिलो|ुऐल\s*की\s*[1१]ली)\s*पुस्तक|ਸਮੂਏਲ\s*ਦੀ\s*ਪਹਿਲੀ\s*ਪੋਥੀ|1\.?\s*Книга\s*на\s*царете|I\.?\s*Книга\s*на\s*царете|(?:1\.?\s*книга\s*Само|I\.?\s*книга\s*Само)илова|δυτικ[οό]ς\s*Σαμου[ήη]λ\s*Α['ʹʹ΄’]|1(?:-?е\.?\s*Книга\s*Царств|(?:-?я|[ея])(?:\.\s*(?:Книга\s*)?Царств|\s*(?:Книга\s*)?Царств)|(?:\.?\s*Книга\s*Ц|-?е\.?\s*Ц)арств|\s*(?:(?:(?:(?:(?:(?:(?:(?:[ei]\.?\s*Samuelit|ਸਮੂਏਲ)|Samuel(?:sbog|i[st]|[el]))|samūelko)|samuelko)|šam[uū]elko)|शमूएलको)|ซ(?:ามูเอล|มอ))|Самуила)|\.\s*(?:Samuel(?:sbog|i[st]|[el])|[sš]am[uū]elko|शमूएलको|ซ(?:ามูเอล|มอ)|Самуила)|사무)|(?:1\.?\s*Ks|I\.?\s*Ks)(?:i[eę]g[ai]\s*Samuela|\.?\s*Samuela)|(?:1\.?\s*Samuelin|I\.?\s*Samuelin)\s*kirja|S(?:amu(?:u['’]eel\s*Kowaad|el[ls])|amuelis\s*I|amueli?\s*I|ámuel\s*I)|Liber\s*I\s*Samuelis|Fyrri\s*Sam[uú]elsb[oó]k|(?:Pr(?:emi(?:ere?|ère)s|imero)|1(?:(?:(?:(?:ere|\.[oº]|º)|er)|re)|ère)\.|Erste|Unang)\s*Samuel|سفر\s*صموئيل\s*الأول|(?:1\.?\s*Samuelsboke|1\.?\s*Sa-?mu-?ê|I\.?\s*Sa-?mu-?ê)n|(?:Primeir[ao]\s*Reino|First\s*Kingdom|1st\.\s*Kingdom|1st\s*Kingdom|(?:1\.?\s*Ki|I\.?\s*Ki)ngdom|(?:1[ao]\.\s*Rei|(?:(?:1\.?\s*Rei|I\.?\s*Rei)|1[ao]\s*Rei))no)s|samūelko\s*pustak|samuelko\s*pustak|šam[uū]elko\s*pustak|(?:(?:1-?(?:ше|а)\.\s*Саму[ії]|1(?:-?е(?:\.\s*Саму[ії]|\s*Саму[ії])|\.\s*Саму[ії]|\s*Саму[ії])|1-?(?:ше|а)\s*Саму[ії]|I(?:\.\s*Саму[иії]|\s*Саму[иії]))ло|1\.?\s*Самуило)ва|(?:Primeir[ao]\s*S|(?:1[ao]\.\s*|1[ao]\s*)S)amuel|(?:Pr(?:emi(?:ere?|ère)\s*|imer\s*)|1(?:(?:(?:(?:ere|\.[oº]|º)|er)|re)|ère)\s*|Una\s*)Samuel|Prv(?:a\s*Samuelova|n[ií]\s*S(?:am(?:uel)?)?)|F(?:ørste\s*Sam(?:uels?)?|irst\s*S(?:a(?:m(?:u[ae]l)?)?|m))|(?:Avval(?:\s*[Ss]|s)am(?:ow(?:ey|i)|(?:u['w’]|oe)i|w[ei]i|u[ei])|avval\s*samu['’]ī|Premye\s*Samy[eè]|Eerste\s*Samu[eë]|(?:Avval|1\s*?)Samow(?:ey|i)|(?:(?:Avval|1)Samu['w’]|(?:Avval|1\s*?)Samoe|1\s*Sam(?:u['w’]|wi))i|(?:Avval|1)Samw[ei]i|Yek(?:\s*sam(?:ow(?:ey|i)|(?:u['w’]|oe)i|w[ei]i|u[ei])|sam(?:ow(?:ey|i)|(?:u['w’]|oe)i|w[ei]i|u[ei]))|1-?(?:ше|а)\.\s*Samu[iï]|Перш[ае]\s*Samu[iï]|(?:Avval|1)Samu[ei]|1-?е\.?\s*Samu[iï]|1-?(?:ше|а)\s*Samu[iï]|1e\.\s*Samu[eë]|1(?:\s*(?:Sam(?:wei|u[iëï])|C[aā]muv[eē])|\.\s*Samu[iëï])|I(?:\.\s*Samu[iëï]|\s*Samu[iëï])|1\s*samūʾī|(?:1\.?\s*Samy|I\.?\s*Samy)[eè]|1e\s*Samu[eë])l|ପ୍ରଥମ\s*ଶାମୁୟେଲଙ|1(?:\.\s*(?:S(?:a(?:m(?:uel(?:s(?:bok)?|i)?)?)?)?|Самуил|शमू(?:एल)?)|\s*Samuel(?:s(?:bok)?|i)?|\s*(?:samūel|சாமு|S(?:am?)?|Сам|صم|Ц)|\s*Самуил|\s*शमू(?:एल)?|Sa)|ପ୍ରଥମ\s*ଶାମୁୟେଲ|(?:Avval(?:\s*[Ss]|s)amou|1(?:\.\s*Shamooa|\s*(?:Shamooa|[sŝ]amuw))|1\.?\s*Samuu['’]e|I(?:\.\s*Samuu['’]e|\s*Samuu['’]e)|(?:Avval|1\s*?)Samou|Els[oő]\s*S[aá]mu|Yek\s*?samou|(?:1\.?\s*Sá|I\.?\s*Sá)mu)el|الممالك\s*الأول|(?:1-?(?:ше|а)\.\s*Саму[ії]|1(?:-?е(?:\.\s*Саму[ії]|\s*Саму[ії])|\.\s*Саму[ії]|\s*Саму[ії])|1-?(?:ше|а)\s*Саму[ії]|I(?:\.\s*Саму[иії]|\s*Саму[иії]))л|П(?:ърв(?:а\s*Цар(?:ств)?|о\s*Цар(?:ств)?)|ерш[ае]\s*Саму[ії]л|рва\s*Самуил)|1st\.\s*S(?:amu[ae]l[ls]|ma)|(?:1(?:-?е\.?\s*Самуил|(?:-?я|[ея])\.?\s*Самуил)|(?:1\.?\s*кр|I\.?\s*кр)аљевим)а|صموئيل\s*الأول|Βασιλει[ωώ]ν\s*Α['ʹʹ΄’]|पहिले\s*शमुवेल|1\.?\s*Samuelin|I\.?\s*Samuelin|1st\.\s*S(?:a(?:m(?:u[ae]l)?)?|m)|1\.?\s*Regnorum|I(?:\.\s*(?:Samuel(?:is|[els])|Regnorum)|\s*(?:Samuel(?:is|[els])|Regnorum))|1°\.\s*Samuele|1st\s*S(?:amu[ae]l[ls]|ma)|(?:اول|۱)\s*سمو(?:ئ(?:یل[ہی]|ل)|یل)|(?:اوّل\s*سموئ[يی]|(?:اوّل(?:-?سموئ|۔سموا)|(?:1\.|۱)-?سموئ|(?:1\.?۔|۱۔)سموا|1-?سموئ|[1۱]سموئئ|[1۱]سموائ|1سم(?:وء|ؤ)|۱سم(?:وء|ؤ))ی|(?:اول|۱)\s*سم(?:و(?:ئ(?:یی|ي)|یی|ای)|(?:و(?:ئئ|ائ|ء)|ؤ)ی|ئوی)|اولسم(?:و(?:ئ(?:یی|ي)|یی|ای)|(?:و(?:ئئ|ائ|ء)|ؤ)ی|ئوی)|یک(?:\s*سم(?:و(?:ئ(?:یی|ي)|یی|ای)|(?:و(?:ئئ|ائ|ء)|ؤ)ی|ئوی)|سم(?:و(?:ئ(?:یی|ي)|یی|ای)|(?:و(?:ئئ|ائ|ء)|ؤ)ی|ئوی))|1(?:\.\s*سموئ[يی]|\s*صموئي)|1\s*سم(?:و(?:ئ(?:یی|ي)|یی|ای)|(?:و(?:ئئ|ائ|ء)|ؤ)ی|ئوی)|[1۱]سموئ(?:یی|ي)|[1۱]سمویی|[1۱]سموای|[1۱]سمئوی)ل|ﺻﻤﻮﺋﻴﻞ\s*ﺍﻷﻭﻝ|1\.?\s*ଶାମୁୟେଲଙ|I(?:\.\s*S(?:a(?:m(?:ueli?)?)?)?|\s*S(?:a(?:m(?:ueli?)?)?)?)|1st\s*S(?:a(?:m(?:u[ae]l)?)?|m)|Kwanza\s*Sam|(?:اول|۱)\s*سموئیل|1\.?\s*ଶାମୁୟେଲ|1°\s*Samuele|(?:1\.?\s*Samua|I\.?\s*Samua|Samua)l[ls]|(?:1\.\s*Samw|I\.?\s*Samw)eli|Α['ʹʹ΄’]\s*Σαμου[ήη]λ|اولسمو(?:ئ(?:یل[ہی]|ل)|یل)|یک(?:\s*سمو(?:ئ(?:یل[ہی]|ل)|یل)|سمو(?:ئ(?:یل[ہی]|ل)|یل))|(?:1\.\s*Ц|I\.?\s*Ц)ар(?:ства|е)|(?:1\.?\s*Regi|I\.?\s*Regi)lor|1\s*(?:சாமுவேல|அரசுகள)்|(?:1\.?\s*Samua|I\.?\s*Samua|Samua)l|اولسموئیل|یک\s*?سموئیل|(?:1\.\s*Ц|I\.?\s*Ц)ар(?:ств)?|1\s*Samweli|1\s*سمو(?:ئ(?:یل[ہی]|ل)|یل)|1\s*Цар(?:ства|е)|1\.?\s*शामुएल|AvvalSam|1\s*سموئیل|1\s*Цар(?:ств)?|שמואל\s*א['’]|[1۱]سموئ(?:یل[ہی]|ل)|1\s*शमुवेल|1e\.\s*Sam|שמואל\s*א|[1۱]سموئیل|《撒(?:(?:慕爾紀)?上》|母耳[記记]上》)|사무엘(?:기(?:\s*상권|상)|\s*?상)|Samuel|(?:1\.?\s*Sá|I\.?\s*Sá)m|1e\s*Sam|《撒(?:(?:慕爾紀)?上|母耳[記记]上)|Α['ʹʹ΄’]\s*Σαμ|avvals|(?:1\.?\s*Sm|I\.?\s*Sm)a|撒(?:(?:慕爾紀)?上》|母耳[記记]上》)|[1۱]سمویل|サムエル(?:\s*1|前書|記[Ⅰ上]|上)|列王記第一巻|1\.?\s*Sm|I\.?\s*Sm|撒(?:(?:慕爾紀)?上|母耳[記记]上)|1سامو|۱(?:سامو|smu)|[1۱]sāmu|Ⅰサムエル|1سمو?|۱(?:سمو?|sm)|1Sam|اولس|1smu|1sm|삼상))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Chr"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:நாளாகமத்தின்\s*இரண்டாம்\s*புத்தகம்|или\s*Втора\s*книга\s*Паралипоменон|Cartea\s*a\s*doua\s*Paralipomena|Втор(?:а\s*(?:(?:книга\s*на\s*летописите|Парал)|Книга\s*на\s*летописите)|о\s*(?:Книга\s*на\s*летописите|Парал))|(?:Druh(?:[aá]\s*kniha|[yý]\s*list)\s*P|Second\s*P|2\s*k\.?\s*P|2nd\.?\s*P)aralipomenon|(?:Втора\s*книга\s*П|2(?:\.?\s*Книга\s*П|-?е\.?\s*П|(?:-?я|[ея])\.?\s*П))аралипоменон|2(?:-?е\.?\s*К|(?:-?я|[ея])\.?\s*К)нига\s*Паралипоменон|II\.?\s*Книга\s*на\s*летописите|سفر\s*أخبار\s*الأيام\s*الثاني|ବଂଶାବଳୀର\s*ଦ୍ୱିତୀୟ\s*ପୁସ୍ତକ|I(?:kalawang\s*(?:Paralipomeno|Kronik(?:el|a))|I(?:\.\s*(?:Paralipomen(?:on|a)|Kronika|Lịch\s*sử|\s*Sử\s*Ký|Sử\s*ký|Chrn)|\s*(?:(?:(?:(?:(?:(?:Paralipomen(?:on|a)|Taw)|Chrn)|Kronika)|Lịch\s*sử)|Sử\s*ký)|\s*Sử\s*Ký))|I\.?\s*Kronikel)|2\.?\s*Книга\s*на\s*летописите|Liber\s*II\s*Paralipomenon|(?:D(?:ruga\s*(?:knjiga\s*)?Ljetopis|ezy[eè]m\s*(?:liv\s*Kwonik\s*l|Istw))|I(?:kalawang\s*(?:Mga\s*)?Cronic|I\.?\s*Mga\s*Cronic)|I(?:kalawang\s*Mg|I\.?\s*Mg)a\s*Kronik|T(?:awarikh\s*Yang\s*Kedu|oinen\s*Aikakirj)|M(?:asodik\s*Kr[oó]nik|ásodik\s*Kr[oó]nik)|2(?:\.\s*(?:Mga\s*[CK]roni[ck]|Cronik)|\s*(?:Mga\s*[CK]roni[ck]|(?:Cronik|(?:Istw|Ny))))|(?:II\.?\s*Lj|2\.\s*Lj)etopis|(?:II\.?\s*A|2\.\s*A)ikakirj|2\s*Ljetopis|2\s*Aikakirj|(?:II\.?\s*Kró|2\.?\s*Kró)nik|II\.?\s*Istw|2\.\s*Istw|Pili\s*Ny|(?:II\.?\s*N|2\.\s*N)y)a|इतिहास(?:को\s*दोस्रो\s*पुस्तक|\s*[2२]रा\s*भाग)|Pili\s*Mambo\s*ya\s*Nyakati|D(?:ruh(?:[aá]\s*(?:kniha\s*)?Kroni(?:ck[aá]|k)|[yý]\s*(?:list\s*Kroni(?:ck[aá]|k)|Letopis[uů]|Kroni(?:ck[aá]|k))|[aá]\s*Letopis[uů])|o(?:(?:vom(?:\s*[Tt]|T)|T)(?:(?:(?:owar[iy]|owri)|oari)|awari)kh|\s*t(?:(?:(?:owar[iy]|owri)|oari)|awari)kh|vomChr))|(?:II\.?\s*Ma|2\.?\s*Ma)mbo\s*ya\s*Nyakati|(?:Deuxi[eè]mes?\s*Chronique|2(?:(?:eme|de?)|ème)\.\s*Chronique|2(?:(?:eme|de?)|ème)\s*Chronique|2nd\.?\s*Chronical|(?:II\.?\s*Chroniq|2\.?\s*Chroniq)ue|2e\.?\s*Chronique|(?:II\.?\s*Chronic|2\.?\s*Chronic)al|2\s*itahā)s|(?:Втор(?:а\s*(?:книга\s*л|Л)етопис|о\s*(?:книга\s*л|Л)етопис)|(?:(?:II\.?\s*книга\s*л|2\.?\s*книга\s*л)е|II\.?\s*Ле)топис)и|Друг(?:а\s*Паралипоменону|а\s*книга\s*хроніки|е\s*(?:книга\s*хроніки|Літопису|[HȞ]roniky|Хроніка|хроніки)|а\s*(?:днев|хро)ника|а\s*Літопису|а\s*[HȞ]roniky|а\s*Хроніка|а\s*хроніки)|itahās\s*dī\s*dūjī\s*potʰī|(?:Ikalawang\s*Chronicl|2(?:(?:\s*(?:i\.?\s*Kronika|e\.?\s*Kronika)|\s*Kronika)|\.\s*Kronika)v)e|Mambo\s*ya\s*Nyakati\s*II|(?:Dru(?:g(?:a\s*Ks(?:i[eę]g[ai]\s*K|\.?\s*K)|i\s*Ks(?:i[eę]g[ai]\s*K|\.?\s*K))|h(?:[aá]|[yý])\s*kniha\s*k)|(?:II\.?\s*Ks|2\.?\s*Ks)(?:i[eę]g[ai]\s*K|\.?\s*K)|(?:(?:II\.?\s*k|2\.\s*k)|2\s*k)niha\s*k)ronik|2-?(?:ге|а)\.\s*(?:книга\s*хроніки|Літопису|[HȞ]roniky|Хроніка|хроніки)|Druh(?:[aá]|[yý])\s*Paralipomenon|δυτικ[οό]ς\s*Χρονικ[ωώ]ν\s*Β['ʹʹ΄’]|أخبار\s*الأيام\s*الثاني|2-?(?:ге|а)\.\s*(?:книга\s*х|Х)ронік|Друг(?:а\s*(?:книга\s*х|Х)ронік|е\s*(?:книга\s*х|Х)ронік)|Se(?:cond(?:(?:\s*C(?:h?oron[io]cles|hr(?:onicles|n)|(?:hrono|ron[io])cles)|[ao]\s*Cronache)|\s*Chronicals)|gund(?:a\s*Cr[oô]nicas|o\s*Cr[oóô]nicas))|Taariikhdii\s*Labaad|(?:Druh(?:[aá]\s*(?:kniha\s*)?Kroní|[yý]\s*(?:list\s*)?Kroní)|S(?:iðari\s*Kron[ií]kub[oó]|íðari\s*(?:Kron[ií]kub[oó]|kroníkubó))|Andre\s*Krønikebo|2\s*k\.\s*Kroní|II\.?\s*Kroní|2\s*k\s*Kroní|2\.?\s*Kroní)k|II\.?\s*Паралипоменону|2-?е\.?\s*книга\s*хроніки|2-?(?:ге|а)\s*(?:книга\s*хроніки|Літопису|[HȞ]roniky|Хроніка|хроніки)|(?:(?:Andra\s*Kr[oö]nikebo|2\.?\s*Kronikebo|2\.\s*Krönikebo|2\s*Krönikebo|II\.?\s*Kronie|2\.?\s*Kronie)ke|II\.?\s*Sử\s*biên\s*niê|Tweede\s*Kronieke|2\.?\s*Sử\s*biên\s*niê|2e\.?\s*Kronieke|Anden\s*Kro)n|ਇਤਹਾਸ\s*ਦੀ\s*ਦੂਜੀ\s*ਪੋਥੀ|Second\s*C(?:h?oron[io]cle|hronicle|(?:hrono|ron[io])cle|hr(?:on?)?|ron)|2-?е\.?\s*книга\s*хронік|2-?(?:ге|а)\s*(?:книга\s*х|Х)ронік|2(?:\.\s*(?:Паралипоменону|Kr(?:ønikebo[gk]|oni(?:kel|ca))|Летопис[иь]|इतिहासको|พ(?:งศาวดาร|ศด)|Chr(?:onik|n))|\s*Паралипоменону|-?е\.?\s*Летопись|(?:-?я|[ея])(?:\.\s*(?:Летопись|Хроник)|\s*(?:Летопись|Хроник))|\s*(?:குறிப்பேடு|N[aā][lḷ][aā]kamam|tavārīḫ|ਇਤਹਾਸ|Tawh|Krn)|\s*Krønikebo[gk]|(?:-?е\.?\s*Хрони|\.?\s*Хрони)к|\s*Kroni(?:kel|ca)|\s*Летопис[иь]|\s*इतिहासको|\s*พ(?:งศาวดาร|ศด)|\s*Chr(?:onik|n)|tawā|역대)|(?:II\.?\s*книга\s*х|2\.?\s*книга\s*х)роніки|Παραλειπομ[έε]νων\s*Β['ʹʹ΄’]|ﺃﺧﺒﺎﺭ\s*ﺍﻷﻳﺎﻡ\s*ﺍﻟﺜﺎﻥ|2(?:\.\s*(?:Парал(?:ипоменон)?|Kr(?:o(?:n(?:ika?)?)?|øn?)|इति(?:हास)?|C(?:hr(?:on?)?|ron)|Лет)|\s*Парал(?:ипоменон)?|\s*(?:i\.?\s*Kronika|e\.?\s*Kronika)|\s*Kro(?:n(?:ika?)?)?|\s*(?:itih[aā]s|Aik(?:ak)?|C(?:r(?:[óô]n?|o)?|h)|Krön|Ljet|хрон|குறி|நாளா|Ist|Taw|Пар|Дн|Хр)|\s*इति(?:हास)?|\s*Chr(?:on?)?|\s*Cron|\s*Krøn?|\s*Лет|Taw|توا?)|II(?:\.\s*(?:Pa(?:r(?:alipomeno)?)?|C(?:ron(?:ici)?|hr(?:on?)?)|Kro(?:n(?:ik)?)?|Парал|Taar|Sử)|\s*(?:(?:(?:(?:(?:Pa(?:r(?:alipomeno)?)?|C(?:ron(?:ici)?|hr(?:on?)?))|Kro(?:n(?:ik)?)?)|Sử)|Taar)|Парал))|(?:II\.?\s*книга\s*х|2\.?\s*книга\s*х)ронік|2\.?\s*Paralipomen(?:on|a)|Anden\s*Krønikebog|2nd\.?\s*C(?:h?oron[io]cles|hr(?:onicles|n)|(?:hrono|ron[io])cles)|(?:Paralipomenon|Kr[oó]nik[aá]k)\s*II|ଦ୍ୱିତୀୟ\s*ବଂଶାବଳୀର|2\.?\s*Pa(?:r(?:alipomeno)?)?|2nd\.?\s*C(?:h?oron[io]cle|hronicle|(?:hrono|ron[io])cle|hr(?:on?)?|ron)|ଦ୍ୱିତୀୟ\s*ବଂଶାବଳୀ|(?:dovvom\s*tawā|2\s*?Tawa|2\s*?Toa)rikh|(?:II\.?\s*Taariikhdi|2\.?\s*Taariikhdi)i|(?:II(?:\.\s*Ch?o|\s*Ch?o)|2(?:\.\s*Ch?o|\s*Ch?o))ron[io]cles|(?:II(?:\.\s*Ch?o|\s*Ch?o)|2(?:\.\s*Ch?o|\s*Ch?o))ron[io]cle|(?:II\.?\s*Cronicilo|2\.?\s*Cronicilo)r|(?:(?:II\.?\s*Chronic|2\.?\s*Chronic)l|II\.?\s*Cronicl|2\.?\s*Cronicl)es|(?:II(?:\.\s*Ch?rono|\s*Ch?rono)|2(?:\.\s*Ch?rono|\s*Ch?rono))cles|Zweite\s*Chronik|(?:(?:II\.?\s*Chronic|2\.?\s*Chronic)l|II\.?\s*Cronicl|2\.?\s*Cronicl)e|(?:II(?:\.\s*Ch?rono|\s*Ch?rono)|2(?:\.\s*Ch?rono|\s*Ch?rono))cle|2\s*k\.\s*Kroni(?:ck[aá]|k)|(?:2(?:(?:\.[oº]|º)(?:\.\s*Cr[oó]|\s*Cr[oó])|\.\s*Cr[óô])|II(?:\.\s*Cr[óô]|\s*Cr[óô])|2a\.\s*Cr[oô]|2a\s*Cr[oô])nicas|(?:D(?:ezy[eè]m\s*Kw|rug[ai]\s*Kr)|II\.?\s*Kw|2\.?\s*Kw)onik|(?:2(?:-?е\.?\s*Лі|\.?\s*Лі)|II\.?\s*Лі)топису|דברי\s*הימים\s*ב['’]|M(?:asodik\s*Kr[oó]n|ásodik\s*Kr[oó]n)|דברי\s*הימים\s*ב|(?:II\.?\s*Le|2\.?\s*Le)topis[uů]|II\.?\s*Kronick[aá]|2\s*k\s*Kroni(?:ck[aá]|k)|(?:II\.?\s*Cronica|2\.?\s*Cronica)s|(?:II\.?\s*Crona|2\.?\s*Crona)che|2°\.\s*Cronache|2o\.\s*Cr[oóô]nicas|دو(?:م(?:-?\s*توارِیخ|\s*توار(?:ی(?:که|خ)|خ)|(?:\s*تو\s*|۔تو)اریخ|توار(?:ی(?:که|خ)|خ)|\s*?تواريخ)|\s*?توار(?:ی(?:که|خ)|خ)|\s*?تواريخ)|(?:II\.?\s*д|2\.?\s*д)невника|(?:2(?:-?е(?:\.\s*[HȞ]|\s*[HȞ])|\.\s*[HȞ]|\s*[HȞ])|II(?:\.\s*[HȞ]|\s*[HȞ]))roniky|2(?:-?е\.?\s*Хроні|\.?\s*Хроні)ка|2-?е\.?\s*хроніки|दुसरे\s*इतिहास|II\.?\s*Cronica|Tweede\s*Kron|2(?:-?е\.?\s*Хроні|\.?\s*Хроні)к|2(?:\.\s*itih[aā]sk|\s*itih[aā]sk)o|2\.\s*Tawarikh|2\.?\s*Kronick[aá]|Β['ʹʹ΄’]\s*(?:Χρονικ[ωώ]ν|Παρ)|2°\s*Cronache|2o\s*Cr[oóô]nicas|(?:2\.|۲)-?\s*توارِیخ|(?:(?:II\.?\s*х|2\.\s*х)|2\s*х)роника|II\.?\s*Хроніка|(?:(?:II\.?\s*х|2\.\s*х)|2\s*х)роніки|Χρονικ[ωώ]ν\s*Β['ʹʹ΄’]|2\.?\s*ବଂଶାବଳୀର|2\.?\s*Cronici|And(?:en\s*Krøn|re\s*Krøn?)|2\.?\s*Cronica|دو(?:م\s*?تواریک|\s*?تواریک)|II\.?\s*Хронік|2\.?\s*ବଂଶାବଳୀ|2\.\s*Lịch\s*sử|2\s*?Towar[iy]kh|2\s*Cr[óô]nicas|(?:(?:2\.?|۲)\s*تو\s*|(?:2\.?۔|۲۔)تو)اریخ|2-?\s*توارِیخ|2\s*Дневника|2\s*நாளாகமம்|Втор[ао]\s*Лет|2\s*Lịch\s*sử|2\.?\s*\s*Sử\s*Ký|2\s*?Towrikh|2\.?\s*Itihas|(?:II\.?\s*Bab|2\.?\s*Bab)ad|2\s*توار(?:ی(?:که|خ)|خ)|۲\s*توار(?:ی(?:که|خ)|خ)|الأخبار\s*2|Druh(?:[aá]|[yý])\s*Pa|2e\.?\s*Kron|(?:II\.?\s*Kró|2\.?\s*Kró)n|2\s*تواریک|۲\s*تواریک|2\.?\s*Sử\s*ký|[2۲]تواریکه|(?:2\s*تواري|۲\s*تواري|2(?:تواري|\s*أ)|۲تواري)خ|2\.?\s*Taar|Β['ʹʹ΄’]\s*(?:Χρ(?:ον)?|Πα)|[2۲]تواریک|II\.?\s*Лет|2towāri|2تواری?خ|۲(?:towāri|تواری?خ)|dovvomt|2tow(?:ār)?|2تواری?|۲(?:tow(?:ār)?|تو(?:اری?)?)|역대(?:기\s*하권|지?하)|(?:《?歷代志|《?历代志|《?代)下》|《?編年紀下》|2\.?\s*Sử|역대기\s*하|(?:《?歷代志|《?历代志|《?代)下|《?編年紀下|歴(?:代(?:志略?下|誌[Ⅱ下]|史下)|下)|歴代誌\s*2|2Chr|《?歷下》|《?歷下|Ⅱ歴代|대하))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Chr"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:или\s*Първа\s*книга\s*Паралипоменон|நாளாகமத்தின்\s*முதலாம்\s*புத்தகம்|П(?:ърв(?:а\s*(?:(?:книга\s*на\s*летописите|Парал)|Книга\s*на\s*летописите)|о\s*(?:Книга\s*на\s*летописите|Парал))|ерш[ае]\s*(?:книга\s*хроніки|[HȞ]roniky|Хроніка)|рв(?:а\s*(?:(?:(?:Паралипоменону|(?:днев|хро)ника)|Летописи)|книга\s*летописи)|о\s*(?:книга\s*л|Л)етописи)|ерш[ае]\s*Літопису|ърв[ао]\s*Летописи|ерш[ае]\s*хроніки)|(?:Cartea\s*[iî]nt[aâ]i\s*Paralipomen|Pr(?:va\s*(?:knjiga\s*)?Ljetopis|emye\s*(?:liv\s*Kwonik\s*l|Istw))|Ensimm[aä]inen\s*Aikakirj|Una(?:ng\s*(?:Mga\s*(?:Cronic|Kronik)|Cronic)|\s*(?:Mga\s*(?:Cronic|Kronik)|Cronic))|1(?:\.\s*(?:Mga\s*[CK]roni[ck]|Cronik)|\s*(?:Mga\s*[CK]roni[ck]|(?:Cronik|(?:Istw|Ny))))|I\.?\s*Mga\s*(?:Cronic|Kronik)|(?:1\.\s*Lj|I\.?\s*Lj)etopis|(?:1\.\s*A|I\.?\s*A)ikakirj|(?:Els[oő]\s*Kr[oó]ni|(?:1\.?\s*Kró|I\.?\s*Kró)ni)k|1\s*Ljetopis|1\s*Aikakirj|Kwanza\s*Ny|1\.\s*Istw|I\.?\s*Istw|(?:1\.\s*N|I\.?\s*N)y)a|(?:Първа\s*книга\s*П|1\.?\s*Книга\s*П|1(?:-?е\.?\s*П|(?:-?я|[ея])\.?\s*П))аралипоменон|(?:Prv(?:(?:[aá]\s*kniha|[aá])\s*P|[yý]\s*(?:list\s*)?P)|First\s*P|1\s*k\.?\s*P|1st\.\s*P|1st\s*P)aralipomenon|1(?:-?е\.?\s*К|(?:-?я|[ея])\.?\s*К)нига\s*Паралипоменон|Kwanza\s*Mambo\s*ya\s*Nyakati|(?:(?:P(?:ierwsz[aey]\s*Ks(?:i[eę]g[ai]\s*K|\.?\s*K)|rvn[ií]\s*(?:kniha\s*k|K))|(?:1\.?\s*Ks|I\.?\s*Ks)(?:i[eę]g[ai]\s*K|\.?\s*K)|(?:(?:1\.\s*k|I\.?\s*k)|1\s*k)niha\s*k)roni|Prv(?:(?:[aá]\s*kniha|[aá])\s*Kroní|[yý]\s*(?:list\s*)?Kroní)|Fyrri\s*(?:Kron[ií]kub[oó]|kroníkubó)|(?:P(?:ierwsz[aey]\s*Kr|remye\s*Kw)|1\.?\s*Kw|I\.?\s*Kw)oni|Erste\s*Chroni|1\s*k\.\s*Kroní|1\s*k\s*Kroní|1\.?\s*Kroní|I\.?\s*Kroní)k|it(?:ahās\s*dī\s*pahilī\s*potʰī|ih[aā]sko\s*pustak)|1\.?\s*Книга\s*на\s*летописите|I\.?\s*Книга\s*на\s*летописите|سفر\s*أخبار\s*الأيام\s*الأول|Ta(?:warikh\s*Yang\s*Pertama|ariikhdii\s*Kowaad)|Liber\s*I\s*Paralipomenon|इतिहास(?:को\s*पहिलो\s*पुस्तक|\s*[1१]ला\s*भाग)|ବଂଶାବଳୀର\s*ପ୍ରଥମ\s*ପୁସ୍ତକ|(?:Premi(?:eres?\s*Chroniqu|ères?\s*Chroniqu|ers?\s*Chroniqu)|(?:1(?:(?:ere?|re)|ère)\.\s*Chroniq|(?:1(?:(?:ere?|re)|ère)\s*Chroniq|(?:1\.?\s*Chroniq|I\.?\s*Chroniq)))u)es|Prv(?:[aá]\s*kniha\s*Kroni(?:ck[aá]|k)|[yý]\s*(?:list\s*Kroni(?:ck[aá]|k)|Kroni(?:ck[aá]|k))|n[ií]\s*Letopis[uů]|[aá]\s*Kroni(?:ck[aá]|k))|(?:1\.?\s*Ma|I\.?\s*Ma)mbo\s*ya\s*Nyakati|1-?(?:ше|а)\.\s*(?:книга\s*хроніки|[HȞ]roniky|Хроніка)|(?:F(?:[oö]rsta\s*Kr[oö]nikeboke|ørste\s*Kro)|(?:Eerste\s*Kronie|1e\.\s*Kronie|1\.?\s*Kronie|I\.?\s*Kronie|1e\s*Kronie)ke|1\.?\s*Sử\s*biên\s*niê|I\.?\s*Sử\s*biên\s*niê|1\.?\s*Kronikeboke|1\.\s*Krönikeboke|1\s*Krönikeboke)n|Prvn[ií]\s*Paralipomenon|δυτικ[οό]ς\s*Χρονικ[ωώ]ν\s*Α['ʹʹ΄’]|ਇਤਹਾਸ\s*ਦੀ\s*ਪਹਿਲੀ\s*ਪੋਥੀ|1-?(?:ше|а)\.\s*(?:книга\s*х|Х)ронік|П(?:ерш[ае]\s*(?:книга\s*х|Х)ронік|ърв[ао]\s*Лет)|Una(?:ng\s*(?:Paralipomeno|Chronicle|Kronik(?:el|a))|\s*(?:Paralipomeno|Chronicle|Kronik(?:el|a)))|1-?е\.?\s*книга\s*хроніки|1-?(?:ше|а)\s*(?:книга\s*хроніки|[HȞ]roniky|Хроніка)|Mambo\s*ya\s*Nyakati\s*I|أخبار\s*الأيام\s*الأول|1-?е\.?\s*книга\s*хронік|1-?(?:ше|а)\s*(?:книга\s*х|Х)ронік|1(?:\.\s*(?:Паралипоменону|Kroni(?:kel|ca)|Летопис[иь]|इतिहासको|พ(?:งศาวดาร|ศด)|Chr(?:onik|n))|\s*Паралипоменону|-?е\.?\s*Летопись|(?:-?я|[ея])(?:\.\s*(?:Летопись|Хроник)|\s*(?:Летопись|Хроник))|\s*(?:குறிப்பேடு|N[aā][lḷ][aā]kamam|tavārīḫ|ਇਤਹਾਸ|Tawh|Krn)|(?:-?е\.?\s*Хрони|\.?\s*Хрони)к|\s*Kroni(?:kel|ca)|\s*Летопис[иь]|\s*इतिहासको|\s*พ(?:งศาวดาร|ศด)|\s*Chr(?:onik|n)|tawā|역대)|(?:Prime(?:ir[ao]\s*Cr[oô]nica|r(?:o\s*Cr[oó]|\s*Cr[oó])nica)|(?:1(?:\.[oº]|º)\.\s*Cr[oó]|1(?:o(?:\.\s*Cr[oóô]|\s*Cr[oóô])|\.\s*Cr[óô])|1(?:\.[oº]|º)\s*Cr[oó]|I(?:\.\s*Cr[óô]|\s*Cr[óô]))nica|(?:1\.?\s*Chronic|I\.?\s*Chronic)al|1a\.\s*Cr[oô]nica|1a\s*Cr[oô]nica|1\s*Cr[óô]nica|Chronical|1\.?\s*Itiha|1\s*itahā)s|F(?:irst\s*C(?:h(?:(?:oronicles|r(?:onicals|n))|ronicles)|(?:ho?rono|ron[io])cles|oron[io]cles)|ørste\s*Krønikebo[gk])|I\.?\s*Паралипоменону|(?:1\.?\s*книга\s*л|I\.?\s*книга\s*л)етописи|Παραλειπομ[έε]νων\s*Α['ʹʹ΄’]|1(?:\.\s*(?:Парал(?:ипоменон)?|Kro(?:n(?:ika?)?)?|इति(?:हास)?|C(?:hr(?:on?)?|ron)|Лет)|\s*Парал(?:ипоменон)?|\s*(?:i\.?\s*Kronika|e\.?\s*Kronika)|\s*Kro(?:n(?:ika?)?)?|\s*(?:itih[aā]s|Aik(?:ak)?|C(?:r(?:[óô]n?|o)?|h)|Krön|Ljet|хрон|குறி|நாளா|Ist|Taw|Пар|Дн|Хр)|\s*इति(?:हास)?|\s*Chr(?:on?)?|\s*Cron|\s*Лет|Taw|توا?)|F(?:irst\s*C(?:(?:ho?rono|ron[io])cle|hronicle|oron[io]cle|hr(?:on?)?|ron)|ørste\s*Krøn?)|1\.?\s*Paralipomen(?:on|a)|I(?:\.\s*(?:Paralipomen(?:on|a)|Kronika|Lịch\s*sử|Sử\s*[Kk]ý|Chrn)|\s*(?:(?:(?:(?:(?:Paralipomen(?:on|a)|Taw)|Chrn)|Kronika)|Sử\s*[Kk]ý)|Lịch\s*sử))|1st\.\s*C(?:h(?:(?:oronicles|r(?:onicals|n))|ronicles)|(?:ho?rono|ron[io])cles|oron[io]cles)|(?:1\.?\s*книга\s*х|I\.?\s*книга\s*х)роніки|1\.?\s*Pa(?:r(?:alipomeno)?)?|I(?:\.\s*(?:Pa(?:r(?:alipomeno)?)?|C(?:ron(?:ici)?|hr(?:on?)?)|Kro(?:n(?:ik)?)?|Парал|Taar|Sử)|\s*(?:(?:(?:(?:(?:Pa(?:r(?:alipomeno)?)?|C(?:ron(?:ici)?|hr(?:on?)?))|Kro(?:n(?:ik)?)?)|Sử)|Taar)|Парал))|1st\.\s*C(?:(?:ho?rono|ron[io])cle|hronicle|oron[io]cle|hr(?:on?)?|ron)|(?:1\.?\s*книга\s*х|I\.?\s*книга\s*х)ронік|1st\s*C(?:h(?:(?:oronicles|r(?:onicals|n))|ronicles)|(?:ho?rono|ron[io])cles|oron[io]cles)|Paralipomenon\s*I|1st\s*C(?:(?:ho?rono|ron[io])cle|hronicle|oron[io]cle|hr(?:on?)?|ron)|(?:1\.?\s*Cho|I\.?\s*Cho)ronicles|(?:(?:1\.?\s*Cho|I\.?\s*Cho)rono|1(?:\.\s*Ch?rono|\s*Ch?rono)|I(?:\.\s*Ch?rono|\s*Ch?rono)|Chrono)cles|(?:1\.?\s*Taariikhdi|I\.?\s*Taariikhdi)i|(?:avval\s*tawā|1\s*?Tawa|1\s*?Toa)rikh|Avval(?:\s*[Tt]|[Tt])(?:(?:(?:owar[iy]|owri)|oari)|awari)kh|(?:1(?:(?:\s*(?:i\.?\s*Kronika|e\.?\s*Kronika)|\s*Kronika)|\.\s*Kronika)v|Prim[ao]\s*Cronach|1°\.\s*Cronach|(?:1\.?\s*Crona|I\.?\s*Crona)ch|1°\s*Cronach)e|(?:1-?(?:ше|а)\.\s*Лі|(?:(?:1(?:-?е\.?\s*Лі|\.?\s*Лі)|I\.?\s*Лі)|1-?(?:ше|а)\s*Лі))топису|ପ୍ରଥମ\s*ବଂଶାବଳୀର|ﺃﺧﺒﺎﺭ\s*ﺍﻷﻳﺎﻡ\s*ﺍﻷ|P(?:aralipomenon|rvn[ií]\s*Pa)|(?:(?:1\.?\s*Cho|I\.?\s*Cho)rono|1(?:\.\s*Ch?rono|\s*Ch?rono)|I(?:\.\s*Ch?rono|\s*Ch?rono)|Chrono)cle|ପ୍ରଥମ\s*ବଂଶାବଳୀ|(?:1\.?\s*Cronicilo|I\.?\s*Cronicilo)r|1\s*k\.\s*Kroni(?:ck[aá]|k)|(?:(?:1\.?\s*Chronic|I\.?\s*Chronic)l|1\.?\s*Cronicl|I\.?\s*Cronicl|Chronicl)es|(?:1\.?\s*Co|I\.?\s*Co|Ch?o)ron[io]cles|1\.?\s*Krønikebo[gk]|(?:1-?(?:ше|а)\.\s*хроні|(?:(?:1-?е\.?\s*хроні|(?:1\.?\s*хроні|I\.?\s*хроні))|1-?(?:ше|а)\s*хроні))ки|דברי\s*הימים\s*א['’]|(?:(?:1\.?\s*Chronic|I\.?\s*Chronic)l|1\.?\s*Cronicl|I\.?\s*Cronicl|Chronicl)e|(?:1\.?\s*Co|I\.?\s*Co|Ch?o)ron[io]cle|דברי\s*הימים\s*א|1\s*k\s*Kroni(?:ck[aá]|k)|Yek(?:\s*t(?:(?:(?:owar[iy]|owri)|oari)|awari)kh|t(?:(?:(?:owar[iy]|owri)|oari)|awari)kh)|ا(?:و(?:ّل(?:-?توارِ|[\s*۔]توار)یخ|ل(?:\s*توار(?:ی(?:که|خ)|خ)|توار(?:ی(?:که|خ)|خ))|ل\s*?تواريخ)|لأخبار\s*1)|(?:1(?:-?е(?:\.\s*[HȞ]|\s*[HȞ])|\.\s*[HȞ]|\s*[HȞ])|I(?:\.\s*[HȞ]|\s*[HȞ]))roniky|1(?:-?е\.?\s*Хроні|\.?\s*Хроні)ка|पहिले\s*इतिहास|E(?:erste\s*Kron|ls[oő]\s*Kr[oó]n)|1(?:-?е\.?\s*Хроні|\.?\s*Хроні)к|(?:1\.?\s*Le|I\.?\s*Le)topis[uů]|1\.?\s*Kronick[aá]|I\.?\s*Kronick[aá]|Α['ʹʹ΄’]\s*(?:Χρονικ[ωώ]ν|Παρ)|(?:1\.?\s*Cronica|I\.?\s*Cronica)s|1\.\s*Tawarikh|I\.?\s*Kronikel|1(?:\.\s*itih[aā]sk|\s*itih[aā]sk)o|(?:1\.?\s*д|I\.?\s*д)невника|I\.?\s*Летописи|Χρονικ[ωώ]ν\s*Α['ʹʹ΄’]|1\.?\s*ବଂଶାବଳୀର|1\.?\s*Cronici|1\.?\s*Cronica|I\.?\s*Cronica|اول\s*?تواریک|1\.?\s*ବଂଶାବଳୀ|1\.\s*Lịch\s*sử|1\s*?Towar[iy]kh|یک(?:\s*توار(?:ی(?:که|خ)|خ)|توار(?:ی(?:که|خ)|خ))|(?:1\.|۱)-?توارِیخ|I\.?\s*Хроніка|(?:1\.?\s*хрони|I\.?\s*хрони)ка|1\s*Дневника|Kr[oó]nik[aá]k\s*I|1\s*நாளாகமம்|یک\s*?تواریک|I\.?\s*Хронік|1\s*Lịch\s*sử|Cron[io]cles|1\s*?Towrikh|1\s*توار(?:ی(?:که|خ)|خ)|۱\s*توار(?:ی(?:که|خ)|خ)|(?:یک\s*?تواري|1\s*تواري|۱\s*تواري|1(?:تواري|\s*أ)|۱تواري)خ|(?:1\.\s*|(?:1\.?۔|۱۔))تواریخ|1-?توارِیخ|1e\.\s*Kron|Cron[io]cle|1\s*تواریک|۱\s*تواریک|1\.?\s*Sử\s*[Kk]ý|AvvalChr|[1۱]تواریکه|(?:1\.?\s*Bab|I\.?\s*Bab)ad|1\.?\s*Taar|Α['ʹʹ΄’]\s*(?:Χρ(?:ον)?|Πα)|(?:1\.?\s*Kró|I\.?\s*Kró)n|1e\s*Kron|1\.?\s*Krøn?|[1۱]تواریک|1towāri|1تواری?خ|۱(?:towāri|تواری?خ)|1tow(?:ār)?|1تواری?|۱(?:tow(?:ār)?|تو(?:اری?)?)|I\.?\s*Лет|avvalt|역대(?:기\s*상권|지?상)|(?:《?歷代志|《?历代志|《?代)上》|《?編年紀上》|1\.?\s*Sử|역대기\s*상|(?:《?歷代志|《?历代志|《?代)上|《?編年紀上|歴(?:代(?:志略?上|誌[Ⅰ上]|史上)|上)|歴代誌\s*1|1Chr|《?歷上》|《?歷上|Ⅰ歴代|대상))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Ezra"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(Ezra\s*[ah]|(?:எஸ்(?:றாவின்\s*புத்தகம்|ரா)|(?:K(?:s(?:i[eę]g[ai]\s*Ezdrasz|\.?\s*Ezdrasz)|njiga\s*Ezrin)|E(?:sran\s*kirj|zdrasz)|(?:[EÊ]-?xơ-?|Aej)r|Cesra|Étr)a|एज्राको\s*पुस्तक|Книга\s*(?:на\s*Ездра|Ездр[иы])|Li(?:v\s*Esdras\s*la|ber\s*Esdrae)|Первая\s*Ездры|E(?:s(?:r(?:a(?:s\s*bok|b[oó]k)|ā)|dra[es])|z(?:ra(?:s\s*Bog|[ah])|sdr[aá]s|dr(?:aš|á[sš]))|d)|سفر\s*عزرا|एज्रा(?:को)?|ع(?:ِ(?:\s*زر(?:اء|ه)|زر(?:اء|ه))|\s*زر(?:اء|ه)|زر(?:ا[ءی]|ه)|ـز)|《?厄斯德拉上》|E(?:z(?:d(?:r(?:as?)?)?|ra?|sd)|s(?:d(?:ra?)?|r(?:a(?:n|s)?)?))|ع(?:ِ\s*?زرا|\s*زرا|زرا?)|《?厄斯德拉上|e(?:ǳr[aā]ko|zrāy|dzr[aā])|Izra(?:\s*[ah]|[ah])|Εσδρας|Έσδρας|ع(?:ِ\s*?ذ|ز\s*|\s*ذ|ذ)را|(?:《?以斯拉[記记]|《拉)》|Езрина|Јездра|எஸ்றா|《?以斯拉[記记]|Єздри|Ез(?:др[аиы]|ра)|ʿizrā|1\s*Езд|Уза[ий]р|ਅਜ਼ਰਾ|ଏଜ୍ରା|เอสรา|Cesr?|e(?:zrā?|ǳr[aā])|Izra|Esṛ[aā]|Êxra|에[스즈]라기|azrā|עזרא|エ[スズ]ラ[書記]|Êxr|Єзд|Ез[др]|에(?:즈라?|스라)|エ[スズ]ラ|อสร|Εσ|《拉|Ἔσ|拉》|스))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Ruth"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:ரூத்த(?:ின்\s*சரித்திரம்|ு)|K(?:itabu\s*cha\s*Ruth[iu]|njiga\s*o\s*Ruti|s(?:i[eę]g[ai]\s*Ruthy|\.?\s*Ruthy))|ଋତର\s*ବିବରଣ\s*ପୁସ୍ତକ|r(?:ūt(?:ʰko\s*pustak|h?ī)|utʰko\s*pustak)|र(?:ू(?:थको\s*पुस्तक|त)|ुत)|Ruutin\s*kirja|Ks(?:i[eę]g[ai]\s*Rut|\.?\s*Rut)|Li(?:ber\s*Ruth|v\s*Rit\s*la)|Книга\s*Ру(?:фи|т)|R(?:u(?:t(?:h(?:s\s*Bog|[iu])|[ei])|-?tơ|ud)|oot[eh]|th|[iúū]t)|سفر\s*راعوث|Rut(?:arb[oó]|s\s*bo)k|R(?:u(?:ut(?:in)?|t(?:a|h|s)?)?|oot|t)|r(?:ūt(?:ʰ(?:ko)?|h?)|utʰ(?:ko)?)|น(?:างรู|ร)ธ|रूथ(?:को)?|(?:《?盧德傳|《?得)》|《?路得[記记]》|راعوث|《?盧德傳|《?路得[記记]|ரூத்|ر(?:و(?:ت[تـهی]|[ثط])|ُوت|ۆت)|Ру(?:та|фь)|Ρουθ|ر(?:وت|ا)|Ру[тф]|רות|ルツ記|῾Ρθ|ਰੂਥ|ルツ|《?得|룻기|룻))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Neh"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))(نحيميا-?ي[اه]|(?:நெகேமியாவின்\s*புத்தகம்|ନିହିମିୟାଙ୍କର(?:\s*ପୁସ୍ତକ)?|n(?:ahemy[aā]hko\s*pustak|ahamyāh|iḥimyāh|īm(?:iān|ī))|K(?:s(?:i[eę]g[ai]\s*Nehemiasz|\.?\s*Nehemiasz)|njiga\s*Nehemijin)a|न(?:हेम(?:्याहको\s*पुस्तक|ायाह)|्हेम्याह)|Книга\s*(?:на\s*Неемия|Неем(?:ии|і[ії]))|N(?:e(?:h(?:e(?:mi(?:a(?:n\s*kirj|h?-?y|sz)|j)|em[iy])|imy|my)|emij)|ê-?hê-?mi-?|ơkhemi|ihemi)a|Li(?:ber\s*Nehemiae|v\s*Neyemi\s*an)|Ne(?:h(?:em(?:i(?:(?:a(?:s’\s*Bog|[eš])|[eh])|á[sš])|j(?:aš|á[sš])|yah|ía[hs])|amiah|em(?:ii|a[ai])h|im(?:(?:a[ai]|a)h|i(?:a?|i)h)|emah)|k[eē]miy[aā]|emias|yemi)|Nehem(?:jas\s*bo|iab[oó]|íab[oó])k|ن(?:(?:حيم(?:ي(?:ا-?(?:ها|یه)‌|ه‌)|-?يا-?)|حي?میه-?)ه|ِ(?:حِمی(?:اه?-?|ه-?)ه|ح(?:ِم\s*|م)ی|\s*حِمی)|ح(?:يم(?:ي(?:ه-?[هي]|اه)|-?ياه)|یمیاه|مي)|حیم-?ی)ا|n(?:ahemy[aā](?:hko)?|īmiā)|नहेम(?:्या(?:ह(?:को)?)?|ा)|ن(?:ح(?:(?:يم(?:ي(?:ا(?:-?(?:ها|یه))?|ه)|-?يا)|یمیا|م(?:یا?)?)?|ي?میه)|ِحِم(?:ی(?:اه?)?)?)|N(?:e(?:(?:h(?:emia[ai]|em(?:ii|a[ai])[ai]|im(?:a[ai][ai]|i(?:a[ai]|i[ai])))|xemyaa)|hem-?ya)|ahemya)h|سفر\s*نحميا|N(?:e(?:h(?:em(?:ia(?:h|n|s)?|jas?|ya)|amia|imia|m)?|em(?:ia?)?|x)?|ê(?:-?hê-?mi)?|éh?)|நெகே(?:மியா)?|ن(?:ِحِمی(?:ا[ءً]|ّ[اه])|ح(?:(?:يم(?:ياً|ی(?:ّه|ا)|-?يه)|میاہ)|يم-?ی[اه]))|Не(?:хемија|ем(?:ија|(?:и[ия]|і[яії]))|мија)|เนหะมีย์|Νεεμ[ίι]ας|N(?:ehémi|éh[eé]mi)e|《?厄斯德拉下》|《?厄斯德拉下|ネヘミヤ\s*?記|(?:《尼希米[記记]|尼希米[記记])》|ਨਹਮਯਾਹ|Неємі[ії]|《尼希米[記记]|느헤미(?:야기|아)|נחמיה|느(?:헤(?:미야)?)?|Не(?:е?|є)м|ネヘミヤ|尼希米[記记]|《尼》|นหม|Νε|《尼|尼》|尼))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Esth"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:אסתר,\s*כולל\s*פרקים\s*גנוזים|எஸ்தர(?:ின்\s*சரித்திரம)?்|est(?:arko\s*pustak|erh)|एस्तरको\s*पुस्तक|Ks(?:i[eę]g[ai]\s*Estery|\.?\s*Estery)|Esterin\s*kirja|Li(?:ber\s*Esther|v\s*Est[eè]\s*a)|Книга\s*Ес(?:ф(?:ири|ір)|т[еи]р)|ଏଷ୍ଟର\s*ବିବରଣ|E(?:st(?:er(?:s\s*Bog|ei|y)|ar|hr|[rè])|t)|Ester(?:arb[oó]|s\s*bo)k|سفر\s*أستير|เอสเธอร์|Es(?:t(?:e(?:r(?:in|a|s)?)?|a|h)?|zt)?|est(?:arko|er)|एस्तर(?:को)?|Јестира|Ê-?xơ-?tê|《?艾斯德爾傳》|《?艾斯德爾傳|Ес(?:тира|фирь)|اِ?ستره|(?:Es(?:t(?:e[eh]|he)|zte)|asta|āsta)r|Aester|エステル(?:\s*記|[書記])|(?:《?以斯帖[記记]|《?斯)》|(?:ا(?:ِس(?:ت[ـَ]|[طٹ])|ستِ)|(?:ا(?:ِ\s*|ی)|آ)ست)ر|एस्तेर|ऐस्तेर|Ес(?:т(?:ир)?|ф)|ا(?:ِستر|ستر?)|《?以斯帖[記记]|에스(?:테르기|더기|텔)|Εσθ[ήη]ρ|أستير|Ес(?:те|фі)р|Јест|אסתר|エステル|ਅਸਤਰ|ast|에(?:스더?)?|Εσθ|எஸ்|อสธ|أس|《?斯))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Job"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:யோபுடைய\s*சரித்திரம்|K(?:itabu\s*cha\s*(?:Ayu|Yo)bu|njiga\s*o\s*Jobu)|अय(?:्यूबको\s*पुस्तक|युब)|ay(?:y[uū]bko\s*pustak|ūbi)|Книга\s*(?:на\s*(?:Иова?|Йов)|[ІИЙ]ова)|(?:K(?:s(?:i[eę]g[ai]\s*(?:(?:Hi|J)|Ij)ob|\.\s*(?:(?:Hi|J)|Ij)ob|\s*(?:(?:Hi|J)|Ij)ob)|niha\s*J[oó]bov|\.\s*J[oó]bov|\s*J[oó]bov)|Jobin\s*kirj)a|ଆୟୁବ\s*ପୁସ୍ତକ|Li(?:v\s*J[oò]b\s*la|ber\s*Iob)|अय्यूब(?:को)?|J(?:o(?:b(?:s\s*Bog|a)|v)|ób|b)|Jobs(?:\s*bo|b[oó])k|سفر\s*أيوب|ay(?:y(?:ūb(?:ko)?|ubko)|ūb?)|G(?:i(?:obbe|óp)|b)|ا(?:ی(?:و(?:ُبی|ب[هَی]|پ)|ُوب)|ِیوب)|(?:A(?:y(?:y(?:o[ou]|u)|[ou]u)|iu)|(?:Ai|Iy)ou|E(?:yy?|io)u|Jò)b|(?:Aiyo|Eiyo|Ij|[iī]y)ob|(?:ا(?:ی(?:ُوُ|[وّ]و)|ِ(?:یوُ|و))|أيو)ب|(?:ا(?:ی(?:ُّ|[\s*ـ])|ي)|(?:ا\s*|[آئ])ی)وب|J(?:ob(?:in?|s)?|ó)|ای(?:و(?:ُب|ب)?|ّ)|Ay(?:obe|b)|Hiob[ai]|Ayubu|(?:《?約伯[傳記]|《伯)》|《?约伯记》|ਅੱ?ਯੂਬ|Hi(?:ob)?|Ayub|《?約伯[傳記]|《?约伯记|ଆୟୁବ|யோபு|Yobu|ヨ[フブ]\s*?記|Y[oō]pu|איוב|[इई]योब|Іова|[ИЙ]ова|Ayu?|Yob|[ИЙ]ов|Io[bv]|(?:Ι[ωώ]|Ἰ)β|Аюб|โยบ|Јов|أي|ヨ[フブ]|《伯|욥기|Ιβ|伯》|욥))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Mal"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))(mal'(?:ākh[iī]|a)|(?:ମଲାଖି\s*ଭବିଷ୍ୟ‌ଦ୍‌ବକ୍ତାଙ୍କ\s*ପୁସ୍ତକ|Pro(?:roctwo\s*Malachyaszow|phetia\s*Malachia)e|Книга\s*(?:на\s*пророк\s*Малахия|пророка\s*Малах(?:ии|і[ії])|Малахі[ії])|Ks(?:i[eę]g[ai]\s*Malachiasza|\.?\s*Malachiasza)|मल(?:ा(?:कीको\s*पुस्तक|खी)|की)|(?:Mala(?:kian\s*kirj|chiasz|[hȟ]ij)|Liv\s*Malachi\s*)a|M(?:a(?:l(?:(?:a(?:k(?:i(?:as’\s*Bog|s\s*bok|[ei])|e[ey]|í)|c(?:hi(?:aš|á[sš]|e)|i)|qu[ií]as|kiás)|eaki|kiy[aā]|ch)|aaki[ei])|alaki[ei])|a(?:-?la-?(?:ch|k)|leak?h|l(?:ea|i)ch)i|al['’]aaki|[ei]laki|l)|Ma(?:l(?:(?:a(?:c(?:h(?:i(?:as?)?)?)?|ki(?:a(?:n|s)?)?|qu)?|c)?|aaki)|alaki)|سفر\s*ملاخي|Μαλαχ[ίι]ας|mal(?:’(?:ākh[iī]|a)|[aā]kʰ[iī]|[aā]k[iī])|Малах(?:и(?:ја|[ия])|і[яії])|எபிரேயம்|م(?:َل(?:اک(?:یی|[ىيے])|كی)|ل(?:اکیه|ک[ىیے]))|மல(?:ாக்கி|்கியா)|م(?:َل(?:اکی|ك)|ل(?:ا(?:کی?)?)?)|《(?:玛(?:拉基书》|(?:拉基)?》)|瑪(?:拉基[亞書]》|》))|ม(?:าลาคี|ลค)|《(?:玛(?:拉基书|(?:拉基)?)|瑪(?:拉基[亞書])?)|மல(?:்கி|ா)|मलाकी|ମଲାଖି|玛拉基书》|瑪(?:拉基[亞書]》|》)|מלאכי|ਮਲਾਕੀ|م(?:لاخ|َلک)ي|玛拉基书|瑪(?:拉基[亞書])?|말라[기키]서|玛(?:拉基)?》|マラキ書|말(?:라기?)?|Μαλ?|Мал|玛(?:拉基)?|マラキ?|ﻣﻼﺥ))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Matt"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:The\s*Gospel\s*(?:according\s*to\s*(?:S(?:aint\s*M(?:at(?:t(?:h[ht]|th)i?ew|h(?:[ht](?:[ht]i?ew|i?ew)|i?ew)|t(?:h?|t)iew|th?we|t(?:h?|t)ew)|t)|t(?:\.\s*M(?:at(?:t(?:h[ht]|th)i?ew|h(?:[ht](?:[ht]i?ew|i?ew)|i?ew)|t(?:h?|t)iew|th?we|t(?:h?|t)ew)|t)|\s*M(?:at(?:t(?:h[ht]|th)i?ew|h(?:[ht](?:[ht]i?ew|i?ew)|i?ew)|t(?:h?|t)iew|th?we|t(?:h?|t)ew)|t)))|M(?:at(?:t(?:h[ht]|th)i?ew|h(?:[ht](?:[ht]i?ew|i?ew)|i?ew)|t(?:h?|t)iew|th?we|t(?:h?|t)ew)|t))|of\s*(?:S(?:aint\s*M(?:at(?:t(?:h[ht]|th)i?ew|h(?:[ht](?:[ht]i?ew|i?ew)|i?ew)|t(?:h?|t)iew|th?we|t(?:h?|t)ew)|t)|t(?:\.\s*M(?:at(?:t(?:h[ht]|th)i?ew|h(?:[ht](?:[ht]i?ew|i?ew)|i?ew)|t(?:h?|t)iew|th?we|t(?:h?|t)ew)|t)|\s*M(?:at(?:t(?:h[ht]|th)i?ew|h(?:[ht](?:[ht]i?ew|i?ew)|i?ew)|t(?:h?|t)iew|th?we|t(?:h?|t)ew)|t)))|M(?:at(?:t(?:h[ht]|th)i?ew|h(?:[ht](?:[ht]i?ew|i?ew)|i?ew)|t(?:h?|t)iew|th?we|t(?:h?|t)ew)|t)))|Gospel\s*(?:according\s*to\s*(?:S(?:aint\s*M(?:at(?:t(?:h[ht]|th)i?ew|h(?:[ht](?:[ht]i?ew|i?ew)|i?ew)|t(?:h?|t)iew|th?we|t(?:h?|t)ew)|t)|t(?:\.\s*M(?:at(?:t(?:h[ht]|th)i?ew|h(?:[ht](?:[ht]i?ew|i?ew)|i?ew)|t(?:h?|t)iew|th?we|t(?:h?|t)ew)|t)|\s*M(?:at(?:t(?:h[ht]|th)i?ew|h(?:[ht](?:[ht]i?ew|i?ew)|i?ew)|t(?:h?|t)iew|th?we|t(?:h?|t)ew)|t)))|M(?:at(?:t(?:h[ht]|th)i?ew|h(?:[ht](?:[ht]i?ew|i?ew)|i?ew)|t(?:h?|t)iew|th?we|t(?:h?|t)ew)|t))|of\s*(?:S(?:aint\s*M(?:at(?:t(?:h[ht]|th)i?ew|h(?:[ht](?:[ht]i?ew|i?ew)|i?ew)|t(?:h?|t)iew|th?we|t(?:h?|t)ew)|t)|t(?:\.\s*M(?:at(?:t(?:h[ht]|th)i?ew|h(?:[ht](?:[ht]i?ew|i?ew)|i?ew)|t(?:h?|t)iew|th?we|t(?:h?|t)ew)|t)|\s*M(?:at(?:t(?:h[ht]|th)i?ew|h(?:[ht](?:[ht]i?ew|i?ew)|i?ew)|t(?:h?|t)iew|th?we|t(?:h?|t)ew)|t)))|M(?:at(?:t(?:h[ht]|th)i?ew|h(?:[ht](?:[ht]i?ew|i?ew)|i?ew)|t(?:h?|t)iew|th?we|t(?:h?|t)ew)|t)))|The\s*Gospel\s*(?:according\s*to\s*(?:S(?:aint\s*Matt?|t(?:\.\s*Matt?|\s*Matt?))|Matt?)|of\s*(?:S(?:aint\s*Matt?|t(?:\.\s*Matt?|\s*Matt?))|Matt?))|(?:(?:(?:Mabuting\s*Balita\s*ayon\s*kay\s*S|S(?:ulat\s*ni\s*S)?)an|Mabuting\s*Balita\s*ayon\s*kay)\s*Ma|E(?:(?:(?:banghelyo\s*(?:ayon\s*kay|ni\s*San)|banghelyo\s*ni)|vangelio\s*de)|l\s*Evangelio\s*de)\s*Ma)teo|matt(?:ay[aā]ne\s*lihilele\s*[sŝ]ubʰavartam[aā]n|īle\s*lekʰeko\s*susm[aā]c[aā]r|ile\s*lekʰeko\s*susm[aā]c[aā]r|ī\s*(?:kī\s*in|dī\s*ĩ)jīl|ā['’]ūsi)|Gospel\s*(?:according\s*to\s*(?:S(?:aint\s*Matt?|t(?:\.\s*Matt?|\s*Matt?))|Matt?)|of\s*(?:S(?:aint\s*Matt?|t(?:\.\s*Matt?|\s*Matt?))|Matt?))|Evangelium\s*secundum\s*Matthaeum|Evankeliumi\s*Matteuksen\s*mukaan|(?:E(?:w(?:angelia\s*(?:w(?:edług\s*[sś]w\.?\s*Mateusz|g\s*[sś]w\.?\s*Mateusz)|Mateusz)|\.?\s*Mateusz)|vanjelium\s*Pod[lľ]a\s*Mat[uú][sš])|Mat['’]thiy)a|मत्त(?:याने\s*लिहिलेले\s*शुभवर्तमान|ी(?:ले\s*लेखे)?को\s*सुसमाचार|ि)|(?:Evangelie\s*volgens\s*Matte[uü]|Mat(?:(?:t(?:h(?:e[uü]|au)|eü)|éu)|thé[uü]))s|மத்தேயு\s*(?:எழுதிய\s*(?:சுவிசேஷம்|நற்செய்தி)|நற்செய்தி)|(?:Evangeliet\s*etter\s*Matte|Mat(?:th(?:ae|ä)|i))us|От\s*Матея\s*свето\s*Евангелие|(?:Evangelium\s*podle\s*Matou[sš]|M(?:at(?:th?w|['’]te|y)|etti))e|Евангелие(?:то\s*според\s*Матеј|\s*(?:според\s*Матеј|от\s*Мате[ий]))|Євангелі(?:є\s*від\s*св\.?\s*Матвія|я\s*від\s*(?:св\.?\s*Матвія|Матвія)|є\s*від\s*Мат(?:ві|е)я)|Jevan(?:helije\s*vid\s*Matvija|đelje\s*po\s*Mateju)|הבשורה\s*(?:הקדושה\s*על-?|(?:על[\s*-]|ל))פי\s*מתי|M(?:a(?:t(?:t(?:e(?:uksen\s*evankelium|yu\s*Na[rṛ]ceyt)|ēyu\s*Na[rṛ]ceyt)|['’]y)i|t(?:t(?:h(?:ie[uw]|e[aiw]|y)|i(?:ew|i)|e[eow]|y)|eusza|a(?:yos|i)|[uú][sš]a|['’]t[iy]|e[ijo]|hy)|-?thi-?ơ|at(?:ha|t)i)|aattey|itt(?:hy|i)|etty|át[eé]|tt)|ମାଥିଉ\s*ଲିଖିତ\s*ସୁସମାଗ୍ଭର|Vangelo\s*di\s*(?:San\s*)?Matteo|พระวรสารนักบุญแม็ทธิว|Mat(?:ou[sš]ovo\s*evangeli|tei\s*evangeli)um|Evan[ðđ]elje\s*po\s*Mateju|(?:Евангелие\s*от\s*|(?:От\s*)?)Матфея|Јеванђеље\s*по\s*Матеју|Matteusarguðspjall|Matt(?:(?:hæ|e)|æ)usevangeliet|Еванђеље\s*по\s*Матеју|Ungjilli\s*i\s*Mateut|(?:Injili\s*ya\s*)?Mathayo|Saint\s*M(?:at(?:t(?:h[ht]|th)i?ew|h(?:[ht](?:[ht]i?ew|i?ew)|i?ew)|t(?:h?|t)iew|th?we|t(?:h?|t)ew)|t)|م(?:ت(?:ّی\s*کی\s*انجیل|ی\s*کی\s*انجیل|ایی|تی|[ىي])|َت(?:ّ(?:تی|[ىيی])|تی|ی[هی]|ي))|ਮੱਤੀ\s*ਦੀ\s*ਇੰਜੀਲ|St\.\s*M(?:at(?:t(?:h[ht]|th)i?ew|h(?:[ht](?:[ht]i?ew|i?ew)|i?ew)|t(?:h?|t)iew|th?we|t(?:h?|t)ew)|t)|Κατ[άα]\s*Ματθα[ίι]ον|Injil\s*Matius|St\s*M(?:at(?:t(?:h[ht]|th)i?ew|h(?:[ht](?:[ht]i?ew|i?ew)|i?ew)|t(?:h?|t)iew|th?we|t(?:h?|t)ew)|t)|M(?:at(?:t(?:e(?:u(?:ksen|s)|y)|h(?:æus|i)?|eyu|ēyu|ie?)?|eusz|['’]thi|e(?:us?)?|ayo|ou[sš]|hi?|[uú][sš]|é)?|t)|Saint\s*Matt?|Від\s*Матвія|matt(?:ay[aā]ne|ā(?:['’]ūs)?|īle|ile|ī)|マタイ(?:による福音書|[の傳]福音書|福音書|[伝書])|Matt(?:h[ht]|th)i?ew|Math[ht](?:[ht]i?ew|i?ew)|إنجيل\s*متى|От\s*Матея|मत्त(?:य(?:ाने)?|ी(?:ले)?)|St\.\s*Matt?|Μ(?:ατθα[ίι]ος|θ)|Mattheei|Matttiew|Matthee|மத்(?:தேயு)?|St\s*Matt?|마태(?:오\s*)?복음서|Mat(?:hi?e|tte)w|Mátthêu|마(?:태(?:오\s*복음|복음)?)?|Ew\s*Mat|М(?:ат(?:е(?:ја|[ий])|то)|[тф])|《?瑪竇福音》|(?:《[馬马]|[馬马])太福音》|Матвія|มัทธิว|Мат(?:еј)?|《?瑪竇福音|(?:《[馬马]|[馬马])太福音|ମାଥିଉ|(?:《?瑪特斐|《太)》|Мата[ий]|Ματθ|مت(?:ای|ّی|ت|ی)?|ਮੱਤੀ|《?瑪特斐|マタイ|מתי|《太|มธ|太》))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Ps"],
        testament: "oa",
        testament_books: { "Ps": "oa" },
        regexp: /(?:^|(?<=[^\p{L}]))((?:Ψαλμ(?:ο(?:[ίι]\s*του\s*Δαυ[ίι]δ|ς)|ός)|Cartea\s*Psalmilor|Li(?:b(?:ri\s*i\s*Psalmeve|er\s*Psalmorum)|v\s*S[oò]m\s*yo)|Псал(?:м(?:и\s*Давидови|ы)|тирь|[ао]м)|சங(?:்கீத(?:\s*புத்தக)?|கீத)ம்|स्त(?:्र)?ोत्रसंहिता|P(?:s(?:a(?:(?:l(?:m(?:i(?:en\s*kirja|[it])|e[nt]|u[ls]|[sy])|s)|m(?:l[as]|s)|aa)|las)|m(?:als|m)|lm[ms])|la(?:sm?s|ms)|(?:s(?:a(?:ma|am)|lma)|l(?:ama|m))s|a(?:s(?:(?:ml|s)|m)s|(?:l[lm]|m[ls])s))|K(?:s(?:i[eę]g[ai]\s*Psalm[oó]w|\.\s*Psalm[oó]w|\s*Psalm[oó]w)|niha\s*[zž]alm(?:ov|[uů])|(?:\.\s*[zž]almo|\s*[zž]almo)v)|தி(?:ருப்பாடல்கள்|பா)|S(?:alm(?:e(?:rnes\s*Bog|nes\s*bok)|os|[is])|lm)|stotrasa[mṃ]hit[aā]|bʰaǳansa[mṃ]grah|Книга\s*Псалмів|(?:مزموُر-?ها-?|م(?:ز(?:مو(?:ُرها|ر)-?|امیر-?)|َزمُور|ِزمُور)|م(?:َزموُ?ر|ِزمور)-?)ها|سفر\s*المزامير|திருப்பாடல்|Sabuurradii|சங்கீதங்கள்|भजन-?सहिन्ता|م(?:زمو(?:ُرها|[وَ]ر)ه|َزمیر|ِزمیر)ا|ز(?:(?:(?:(?:مير-?ها-?|َبُور[-‌]|ب(?:(?:ُ?ور‌|ير(?:ها|-?))|يري-?))|مير)|َبور‌)|ُبور‌)ها|(?:M(?:[ai]zamoora|az(?:m(?:oor[ae]|ura)|am(?:ura|ir[ae]|īr[ae]))|[ei]zamire|āz(?:moore|āmīra))|Thánh\s*vịn)h|Māzam(?:oo|ī)rah|भजन\s*संहिता|ଗ(?:ୀତି?ସଂହିତା|ାତସଂହିତା)|مزموُر-?ها|Zsolt[aá]rok|Thánh\s*Thi|(?:Psaltare|Thi\s*Thiê)n|(?:S[aá]lmarni|M(?:[ai]zamoo’|az(?:\s*moo|am(?:i['h’]|u['hou’])|mu['hou’])|ez(?:m(?:oo’|u)|am[uī])|ezami[h’]|iz(?:am(?:i[h’]|u)|mu)|āzāmī’)|Mizāmī|Zalt[aá]|Žalt[aá]|Masmu|Jabu|za(?:bū|mī))r|भजनसं?ग्रह|Mga\s*Salmo|Maza?moure|Mezmoorah|(?:الم(?:َزمُ|زم)و|م(?:ز(?:ام(?:ي[َِ]|یَ)|م(?:وُو|يِ|ُُ))|َزمي[َِ]|ِزم(?:ي[َِ]|وُ))|(?:م(?:زم[مَّ]|(?:ز[\s*ز]|ظ)م)|زُبُ)و)ر|เพลงสดุดี|P(?:s(?:a(?:l(?:m(?:i(?:en)?|e)?)?|ml?|u)?|ala|m(?:al?)?|l[am])?|l(?:a(?:sm?|m)|s(?:ss?|a)))|S(?:a(?:l(?:m(?:e(?:nes?|rne)?|o)?)?|buur)|l)|M(?:[ai]zamoor|az(?:m(?:oo|u)r|am(?:[iu]|ī)r)|aza?mor|āzām[īū]r)|م(?:ز(?:م(?:و(?:ُر(?:ها?)?|ره?|[وَ]ر)?|ُ(?:ور)?|ي)?|ا(?:م(?:ی(?:ره?)?|ير?))?)?|َزمي|ِزمي)|M(?:az(?:amure|\s*mor|mure)|aza?more|āzāmūre)|(?:Mga\s*)?Awit|maz(?:(?:amī|mū)|āmū)rī|م(?:ز(?:ام(?:یره?ا|ير[هيی])|م(?:و(?:ر(?:های|ر)|ُرر)|ُ(?:ور)?ر|یر[ای]))|َزمُر)|Псалти́р|(?:M(?:ez\s*mo|iz\s*?mo)|zabo)or|(?:Ca[nṅ]k[iī]ta|S[oò]|Mz)m|(?:المزا|م[َِ]زا)مير|Пс(?:ал(?:тир|ми)?)?|م(?:َزموُ?ر|ِزمور)|ز(?:مير(?:-?ها)?|َبُور|ب(?:(?:ُور?|ور)|يري))|स्तोत्र|P(?:s(?:a(?:(?:lm[alm]|ml?m|ume)|lam)|m(?:alm|l)|lam)|l(?:a(?:sm)?a|s(?:sss|a?m))|s(?:a[al]l|lal)m|a(?:ls|sl)m)s|מזמורים|Псалмів|P(?:s(?:a(?:(?:lm[alm]|ml?m|ume)|lam)|m(?:alm|l)|lam)|l(?:a(?:sm)?a|s(?:sss|a?m))|s(?:a[al]l|lal)m|a(?:ls|sl)m)|mazm(?:ūr)?|Ψα(?:λμο[ίι])?|Zaburi|תהילים|Z(?:ab(?:ur)?|solt)?|சங்(?:கீ)?|Zalmy|Žalmy|詩(?:篇(?:\/聖詠|》)|[》編])|Bhjan|Забур|《?聖詠集》|ਜ਼?ਬੂਰ|สดุดี|Zalm|Ž(?:alm)?|《?聖詠集|Pssm|(?:《[詩诗]篇|诗篇)》|Pss|Thi|Заб|भजन|《[詩诗]篇|《[詩诗]》|สดด|詩篇?|《[詩诗]|诗篇|시편|诗》|시|诗))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Eccl"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:К(?:нига\s*(?:на\s*Еклисиаста\s*или\s*Проповедник|Ек(?:кле(?:зіястов|сиаст)|лезіястов))а|оге́лет)|(?:K(?:s(?:i[eę]g[ai]\s*(?:K(?:aznodziei\s*Salomon|ohelet)|Eklezjastes)|\.\s*(?:K(?:aznodziei\s*Salomon|ohelet)|Eklezjastes)|\s*(?:K(?:aznodziei\s*Salomon|ohelet)|Eklezjastes))|niha\s*kazate[lľ]ov|\.\s*kazate[lľ]ov|\s*kazate[lľ]ov)|Saarnaajan\s*kirj)a|Eklezyas\s*-?\s*Liv\s*Filoz[oò]f\s*la|Kaznodziei\s*Salomonowego|ச(?:ங்கத்\s*திருவுரை\s*ஆகமம்|பை\s*உரையாளர்|உ)|Li(?:ber\s*(?:Ecclesiastes|Qoelet)|v\s*Filoz[oò]f\s*la)|K(?:ohelet(?:\s*—\s*Kazate[lľ]|h)|a(?:zate[lľ]|alam))|upade(?:[sš]akko\s*pust|ŝ)ak|(?:Pr(?:(?:edikantens\s*bo|opovjedni)|edikarens\s*bo)|Forkynnerens\s*bo)k|P(?:r(?:ædikerens\s*Bog|edikerens|edikator|edikátor|édik[aá]tor|ediger|ad)|khb)|A(?:ng\s*Mangangaral|lkhatib)|उपदेशकको\s*पुस्तक|E(?:cc?lesiastic[eé]|c(?:clesiasti[eé]|lesiasti[eé])|clesyast[eé]|kles[iy]ast[eé])s|Eccles(?:ia?ia|aia)stes|Ec(?:cless[ai][ai](?:st[eé]|t[eé])|clesiast[eé]|cles[ai]ist[eé]|clesaa(?:st[eé]|t[eé])|les(?:s[ai][ai](?:st[eé]|t[eé])|i(?:a(?:st[eé]|t[eé])|i(?:st[eé]|t[eé]))|a[ai](?:st[eé]|t[eé]))|cles(?:ait|i[ai]t)[eé])s|Pr(?:edikar(?:boke|in)|édikarin)n|Sabhopadeshak|Ec(?:cles(?:i(?:a[ai]s|s)|as)|lesis)tes|E(?:cl(?:esiai|is[iy])|kl(?:ezi|is[iy]))astes|Екк?лезіястова|Ec(?:cless[ai][ai](?:st[eé]|t[eé])|clesiast[eé]|cles[ai]ist[eé]|clesaa(?:st[eé]|t[eé])|les(?:s[ai][ai](?:st[eé]|t[eé])|i(?:a(?:st[eé]|t[eé])|i(?:st[eé]|t[eé]))|a[ai](?:st[eé]|t[eé]))|cles(?:ait|i[ai]t)[eé])|Εκκλησιαστ[ήη]ς|Ec(?:clesiastu|le[sz]iastu)l|Проповедника|Ecclesi(?:aa)?tes|Ekklesiastes|Проповідника|Fork(?:ynneren)?|Проп(?:оведник)?|Ecclésiaste|Pengkhotbah|J(?:uru\s*Kotbah|am(?:(?:(?:\s*ae|aa)h|(?:a['’]|['’])a[ht])|aih))|Екклезіяста|Mangangaral|Размышления|(?:Ekklezijas|kolliyā)t|سفر\s*الجامعة|E(?:c(?:c(?:l(?:es(?:iast)?|és)?)?|l(?:e(?:ziast|s))?)?|kl(?:ezyas)?)|P(?:r(?:ed(?:iker(?:en)?)?|æd(?:ikeren)?|op|éd)|engkh|kh)|Predikaren|Saar(?:n(?:aajan?)?)?|Ек(?:к(?:л(?:езіяст)?)?|л)|upade[sš]ak(?:ko)?|(?:P(?:redikues|iraca[nṅ]k)|M(?:agwawal|hubir))i|Wacdiyah(?:ii|a)|Еклисиаста|ป(?:ัญญาจารย์|ญจ)|Truyền\s*đạo|Екк?лесиаст|Еклисиаст|Gi(?:áo\s*huấn|ảng\s*Sư)|उपदेशक(?:को)?|Qoheleth|பிரசங்கி|コヘレトの(?:こと[はば]|言葉)|सभोपदेशक|K(?:oh(?:elet)?|azn?)|Qohelet|Filoz[oò]f|(?:jāme['’]e|Pkht)h|(?:Qo(?:hè|[eè])|Co[eé])let|الجامعة|ਉਪਦੇਸ਼ਕ|Jam(?:\s*ae|(?:a['’]|['’])a|aa)|جام(?:ع(?:ه[ـهی]|[اۀہ])|ع[\s*ـی]ه|ـعه|[هہ]ع)|המ(?:קהיל|רצה)|ଉପଦେଶକ|M(?:anga|hu)|jām(?:e['’])?|جا(?:م(?:عه?)?)?|واعِ?ظ|(?:《(?:传道书|傳道書)|傳道書|传道书)》|《?訓道篇》|کلیات|伝道者?の書|Giáo|Разм|《(?:传道书|傳道書)|《?訓道篇|பிரச|コヘレト|伝道者の|vāʿẓ|קהלת|傳道之書|Qoh?|Wac|सभो|傳道書|传道书|전도서|《[传傳]》|코헬렛|Εκ|《[传傳]|코헬|傳》|Ἐκ|传》|傳|전|传))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Ezek"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))(ح(?:زقی\s*ای|ِزقیا\s*)ل|(?:எசேக்கியேல்\s*தீர்க்கதரிசியின்\s*புத்தகம்|ଯିହିଜିକଲ\s*ଭବିଷ୍ୟ‌ଦ୍‌ବକ୍ତାଙ୍କ\s*ପୁସ୍ତକ|Книга\s*(?:на\s*пророк\s*(?:Иезекииля|Езекиил)|(?:пророка\s*Иезекии|пророка\s*Єзекі[ії])ля)|Prophetia\s*Ezechielis|iǳakielko\s*pustak|Hesekielin\s*kirja|Ks(?:i[eę]g[ai]\s*Ezechie|\.?\s*Ezechie)la|इजकिएलको\s*पुस्तक|Liv\s*Ezeky[eè]l\s*la|E(?:z(?:e(?:kiel(?:s’?\s*Bog|i)|chiel[ae])|[kq])|sk)|(?:He|E)sekiels\s*bok|எசே(?:க்கியேல்)?|Ê-?xê-?(?:chi-?|ki-?)ên|H(?:es(?:ekiel(?:in)?)?|iz(?:(?:kiya[ei]|kiya)l|qiya(?:lh?|[aei]l)))|Hiz(?:(?:kiya[ei]|kiya)lh|q(?:iy(?:a(?:(?:lha|[aei]lh)|hl)|['’]al)|eyal))|ح(?:ِز(?:قیی?ائله|قی(?:(?:الله|(?:(?:(?:ال[هی]|یل)|لی)|ئل))|یاله)|کی(?:ا(?:ل(?:له|ی)|ئله)|لی|ئل))|ز(?:(?:قیا?|کیا)ل|قیئل))|(?:Hizq(?:iy(?:a(?:ha|['’])|['’]aa)|eya[ei])|E(?:c[eē]kkiy[eē]|ze(?:chië|qu(?:i[ae]|e)|k(?:ia|e))|z(?:e[ei]qu|i(?:(?:[ei])?qu|(?:[ei])?k)|e[ei]k)e|x[ei](?:[ei])?ke)|Y(?:eh(?:ezki[eè]|èzki[eè])|éh[eè]zki[eè])|(?:E(?:z(?:e[ei]qu|i(?:(?:[ei])?qu|(?:[ei])?k)|e[ei]k)i|x[ei](?:[ei])?ki|sek[yí])|Yexesqe|(?:Yehes|Ezé)ki|Hezechi|Iezechi|Ezéchi|Éz[eé]chi|hizkī)e|Yahejake|yahe(?:dz|ǳ)ke|Ezeky[eè]|hazqiā)l|سفر\s*حزقيال|ح(?:ِز(?:قیی?ائل|قی(?:یال|(?:ال?|ل))|کی(?:ائ?ل|ل))|ز(?:قی?)?)|iǳakielko|Иезекиил[ья]|Jezeki[iï]l['’]|ḥiziqīʾīl|ح(?:ِز(?:ق(?:(?:ی(?:\s*ای|ا[اي])|ا)|یئا)|ک(?:ی(?:ئا|اي)|ا))|ز(?:(?:قی‌ای|(?:قیا[ئي]|کی(?:ا[ئي]|ئ)))|قیئا))ل|เอเสเคียล|E(?:z(?:e(?:c(?:h(?:iel)?)?|k(?:iel)?|qu?)?|é)|sek(?:iel)?)|Иез(?:екиил)?|इजकिएल(?:को)?|ଯିହିଜିକଲ|Єзекі[ії]л[аья]|Ιεζ(?:εκι[ήη]λ|κ)|यहेज्?केल|ح(?:ِز(?:کی|ِق)ی|ز(?:ق(?:یی|ي)|کیی))ال|ਹਿਜ਼ਕੀਏਲ|Йезекиил|Језекиљ|Езеки[еи]л|hazqīl|Езекил|יחזקאל|(?:《?以西(?:結[书書]|结书)|《[結结]|[結结])》|《?厄則克耳》|エ[セゼ]キエル書|hazqī?|Ezéch|Éz[eé]ch|Ιεζ(?:εκ)?|《?以西(?:結[书書]|结书)|《?厄則克耳|エ[セゼ]キエル|에(?:제키엘|스겔)서|Ê-?xê|에(?:제(?:키엘)?|스겔)|Езек|यहेज|Ye[hx]|Јез|Йез|Yez|᾿Ιζ|อสค|Єз|《[結结]|[結结]|겔))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Hos"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))(Hosha-?i-?ya|Hushia-?y|(?:ହୋଶ(?:େୟ\s*ଭବିଷ୍ୟ‌ଦ୍‌ବକ୍ତାଙ୍କ\s*ପୁସ୍ତକ|ହେ)|Книга\s*(?:на\s*пророк\s*Осия|пророка\s*Ос(?:ии|і[ії]))|Ks(?:i[eę]g[ai]\s*Ozeasza|\.?\s*Ozeasza)|Prophetia\s*Osee|(?:H(?:oosean\s*kirj|(?:o(?:ziyah-?h|osheec|seya-?h|s’iya|še)|os(?:ha-?y|ee)-?y|u(?:sha-?[iy]-?y|zi)|os(?:ia-?|a)y|ô-?sê-?))|Liv\s*Oze\s*|hushaiy|O(?:zeasz|sij))a|होशे(?:को\s*पुस्तक|य)|H(?:(?:o(?:s(?:eas(?:’\s*Bog|\s*bok)|h(?:a-?i|ia|[ou]))|zia(?:(?:h-?ha)?|-?y)a)|o(?:shae|zai)ah|o(?:shiy|zai?y)ah|u(?:s(?:h(?:i(?:yah|a)|(?:ae|ea)h)|aiyah)|zayah)|osheah|osiyah|óseas|s)|oseia[hs])|ه(?:و(?:(?:زيا(?:يي|ئي|ت)[-‌]|زيا(?:ي[-‌]|[-‌]))ه|ش(?:يا(?:(?:يي[-‌]|ت[-‌]|-?))?ه|عي[-‌]ه))ا|و(?:(?:زي(?:ايانه|(?:ایی|ه))|ش(?:يايانه|ع(?:لل|یی|ه)|ععه|؏عع|[ئا]عع|؏ه))|زياها)|ُو(?:ْز|[زش])يا)|H(?:(?:o(?:zi(?:a(?:h-?ha|-?y|h)?|yah?)|os(?:ean|h)?|s(?:eas?|hae?)?|seya|š)?|ush(?:a(?:-?i)?|i(?:ya)?|ae|ea|e)|oshea|osiya|ós(?:ea)?|oshe)|oseia)|ه(?:و(?:(?:زيايان|ش(?:ي(?:ا(?:ي(?:ان|ي)?|ت)?)?|ع(?:ل|ی)?|عي|عع|؏ع|[ئا]ع|؏)?|زيا(?:يي|ئي|ت)|ز(?:ي(?:اي?)?)?)?|زياه)|ُوزي)|ہو(?:\s*سیعاہ|سیعَِ)|سفر\s*هوشع|โฮเชยาห์|H(?:o(?:s(?:[eh]|i)a’|zia’)|usha’)y|h(?:o(?:(?:sh['’]ai|šeā|ŝey)|sey)|u(?:shaia|z(?:aiy|ia[ah]))|ūsīʿ)|h(?:o(?:(?:sh(?:['’]a)?|še)|se)|uz(?:ai|ia))|โฮเชยา|H[oó]seás|Hoze[aá][sš]|O(?:s(?:e(?:ia[hs]|a[hs]|e)|é(?:ias|e))|ze(?:aš|á[sš]))|(?:《何西阿[书書]|何西阿[书書])》|ਹੋਸ਼ੇਆ|O(?:s(?:ei?a)?|z(?:e(?:as)?)?)|《何西阿[书書]|ہوسیع|ହୋଶେୟ|Ociy[aā]|Ōciy[aā]|ホセア(?:しょ|書)|《?歐瑟亞》|Осија|Хошеа|ஓச[ிே]யா|ஒசேயா|何西阿[书書]|《?歐瑟亞|होशे|호세아서|Ωση[έε]|Ос(?:и[ия]|і[яії])|Ô-?sê|הושע|호(?:세아?)?|ஓச[ிே]|ホセア|《何》|ฮชย|Ωσ|Ос|《何|Ὠσ|何》|何))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Obad"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))(عُ?وبدیا-?یی|(?:ଓବଦିଅ\s*ଭବିଷ୍ୟ‌ଦ୍‌ବକ୍ତାଙ୍କ\s*ପୁସ୍ତକ|Книга\s*(?:на\s*пророк\s*Авди[ий]|пророка\s*(?:Авд[иі]|Овді)я)|Pro(?:roctwo\s*Abdyaszow|phetia\s*Abdia)e|ع(?:ُوب(?:(?:(?:(?:دیا(?:ت‌نامه|يی)|يديا(?:[ئي]ي|ت))[-‌]|دیا(?:ئی(?:ان‌|[-‌])|ت-?|ه‌|ی-?|[-‌])|يديا-?)|(?:دیات‌|يديا))ه|یدیا(?:(?:ي(?:ي[-‌]|-?)|ئی[-‌]|ت[-‌]|-?))?ه)|(?:وب(?:(?:دیات‌نامه|يديا(?:يي|ت))|دیايی)[-‌]|وب(?:دیائی(?:ان‌|[-‌])|(?:(?:(?:يديا(?:ئي[-‌]|ي[-‌]|[-‌])|دیا[-‌])|دیات-?)|دیای-?)))ه|وبیدیا(?:(?:ي(?:ي[-‌]|-?)|ئی[-‌]|ت[-‌]|-?))?ه|وب(?:دیات‌ه|(?:يدياه|َ?دي|دِی|ادی)))ا|ओब(?:द(?:ियाको\s*पुस्तक|्याह)|द्दाह|ेधाह|धाह)|(?:Ks(?:i[eę]g[ai]\s*Abdiasz|\.?\s*Abdiasz)|O(?:ba(?:d(?:jan\s*kirj|ij|í)|j)|uba-?dy|obad[iy])|obad-?(?:ya-?h|iy)|Ô-?ba-?đi-?|Abdiasz|Obad-?iy|O(?:ube|va)di|Óbad[ií]|Áp-?đi|Ubedi)a|ع(?:ُوب(?:دیا(?:ت‌نامه|يی)|دیا(?:ئی(?:ان)?|ت|ه|ي|ی)?|يديا(?:[ئي]ي|ت)|یدیا(?:يي?|ئی|ت)?|يديا|َدیا)|و(?:(?:ب(?:(?:دیات‌نامه|يديا(?:يي|ت))|دیايی)|(?:(?:(?:(?:(?:(?:ب(?:يديا(?:ئي(?:ان)?|ي)?|َدیا?|د(?:یا?)?)?)?|بدیات)|بدیاي)|بدیای)|بدیائی(?:ان)?)|بَدِیا))|بیدیا(?:يي?|ئی|ت)?))|ع(?:ُوب(?:دیا(?:ی‌نامه|يانه|ها)|یدیائیان|َدیاء)|وب(?:يديائيانه|َدی(?:ا[ءىيہی]|[آه])|دیا[هىہ])|وبدیای‌نامه|وبیدیائیان|وبدیايانه|وبَدِیاء|بدیاہ)|Liv\s*Abdyas\s*la|O(?:b(?:ad(?:ia(?:s['’]\s*Bog|[hš])|ja(?:s\s*bok|š)|iyah|yah)|adjá[sš]|adiá[sš]|edi(?:a[sš]|á[sš])|d)|uba-?dia|vdij)|ob(?:ad(?:-?ya-?ye|iyā|ʰ[aā])|d(?:ay|i)yā)|O(?:uba(?:-?di|d)y|bad-?y)ah|U(?:bad(?:(?:-?iya-?i|ia)|iyah)|bad-?diyah|ubadiyah|bad-?yah)|سفر\s*عوبديا|ob(?:ad-?ya(?:-?y)?|d)|O(?:uba(?:-?di|d)y|bad-?y)a|U(?:(?:bad-?diy|(?:bad-?iy|bad-?y))|ubadiy)a|Obadi?ya’i|(?:O(?:ubadi|bade)y|obadiy)ah|(?:Cobadyaa|O(?:ubadi|bade)ye|Ubad-?iye|Obadiye|Ob(?:adh|id)a)h|ʿabadiyāh|(?:O(?:ubadi|bade)y|obadiy)a|โอบาดี[ยห]์|O(?:b(?:a(?:d(?:j(?:a(?:n|s)?)?|ias?|iya|ya)?)?|adjá|edia)?|uba-?di)|Abdi(?:j[aá]|á)[sš]|Opatiy[aā]|Ов(?:адија|ді[ийя])|obadyāh|(?:《俄巴底(?:亚书|亞書)|俄巴底(?:亚书|亞書))》|Ab(?:d(?:ias?)?)?|ओब(?:द[ि्]या|धा)?|《俄巴底(?:亚书|亞書)|Abd(?:iaš|[yí]as)|Αβδιο[υύ]|Авди(?:ј[ае]|[ийя])|ஒபதியா|オ[ハバ][テデ](?:ヤ(?:しょ|書)|ア書)|עו?בדיה|Οβδ[ίι]ας|《?亞北底亞》|ਓਬਦਯਾਹ|Cob(?:ad)?|Авд(?:иј)?|俄巴底(?:亚书|亞書)|《?亞北底亞|ଓବଦିଅ|오바(?:드야서|댜서|디야)|Avdie|Авдія|ஒப(?:தி)?|オ[ハバ](?:[テデ]ヤ)?|Овд?|Αβδ|오바댜?|《俄》|Ἀβδ|อบด|Áp|Ób|《俄|俄》|俄|옵))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Hag"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))(Haggi-?i|(?:ହାଗୟ\s*ଭବିଷ୍ୟ‌ଦ୍‌ବକ୍ତାଙ୍କ\s*ପୁସ୍ତକ|Pro(?:roctwo\s*Aggieuszowe|phetia\s*Aggaei)|Книга\s*(?:на\s*пророк\s*Аге[ий]|пророка\s*(?:Агге|Огі)я|Огія)|ح(?:َج(?:ّ(?:ی(?:‌نامه(?:‌نامه‌|-?)|ی‌)|ای-?)ها|ّیان‌(?:نامه‌)?ها|ّ(?:(?:ی(?:ان‌نامه‌ی|‌(?:نامه‌(?:ها)?ی|(?:ها)?ی))|ای(?:ی(?:ان|ه)|‌ی))|ایانه)|ّ(?:ی‌(?:نامه‌)?ا|ای‌ا)ی|ّای‌نامه‌ی|ّای‌ها‌ی|َّی(?:‌(?:(?:ها‌|ا?)ی|نامه)|ہ?ئ[ةۀ-ۂ]|ا(?:نه|[ءت])|-?ها|ہ[ءةۀۂ]|[ءةهی]))|جای(?:‌نامه‌|(?:ه‌|-?))ها|جای‌ها‌ی|ج(?:ایانه|(?:(?:ا(?:ی‌ی|ي)|َّ[يی]|يّ)|ییی))|ج(?:ای‌ا|ّ)ی)|ح(?:َج(?:ّ(?:(?:(?:(?:ی(?:‌(?:نامه(?:‌(?:نامه|ها))?|ها)|ان(?:‌نامه)?)?|ایی?)|ایان)|ای‌نامه)|ای‌ها)|َّی(?:‌ها|ان|ہ)?)|ج(?:(?:(?:ای‌نامه|(?:ایه|(?:(?:ای?|ي|ی)?|یی)))|ایان)|ای‌ها))|Ks(?:i[eę]g[ai]\s*Aggeusza|\.?\s*Aggeusza)|हाग्ग(?:ैको\s*पुस्तक|[ये])|(?:Ha(?:g(?:g(?:ai(?:n\s*kirj|y)|iy)|’y)|g(?:g(?:ai-?|ā’)|-?)y|jjay-?y)|Ha(?:gg(?:ay-?|āī[-’])|jj(?:āī?-?|ī[-’]))y|Liv\s*Aje\s*|Aggeusz|ha(?:ggā’y|jjī[-’]y))a|H(?:a(?:g(?:g(?:a(?:i(?:s\s*bok|i)|js\s*Bog|[íï])|ā(?:y-?)?i|ia[hi]|e(?:us|o)|y)|(?:gāy-?)?ya|’ā[iy]|a[ijy]|e[jo]|i)|g(?:g(?:ai-?|ā’)|-?)i|j(?:j(?:a(?:y-?)?i|āy)|iya[hy]))|gg)|H(?:a(?:g(?:(?:(?:gāy-?)?y|g(?:a(?:in?|j)|āy|i)?)?|gay)|jj(?:ay|āī))|g)|(?:Ha(?:gg(?:ai’|ā-?)|jji)|Xagga|Ak[aā]|Āk[aā])y|h(?:agg(?:āī’|a)y|ajj(?:(?:āī|īy)y|aī)|āggay)|Agg(?:(?:ae|ä)|a)us|Αγγα[ίι]ος|سفر\s*حجي|(?:Ha(?:gga|j)a|h[aā]ggə|Ha-?ga|ḥajja|A-?ga)i|Ag(?:g(?:eus)?|eu)?|ha(?:jj(?:āī?|īy?)|ggā)|हाग्गै|ฮ(?:ักกัย|กก)|A(?:g(?:ge[eo]|e(?:us|[jo])|heu)|-?ghê)|Агге[ийя]|《?哈(?:(?:該[书書]|蓋)|该书)》|ஆகாய்|ハ[カガ]イ(?:しょ|書)|Хагај|A(?:ggé|j)e|Xagg?|《?哈(?:該[书書]|该书|蓋)|ହାଗୟ|Ohij|Аге[ийј]|Огі[ийя]|하(?:까이서|깨)|ਹੱਜਈ|Агг?|ஆகா|ハ[カガ]イ|학개서|חגי|(?:《[該该]|[該该])》|학개?|Αγ|Ог|《[該该]|하까|Ἀγ|[該该]))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Hab"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:ହବ(?:‌କ୍‌କୂକ\s*ଭବିଷ୍ୟ‌ଦ୍‌ବକ୍ତାଙ୍କ\s*ପୁସ୍ତକ|କ[ୁୂ]କ୍)|Книга\s*(?:на\s*пророк\s*Авакума?|пророка\s*Авв?акума)|Pro(?:roctwo\s*Abakukowe|phetia\s*Habacuc)|(?:Habakukin\s*kirj|Ks(?:i[eę]g[ai]\s*Habakuk|\.?\s*Habakuk))a|हबक(?:ूकको\s*पुस्त|्कू)क|Hab(?:a(?:k(?:ku(?:k(?:s\s*Bog|k)|c)|u(?:k[aku]|c))|cuc)|bak(?:k(?:akk|u(?:kk|c))|akk|u(?:kk|c))|akk?akk|[ck])|(?:H(?:ab(?:a(?:k(?:k(?:uks\s*b|o)|o)|co)o|ba[ck]oo|acku)|b)|Abak(?:ou|i)|habak[uū])k|Liv\s*Abakik\s*la|ح(?:َبَق(?:و(?:ق(?:ی(?:ی(?:یه|[ءئه])|ائ[هہ]|ئی|ہ[ئاه]|[ءةهۂ])|ائ[هہ]|وو|ئی|ہ[ئاه]|[ءةـهۂ])|ک)|ق)|بقوق)|அபக்கூக்கு|Hab(?:a(?:k(?:uk(?:in?)?|kuk)?|c)|bak(?:k[au]k|[au]k)|akk?ak)?|ح(?:َبَقوق(?:ی(?:ئ|ہ|ی)?|ا|و|ئ|ہ)?|ب(?:قو?)?)|ହବ‌କ୍‌କୂକ|Ha(?:-?ba-?cú|b(?:bac[au]|aca))c|Habacuque|سفر\s*حبقوق|Α(?:ββακο[υύ]μ|μβακο[υύ]μ)|habakk[uū]k|(?:Xabaqu|Habaq)uq|ḥabaqqūq|حَبَقووق|Аввакума?|A(?:b(?:akuka|k)|va[ck]um)|habaqūq|ฮ(?:าบากุ|บ)ก|Ха[бв]акук|ح(?:بقُ?ّ|َبق)وق|Авакума?|Abak(?:uk)?|habaqū?|हबक(?:्कू|ूक)?|ஆபகூக்|《哈(?:巴谷(?:[书書])?》|》)|Apak[uū]k|Āpak[uū]k|ハ[ハバ]クク(?:しょ|書)|ਹਬ(?:ਕੱ?|ੱਕ)ੂਕ|Abacuc|《哈(?:巴谷[书書]?)?|哈(?:巴谷(?:[书書])?》|》)|חבקוק|Ав(?:ак|в)?|哈(?:巴谷[书書]?)?|ハ[ハバ]クク|하(?:바(?:쿡서|꾹)|박국서)|Xab|하(?:박국|바)|Авк|Αβ|அப|ஆப|Ἀβ|합))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Mic"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:ମ(?:ୀଖା\s*ଭବିଷ୍ୟ‌ଦ୍‌ବକ୍ତାଙ୍କ\s*ପୁସ୍ତକ|ିଖା)|Книга\s*(?:на\s*пророк\s*Михе[ий]|пророка\s*М[иі]хея)|Prophetia\s*Michaeae|Ks(?:i[eę]g[ai]\s*Micheasza|\.?\s*Micheasza)|म(?:ी(?:काको\s*पुस्तक|खा)|िका)|(?:M(?:i(?:ikan\s*kirj|cheasz|hei|kh)|eek)|Liv\s*Miche\s*)a|M(?:i(?:k(?:as\s*(?:Bog|bok)|eas|ā)|(?:ch(?:ae|ä)|k(?:ey|ie))as|qu(?:ei?|éi)as|ch(?:a[aá][sš]|e(?:aš|á[sš]|e)|ah)|keás|-?c(?:hê|a)|hej)|(?:i(?:kah|ika)a|k)h|ikaaha|(?:icah|ík)a|y(?:kaha|cah|[hȟ]ej)|q)|Μ(?:ΙΧΑ(?:Ϊ́|[ΊΙ])ΑΣ|ιχα[ΐίι]ας|χ)|سفر\s*ميخا|M(?:i(?:c(?:h(?:e(?:as?)?|a)?|a)?|ik(?:an?)?|k(?:a(?:h|s)?|ea)?|h|q)|ikaah|icah|ykah|ík)|m(?:īk(?:hāyā|āh|ʰ[aā]|a)|ik(?:ʰ[aā]|[aā]))|م(?:ی(?:ک(?:ا(?:ه(?:ئی|ی[هی]|[ءةـوِہ])|ہ[ئاهوی]|ئ[هہ]|[ةۂی])|ه)|کا[ءاِ]ه|كاه)|ِیکاہ|ي[كک]اه)|mīk(?:hāy?|ā)|ม(?:ีคาห์|คา)|மீக(?:்க)?ா|Michée|م(?:یک(?:ا(?:ه|ہ)?)?|ي)|Мих(?:е[ийяј]|а)|(?:《(?:弥迦书|彌迦書)|弥迦书|彌迦書)》|《?米該亞》|ਮੀਕਾਹ|Міхея|《(?:弥迦书|彌迦書)|《?米該亞|मीका|ମୀଖା|மீக்|Mīk[aā]|ミカ(?:しょ|書)|מיכה|ميخا|М[иі]х|弥迦书|彌迦書|미[가카]서|《[弥彌]》|미[가카]?|《[弥彌]|ミカ|弥》|彌》|弥|彌))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Zech"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:ଯିଖରିୟ\s*ଭବିଷ୍ୟ‌ଦ୍‌ବକ୍ତାଙ୍କ\s*ପୁସ୍ତକ|Книга\s*(?:на\s*пророк\s*Захария|пророка\s*Захарии|пророка\s*Захарія|Захарі[ії])|Prophetia\s*Zachariae|(?:کتاب\s*پیام‌های|سخنان|حکایت|پیام)\s*زکر[يی]ا|Ks(?:i[eę]g[ai]\s*Zachariasza|\.?\s*Zachariasza)|ز(?:ک(?:ر(?:یا(?:‌(?:نامه‌(?:(?:هات|ش)ان|گان|ای)|ا?ی)|(?:ئ[ۀ-ۃ](?:ئہ|ء)|[ۀ-ۃ](?:ئہ|ء)|ها|ء))|يا‌(?:نامه‌(?:(?:هات|ش)ان|گان|ای)|ا?ی))|‌نامه)|َکر[يی]ا‌نامه‌ی)|(?:ز(?:(?:(?:کر(?:یا(?:‌نامه‌گ?ی‌|-?)|يا(?:‌نامه‌گ?ی‌|-?))|کريا)ه|َ(?:کر[يی]ا(?:‌نامه‌|-?)ه|كَرِيّ))|كري)|سفر\s*زكري)ا|ज(?:क(?:र(?:ियाको\s*पुस्तक|्याह)|यार्ह)|ख[रऱ]्या)|ز(?:ک(?:ر(?:یا‌نامه(?:‌(?:هات?|ی))?|يا(?:‌نامه(?:‌(?:هات?|ی))?)?|ی(?:ا(?:ئ[ۀ-ۃ]|ه|[ۀ-ۃ])?)?)?)?|َکر[يی]ا(?:‌نامه)?|ك)|(?:Sa(?:kar(?:jan\s*kirj|í)|charj)|Liv\s*Zakari\s*|X(?:a-?ch|ê-?c)a-?ri-?|Z(?:a(?:(?:c(?:hariasz|cari)|kar(?:iy|ai)y)|khariy)|ekariy))a|Z(?:a(?:(?:(?:kari(?:a(?:s['’]\s*Bog|h)|ya)|char(?:i(?:(?:a[hš]|[eh])|á[sš])|j[aá][sš])|harij?a|ȟarij)|charah)|cher[ai]h)|(?:akaraya|acheria|c)h|akhariah|e(?:ch[ae]riah|ch[ae]r[ai]h|kariah|jarīyā))|Sa(?:kar(?:ja(?:boken|s\s*bok)|ias)|car[ií]as)|رساله\s*زکر[يی]ا|کتاب\s*زکر[يی]ا|نامه\s*زکر[يی]ا|เศคาริยาห์|Xa(?:-?cha-?ri)?|Z(?:a(?:c(?:h(?:arias?)?|ch?|ar)?|k(?:ari(?:as?)?)?|h(?:arij)?)?|akaraya|acheria|akharia|e(?:c(?:h[ae]ria|h?)|k(?:aria)?|jarīy?)|c)|(?:Z(?:ach(?:ar(?:ii|a[ai])|er(?:a[ai]|ii))|ech[ae]r(?:a[ai]|ii))|zakari?yā)h|(?:Zekhari|Sekarya)ah|ச(?:ெக்)?கரியா|Zaccharie|S(?:a(?:k(?:ar(?:jan?|ia))?|ch)|ek)|Zakariás|Zacar[ií]as|Ζ(?:αχαρ[ίι]ας|χ)|zej(?:arīyā|ār)|Захар(?:и(?:ја|[ия])|і[ийяії])|Jakaryah|Cakariy[aā]|jak(?:ariy[aā]|ʰary[aā])|《?撒(?:(?:迦利(?:亞書|亚书)|迦利亞)|加利亞書)》|ਜ(?:਼ਕਰ[ਜਯ]ਾਹ|ਕਰਯਾਹ)|Закария|zejarī|《?撒(?:迦利(?:(?:亞書|亚书)|亞)|加利亞書)|जकरिया|ଯିଖରିୟ|[セゼ]カリヤ(?:しょ|書)|(?:《?匝加利亞|《[亚亞]|[亚亞])》|《?匝加利亞|즈(?:카르야서|가리야)|זכריה|ச(?:கரி|ெக்)|[セゼ]カリヤ|스가랴서|Ζαχ?|За[кх]|스가랴|ศคย|즈카|《[亚亞]|[亚亞]|슥))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Zeph"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:ସିଫନିୟ\s*ଭବିଷ୍ୟ‌ଦ୍‌ବକ୍ତାଙ୍କ\s*ପୁସ୍ତକ|Книга\s*(?:на\s*пророк\s*Софония|пророка\s*Софон(?:ии|і[ії]))|Pro(?:roctwo\s*Sofoniaszow|phetia\s*Sophonia)e|(?:کتاب\s*پیام‌های|سخنان|حکایت|دعای)\s*ضفينيا|ضفينيا(?:‌(?:نامه‌هاتان|نامه‌شان|های‌شان|یی)|‌نامه‌(?:ها‌|ا)ی|\s*نبی|ی)|Ks(?:i[eę]g[ai]\s*Sofoniasza|\.?\s*Sofoniasza)|(?:ضف(?:ينيا(?:‌(?:نامه‌گ?ی‌ه|ای‌ه)|-?ه)|‌نامه‌ه|(?:‌ن)?ی)|ص(?:فینيا‌نامه‌ی‌|(?:َفینيا‌ی‌|فینیا-?))ه|ص(?:ف(?:ین(?:يا‌(?:نامه‌)?ه|یاه)|‌نامه‌ه|ني)|َفین(?:ياه|ی))|کتاب\s*صفینی|صَفانی)ا|स(?:पन्याहको\s*पुस्तक|फन्या)|ضف(?:ينيا(?:‌(?:نامه(?:‌(?:هات?|ی))?|ا?ی))?|‌نامه|‌ن)?|صف(?:ینيا‌نامه‌ش|‌نامه‌گ)ان|صفین(?:يا‌(?:نامه‌ا|ی)|یا‌ا)ی|(?:S(?:efan(?:jan\s*kirj|ij|í)|ô-?phô-?ni-?|ofoniasz)|Xê-?pha-?ni-?|Ze(?:phan(?:ay|j)|f(?:an(?:ay|[jy])|iny))|Dhof(?:-?ni|eny|in[iy])|(?:Z[eo]f-?|[TŢȚ]efa)ni|Z[eo]feny|Zofin[iy])a|صفینيا‌نامه‌ی|Sefanias['’]\s*Bog|Z(?:e(?:(?:fania(?:s’\s*Bog|h)|phania[hs])|panias)|of[oó]ni[aá]s)|Liv\s*Sofoni\s*an|S(?:e(?:fanjas\s*bok|panias)|o(?:fon(?:i(?:(?:aš|j[ae]|e)|á[sš])|j[aá][sš])|phonie)|f)|رساله\s*ضفينيا|ص(?:ف(?:ین(?:يا‌نامه|یا)|‌ن(?:امه)?|ن(?:یا?)?)?|َف(?:َنی(?:اء?|ہ)|ینيا))|(?:پیام\s*صفی|سفر\s*صف|صفي)نيا|(?:پیام|کتاب)\s*ضفينيا|نامه\s*ضفينيا|ص(?:َف(?:ینيا‌یی|َنی(?:ا(?:ء[ءةہۂی]|ئ[ءةهہۂی]|[ةهہۂ])|ہ[ءةہۂ]|ۂ))|ف(?:‌نامه‌ی|ن(?:‌نامه|یاہ)|ینیا‌ی))|صفینيا\s*نبی|Z(?:ephanai|a(?:ph|f)ani)ah|Dhof(?:eniyah|ania)|(?:(?:Dhofaniy|(?:(?:S(?:efanya|apany)|Zefaniy)|Zofaniy))a|sapany[aā])h|S(?:ô-?phô-?ni|e(?:f(?:an(?:ias?|jan?))?|pania)|o(?:f(?:oni(?:as?)?)?|ph)|zof)|Z(?:ephanai|a(?:ph|f)ani)a|Dhofeniya|So(?:phoni|foní)as|Sz(?:ofo|efa)ni[aá]s|Xô-?phô-?ni|Z[eo]feniyah|Ceppa[nṉ]iy[aā]|செப்பனியா|ṣafaniyāh|เศฟันยาห์|Ze(?:f(?:anias?)?|p(?:h(?:ania)?)?)|Z[eo]feniya|zofanj(?:īy|ā)|Σ(?:οφον[ίι]ας|φν)|С(?:офон(?:и(?:ј[ае]|[ийя])|і[яії])|ефанија)|sapʰany[aā]|safanyāh|zof(?:anjī)?|सपन(?:्याह)?|Zofania|[セゼ](?:ファニ(?:ヤ(?:しょ|書)|ア書)|[ハパ]ニヤ書)|ਸਫ਼ਨਯਾਹ|ସିଫନିୟ|(?:《?索福尼亞|《?番)》|《?西番雅[书書]》|[セゼ](?:ファ(?:ニア)?|[ハパ]ニヤ)|《?索福尼亞|《?西番雅[书書]|스바(?:니야|냐)서|צפניה|스바(?:니야|냐)?|செப்|[TŢȚ]ef|Соф|Zph|ศฟย|Xô|Zp|《?番|습))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Luke"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))(Lu-?ca|(?:The\s*Gospel\s*(?:according\s*to\s*(?:S(?:aint\s*L(?:uke|k)|t(?:\.\s*L(?:uke|k)|\s*L(?:uke|k)))|L(?:uke|k))|of\s*(?:S(?:aint\s*L(?:uke|k)|t(?:\.\s*L(?:uke|k)|\s*L(?:uke|k)))|L(?:uke|k)))|Mabuting\s*Balita\s*ayon\s*kay\s*(?:San\s*Lu[ck]as|Lu[ck]as)|The\s*Gospel\s*(?:according\s*to\s*(?:S(?:aint\s*Luk?|t(?:\.\s*Luk?|\s*Luk?))|Luk?)|of\s*(?:S(?:aint\s*Luk?|t(?:\.\s*Luk?|\s*Luk?))|Luk?))|Gospel\s*(?:according\s*to\s*(?:S(?:aint\s*L(?:uke|k)|t(?:\.\s*L(?:uke|k)|\s*L(?:uke|k)))|L(?:uke|k))|of\s*(?:S(?:aint\s*L(?:uke|k)|t(?:\.\s*L(?:uke|k)|\s*L(?:uke|k)))|L(?:uke|k)))|Gospel\s*(?:according\s*to\s*(?:S(?:aint\s*Luk?|t(?:\.\s*Luk?|\s*Luk?))|Luk?)|of\s*(?:S(?:aint\s*Luk?|t(?:\.\s*Luk?|\s*Luk?))|Luk?))|l(?:ūk(?:āne\s*lihilele\s*[sŝ]ubʰavartam[aā]|ane\s*lihilele\s*[sŝ]ubʰavartam[aā])|uk[aā]ne\s*lihilele\s*[sŝ]ubʰavartam[aā])n|Ebanghelyo\s*ayon\s*kay\s*(?:San\s*Lu[ck]as|Lu[ck]as)|(?:E(?:w(?:angelia\s*(?:w(?:edług\s*[sś]w\.?\s*Łukasz|g\s*[sś]w\.?\s*Łukasz)|Łukasz)|\.?\s*Łukasz)|vanjelium\s*Pod[lľ]a\s*Luk[aá][sš])|Injili\s*ya\s*Luk|L(?:lu|oo)k)a|Evan(?:keliumi\s*Luukkaan\s*mukaan|gelium\s*(?:secundum\s*Lucam|podle\s*Luk[aá][sš]e))|ल(?:ूका(?:ने\s*लिहिलेले\s*शुभवर्तमान|(?:ले\s*लेखे)?को\s*सुसमाचार)|ुका)|l(?:ū(?:(?:kāle\s*lekʰeko\s*susm[aā]c[aā]r|(?:qā(?:\s*kī\s*injīl|n)|kā\s*dī\s*ĩjīl))|kale\s*lekʰeko\s*susm[aā]c[aā]r)|uk[aā]le\s*lekʰeko\s*susm[aā]c[aā]r)|லூக்கா\s*(?:எழுதிய\s*(?:சுவிசேஷம்|நற்செய்தி)|நற்செய்தி)|От\s*Лук(?:а\s*свето\s*Евангелие|и)|Evangelie\s*volgens\s*Lu[ck]as|Ebanghelyo\s*ni\s*San\s*Lu[ck]as|Евангелие(?:то\s*според\s*Лука|\s*(?:според\s*Лука|от\s*Лук[аи]))|(?:Evangeliet\s*etter\s*Luk|E(?:l\s*E)?vangelio\s*de\s*Luc|S(?:ulat\s*ni\s*S)?an\s*Luc|Injil\s*Luk)as|Євангелі(?:я\s*від\s*(?:св\.?\s*Луки|Луки)|є\s*від\s*(?:св\.?\s*Луки|Лу\s*?ки))|L(?:u(?:ukkaan\s*evankelium|kk[aā]\s*Na[rṛ]ceyt)|ūkk[aā]\s*Na[rṛ]ceyt)i|Jevan(?:helije\s*vid\s*Luky|đelje\s*po\s*Luki)|Luk(?:(?:as(?:ovo)?|ašovo)\s*evangeliu|á[sš]ovo\s*evangeliu)m|ଲୂକ\s*ଲିଖିତ\s*ସୁସମାଗ୍ଭର|Vangelo\s*di\s*(?:San\s*)?Luca|הבשורה\s*על(?:-?פי\s*לוקא?ס|\s*פי\s*לוקס)|Evan[ðđ]elje\s*po\s*Luki|(?:Јеванђеље\s*по|Еванђеље\s*по|Від)\s*Луки|พระวรสารนักบุญลูค|L[uú]kasarguðspjall|(?:Ungjilli\s*i\s*Luk[eë]|Lu(?:k[aá]c|uko))s|L(?:u(?:k(?:a(?:sevangeliet|ah)|aša|á[sš]a|e)|cas)|o(?:oqa(?:at|h)|[kq]aa[ht])|uqa(?:at|h)|ik|[ck])|ل(?:ُوقا\s*کی\s*انجیل|و(?:قا\s*کی\s*انجیل|(?:ق(?:ا(?:ءه|[تهی])|[آةهىی])|[كک](?:ا[ءه]|ة))))|ਲੂਕਾ\s*ਦੀ\s*ਇੰਜੀਲ|Κατ[άα]\s*Λουκ[άα]ν|Saint\s*L(?:uke|k)|إنجيل\s*لوقا|Saint\s*Luk?|L(?:u(?:uk(?:kaan)?|k(?:a(?:sa?)?|aš|á[sš])?|ca?)?|o(?:oqaa?|[kq]a)|uqaa?|ukk[aā]|ūkk[aā]|lu|úk)?|ルカ(?:による福音書|[の傳]福音書|福音書|[伝書])|St\.\s*L(?:uke|k)|От\s*Лука|St\.\s*Luk?|Ł(?:ukasza|k)|St\s*L(?:uke|k)|Łuk(?:asz)?|l(?:ū(?:(?:(?:kāle|(?:qā?|kā))|kāne)|ka[ln]e)|uk[aā][ln]e)|லூ(?:க்(?:கா)?)?|Ew\s*Łuk|लूक(?:ा(?:ने|ले)?)?|St\s*Luk?|Λ(?:ουκ[άα]ς|κ)|《?路加福音》|루카\s*복음서|ل(?:و(?:ق(?:اء?)?|[كک]ا)?|ُوقا)|《?路加福音|루카(?:\s*복음)?|누가복음서|Λουκ|누가복음|ਲੂਕਾ|Л(?:ук[aаио]|к)|ล(?:ูกา|ก)|《?魯喀》|לוקס|Лук|《?魯喀|ଲୂକ|《路》|《路|ルカ|누가|路》|路|눅))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Jer"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))(ارمييا-?ها-?ها|اِرمی\s*ی[اه]|(?:எரேமியா\s*தீர்க்கதரிசியின்\s*புத்தகம்|ଯିରିମିୟ\s*ଭବିଷ୍ୟ‌ଦ୍‌ବକ୍ତାଙ୍କ\s*ପୁସ୍ତକ|Книга\s*(?:на\s*пророк\s*(?:[ИЙ]е|Е)ремия|пророка\s*(?:Иеремии|Єремі[ії]))|A(?:klat\s*ni\s*Jeremia[hs]|[ae]rmii[ay]ah|rm(?:iiyah|eya[ah]))|Ks(?:i[eę]g[ai]\s*Jeremiasza|\.?\s*Jeremiasza)|Sulat\s*ni\s*Jeremias|y(?:armiy[aā]ko\s*pustak|irm(?:iiyaah|ay(?:āh|a)|īyā))|य(?:र्मियाको\s*पुस्तक|िर्मयाह)|(?:Irmeiyaah-?ha-?h|(?:Yirmei|yirmiy)aah-?ha-?h|Jeremi(?:a(?:n\s*kirj|sz)|j)|A(?:rmi(?:aah-?ha-?h|ya)|[ae]rmiya)|Giê-?rê-?mi-?|(?:Ermeyiah-?|Irm['’]yaa)h|Geremi|Y(?:(?:ere?|eré)mi|ér[eé]mi))a|Li(?:ber\s*Ieremiae|v\s*Jeremi\s*an)|ا(?:رم(?:(?:(?:ييا(?:ت(?:(?:ُ-?)?ها|-?ها|َ)-?|-?ها‌|تِ-?|ه(?:ا-?|[-‌])|‌)|ی[-‌])|يياي[-‌])|ييايي[-‌])ه|ِر(?:م(?:(?:ي(?:يا(?:(?:-?ها[-‌]|يي[-‌]|ي[-‌]|‌)ه|ت-?[هي]|-?ي)|ی)|یا\s*[يی]|ی[-‌]ه)|\s*ی)|\s*می)|رمييات?-?ي)ا|J(?:er(?:em(?:i(?:a(?:s['’]\s*Bog|[hš])|e)|iá[sš]|j[aá][sš]|ah)|amah|imih)|r)|Irmeiyaah(?:-?ha)?|(?:Yirmei|yirmiy)aah(?:-?ha)?|Jeremias\s*bok|ا(?:ر(?:(?:(?:م(?:ييا(?:ت(?:(?:ُ-?)?ها|-?ها|َ)|-?ها|ت(?:ُ|ِ)?|ها?)?|یا?)?)?|ميياي)|مييايي)|ِرم(?:ي(?:يا(?:-?ها|يي|ت|ي)?|ا)|ی(?:اء?|ا?ه)?))|Armiaah(?:-?ha)?|เยเรมีย(?:าห)?์|G(?:iê(?:-?rê-?mi)?|er)|y(?:irm(?:iiyaa|i(?:iya|y)|ayā|īy?)|armiy[aā]ko)|य(?:र्मिया(?:को)?|िर्म(?:या)?)|ا(?:رم(?:ييات[ُِ]ه|ی(?:ا[ءاه]|[هى]))|رمي(?:ياتـ|یا)ه|ِرم(?:ي(?:يا(?:ءِ|ه)|ا[ءا])|ی(?:ا(?:ء[هى]|ئه|[اى])|ا?ها|ی[اه]|ى))|رميياءِ|رمیی[اه])|Yrm['’]yaaha|Er(?:m(?:e(?:yiah|i)a|['’]yaaha|ii?yah|iaha)|[eē]miy[aā])|(?:Yrmi(?:iya|y)a|Jeramia|[IY]rmeya[ah]|Erm(?:iy?aa|eya[ah])|[IY]rmiaa)h|(?:Jeremaia|Erm(?:i(?:iyaa|a['’])|eyiaa)|Jer(?:emii|am[ai]i|im(?:i[ai]|a))|Irmiyaa|yirmiyā|[IY]rmia['’])h|(?:Yeremya|Yrmeiy|Erm(?:eiy|['’]i)|Yirmay|Jer(?:ai|m[im])|Irm['’]i|Yrm['’]i)ah|سفر\s*إرميا|J(?:e(?:(?:r(?:e(?:m(?:i(?:a(?:n|s)?)?)?)?)?)?|rém)|é(?:r(?:[eé]m)?)?)|Yrm['’]ya(?:ah?)?|Erm(?:['’]ya(?:ah?)?|iy?a|eya|iah)|Yrmi(?:iya|y)a|Yrmiiyah|Jeremías|I(?:eremias|rm(?:ei(?:yah|a)|iyah))|Ιερεμ[ίι]ας|Jeremaih|(?:Jer[ae]mih|[IY]rmiah)a|Јеремија|Irmiiya[ah]|H[ei]r[ei]m[iy]as|ਯਿਰਮਿਯਾਹ|Jeremía|I(?:er(?:emia)?|rm(?:i|['’])ya)|Jer[ae]mih|Jeramia|[IY]rmeya[ah]|Erm(?:iy?aa|eya[ah])|எரே(?:மியா)?|ଯିରିମିୟ|Еремија|Иереми[ия]|ஏரேமியா|یرمِ?یاہ|J(?:erémi|ér[eé]mi)e|Йеремия|[IY]rmeya|[IY]rmiah|[IY]rmiaa|Єремі[яії]|Еремия|Yrmeia|《耶(?:(?:利米[书書])?|肋米亞)》|ירמיהו|ﺃﺭﻣﻴﺎء|[IY]rmia|《耶(?:利米[书書]|肋米亞)?|ירמיה|耶(?:(?:利米[书書])?|肋米亞)》|예레미(?:야서|아)|エレミヤ書|ヱレミヤ記|[أإ]رميا|耶(?:利米[书書]|肋米亞)?|예레(?:미야)?|エレミヤ|Ye?r|Јер|Иер|Йер|ஏரே|ยรม|Ιε|Єр|Ер|Gr|Ἰε|렘))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Cor"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Втор(?:а\s*писмо\s*од\s*апостол\s*Павле\s*до\s*христијаните\s*во\s*Коринт|о\s*(?:п(?:исмо\s*од\s*апостол\s*Павле\s*до\s*христијаните\s*во\s*Коринт|ослание\s*към\s*коринтяните)|(?:Коринтя|Корин[кќ]а)ните)|(?:а\s*Коринтя|а\s*Корин[кќ]а)ните)|(?:II\.?\s*пи|2\.?\s*пи)смо\s*од\s*апостол\s*Павле\s*до\s*христијаните\s*во\s*Коринт|(?:Второ\s*послание\s*на\s*св(?:\.\s*ап\.?\s*Павла\s*до\s*Коринт|\s*ап\.?\s*Павла\s*до\s*Коринт)|2-?е\.?\s*Коринт)яни|D(?:(?:(?:ru(?:he\s*poslannja\s*apostola\s*Pavla\s*do\s*korynfj|g[ai]\s*Korynti)|rug(?:a\s*(?:List\s*[sś]w\.?\s*Pawła\s*do\s*Korynt|list\s*do\s*Korynt)|i\s*(?:List\s*[sś]w\.?\s*Pawła\s*do\s*Korynt|list\s*do\s*Korynt))i)a|o(?:(?:(?:vom)?\s*|(?:vom)?)Qorint(?:h(?:iy?a|yu)|iy?a|yu)|(?:(?:vom)?\s*|(?:vom)?)Korinth?ia))n|ezy[eè]m\s*Korentyen|ru(?:g(?:a\s*Korynt[oó]w|i\s*Korynt[oó]w)|h(?:[aá]|[yý])K))|கொரிந்தியருக்கு\s*எழுதிய\s*இரண்டா(?:வது\s*(?:திருமுக|நிருப)ம்|ம்\s*(?:திருமுக|கடித)ம்)|Korint(?:iyarukku\s*E[lḻ]utiya\s*Ira[nṇ][tṭ][aā]vatu\s*Nirupam|os\s*Labaad)|2-?(?:ге|а)\.\s*(?:послання\s*апостола\s*Павла\s*до\s*коринфян|(?:Послання\s*до\s*Коринт|(?:до\s*)?коринт|Коринф)ян|Коринтяни)|Друг(?:а\s*послання\s*апостола\s*Павла\s*до\s*коринфян|е\s*(?:послання\s*апостола\s*Павла\s*до\s*коринфян|(?:Послання\s*до\s*Коринт|(?:до\s*)?коринт|Коринф)ян|Коринтяни)|а\s*(?:(?:посланица\s*)?Коринћанима|Коринтяни)|(?:а\s*Послання\s*до\s*Коринт|а\s*(?:до\s*)?коринт|а\s*Коринф)ян)|رسالة\s*بولس\s*الرسول\s*الثانية\s*إلى\s*أهل\s*كورنثوس|2-?е\.?\s*послання\s*апостола\s*Павла\s*до\s*коринфян|2-?(?:ге|а)\s*(?:послання\s*апостола\s*Павла\s*до\s*коринфян|(?:Послання\s*до\s*Коринт|(?:до\s*)?коринт|Коринф)ян|Коринтяни)|(?:II\.?\s*по|2\.?\s*по)слання\s*апостола\s*Павла\s*до\s*коринфян|ک(?:رنتھ(?:ِیُوں\s*کے\s*نام\s*پولس\s*رسول|یوں\s*کے\s*نام)|ُرِنتھِیوں\s*کے\s*نام)\s*کا\s*دوسرا\s*خط|(?:Pavlova\s*druga\s*poslanica\s*Korin[cć]anim|S[ií]ðara\s*br[eé]f\s*P[aá]ls\s*til\s*Korintumann|Druga\s*Korin[cć]anima\s*Poslanic|Druga\s*poslanica\s*Korin[cæć]anim|(?:II(?:\.\s*Korin[cć]|\s*Korin[cć])|2(?:\.\s*Korin[cć]|\s*Korin[cć]))anima\s*Poslanic)a|(?:Paulus(?:'\s*Andet\s*Brev\s*til\s*Korinth|’\s*(?:Andet\s*Brev\s*til\s*Korinth|andre\s*brev\s*til\s*korint))ern|(?:II\.?\s*Korintt|2\.?\s*Korintt)olaiskirj|And(?:re\s*Korinti|en\s*Korint)ern|2(?:\s*(?:[ei](?:\.\s*Korin?t|\s*Korin?t)|Korit)asv|\.\s*Kori(?:nt(?:i?ern|asv)|tasv)|\s*Korinti?ern|\s*Korintasv))e|कोरिन्थीहरूलाई\s*(?:पावलको\s*दोस|दोस्त)्रो\s*पत्र|(?:(?:(?:(?:(?:II\.?\s*L|2\.?\s*L)ist\s*[sś]w\.?\s*Pawła\s*do\s*Korynt|(?:II\.?\s*list\s*d|2\.?\s*list\s*d)o\s*Korynt)|(?:II\.?\s*Kory|2\.?\s*Kory)nt)i|2Korinth?i)a|2(?:\.\s*Kurinthiayo|\s*K(?:urinthiayo|orinth?ia))|2\s*?Qorint(?:h(?:iy?a|yu)|iy?a|yu))n|k(?:ur(?:intʰiyōṅ\s*ke\s*nām\s*kā\s*dūsrā\s*ḫaṭ|ĩtʰīāṃ\s*nū̃\s*dūjī\s*pattrī)|orintʰ[iī]har[uū]l[aā][iī]\s*dostro\s*patra|ari[mṃ]tʰkar[aā][mṃ]s\s*dusre\s*patra)|الرسالة\s*الثانية\s*إلى\s*أهل\s*كورنثوس|କରିନ୍ଥୀୟଙ୍କ\s*ପ୍ରତି\s*ଦ୍ୱିତୀୟ\s*ପତ୍ର|T(?:oinen\s*K(?:irje\s*korinttilaisill|orintt(?:olaiskirj|ilaisill))e|weede\s*(?:Korint(?:h?i[eë]rs|he)|Corint(?:h?i[eë]rs|he)))|(?:Waraka\s*wa\s*Pili\s*kwa\s*Wakorinth|Ika-?\s*2\s*Sulat\s*sa\s*mga\s*Corinti|SECOND\s*Sulat\s*sa\s*mga\s*Corinti|I(?:kalawang\s*Mga\s*Taga-?\s*Corint|I\.?\s*Mga\s*Taga-?\s*Corint)|(?:2(?:\.\s*(?:Mga\s*Taga-?\s*|Taga-?)|\s*(?:Mga\s*Taga-?\s*|Taga-?))C|2\.?\s*Mga\s*Taga-?C)orint|Ikalawang\s*[CK]orinti|(?:Pili\s*W|II\.?\s*W|2\.?\s*W)akorinth)o|אגרת\s*פולוס\s*השנייה\s*אל-?הקור(?:נתים|ינ)|Waraka\s*wa\s*Pili\s*kwa\s*Wakorinto|Barua\s*ya\s*Pili\s*kwa\s*Wakorintho|पौलाचे\s*करिंथकरांस\s*दूसरे\s*पत्र|Ika-?\s*2\s*Sulat\s*sa\s*mga\s*Corinto|S(?:ECOND\s*Sulat\s*sa\s*mga\s*Corinto|econd\s*Corinthia?ns|[ií]ðara\s*K[oó]rintubr[eé]f)|(?:II\.?\s*Ki|2\.?\s*Ki)rje\s*korinttilaisille|(?:Second(?:(?:a\s*lettera\s*ai|o)|a)\s*Corinz|II(?:\.\s*Corin(?:ti?en|z)|\s*Corin(?:ti?en|z))|2(?:\.\s*Corin(?:ti?en|z)|\s*Corin(?:(?:tien|z)|ten))|2°\.\s*Corinz|2°\s*Corinz)i|ה(?:איגרת\s*השנייה\s*אל\s*הקורי|שנייה\s*אל\s*הקורי?)נתים|S(?:[ií]ðara\s*br[eé]f\s*P[aá]ls\s*til\s*Kori|econd\s*Co(?:r(?:in(?:t(?:h(?:ian)?)?)?|th)?)?)|Epistula\s*(?:II\s*ad\s*Corinthios|ad\s*Corinthios\s*II)|(?:II\.?\s*по|2\.?\s*по)сланица\s*Коринћанима|(?:(?:2(?:-?е\.?\s*П|\.?\s*П)|II\.?\s*П)ослання\s*до\s*Коринт|(?:(?:2(?:-?е\.?\s*д|\.?\s*д)|II\.?\s*д)о\s*к|II\.?\s*к)оринт|2(?:-?е\.?\s*ко|\.?\s*ко)ринт|II\.?\s*Коринф)ян|ਕੁਰਿੰਥੀਆਂ\s*ਨੂੰ\s*ਦੂਜੀ\s*ਪੱਤ੍ਰੀ|M[aá]sodik\s*Korint(?:husiakhoz|usi)|And(?:r(?:a\s*Korint(?:h?i|h?)erbrevet|e\s*korinterbrev)|(?:e[nt]\s*Korinth|en\s*Korint)erbrev)|(?:Druh(?:(?:[aá]\s*kniha|[aá])\s*Korintsk[yý]|(?:[aá]\s*kniha|[aá])\s*Korintano|(?:[aá]\s*kniha|[aá])\s*Korinťano|[aá]\s*list\s*Korint?sk[yý]|[yý]\s*(?:list\s*Korin(?:tsk[yý]|tano|ťano|sk[yý])|Korin(?:t(?:sk[yý]|ano)|ťano)))|(?:(?:II\.?\s*list\s*K|2\.?\s*list\s*K)orint?s|II\.?\s*Korints|2\.?\s*Korints)k[yý]|2\s*k\.?\s*Korintsk[yý]|2\s*k\.?\s*Korintano|(?:2\s*k\.?\s*Korinť|II\.?\s*Korinť|2\.?\s*Korinť)ano|(?:II\.?\s*Korintan|2\.?\s*Korintan)o)m|(?:(?:Deuxi[eè]mes?\s*Corinthie|2(?:(?:eme|de?)|ème)\.\s*Corinthie|2(?:(?:eme|de?)|ème)\s*Corinthie|(?:II\.?\s*Corinthia|2\.?\s*Corinthia)[ai]|(?:II\.?\s*Corini|2\.\s*Corini)thia|(?:II\.?\s*Corii|2\.?\s*Corii)nthia|(?:(?:(?:II\.?\s*Corini|2\.\s*Corini)|2\s*Corini)t|(?:II\.?\s*Corit|2\.?\s*Corit))hai|(?:II\.?\s*Corn|2\.?\s*Corn)(?:inthai|thia)|(?:(?:II\.?\s*Corintha|2\.?\s*Corintha)|(?:II\.?\s*Corn|2\.?\s*Corn)itha)ia|(?:(?:II\.?\s*Corr|2\.?\s*Corr)in?tha|(?:II\.?\s*Corn|2\.?\s*Corn)tha)i|(?:II\.?\s*Corintho|2\.?\s*Corintho)a|II\.?\s*Corintia|2\s*Corinithia|(?:II\.?\s*Corit|2\.?\s*Corit)hia|2\.?\s*Corintia)n|Second\s*C(?:or(?:i(?:(?:inthii|nthii|nthoi|tho)|thii)|n(?:in?thi|thii)|rin?thi)an|or(?:i(?:(?:n(?:thi(?:an[ao]|na)|ithina)|thin)|nthan)|i(?:ni)?than|n(?:in?than|thin))|(?:or(?:i(?:(?:n(?:(?:t(?:hi(?:a[ai]|o)|i[ao])|ithia)|thoa)|inthia)|thia)|i(?:ni)?thai|n(?:inthai|thia))|or(?:in|ni)thaia|or(?:rin?tha|ntha)i)n|orin[an]thian|hor(?:(?:(?:(?:inth(?:ia|ai)|inthi)|ithia)|nthia)|anthia)n|or(?:in|ni)thain|oranthian)|2nd\.?\s*C(?:or(?:i(?:(?:inthii|nthii|nthoi|tho)|thii)|n(?:in?thi|thii)|rin?thi)an|or(?:i(?:(?:n(?:thi(?:an[ao]|na)|ithina)|thin)|nthan)|i(?:ni)?than|n(?:in?than|thin))|(?:or(?:i(?:(?:n(?:(?:t(?:hi(?:a[ai]|o)|i[ao])|ithia)|thoa)|inthia)|thia)|i(?:ni)?thai|n(?:inthai|thia))|or(?:in|ni)thaia|or(?:rin?tha|ntha)i)n|orin[an]thian|hor(?:(?:(?:(?:inth(?:ia|ai)|inthi)|ithia)|nthia)|anthia)n|or(?:in|ni)thain|oranthian)|(?:(?:II\.?\s*Corii|2\.?\s*Corii)nthii|II\.?\s*Corinthii|Do(?:(?:vom)?\s*|(?:vom)?)Corinti|(?:II\.?\s*Corintho|2\.?\s*Corintho)i|(?:II\.?\s*Corn|2\.?\s*Corn)(?:in?thi|thii)|(?:II\.?\s*Corr|2\.?\s*Corr)in?thi|2\.?\s*Corinthii|(?:II\.?\s*Corit|2\.?\s*Corit)hii|(?:II\.?\s*Corit|2\.?\s*Corit)ho|2Corinti)an|(?:II\.?\s*Corinthia|2\.?\s*Corinthia)n[ao]|(?:II\.?\s*Corini|2\.\s*Corini)thina|(?:II(?:\.\s*Corin[an]|\s*Corin[an])|2(?:\.\s*Corin[an]|\s*Corin[an]))thian|(?:II\.?\s*Ch|2\.?\s*Ch)or(?:(?:(?:(?:inth(?:ia|ai)|inthi)|ithia)|nthia)|anthia)n|2\s*kari[mṃ]tʰkar[aā][mṃ]|2e\.?\s*Corinthien|II(?:\.\s*Corint(?:hi[eo]n|ion)|\s*Corint(?:hi[eo]n|ion))|(?:II\.?\s*Corinthin|2\.?\s*Corinthin)a|(?:(?:(?:II\.?\s*Corini|2\.\s*Corini)|2\s*Corini)t|(?:II\.?\s*Corit|2\.?\s*Corit))han|(?:II\.?\s*Corn|2\.?\s*Corn)(?:in?than|thin)|(?:(?:II\.?\s*Corintha|2\.?\s*Corintha)|(?:II\.?\s*Corn|2\.?\s*Corn)itha)in|(?:II\.?\s*Cora|2\.?\s*Cora)nthian|2\.\s*Corint(?:hi[eo]n|ion)|2\s*Corinithina|(?:II\.?\s*Corintha|2\.?\s*Corintha)n|2\s*Corinthi[eo]n|(?:II\.?\s*Corit|2\.?\s*Corit)hin|2\s*Corintion)s|करिंथकरांस\s*दुसरे\s*पत्र|(?:II\.?\s*Korintt|2\.?\s*Korintt)ilaisille|2(?:\.\s*Korinth?ierb|\s*Korinth?ierb)revet|(?:II\.?\s*Korinthu|2\.?\s*Korinthu)siakhoz|ଦ୍ୱିତୀୟ\s*କରିନ୍ଥୀୟଙ୍କ|2(?:(?:\.\s*(?:korintʰ[iī]har[uū]l[aā][iī]|क(?:ोरिन्(?:थीहरूलाई|‍थी)|ुर(?:िन्(?:यि़|थि)|न्थि)यों)|Korint(?:hiers|i(?:ers|o))|โครินธ์)|\s*(?:(?:(?:(?:korintʰ[iī]har[uū]l[aā][iī]|(?:(?:(?:Korinti(?:yarukku|o)|ਕੁਰਿੰਥੀਆਂ\s*ਨੂੰ|करिंथकरांस|kurĩtʰīāṃ|Corinto|قور|ค[ธร])|Korinthiers)|Korintiers))|कुर(?:िन्(?:यि़|थि)|न्थि)यों)|कोरिन्(?:थीहरूलाई|‍थी))|โครินธ์)|(?:-?е\.?\s*к\s*|\.?\s*к\s*)Коринфянам|(?:-?я|[ея])(?:\.\s*(?:к\s*)?Коринфянам|\s*(?:к\s*)?Коринфянам)|(?:-?е\.?\s*Коринфяна|\.?\s*Коринфяна)м|e\.?\s*Corinthe|كو|코린)|qrnt)|(?:2(?:\.\s*Korinth?erbreve|\s*Korinth?erbreve)|Dezy[eè]m\s*Korin)t|코린토(?:\s*신자들에게\s*보낸\s*둘째\s*서간|2서)|Προς\s*Κορινθ[ίι]ους\s*Β['ʹʹ΄’]|D(?:ru(?:ga\s*Korin[cć]anima|h(?:[aá]|[yý])\s*K)|ovomCor)|Tweede\s*(?:Kor(?:inth?i[eë]r)?|Corinth?i[eë]r)|M[aá]sodik\s*Kor(?:inthus)?|Ikalawang\s*[CK]orinto|(?:(?:Do(?:(?:vom)?\s*|(?:vom)?)Corinth|2Corinth)ian|Second\s*Corthian|2e\.?\s*Corinthier|II(?:\.\s*(?:Corinth?ier|Korinto)|\s*(?:Corinth?ier|Korinto))|2\.\s*Corinth?ier|2nd\.?\s*Corthian|2\s*Corinthier|(?:II\.?\s*Cort|2\.?\s*Cort)hian|2\s*Corintier|2\.?\s*Korinto)s|(?:Segund[ao]\s*Cor[ií]nt|(?:2(?:(?:(?:\.[oº]|º)\.?\s*Cori|\s*Corí)|\.\s*Corí)|II\.?\s*Corí)nt|2[ao]\.\s*Cor[ií]nt|2[ao]\s*Cor[ií]nt)ios|2(?:(?:(?:\.\s*(?:Kor(?:int(?:h(?:e(?:r(?:brev)?)?|ier)|erbrev|ier|er|a)?)?|क(?:ुरिन्थ(?:ियो)?|ोरिन्थी)|Кор)|\s*Korinthe(?:r(?:brev)?)?|\s*Korinterbrev|-?е\.?\s*Коринфян|\s*Korinthier|\s*कुरिन्थ(?:ियो)?|\s*(?:ਕੁਰਿੰਥੀਆਂ|Co(?:r(?:in(?:ti?|i)?)?)?|Ko(?:r(?:int)?)?|கொ(?:ரி)?)|\s*Korintier|\.?\s*Коринфян|\s*Korinter|\s*कोरिन्थी|\s*Korinta|\s*Кор|Kor)|qrn?)|قر(?:نت?)?)|(?:Do(?:(?:vom)?\s*|(?:vom)?)Corinth|2Corinth)ian|ଦ୍ୱିତୀୟ\s*କରିନ୍ଥୀୟ|2nd\.?\s*Corinthia?ns|Zweite\s*Korinther|ad\s*Corinthios\s*II|(?:Втор[ао]\s*Коринтја|(?:II\.?\s*Коринт|2\.?\s*Коринт)ја)ни|(?:II(?:\.\s*Korin[cć]|\s*Korin[cć])|2(?:\.\s*Korin[cć]|\s*Korin[cć]))anima|2nd\.?\s*Co(?:r(?:in(?:t(?:h(?:ian)?)?)?|th)?)?|Second\s*Corthian|Втор(?:а\s*Кор(?:интяни)?|о\s*Кор(?:интяни)?)|دو(?:م(?:(?:-?کُرِنتھِی|(?:(?:\s*کرنتھ(?:ِیُ|ی)|۔کرنتھی)|\s*کُرنتھِی))وں|قرنت(?:ی[او]ن(?:ی?ان|ها|ن)|يان))|(?:م\s*)?قرنت(?:ی[او]ن(?:ی?ان|ها|ن)|يان)|\s*قرنت(?:ی[او]ن(?:ی?ان|ها|ن)|يان))|2\.?\s*korinterbrev|(?:II\.?\s*Corinthia|2\.?\s*Corinthia)ns|(?:2(?:(?:(?:e\.?\s*Corinthië|\.\s*Korinth?ië|\s*(?:Korinth?ië|Corintië))|\s*Corinthië)|\.\s*Corinth?ië)|II(?:\.\s*(?:Corinth?ië|Korinti[eë])|\s*(?:Corinth?ië|Korinti[eë])))rs|(?:II\.?\s*Korinthi|2e\.?\s*Corinti)[eë]rs|2e\.?\s*Korint(?:h?i[eë]rs|he)|(?:II\.?\s*Коринт|2\.?\s*Коринт)яните|(?:II(?:\.\s*Корин[кќ]|\s*Корин[кќ])|2(?:\.\s*Корин[кќ]|\s*Корин[кќ]))аните|(?:II\.?\s*Коринћ|2\.?\s*Коринћ)анима|كورنثوس\s*الثانية|(?:II\.?\s*Corinthia|2\.?\s*Corinthia)n|2e\.?\s*Corinthier|II(?:\.\s*(?:Corinth?ier|Korinto)|\s*(?:Corinth?ier|Korinto))|(?:2(?:(?:(?:e\.?\s*Corinthië|\.\s*Korinth?ië|\s*(?:Korinth?ië|Corintië))|\s*Corinthië)|\.\s*Corinth?ië)|II(?:\.\s*(?:Corinth?ië|Korinti[eë])|\s*(?:Corinth?ië|Korinti[eë])))r|(?:II\.?\s*Korinthi|2e\.?\s*Corinti)[eë]r|2e\.?\s*Korinth?i[eë]r|II(?:\.\s*(?:C(?:orint(?:h(?:ios|e)|ios|o)|ô(?:-?rinh-?|rin)tô)|Korint(?:usi|he|io))|\s*(?:C(?:orint(?:h(?:ios|e)|ios|o)|ô(?:-?rinh-?|rin)tô)|Korint(?:usi|he|io)))|(?:2\.|۲)-?کُرِنتھِیوں|(?:II\.?\s*Corinthin|2\.?\s*Corinthin)s|(?:Pili\s*W|II\.?\s*W|2\.?\s*W)akorinto|(?:Andre\s*Korinte|Pili\s*Ko)r|2\.?\s*କରିନ୍ଥୀୟଙ୍କ|Do(?:(?:vom)?\s*|(?:vom)?)Corinth|2\.\s*Corinth?ier|2nd\.?\s*Corthian|(?:II\.?\s*Korinthu|2\.?\s*Korinthu)s|(?:II\.?\s*Коринт|2\.?\s*Коринт)яни|2\.\s*C(?:orint(?:h(?:ios|e)|ios|o)|ô(?:-?rinh-?|rin)tô)|(?:II\.?\s*Kore|2\.?\s*Kore)ntyen|Β['ʹʹ΄’]\s*Κορινθ[ίι]ους|(?:2\.?\s*کرنتھ(?:ِیُ|ی)|۲\s*کرنتھ(?:ِیُ|ی))وں|(?:2\.?\s*ک|۲\s*ک)ُرنتھِیوں|2-?کُرِنتھِیوں|Wakorintho\s*II|Corinthios\s*II|2\s*கொரிந்தியர்|II(?:\.\s*(?:C(?:o(?:r(?:in(?:t(?:io|h)?)?)?)?|ô(?:-?rinh)?)|Kor(?:int(?:us|a)?)?|Кор)|\s*(?:C(?:o(?:r(?:in(?:t(?:io|h)?)?)?)?|ô(?:-?rinh)?)|Kor(?:int(?:us|a)?)?|Кор))|دو(?:(?:م\s*)?قرنتی[او]ن(?:ه|ی)?|مق(?:رنتی[او]ن(?:ه|ی)?)?|\s*قرنتی[او]ن(?:ه|ی)?)|2\s*Corinthier|(?:II\.?\s*Cort|2\.?\s*Cort)hian|2\s*Corinth(?:ios|e)|2\s*Cô(?:-?rinh-?|rin)tô|2\.?\s*Korintusi|(?:II\.?\s*Kory|2\.?\s*Kory)nt[oó]w|2\s*قرنت(?:ی[او]ن(?:ی?ان|ها|ن)|يان)|۲\s*قرنت(?:ی[او]ن(?:ی?ان|ها|ن)|يان)|コリント(?:人への(?:第二の手紙|後の書|手紙[Ⅱ二])|の信徒への手紙二|\s*2|後書)|2\.\s*C(?:o(?:r(?:in(?:t(?:io|h)?)?)?)?|ô(?:-?rinh)?)|2\.?\s*Korintus|2\s*Corintier|2\.?\s*କରିନ୍ଥୀୟ|2\s*Corintios|(?:2\.?۔|۲۔)کرنتھیوں|[2۲]قرنتی[او]ن(?:ی?ان|ها|ن)|2\s*Corintio|2\s*قرنتی[او]ن(?:ه|ی)?|۲\s*قرنتی[او]ن(?:ه|ی)?|2\.?\s*Korinto|2\s*Corinth|2\s*Cô(?:-?rinh)?|[2۲]قرنتی[او]ن(?:ه|ی)?|And(?:en|re)\s*Kor|(?:II\.?\s*Cort|2\.?\s*Cort)h|2Corinth|[2۲]قرنتيان|Ⅱ\s*コリント人へ|2e\.?\s*Kor|(?:《?哥林多后书|《?哥林多後書|(?:《[格歌]|[格歌])林多後書|《林[后後]|林[后後])》|《?适凌爾福後》|Β['ʹʹ΄’]\s*Κορ?|《?哥林多后书|《?哥林多後書|(?:《[格歌]|[格歌])林多後書|《?适凌爾福後|۲(?:قر(?:نت?)?|qrn?)|۲qrnt|고린도[2후]서|2Cor|《林[后後]|林[后後]|고후))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Cor"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:П(?:рв(?:а\s*писмо\s*од\s*апостол\s*Павле\s*до\s*христијаните\s*во\s*Коринт|о\s*(?:писмо\s*од\s*апостол\s*Павле\s*до\s*христијаните\s*во\s*Коринт|Корин(?:[кќ]аните|тјани))|а\s*(?:(?:посланица\s*)?Коринћанима|Коринтјани)|а\s*Корин[кќ]аните)|(?:ърво\s*послание\s*на\s*св(?:\.\s*ап\.?\s*Павла\s*до\s*Коринт|\s*ап\.?\s*Павла\s*до\s*Коринт)я|ерш[ае]\s*Коринтя)ни|ерш[ае]\s*(?:послання\s*апостола\s*Павла\s*до\s*коринф|(?:Послання\s*до\s*Коринт|(?:до\s*)?коринт|Коринф))ян|ърво\s*послание\s*към\s*коринтяните|ърв[ао]\s*Коринтяните)|(?:1\.?\s*пи|I\.?\s*пи)смо\s*од\s*апостол\s*Павле\s*до\s*христијаните\s*во\s*Коринт|(?:(?:P(?:er[sš]e\s*poslannja\s*apostola\s*Pavla\s*do\s*korynfj|ierwsz[aey]\s*Korynti)|(?:Pierwsz[aey]\s*(?:List\s*[sś]w\.?\s*Pawła\s*do\s*Korynt|list\s*do\s*Korynt)|(?:1\.?\s*L|I\.?\s*L)ist\s*[sś]w\.?\s*Pawła\s*do\s*Korynt|(?:1\.?\s*list\s*d|I\.?\s*list\s*d)o\s*Korynt)i|Avval\s*?Korinth?i|(?:1\.?\s*Kory|I\.?\s*Kory)nti|1Korinth?i)a|Premye\s*Korentye|1(?:\.\s*Kurinthiayo|\s*K(?:urinthiayo|orinth?ia))|(?:1\.?\s*Kore|I\.?\s*Kore)ntye)n|K(?:orint(?:iyarukku\s*E[lḻ]utiya\s*Mutal[aā]vatu\s*Nirupam|os\s*Kowaad)|wanza\s*Kor)|1-?(?:ше|а)\.\s*(?:послання\s*апостола\s*Павла\s*до\s*коринф|(?:Послання\s*до\s*Коринт|(?:до\s*)?коринт|Коринф))ян|கொரிந்தியருக்கு\s*எழுதிய\s*முதல(?:(?:ாவது\s*திருமுக|ா(?:வது\s*நிருப)?)|்\s*திருமுக)ம்|1-?е\.?\s*послання\s*апостола\s*Павла\s*до\s*коринфян|1-?(?:ше|а)\s*(?:послання\s*апостола\s*Павла\s*до\s*коринф|(?:Послання\s*до\s*Коринт|(?:до\s*)?коринт|Коринф))ян|رسالة\s*بولس\s*الرسول\s*الأولى\s*إلى\s*أهل\s*كورنثوس|(?:1\.?\s*посланн|I\.?\s*посланн)я\s*апостола\s*Павла\s*до\s*коринфян|ک(?:رنتھ(?:ِیُوں\s*کے\s*نام\s*پولس\s*رسول|یوں\s*کے\s*نام)|ُرِنتھِیوں\s*کے\s*نام)\s*کا\s*پہلا\s*خط|Paulus(?:(?:'\s*Første|'\s*1\.?)\s*Brev\s*til\s*Korinth|’\s*(?:Første\s*Brev\s*til\s*Korinth|første\s*brev\s*til\s*korint|1\.\s*Brev\s*til\s*Korinth|1\s*Brev\s*til\s*Korinth))erne|(?:Ensimm[aä]inen\s*K(?:irje\s*korinttilaisill|orintt(?:olaiskirj|ilaisill))|(?:1\.?\s*Ki|I\.?\s*Ki)rje\s*korinttilaisill|(?:1\.?\s*Korintt|I\.?\s*Korintt)olaiskirj|(?:1\.?\s*Korintt|I\.?\s*Korintt)ilaisill|1(?:\s*(?:[ei](?:\.\s*Korin?t|\s*Korin?t)|Korit)asv|\.\s*Kori(?:nt(?:i?ern|asv)|tasv)|\s*Korinti?ern|\s*Korintasv))e|(?:P(?:avlova\s*prva\s*poslanica\s*Korin[cć]anim|rva\s*Korin[cć]anima\s*Poslanic|rva\s*poslanica\s*Korin[cæć]anim)|Fyrra\s*br[eé]f\s*P[aá]ls\s*til\s*Korintumann|(?:1(?:\.\s*Korin[cć]|\s*Korin[cć])|I(?:\.\s*Korin[cć]|\s*Korin[cć]))anima\s*Poslanic)a|कोरिन्थीहरूलाई\s*प(?:ावलको\s*प)?हिलो\s*पत्र|k(?:ur(?:intʰiyōṅ\s*ke\s*nām\s*kā\s*pahlā\s*ḫaṭ|ĩtʰīāṃ\s*nū̃\s*pahilī\s*pattrī)|orintʰ[iī]har[uū]l[aā][iī]\s*pahilo\s*patra|ari[mṃ]tʰkar[aā][mṃ]s\s*pahile\s*patra)|(?:Waraka\s*wa\s*Kwanza\s*kwa\s*Wakorinth|(?:I(?:ka-?\s*1\s*S|\.?\s*S)|1\.?\s*S)ulat\s*sa\s*mga\s*Corinti|Una(?:ng\s*(?:Sulat\s*sa\s*mga\s*Corinti|Mga\s*Taga-?\s*Corint|[CK]orinti)|\s*(?:Sulat\s*sa\s*mga\s*Corinti|Mga\s*Taga-?\s*Corint|[CK]orinti))|(?:1(?:\.\s*(?:Mga\s*Taga-?\s*|Taga-?)|\s*(?:Mga\s*Taga-?\s*|Taga-?))C|1\.?\s*Mga\s*Taga-?C)orint|I\.?\s*Mga\s*Taga-?\s*Corint|(?:Kwanza\s*W|1\.?\s*W|I\.?\s*W)akorinth)o|Waraka\s*wa\s*Kwanza\s*kwa\s*Wakorinto|Barua\s*ya\s*Kwanza\s*kwa\s*Wakorintho|אגרת\s*פולוס\s*הראשונה\s*אל-?הקור(?:נתים|י)|الرسالة\s*الأولى\s*إلى\s*أهل\s*كورنثوس|पौलाचे\s*करिंथकरांस\s*पहिले\s*पत्र|କରିନ୍ଥୀୟଙ୍କ\s*ପ୍ରତି\s*ପ୍ରଥମ\s*ପତ୍ର|(?:I(?:ka-?\s*1\s*S|\.?\s*S)|1\.?\s*S)ulat\s*sa\s*mga\s*Corinto|ה(?:איגרת\s*הראשונה\s*אל\s*הקורי|ראשונה\s*אל\s*הקורי?)נתים|Una(?:ng\s*(?:Sulat\s*sa\s*mga\s*C|[CK])orinto|\s*(?:Sulat\s*sa\s*mga\s*C|[CK])orinto)|ਕੁਰਿੰਥੀਆਂ\s*ਨੂੰ\s*ਪਹਿਲੀ\s*ਪੱਤ੍ਰੀ|F(?:yrra\s*br[eé]f\s*P[aá]ls\s*til\s*Korin|ørste\s*Kor(?:inter)?|irst\s*Co(?:r(?:in(?:th?)?)?)?)|(?:(?:1(?:-?е\.?\s*П|\.?\s*П)|I\.?\s*П)ослання\s*до\s*Коринт|(?:(?:1(?:-?е\.?\s*д|\.?\s*д)|I\.?\s*д)о\s*к|I\.?\s*к)оринт|1(?:-?е\.?\s*ко|\.?\s*ко)ринт|I\.?\s*Коринф)ян|(?:Prim(?:(?:a\s*lettera\s*ai|o)|a)\s*Corinz|1(?:\.\s*Corin(?:ti?en|z)|\s*Corin(?:(?:tien|z)|ten))|I(?:\.\s*Corin(?:ti?en|z)|\s*Corin(?:ti?en|z))|1°\.\s*Corinz|1°\s*Corinz)i|(?:Epistula\s*I\s*ad\s*Corinthio|(?:Prime(?:ir[ao]\s*Cor[ií]nt|ro?\s*Corint)|(?:1(?:\.[oº]|º)\.\s*Cori|1(?:\.[oº]|º)\s*Cori|1\.?\s*Corí|I\.?\s*Corí)nt|1[ao]\.\s*Cor[ií]nt|1[ao]\s*Cor[ií]nt)io|(?:First\s*Corinthia|1st\.\s*Corinthia|1st\s*Corinthia|1\.?\s*Corinthia|I\.?\s*Corinthia)n[ao]|(?:First\s*Corini|1st\.\s*Corini|1st\s*Corini|1\.\s*Corini|I\.?\s*Corini)thina|(?:First\s*Corinthin|1st\.\s*Corinthin|1st\s*Corinthin|1\.?\s*Corinthin|I\.?\s*Corinthin)a|(?:(?:First\s*Corini|1st\.\s*Corini|1st\s*Corini|1\.\s*Corini|I\.?\s*Corini)t|(?:(?:First\s*Corit|1st\.\s*Corit|1st\s*Corit|1\.?\s*Corit|I\.?\s*Corit)|1\s*Corinit))han|(?:First\s*Corn|1st\.\s*Corn|1st\s*Corn|1\.?\s*Corn|I\.?\s*Corn)(?:in?than|thin)|(?:(?:First\s*Corintha|1st\.\s*Corintha|1st\s*Corintha|1\.?\s*Corintha|I\.?\s*Corintha)|(?:First\s*Corn|1st\.\s*Corn|1st\s*Corn|1\.?\s*Corn|I\.?\s*Corn)itha)in|(?:First\s*Ch|1st\.\s*Ch|1st\s*Ch|1\.?\s*Ch|I\.?\s*Ch)orinthin|(?:First\s*Corintha|1st\.\s*Corintha|1st\s*Corintha|1\.?\s*Corintha|I\.?\s*Corintha)n|1(?:\s*(?:(?:kari[mṃ]tʰkar[aā][mṃ]|Corinthi[eo]n)|Corintion)|\.\s*Corint(?:hi[eo]n|ion))|(?:First\s*Corit|1st\.\s*Corit|1st\s*Corit|1\.?\s*Corit|I\.?\s*Corit)hin|I(?:\.\s*Corint(?:hi[eo]n|ion)|\s*Corint(?:hi[eo]n|ion))|1\s*Corinithina|C(?:or(?:i(?:(?:n(?:thi(?:an[ao]|na|on)|ithina)|thin)|nthan)|i(?:ni)?than|n(?:in?than|thin))|or(?:in|ni)thain|horinthin))s|(?:Epistula\s*)?ad\s*Corinthios\s*I|(?:1\.?\s*послани|I\.?\s*послани)ца\s*Коринћанима|F(?:[oö]rsta\s*Korint(?:h?i|h?)erbrevet|ørste\s*(?:Korint(?:herbrev|(?:erbrev|i?erne))|korinterbrev)|yrra\s*Korintubr[eé]f)|(?:Prv(?:n[ií]\s*(?:list\s*Korint?s|Korints)k[yý]|[aá]\s*kniha\s*Korin(?:t(?:sk[yý]|ano)|ťano)|[yý]\s*(?:list\s*Korin(?:t(?:sk[yý]|ano)|ťano)|Korin(?:t(?:sk[yý]|ano)|ťano))|a\s*Korintsk[yý]|a\s*Korintano|a\s*Korinťano|á\s*Korin(?:t(?:sk[yý]|ano)|ťano))|(?:(?:1\.?\s*list\s*K|I\.?\s*list\s*K)orint?s|1\.?\s*Korints|I\.?\s*Korints)k[yý]|1\s*k\.\s*Korin(?:t(?:sk[yý]|ano)|ťano)|1\s*k\s*Korin(?:t(?:sk[yý]|ano)|ťano)|(?:1\.?\s*Korintan|I\.?\s*Korintan)o|(?:1\.?\s*Korinť|I\.?\s*Korinť)ano)m|(?:Premi(?:eres?\s*Corinthie|ères?\s*Corinthie|ers?\s*Corinthie)|(?:First\s*Corinthia|1st\.\s*Corinthia|1st\s*Corinthia|1\.?\s*Corinthia|I\.?\s*Corinthia)[ai]|(?:First\s*Corini|1st\.\s*Corini|1st\s*Corini|1\.\s*Corini|I\.?\s*Corini)thia|(?:First\s*Corii|1st\.\s*Corii|1st\s*Corii|1\.?\s*Corii|I\.?\s*Corii)nthia|(?:(?:First\s*Corini|1st\.\s*Corini|1st\s*Corini|1\.\s*Corini|I\.?\s*Corini)t|(?:(?:First\s*Corit|1st\.\s*Corit|1st\s*Corit|1\.?\s*Corit|I\.?\s*Corit)|1\s*Corinit))hai|(?:First\s*Corn|1st\.\s*Corn|1st\s*Corn|1\.?\s*Corn|I\.?\s*Corn)(?:inthai|thia)|(?:(?:First\s*Corintha|1st\.\s*Corintha|1st\s*Corintha|1\.?\s*Corintha|I\.?\s*Corintha)|(?:First\s*Corn|1st\.\s*Corn|1st\s*Corn|1\.?\s*Corn|I\.?\s*Corn)itha)ia|(?:(?:First\s*Corr|1st\.\s*Corr|1st\s*Corr|1\.?\s*Corr|I\.?\s*Corr)in?tha|(?:First\s*Corn|1st\.\s*Corn|1st\s*Corn|1\.?\s*Corn|I\.?\s*Corn)tha)i|(?:First\s*Ch|1st\.\s*Ch|1st\s*Ch|1\.?\s*Ch|I\.?\s*Ch)orinth(?:ia|ai)|1(?:(?:ere?|re)|ère)\.\s*Corinthie|First\s*Corinthio|(?:First\s*Corintho|1st\.\s*Corintho|1st\s*Corintho|1\.?\s*Corintho|I\.?\s*Corintho)a|1(?:(?:ere?|re)|ère)\s*Corinthie|1st\.\s*Corinthio|(?:First|1st\.?)\s*Corinti[ao]|(?:First\s*Corit|1st\.\s*Corit|1st\s*Corit|1\.?\s*Corit|I\.?\s*Corit)hia|1st\s*Corinthio|1\s*Corinithia|1\.?\s*Corintia|I\.?\s*Corintia|C(?:or(?:i(?:(?:n(?:(?:t(?:hia[ai]|i[ao])|ithia)|thoa)|inthia)|thia)|i(?:ni)?thai|n(?:inthai|thia))|or(?:in|ni)thaia|or(?:rin?tha|ntha)i|horinth(?:ia|ai)))ns|करिंथकरांस\s*पहिले\s*पत्र|E(?:ls[oő]\s*Korint(?:husiakhoz|usi)|erste\s*[CK]orinthe)|1(?:\.\s*Korinth?ierb|\s*Korinth?ierb)revet|(?:(?:First\s*Corii|1st\.\s*Corii|1st\s*Corii|1\.?\s*Corii|I\.?\s*Corii)nthii|First\s*Corinthii|(?:First\s*Corintho|1st\.\s*Corintho|1st\s*Corintho|1\.?\s*Corintho|I\.?\s*Corintho)i|(?:First\s*Corn|1st\.\s*Corn|1st\s*Corn|1\.?\s*Corn|I\.?\s*Corn)(?:in?thi|thii)|(?:First\s*Corr|1st\.\s*Corr|1st\s*Corr|1\.?\s*Corr|I\.?\s*Corr)in?thi|(?:First\s*Corin[an]|1st\.\s*Corin[an]|1st\s*Corin[an]|1(?:\.\s*Corin[an]|\s*Corin[an])|I(?:\.\s*Corin[an]|\s*Corin[an]))thi|(?:First\s*Ch|1st\.\s*Ch|1st\s*Ch|1\.?\s*Ch|I\.?\s*Ch)or(?:an|[in])thi|1st\.\s*Corinthii|(?:First\s*Corit|1st\.\s*Corit|1st\s*Corit|1\.?\s*Corit|I\.?\s*Corit)hii|(?:First\s*Cora|1st\.\s*Cora|1st\s*Cora|1\.?\s*Cora|I\.?\s*Cora)nthi|1st\s*Corinthii|(?:First\s*Corit|1st\.\s*Corit|1st\s*Corit|1\.?\s*Corit|I\.?\s*Corit)ho|1\.?\s*Corinthii|I\.?\s*Corinthii|C(?:or(?:i(?:(?:inthii|nthii|nthoi|tho)|thii)|n(?:in?thi|thii)|rin?thi)|orin[an]thi|hor(?:an|[in])thi))ans|1(?:(?:(?:(?:(?:\.\s*(?:korintʰ[iī]har[uū]l[aā][iī]|क(?:ोरिन्(?:थीहरूलाई|‍थी)|ुर(?:िन्(?:यि़|थि)|न्थि)यों)|Korint(?:hiers|i(?:ers|o))|โครินธ์)|\s*(?:(?:(?:(?:korintʰ[iī]har[uū]l[aā][iī]|(?:(?:(?:Korinti(?:yarukku|o)|ਕੁਰਿੰਥੀਆਂ\s*ਨੂੰ|करिंथकरांस|kurĩtʰīāṃ|Corinto|قور|ค[ธร])|Korinthiers)|Korintiers))|कुर(?:िन्(?:यि़|थि)|न्थि)यों)|कोरिन्(?:थीहरूलाई|‍थी))|โครินธ์)|(?:-?е\.?\s*к\s*|\.?\s*к\s*)Коринфянам|(?:-?я|[ея])(?:\.\s*(?:к\s*)?Коринфянам|\s*(?:к\s*)?Коринфянам)|(?:-?е\.?\s*Коринфяна|\.?\s*Коринфяна)м|كو|코린)|\s*Corinth(?:ios|e))|\s*Corintios)|\s*Cô(?:-?rinh-?|rin)tô)|\.\s*C(?:orint(?:h(?:ios|e)|ios|o)|ô(?:-?rinh-?|rin)tô))|(?:1\.?\s*Korinthu|I\.?\s*Korinthu)siakhoz|(?:1(?:\.\s*Korinth?erbreve|\s*Korinth?erbreve)|Premye\s*Korin)t|(?:Eerste\s*(?:Korinth?i[eë]r|Corinth?i[eë]r)|1e\.\s*(?:Korinth?i[eë]r|Corinth?i[eë]r)|1(?:\.\s*Corinth?ier|(?:(?:\s*Corinthier|\.?\s*Korinto)|\s*Corintier))|I(?:\.\s*(?:Corinth?ier|Korinto)|\s*(?:Corinth?ier|Korinto))|(?:1(?:(?:(?:\.\s*Korinth?ië|\s*(?:Korinth?ië|Corintië))|\s*Corinthië)|\.\s*Corinth?ië)|I(?:\.\s*(?:Corinth?ië|Korinti[eë])|\s*(?:Corinth?ië|Korinti[eë])))r|I\.?\s*Korinthi[eë]r|1e\s*(?:Korinth?i[eë]r|Corinth?i[eë]r))s|코린토(?:\s*신자들에게\s*보낸\s*첫째\s*서간|1서)|Προς\s*Κορινθ[ίι]ους\s*Α['ʹʹ΄’]|Eerste\s*(?:Korinth?i[eë]r|Corinth?i[eë]r)|P(?:ierwsz[aey]\s*Korynt[oó]w|rvn[ií]K)|(?:First\s*Corinthia|1st\.\s*Corinthia|1st\s*Corinthia|1\.?\s*Corinthia|I\.?\s*Corinthia)ns|Avval\s*Corinth?ians|(?:Avval\s*Q|AvvalQ|1\s*?Q)orint(?:h(?:iy?a|yu)n|(?:iy?a|yu)n)|ପ୍ରଥମ\s*କରିନ୍ଥୀୟଙ୍କ|1(?:(?:(?:(?:(?:\.\s*(?:Kor(?:int(?:h(?:e(?:r(?:brev)?)?|ier)|erbrev|ier|er|a)?)?|क(?:ुरिन्थ(?:ियो)?|ोरिन्थी)|Кор)|\s*Korinthe(?:r(?:brev)?)?|\s*Korinterbrev|-?е\.?\s*Коринфян|\s*Korinthier|\s*कुरिन्थ(?:ियो)?|\s*(?:ਕੁਰਿੰਥੀਆਂ|Co(?:r(?:in(?:ti?|i)?)?)?|Ko(?:r(?:int)?)?|கொ(?:ரி)?)|\s*Korintier|\.?\s*Коринфян|\s*Korinter|\s*कोरिन्थी|\s*Korinta|\s*Кор|Kor)|\s*Corinth)|\s*Corintio)|\s*Cô(?:-?rinh)?)|\.\s*C(?:o(?:r(?:in(?:t(?:io|h)?)?)?)?|ô(?:-?rinh)?))|Prv(?:a\s*Korin[cć]anima|n[ií]\s*K(?:or)?)|(?:First\s*Corinthia|1st\.\s*Corinthia|1st\s*Corinthia|1\.?\s*Corinthia|I\.?\s*Corinthia)n|Avval\s*Corinth(?:ian)?|اوّل(?:-?کُرِنتھِی|(?:(?:\s*کرنتھِیُ|۔کرنتھی)|\s*کُرنتھِی))وں|(?:First\s*Corinthin|1st\.\s*Corinthin|1st\s*Corinthin|1\.?\s*Corinthin|I\.?\s*Corinthin)s|(?:Avval|1)Corinth?ians|(?:Kwanza\s*W|1\.?\s*W|I\.?\s*W)akorinto|(?:Avval|1)Corinth(?:ian)?|Първ(?:а\s*Кор(?:интяни)?|о\s*Кор(?:интяни)?)|1\.?\s*korinterbrev|Erste\s*Korinther|(?:First\s*Cort|(?:1st\.\s*Cort|(?:1st\s*Cort|(?:1\.?\s*Cort|I\.?\s*Cort))))hians|Yek(?:\s*Corinth?ians|\s*?Qorint(?:h(?:iy?a|yu)n|(?:iy?a|yu)n)|Corinth?ians|\s*?Korinth?ian)|(?:1-?(?:ше|а)\.\s*Коринт|(?:1-?е\.?\s*Коринт|1-?(?:ше|а)\s*Коринт))яни|(?:1(?:\.\s*Korin[cć]|\s*Korin[cć])|I(?:\.\s*Korin[cć]|\s*Korin[cć]))anima|E(?:ls[oő]\s*Kor(?:inthus)?|erste\s*Kor)|1e\.\s*(?:Korinth?i[eë]r|Corinth?i[eë]r)|(?:First\s*Cort|(?:1st\.\s*Cort|(?:1st\s*Cort|(?:1\.?\s*Cort|I\.?\s*Cort))))h(?:ian)?|Yek(?:\s*Corinth(?:ian)?|Corinth(?:ian)?)|ପ୍ରଥମ\s*କରିନ୍ଥୀୟ|(?:1\.|۱)-?کُرِنتھِیوں|(?:1\.?\s*Коринћ|I\.?\s*Коринћ)анима|(?:1\.?\s*Коринтя|I\.?\s*Коринтя)ните|(?:1(?:\.\s*Корин[кќ]|\s*Корин[кќ])|I(?:\.\s*Корин[кќ]|\s*Корин[кќ]))аните|اول\s*قرنت(?:ی[او]ن(?:ی?ان|ها|ن)|يان)|كورنثوس\s*الأولى|1\.?\s*କରିନ୍ଥୀୟଙ୍କ|1(?:\.\s*Corinth?ier|(?:(?:\s*Corinthier|\.?\s*Korinto)|\s*Corintier))|I(?:\.\s*(?:Corinth?ier|Korinto)|\s*(?:Corinth?ier|Korinto))|(?:1(?:(?:(?:\.\s*Korinth?ië|\s*(?:Korinth?ië|Corintië))|\s*Corinthië)|\.\s*Corinth?ië)|I(?:\.\s*(?:Corinth?ië|Korinti[eë])|\s*(?:Corinth?ië|Korinti[eë])))r|I\.?\s*Korinthi[eë]r|1e\s*(?:Korinth?i[eë]r|Corinth?i[eë]r)|ਕੁਰਿੰਥੀਆਂ\s*ਨੂੰ|I(?:\.\s*(?:C(?:orint(?:h(?:ios|e)|ios|o)|ô(?:-?rinh-?|rin)tô)|Korint(?:usi|he|io))|\s*(?:C(?:orint(?:h(?:ios|e)|ios|o)|ô(?:-?rinh-?|rin)tô)|Korint(?:usi|he|io)))|Α['ʹʹ΄’]\s*Κορινθ[ίι]ους|(?:1\.?\s*ک|۱\s*ک)رنتھِیُوں|(?:1\.?\s*ک|۱\s*ک)ُرنتھِیوں|1-?کُرِنتھِیوں|(?:1\.?\s*Коринтј|I\.?\s*Коринтј)ани|(?:اول|1\s*)قرنت(?:ی[او]ن(?:ی?ان|ها|ن)|يان)|یک(?:\s*قرنت(?:ی[او]ن(?:ی?ان|ها|ن)|يان)|قرنت(?:ی[او]ن(?:ی?ان|ها|ن)|يان))|1\s*கொரிந்தியர்|(?:1\.?\s*Korinthu|I\.?\s*Korinthu)s|1st\.\s*Co(?:r(?:in(?:th?)?)?)?|(?:1\.?\s*Коринтя|I\.?\s*Коринтя)ни|اول\s*قرنتی[او]ن(?:ه|ی)?|1\.?\s*Korintusi|1e\.\s*[CK]orinthe|コリント(?:人への(?:第一の手紙|前の書|手紙[Ⅰ一])|の信徒への手紙一|\s*1|前書)|(?:Corinthios|Wakorintho)\s*I|۱\s*قرنت(?:ی[او]ن(?:ی?ان|ها|ن)|يان)|ﻛﻮﺭﻧﺜﻮﺱ\s*ﺍﻻﻭﻝ|1\.?\s*Korintus|I(?:\.\s*(?:C(?:o(?:r(?:in(?:t(?:io|h)?)?)?)?|ô(?:-?rinh)?)|Kor(?:int(?:us|a)?)?|Кор)|\s*(?:C(?:o(?:r(?:in(?:t(?:io|h)?)?)?)?|ô(?:-?rinh)?)|Kor(?:int(?:us|a)?)?|Кор))|1st\s*Co(?:r(?:in(?:th?)?)?)?|(?:اول|1\s*)قرنتی[او]ن(?:ه|ی)?|یک(?:\s*قرنتی[او]ن(?:ه|ی)?|قرنتی[او]ن(?:ه|ی)?)|1\.?\s*କରିନ୍ଥୀୟ|(?:1\.?\s*Kory|I\.?\s*Kory)nt[oó]w|1e\s*[CK]orinthe|(?:1\.?۔|۱۔)کرنتھیوں|Corinthia?ns|[1۱]قرنتی[او]ن(?:ی?ان|ها|ن)|Corinthian|۱\s*قرنتی[او]ن(?:ه|ی)?|[1۱]قرنتی[او]ن(?:ه|ی)?|AvvalCor|[1۱]قرنتيان|Ⅰ\s*コリント人へ|1e\.\s*Kor|(?:《?哥林多前[书書]|(?:《[格歌]|[格歌])林多前書)》|《?适凌爾福前》|1e\s*Kor|Α['ʹʹ΄’]\s*Κορ?|《?哥林多前[书書]|(?:《[格歌]|[格歌])林多前書|《?适凌爾福前|1قر(?:نت?)?|۱(?:قر(?:نت?)?|qrn?)|1qrnt|۱qrnt|고린도[1전]서|1qrn?|1Cor|اولق|《?林前》|《?林前|고전))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Gal"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))(Ga-?la-?ti|(?:П(?:исмо\s*од\s*апостол\s*Павле\s*до\s*христијаните\s*во\s*Галатија|о(?:слання\s*(?:св\.?\s*апостола\s*Павла\s*до\s*г|(?:апостола\s*Павла\s*)?до\s*г)алатів|слание\s*(?:на\s*св(?:\.\s*ап\.?\s*Павла\s*до\s*Галатяни|\s*ап\.?\s*Павла\s*до\s*Галатяни)|к(?:ъм\s*галатяните|\s*Галатам))|\s*слання\s*до\s*Галатів)|осланица\s*Гала(?:ћан|т)има)|P(?:oslannja\s*apostola\s*Pavla\s*do\s*halativ|aulus(?:'\s*Brev\s*til\s*Galaterne|’\s*(?:Brev\s*til\s*G|brev\s*til\s*g)alaterne))|رسالة\s*بولس\s*الرسول\s*إلى\s*أهل\s*غلاطية|கலாத்தியர(?:ுக்கு\s*எழுதிய\s*(?:திருமுக|(?:நிருப|கடித))ம்|்)|گلت(?:یوں\s*کے\s*نام\s*(?:پولُس\s*رسول\s*)?|ِیوں\s*کے\s*نام\s*)کا\s*خط|(?:Kal[aā]ttiyarukku\s*E[lḻ]utiya\s*Nirupa|Galatano|Galatsk[yý])m|(?:P(?:avlova\s*poslanica\s*Gala[cć]anim|oslanica\s*Gala[cæć]anim)|Br(?:ef\s*P[aá]ls\s*til\s*Galatamann|éf\s*P[aá]ls\s*til\s*Galatamann)|gal(?:at[iī]har[uū]l[aā][iī]\s*patr|āt(?:īhar[uū]l[aā][iī]\s*patr|ihar[uū]l[aā][iī]\s*patr)|at(?:ikar[aā][mṃ]s|īkar[aā][mṃ]s)\s*patr)|Mga\s*Taga-?\s*Galasy|Galacanim|Galaćanim|Galaci)a|L(?:ist\s*(?:[sś]w\.?\s*Pawła\s*do\s*Galacjan|do\s*Galacjan|do\s*Galat[oó]w|Gala(?:(?:tsk[yý]|tano)|ťano)m)|ettera\s*ai\s*Galati)|אגרת\s*פולוס\s*השליח\s*אל-?הגלטים|Sulat\s*sa\s*mga\s*(?:taga\s*)?Galacia|g(?:al(?:atiyōṅ\s*ke\s*nām\s*kā\s*ḫaṭ|ātīāṃ\s*nū̃\s*pattrī)|halātī)|गलातीहरूलाई\s*पावलको\s*पत्र|الرسالة\s*إلى\s*أهل\s*غلاطية|(?:Layang\s*Paulus\s*Galat|Barua\s*kwa\s*Wagalat|Mga\s*Taga-?\s*Galac|Wagalat)ia|(?:کتاب\s*پیام‌های|رساله|نامه|پیام)\s*غلا?طيان|ଗାଲାତୀୟଙ୍କ\s*ପ୍ରତି\s*ପତ୍ର|पौलाचे\s*गलतीकरांस\s*पत्र|(?:Kirje\s*galatalaisill|Galat(?:alaisill|(?:asv|ern)))e|Brevet\s*til\s*Galaterne|Epistula\s*ad\s*Galatas|ਗਲਾਤੀਆਂ\s*ਨੂੰ\s*ਪੱਤ੍ਰੀ|غ(?:ل(?:ط(?:ي(?:ان(?:‌نامه‌گی‌|ی?-?)|ون[-‌]|ه[-‌])|یان[-‌])|اطي(?:انی|ه)[-‌]|اطيان[-‌])ها|لطيان‌نامه‌ی‌ها|لطيان(?:ی‌(?:نامه‌)?ه|‌ه)ا|َلطي(?:ون(?:‌(?:نامه‌)?ها|-?ها)|ه(?:‌نامه‌ها|(?:‌(?:ها|ی)|-?ها)))|ل(?:ط(?:يان(?:ی‌نامه‌|‌نامه‌ا)ی|ی(?:ان[نه]|ون[نه]|ها))|(?:(?:اط)?|ط)‌نامه|اطی[او]ن[نه]|اطیها|ظ))|غ(?:ل(?:ط(?:يان‌نامه‌(?:هات|گ)ا|ی[او]نا)|اطی[او]نا)|َلطيا)ن|갈라(?:티아\s*신자들에게\s*보낸\s*서간|디아서)|(?:Mga\s*)?Taga-?Galacia|האיגרת\s*אל\s*הגלטים|गलातीहरूलाई\s*पत्र|غ(?:ل(?:(?:ط(?:ي(?:ان(?:‌نامه(?:‌هات?)?|ی(?:‌نامه)?)?|ون|ه)|ی(?:ان|ون|ه))?|اطي(?:انی|ه)|ا(?:ط(?:يان|ی)?)?|اطی[او]ن|اطیه)?|طيان‌نامه‌ی)|َلطي(?:ون(?:‌نامه)?|ه(?:‌نامه)?))|غل(?:ط(?:يان‌نامه‌ش|ی[او]نی)|اطی[او]نی)ان|Kal[aā]ttiyarukku|G(?:al(?:a(?:t(?:a(?:laiskirj|br[eé]fið|ns)|e(?:n(?:brief|i)|s)|i(?:a(?:ni?s|s)|yans|na?s|on?s)|akhoz|ákhoz|ow)|s(?:yano|ia))|(?:aterbref?ve|á)t)|alatianians|halatians|l)|गलतीकरांस\s*पत्र|g(?:al(?:at[iī]har[uū]l[aā][iī]|āt(?:ī(?:har[uū]l[aā][iī]|āṃ)|ihar[uū]l[aā][iī])|at(?:ikar[aā][mṃ]s|īkar[aā][mṃ]s))|halā(?:ti?)?)|G(?:al(?:at(?:i(?:y[au]nia|a[ai]|oa)|a[ao]|oa)n|at(?:i(?:ana|nan|on[an])|on|n)|at[ai]i(?:[ao])?n|lati(?:[ao])?n)|álata)s|Taga-?\s*Galacia|سخنان\s*غلا?طيان|Προς\s*Γαλ[άα]τας|حکایت\s*غلطيان|کتاب\s*غلا?طيان|رسالة\s*غلاطية|G(?:alatianian|a(?:l(?:a(?:t(?:i(?:y(?:an?|un)|an?)?|as?|e[nr])?|si)?)?)?|halatian|á(?:l(?:at)?)?)|गल(?:ात(?:ी(?:हरूलाई)?|ि)|तीकरांस)|ਗਲਾਤੀਆਂ\s*ਨੂੰ|[カガ]ラテヤ(?:の信徒への手紙|人への手紙|(?:人への)?書)|ଗାଲାତୀୟଙ୍କ|(?:G(?:ala(?:(?:ti(?:(?:an)?u|yo)|sye)|ty[ao])|hal(?:at(?:i(?:y[au]|u)|y[ao])|ātīā))|ghalātiā)n|ad\s*Galatas|Галат(?:ян)?ите|До\s*галатів|Гала(?:ћан|т)има|Galaťanom|אל\s*הגלטים|К\s*Галатам|Галатјани|Гал(?:атяни)?|ก(?:าลาเทีย|ท)|Galacjan|गला?तियों|گلتِ?یوں|Galatów|Γαλ[άα]τες|Галатам|Галатів|[カガ]ラテヤ(?:人へ)?|(?:《加拉太[书書]|《?戛拉提亞|加拉太[书書])》|《?迦拉達書》|Gàlati|கலா(?:த்)?|《加拉太[书書]|《?戛拉提亞|《?迦拉達書|加拉太[书書]|ﻏﻼﻃﻲ|Γαλ?|《加》|갈라?|《加|加》|加))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Eph"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:П(?:исмо\s*од\s*апостол\s*Павле\s*до\s*христијаните\s*во\s*Ефес|о(?:слання\s*(?:св\.?\s*апостола\s*Павла\s*до\s*е|(?:апостола\s*Павла\s*)?до\s*е)фесян|слани(?:е\s*(?:на\s*св(?:\.\s*ап\.?\s*Павла\s*до\s*Ефесяни|\s*ап\.?\s*Павла\s*до\s*Ефесяни)|к(?:ъм\s*ефесяните|\s*Ефесянам))|ца\s*Ефесцима)|\s*слан\s*ня\s*до\s*Єфесян))|L(?:ist\s*(?:[SŚ]wi[eę]tego\s*Pawła\s*Apostoła\s*do\s*Efez[oó]w|Ef(?:ezan[ouů]m|ezsk[yý]m|ézsk[yý]m))|ayang\s*Paulus\s*Efesus|ettera\s*agli\s*Efesini)|P(?:oslan(?:nja\s*apostola\s*Pavla\s*do\s*efesjan|ica\s*Efe[zž]anima)|a(?:vlova\s*poslanica\s*Efe[zž]anima|ulus(?:'\s*Brev\s*til\s*Efeserne|’\s*(?:Brev\s*til\s*E|brev\s*til\s*e)feserne)))|ا(?:فسیوں\s*کے\s*نام\s*پو\s*لس\s*رسول\s*کا\s*خط|ِف(?:ِسِیوں\s*کے\s*نام\s*کا\s*خط|سِ?یوں)|فسیوں\s*کے\s*نام\s*کا\s*خط|(?:ف(?:سسي(?:ان‌نامه‌گی‌|(?:(?:ان(?:‌نامه‌ی‌|-?)|ون(?:‌نامه‌|-?))|اني[-‌]))|ِس(?:سيان(?:‌نامه‌ی‌|ي[-‌]|-?)|يان-?))ه|ف(?:ِس(?:يان‌(?:نامه‌)?ه|سيان‌ه)|سسي(?:‌(?:نامه‌)?ه|[او]ن‌ه)))ا|ف(?:ِس(?:س(?:يان‌نامه‌هات|ی[او]ن[نه])|ي(?:ان(?:‌نامه‌ا?ی|ي)|وني)|ی[او]ن[نه])|س(?:(?:سيان‌نامه‌ای|(?:سيوني|یون|و))|سي‌نامه‌ا?ی))|َفِسس(?:ي(?:ان‌نامه|(?:ان(?:-?ها|‌ها|ي)|وني))|ی[او]نه)|فس‌نامه)|رسالة\s*(?:بولس\s*الرسول\s*إلى\s*أهل\s*)?أفسس|எபேசியர(?:ுக்கு\s*எழுதிய\s*(?:திருமுக|(?:நிருப|கடித))ம்|்)|E(?:p(?:eciyarukku\s*E[lḻ]utiya\s*Nirupa|ēciyarukku\s*E[lḻ]utiya\s*Nirupa)|fezano)m|אגרת\s*פולוס\s*השליח\s*אל\s*האפסיים|א(?:גרת\s*פולוס\s*השליח\s*אל-?|ל\s*)האפסים|List\s*(?:[sś]w\.?\s*Pawła\s*do\s*Efez|do\s*Efez)jan|(?:Br[eé]f\s*P[aá]ls\s*til\s*Efesusmann|epʰis[iī]har[uū]l[aā][iī]\s*patr|ipʰiskar[aā][mṃ]s\s*patr)a|एफिसीहरूलाई\s*पावलको\s*पत्र|ifisiyōṅ\s*ke\s*nām\s*kā\s*ḫaṭ|(?:کتاب\s*پیام‌های|(?:رسال|نام)ه|پیام)\s*افِ?سسيان|पौलाचे\s*इफिसकरांस\s*पत्र|(?:E(?:pistula\s*ad\s*Ephesio|(?:(?:p(?:hesion|esu)|fezi[eë]r)|fésio))|Afis(?:i(?:siya|yu)|siyu)nian|ad\s*Ephesio|E(?:(?:pehe|hp[ei])|sphe)sian|(?:Ep(?:(?:hesie|esia)|hésie)|Éph[eé]sie)n)s|الرسالة\s*إلى\s*أهل\s*أفسس|ଏଫିସୀୟଙ୍କ\s*ପ୍ରତି\s*ପତ୍ର|Sulat\s*sa\s*mga\s*E[fp]esi?o|(?:Kirje\s*efesolaisill|Efes(?:(?:olaiskirj|ian[eë]v|ern)|olaisill))e|af(?:asīāṃ\s*nū̃\s*pattrī|so)|(?:(?:Waraka\s*kwa\s*Wae|(?:(?:(?:Mga\s*)?Taga-?[EÉ]|Wae)|É))|Barua\s*kwa\s*Wae)feso|افس(?:س(?:يان‌نامه‌(?:هات|گ)ا|ی[او])|یا)ن|ਅਫ਼ਸੀਆਂ\s*ਨੂੰ\s*ਪੱਤ੍ਰੀ|ا(?:ف(?:ِسسيان‌نامه‌[شگ]|سسيان‌نامه‌ش)|َفِسُسی)ان|ا(?:ف(?:س(?:(?:(?:سي(?:ان(?:‌نامه(?:‌هات?)?)?|ان‌نامه‌ی|ون(?:‌نامه)?)?|ی(?:وں)?|‌ن)?|سي‌نامه)|سياني)|ِس(?:س(?:يان(?:‌نامه‌ها|ي)?|ی[او]ن)|يان(?:‌نامه)?|ی[او]ن))|َفِسس(?:ي(?:ان|ون)?|یان))|(?:Mga\s*)?Taga-?\s*E[fp]esi?o|ה(?:איגרת\s*אל\s*האפס|שליח\s*אל\s*האפסי)ים|एफिसीहरूलाई\s*पत्र|E(?:p(?:h(?:es(?:(?:zosziakhoz|i(?:an[ds]|os)|er)|ains)|isians|sians)|esi?o)|f(?:(?:(?:(?:(?:es(?:ierbrevet|erbrevet|usbr[eé]fið|os)|ése|s)|èz)|ezusiakhoz)|ézusiakhoz)|esios))|에(?:페소(?:\s*신자들에게\s*보낸\s*서간|서)|베소서)|سخنان\s*افِ?سسيان|इफिसकरांस\s*पत्र|epʰis[iī]har[uū]l[aā][iī]|Προς\s*Εφεσ[ίι]ους|حکایت\s*افسسيان|کتاب\s*افِ?سسيان|E(?:p(?:eciyarukku|ēciyarukku|h(?:e(?:s(?:ian)?)?|esain|isian|sian|s)?)?|f(?:(?:e(?:s(?:us|e|o)?|z(?:us)?)?)?|esio)|hp)|ipʰiskar[aā][mṃ]s|एफिसी(?:हरूलाई)?|ਅਫ਼ਸੀਆਂ\s*ਨੂੰ|エ(?:フェソ(?:の信徒|人)への手紙|[ヘペ]ソ(?:人への(?:手紙|書)|書)|フェソ書)|(?:Af(?:es(?:i(?:y(?:ani|y)|siy)|sisi|y)|ssiy)|Efezj)an|Af(?:esisyani|isiyani|so)|Afis(?:is)?yani|Mga\s*E[fp]esi?o|(?:Af(?:is(?:i(?:s(?:i(?:yu|a)|yu)|yyu|a)|siy?a)|es(?:i(?:syu|yu|[aā])|siy[aou])|siya)|Af(?:e?si|is)yoo|Iafisiyo|afss?iyā|Efezye)n|К\s*Ефесянам|Af(?:esis?yan|is(?:siyu|iy[au])n)|इफिस(?:करांस|ि)|ଏଫିସୀୟଙ୍କ|Efezanima|Efežanima|Ефесяните|Ефешаните|До\s*ефесян|Ê(?:-?phê-?|phê)sô|Efezsk[yý]m|इफिस(?:ियों|ी)|Εφεσ[ίι]ους|Ефесцима|Ефесянам|Эфесянам|Ефесјани|af(?:asīāṃ|s)|Еф(?:есяни?)?|Efesk[yý]m|Efes[ei]ni|เอเฟซัส|(?:《?以弗所[书書]|《?耶斐斯|《?弗)》|《?厄弗所書》|Efez[oó]w|Ephés?|Ép(?:h(?:[eé]s?)?)?|எபே(?:சி)?|エ(?:[ヘペ]ソ人へ|フェソ)|《?以弗所[书書]|《?厄弗所書|《?耶斐斯|ﺃﻓﺴﺲ|Êph|᾿Εφ|Εφ|Эф|에페|《?弗|Єф|أف|อฟ|엡))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Col"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:П(?:исмо\s*од\s*апостол\s*Павле\s*до\s*христијаните\s*во\s*Колос|ослан(?:ня\s*(?:св\.?\s*апостола\s*Павла\s*до\s*колосян|(?:апостола\s*Павла\s*до\s*к|до\s*К)олосян)|и(?:е\s*(?:на\s*св(?:\.\s*ап\.?\s*Павла\s*до\s*Колосяни|\s*ап\.?\s*Павла\s*до\s*Колосяни)|к(?:ъм\s*колосяните|\s*Колоссянам))|ца\s*Колошанима)))|P(?:oslan(?:nja\s*apostola\s*Pavla\s*do\s*kolosjan|ica\s*Kolo[sš]anima)|avlova\s*poslanica\s*Kolo[sš]anima)|ک(?:ُل(?:ِسّیوں\s*کے\s*نام\s*پولُس\s*رسُول\s*کا\s*خط|ُسِّیوں\s*کے\s*نام\s*کا\s*خط|وسي(?:ان‌نامه‌ها|ون(?:‌(?:نامه‌)?ها|-?ها))|س[ِّ]یوں|‌نامه)|(?:ول(?:وسيان‌نامه‌گی‌|ُسیان(?:‌نامه‌گی‌|ی[-‌]|-?)|وسيان(?:ی[-‌]|-?)|سيون-?)|لوسيان(?:ی[-‌]|-?))ها|لسیوں\s*کے\s*نام\s*کا\s*خط|ول(?:وسي|ُسی)ان‌نامه‌ی‌ها|ول(?:ُسی(?:ان(?:‌نامه‌(?:هات|ای)|[نه])|ون[نه]|ها)|(?:وسيان‌نامه‌ا|سي(?:ون‌نامه‌ا|ان))ی|سيون(?:‌نامه‌)?ی)|ولوسيون(?:‌(?:نامه‌)?ها|-?ها)|لوسيان‌نامه‌ا?ی|(?:لوسيان‌(?:نامه‌)?ه|ول(?:سيون‌(?:نامه‌)?ه|وسيان‌ه|ُسیان‌ه))ا|ل‌نامه)|رسالة\s*بولس\s*الرسول\s*إلى\s*أهل\s*كولوسي|கொலோச(?:ையர(?:ுக்கு\s*எழுதிய\s*திருமுகம)?்|(?:ெயருக்கு\s*எழுதிய\s*(?:நிருப|கடித)ம|ெயர)்)|(?:Paulus(?:’\s*(?:Brev\s*til\s*Kolossen|brev\s*til\s*kolos)|'\s*Brev\s*til\s*Kolossen)sern|K(?:irje\s*kolossalaisill|olos(?:(?:s(?:alaiskirj|ern)|ian[eë]v)|salaisill)))e|(?:Kol(?:o(?:ceyarukku\s*E[lḻ]utiya\s*Nirupa|san[ouů])|ōceyarukku\s*E[lḻ]utiya\s*Nirupa)|Kolos(?:sens|(?:ens)?)k[yý])m|אגרת\s*פולוס\s*השליח\s*אל-?הקולוסים|אגרת\s*פולוס\s*השליח\s*אל-?הקולוסי|B(?:r[eé]f\s*P[aá]ls\s*til\s*K[oó]lossumanna|arua\s*kwa\s*Wakolosai)|Br[eé]f\s*P[aá]ls\s*til\s*K[oó]lossumann|(?:List\s*(?:[sś]w\.?\s*Pawła\s*do\s*Kolos|do\s*Kolos)|K(?:olos(?:iy|si)ani|olussiy|alossiy|ūlosiy)|Colusiy)an|k(?:uluss(?:iyōṅ\s*ke\s*nām\s*kā\s*ḫaṭ|īāṃ\s*nū̃\s*pattrī)|ūl(?:ow|sī))|कलस्सीहरूलाई\s*पावलको\s*पत्र|Sulat\s*sa\s*mga\s*[CK]olon?sense|Epistula\s*ad\s*Colossenses|पौलाचे\s*कलस्सैकरांस\s*पत्र|(?:کتاب\s*پیام‌های|رساله|نامه|پیام)\s*کول(?:وسي|ُسی)ان|الرسالة\s*إلى\s*أهل\s*كولوسي|L(?:ayang\s*Paulus\s*Kolos[eé]|ist\s*Kolos(?:an[ouů]m|k[yý]m))|(?:Lettera\s*ai\s*)?Colossesi|Waraka\s*kwa\s*Wakolosai|kalass(?:aikar[aā][mṃ]s\s*patr|[iī]har[uū]l[aā][iī]\s*patr)a|ਕੁਲੁੱਸੀਆਂ\s*ਨੂੰ\s*ਪੱਤ੍ਰੀ|କଲସୀୟଙ୍କ\s*ପ୍ରତି\s*ପତ୍ର|کول(?:(?:(?:وسيان‌نامه‌هات|سی)|وسيان‌نامه‌گ)ا|ُس(?:ی(?:ان(?:‌نامه‌گ|ی?)ا|ونا)|يو))ن|האיגרת\s*אל\s*הקולוסים|ک(?:ول(?:و(?:سيان(?:‌نامه(?:‌هات?)?|ی)?)?|ُسی(?:ان(?:‌نامه(?:‌ها)?|ی)?|ون|ه)|س(?:يون(?:‌نامه)?)?|سی)?|ول(?:وسي|ُسی)ان‌نامه‌ی|ولوسيون(?:‌نامه)?|ُل(?:وسي(?:ان(?:‌نامه)?|ون(?:‌نامه)?)|ِسّیوں)?|ل(?:(?:وسيان‌نامه|(?:وس(?:يان)?|سیوں)?)|وسيانی))|K(?:ol(?:os(?:s(?:e(?:nser(?:brevet|ne)|rbrevet)|z(?:e(?:beliekhez|ieknek)|ébeliekhez)|[eé]iakhoz|iy)|a[sy]|é)|usiy?ans)|ol[ou]ssubr[eé]fið|ól[ou]ssubr[eé]fið|ulusiy)|(?:Mga\s*Taga(?:-?(?:\s*[CK]olosa|Colosa)|\s*[CK]olosa)|Kol(?:us(?:iy[au]ni|y)an|ò)|Taga(?:-?\s*?C|\s*C)olosa|C(?:oloss(?:i(?:ya|[eo])|a)|(?:(?:olas|ol[ao])|oll[ao])si[ao]|al(?:(?:[ao]s|[ao])si[ao]|l(?:asi[ao]|osi[ao])))n|Callossian|Colosa)s|(?:کول(?:وسيان‌نامه‌ش|ُسی(?:ان‌نامه‌ش|ونی))|حکایت\s*کولوسي)ان|कलस्सीहरूलाई\s*पत्र|कलस्सैकरांस\s*पत्र|콜로새(?:\s*신자들에게\s*보낸\s*서간|서)|Προς\s*Κολοσσαε[ίι]ς|k(?:alass(?:aikar[aā][mṃ]s|[iī]har[uū]l[aā][iī])|ulussīāṃ|ūl)|Mga\s*[CK]olon?sense|ad\s*Colossenses|سخنان\s*کول(?:وسي|ُسی)ان|K(?:o(?:l(?:oceyarukku|ōceyarukku|os(?:s(?:e(?:nsern|r)?|é)|i(?:y(?:an)?|an?)|an|e)?|usi(?:y[au]n|an))?)?|ól)|ਕੁਲੁੱਸੀਆਂ\s*ਨੂੰ|کتاب\s*کول(?:وسي|ُسی)ان|क(?:लस्स(?:ी(?:हरूलाई)?|ैकरांस)|ुलुस्सि)|К\s*Колоссянам|رسالة\s*كولوسي|コロサイ(?:の信徒への手紙|人への手紙|(?:人への)?書)|क(?:ुलुस्(?:सियों|‍सी)|लसैकरांस)|(?:Col(?:oss(?:enze|iyu)|usia)|K(?:ol(?:(?:os(?:iy(?:an)?u|(?:senz|y)e)|usiyanu)|osiyoo)|ulussaiyo|ūlosia)|(?:Colūsiy|Kūl(?:usiy|ūsi))ā|kūlsiā)n|Coloss?enses|אל\s*הקולוסים|До\s*колоссян|C(?:olossians|(?:oloseni|ôlôxê|l))|Kolosens[oó]w|Kolosanima|Kološanima|Κολοσσαε[ίι]ς|Колошанима|Колоссянам|Коло(?:ся|ша)ните|C(?:olossian|(?:o(?:l(?:oss?)?)?|ôl))|Wakolosai|کولُسسیان|Колосјани|Кол(?:ос(?:яни?|сян))?|କଲସୀୟଙ୍କ|Cô-?lô-?se|کلُسیان|コロサイ(?:人へ)?|《?哥羅森書》|《?歌(?:罗西书|羅西書)》|โคโลสี|ﻛﻮﻟﻮﺳﻲ|《?哥羅森書|《?歌(?:罗西书|羅西書)|(?:《?适羅斯|《?西)》|கொலோ|《?适羅斯|골로새서|Κολ|قول|콜로|《?西|Κλ|كو|คส|골))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Tim"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:دوم\s*تيموتيوس\s*مقدس|2\.?\s*Ti-?mô-?thê)|(?:2-?(?:ге|а)\.\s*(?:послання\s*(?:св\.?\s*апостола\s*Павла\s*до\s*Ти­мофія|апостола\s*Павла\s*до\s*Тимофія|до\s*Тимотея|до\s*Тимофія|Тимофію)|Ти(?:­мофія|мо(?:те[ий]|фію)))|Друг(?:а\s*(?:послання\s*(?:св\.?\s*апостола\s*Павла\s*до\s*Ти­мофія|апостола\s*Павла\s*до\s*Тимофія|до\s*Тимотея|до\s*Тимофія|Тимофію)|(?:(?:(?:посланица\s*Тимотеју|Тимоте(?:ју|[ий]))|Тимофію)|Ти­мофія))|е\s*(?:послання\s*(?:св\.?\s*апостола\s*Павла\s*до\s*Ти­мофія|апостола\s*Павла\s*до\s*Тимофія|до\s*Тимотея|до\s*Тимофія|Тимофію)|Ти(?:­мофія|мо(?:те[ий]|фію))))|2-?е\.?\s*послання\s*(?:св\.?\s*апостола\s*Павла\s*до\s*Ти­мофія|апостола\s*Павла\s*до\s*Тимофія|до\s*Тимотея|до\s*Тимофія|Тимофію)|2-?(?:ге|а)\s*(?:послання\s*(?:св\.?\s*апостола\s*Павла\s*до\s*Ти­мофія|апостола\s*Павла\s*до\s*Тимофія|до\s*Тимотея|до\s*Тимофія|Тимофію)|Ти(?:­мофія|мо(?:те[ий]|фію)))|(?:II\.?\s*по|2\.?\s*по)слання\s*(?:св\.?\s*апостола\s*Павла\s*до\s*Ти­мофія|апостола\s*Павла\s*до\s*Тимофія|до\s*Тимотея|до\s*Тимофія|Тимофію)|(?:Dru(?:he\s*poslannja\s*apostola\s*Pavla\s*do\s*Tymofij|g(?:a\s*(?:List\s*(?:[sś]w\.?\s*Pawła\s*do\s*Tymoteusz|do\s*Tymoteusz)|T(?:imoteju\s*Poslanic|ymoteusz))|i\s*(?:List\s*(?:[sś]w\.?\s*Pawła\s*do\s*Tymoteusz|do\s*Tymoteusz)|Tymoteusz)))|(?:II\.?\s*L|2\.?\s*L)ist\s*(?:[sś]w\.?\s*Pawła\s*do\s*Tymoteusz|do\s*Tymoteusz)|(?:II\.?\s*Timoteju|2\.?\s*Timoteju)\s*Poslanic|(?:II\.?\s*Ty|2\.\s*Ty)moteusz|2\s*Tymoteusz)a|Второ\s*послание\s*на\s*св(?:\.\s*ап\.?\s*Павла\s*до\s*Тимот|\s*ап\.?\s*Павла\s*до\s*Тимот)ея|த(?:ிம[ொோ]த்தேயுவுக்கு\s*எழுதிய\s*இரண்டாம்\s*திருமுகம்|ீமோத்தேயுவுக்கு\s*எழுதிய\s*இரண்டா(?:வது\s*நிருப|ம்\s*கடித)ம்)|(?:T(?:im(?:ott[eē]yuvukku\s*E[lḻ]utiya\s*Ira[nṇ][tṭ][aā]vatu\s*Nirupa|ōtt[eē]yuvukku\s*E[lḻ]utiya\s*Ira[nṇ][tṭ][aā]vatu\s*Nirupa)|īm[oō]tt[eē]yuvukku\s*E[lḻ]utiya\s*Ira[nṇ][tṭ][aā]vatu\s*Nirupa)|II\.?\s*Tí|2\.?\s*Tí)m|ت(?:یِمُتھِیُس\s*کے\s*نام\s*پولس\s*رسول\s*کا\s*دوسرا\s*خط|ِیمُتھِیُس\s*کے\s*نام\s*کا\s*دوسرا\s*خط|یمتھیس\s*کے\s*نام\s*کا\s*دوسرا\s*خط|يموثاوس\s*الثانية)|Втор(?:а\s*(?:писмо\s*од\s*апостол\s*Павле\s*до\s*Тимотеј|Тимоте[ийј])|о\s*(?:писмо\s*од\s*апостол\s*Павле\s*до\s*Тимотеј|Тимоте[ийј]))|رسالة\s*بولس\s*الرسول\s*الثانية\s*إلى\s*تيموثاوس|(?:II\.?\s*пи|2\.?\s*пи)смо\s*од\s*апостол\s*Павле\s*до\s*Тимотеј|Pavlova\s*druga\s*poslanica\s*Timoteju|Paulus['’]\s*Andet\s*Brev\s*til\s*Timotheus|S(?:[ií]ðara\s*(?:br[eé]f\s*P[aá]ls\s*til\s*T[ií]m[oó]teusar|T[ií]m[oó]teusarbr[eé]f)|econd\s*T(?:himothy|imoth?y|himoty|omothy|m))|Paulus’\s*andre\s*brev\s*til\s*Timoteus|t(?:īm(?:utʰiyus\s*ke\s*nām\s*kā\s*dūsrā\s*ḫaṭ|atʰtʰ[aā]l[aā]\s*dusre\s*patra)|imotʰius\s*nū̃\s*dūjī\s*pattrī|imotʰ(?:il[aā][iī]\s*dostro|īl[aā][iī]\s*dostro)\s*patra|imatʰtʰ[aā]l[aā]\s*dusre\s*patra)|אגרת\s*פולוס\s*השנייה\s*אל-?טימותיוס|الرسالة\s*الثانية\s*إلى\s*تيموثاوس|तिमोथीलाई\s*(?:पावलको\s*दोस|दोस्त)्रो\s*पत्र|אגרת\s*פולוס\s*השנייה\s*אל-?טימותי|Waraka\s*wa\s*Pili\s*kwa\s*Timotheo|पौलाचे\s*तीमथ्थाला\s*दुसरे\s*पत्र|ତୀମଥିଙ୍କ\s*ପ୍ରତି\s*ଦ୍ୱିତୀୟ\s*ପତ୍ର|T(?:oinen\s*(?:Kirje\s*Timoteuksell|Timoteu(?:skirj|ksell))e|imoteyos\s*Labaad)|(?:Второ\s*послание\s*към\s*Тимот|2-?е\.?\s*Тимот)е[ий]|Barua\s*ya\s*Pili\s*kwa\s*Timotheo|S(?:[ií]ðara\s*br[eé]f\s*P[aá]ls\s*til\s*T[ií]m[oó]|econd\s*Ti(?:m(?:oth)?)?)|(?:Se(?:cond(?:(?:a\s*lettera\s*a|o)|a)\s*Timot|gund[ao]\s*Tim[oó]t)|(?:(?:I(?:kalawang\s*Ka|I\.?\s*Ka)y|2(?:\.\s*Ka(?:ng|y)|\s*Ka(?:ng|y)|(?:\.[oº]|[°º])\.))\s*|(?:Ikalawang\s*|2(?:\.[oº]|[°º])\s*))Timot|2[ao]\.\s*Tim[oó]t|2[ao]\s*Tim[oó]t)eo|ה(?:איגרת\s*השנייה\s*אל\s*טימותי|שנייה\s*אל\s*טימותיא?)וס|Druga\s*poslanica\s*Timoteju|Epistula\s*(?:II\s*ad\s*Timotheum|ad\s*Timotheum\s*II)|ਤਿਮੋਥਿਉਸ\s*ਨੂੰ\s*ਦੂਜੀ\s*ਪੱਤ੍ਰੀ|(?:II\.?\s*Ki|2\.?\s*Ki)rje\s*Timoteukselle|D(?:ruh(?:(?:[aá]\s*kniha|[aá])\s*Timotejovi|(?:[aá]\s*kniha|[aá])\s*Timoteovi|[aá]\s*list\s*Tim(?:otej?|etej)ovi|[yý]\s*(?:list\s*Tim(?:otej?|etej)ovi|T(?:imotejovi|(?:imoteovi|m)))|[aá]\s*Tm)|o(?:v(?:omTimot(?:eos|hy)|vomTimothy)|Timothy))|(?:II\.?\s*по|2\.?\s*по)сланица\s*Тимотеју|کتاب\s*مقدس\s*تيموتيوس\s*دوم|(?:دومين\s*نامه\s*به\s*تيموتي|(?:رساله|فرمان)\s*دوم\s*تيموتي|موعظه\s*دوم\s*تيموتي|کتاب\s*دوم\s*تيموتي|نامه\s*دوم\s*تيموتي|دومين\s*تيموتي|دو(?:م(?:\s*تیموتا|تیموتی)|تیموتی)ئ|(?:[2۲]\s*تیموتا|[2۲]تیموتی)ئ)وس|And(?:r(?:a\s*Timot(?:heo|eu)sbrevet|e\s*Timoteusbrev)|(?:e[nt]\s*Timotheusb|en\s*Timoteusb)rev)|(?:پ(?:ولُس\s*به|یام)|درس‌های)\s*تيموتيوس\s*دوم|دو(?:م(?:\s*ت(?:يموتيوس(?:‌(?:نامه‌(?:ا?ی|ها)|ها)|\s*رسول|(?:ی[-‌]|-?)ها)|یموتاؤس)|تیموت(?:ائ(?:وس[هی]|س)|ئوسه))|َم\s*تيموتيوسی|ّم\s*تيموتيوسی|ُم\s*تيموتيوسی|تیموت(?:ائ(?:وس[هی]|س)|ئوسه)|م?تیموتاؤسی)|तीमथ्थाला\s*दुसरे\s*पत्र|(?:II\.?\s*l|2\.?\s*l)ist\s*Tim(?:otej?|etej)ovi|M[aá]sodik\s*Tim[oó]t(?:eus(?:nak|hoz)|heosz)|2\.?\s*Timotheosbrevet|(?:De(?:uxi[eè]me(?:s\s*Timoth[eé]|\s*Timoth[eé])|zy[eè]m\s*Timot)|(?:II\.?\s*Timoteusk|2\.?\s*Timoteusk)irj|2(?:(?:eme|de?)|ème)\.\s*Timoth[eé]|2(?:(?:eme|de?)|ème)\s*Timoth[eé]|2(?:e\.?\s*Timothé|\.?\s*Timothé)|II\.?\s*Timothé)e|دو(?:م(?:\s*ت(?:يموتيو(?:س(?:‌نامه|ی)?)?|یم(?:و(?:ت(?:اؤ)?)?)?)|تی)|َم\s*تيموتيوس|ّم\s*تيموتيوس|ُم\s*تيموتيوس|متیموتا?ئوس|َم\s*تيموتيو|تیموتا?ئوس|م?تیموتاؤس|ّم)|2(?:\.\s*Timoteusbreve|\s*(?:Timoteusbreve|[ei]\.?\s*Timoteu))t|(?:II\.?\s*Timoteuk|2\.?\s*Timoteuk)selle|M[aá]sodik\s*Tim(?:[oó]teus)?|2\s*T(?:im(?:ott[eē]yuvukk|ōtt[eē]yuvukk)|īm[oō]tt[eē]yuvukk)u|2\.?\s*Timotheusbrev|(?:dovvom\s*tīmutā['’]ū|Tweede\s*Timot(?:he[uü]|e[uü])|D(?:o(?:v(?:(?:omTimoth?aio|vomTimotheo|omTimot(?:eo?u|hao|ao))|omTimothe[ou])|Timot(?:hao|e[ou]))|ruh(?:[aá]|[yý])\s*Timoteu)|2(?:e(?:\.\s*Timothe[uü]|\s*Timothe[uü])|\.\s*Timoth?eü|\s*(?:(?:timotʰiu|Timoteü)|Timotheü))|II(?:\.\s*Timoth?eü|\s*Timoth?eü)|(?:II\.?\s*Timotey|2\.?\s*Timotey|2Timothai|2Timotai)o|2e\.?\s*Timote[uü]|2Timoteo?u|2Timothao|2Timotao)s|(?:2(?:\.\s*T(?:eemuathaiy|imoti)|\s*Teemuathaiy|\s*Timoti|Timothe)|Do(?:vomT(?:imothae|īmutā)|Timotha?e)|II\.?\s*Timoti|2Timothae)us|Zweite\s*Timotheus|Προς\s*Τιμ[οό]θεον\s*Β['ʹʹ΄’]|ଦ୍ୱିତୀୟ\s*ତୀମଥିଙ୍କ|ﺍﻟﺜﺎﻧﻴﺔ\s*ﺗﻴﻤﻮﺛﺎﻭﺱ|2(?:(?:(?:(?:\.\s*(?:Ti(?:m(?:ot(?:e(?:us(?:brev)?)?|h(?:eo)?))?)?|त(?:िमोथी|ीम)|Тим)|\s*Timote(?:us(?:brev)?)?|\s*Timoth(?:eo)?|\s*(?:த(?:ீமோத்|ிமொ)|T(?:im?|ym)|तीम)|\s*तिमोथी|e\.?\s*Tim|\s*Тим|Tim)|ت(?:ی(?:م(?:وت?)?)?)?)|tīm?)|\s*تیم(?:وت?)?)|2\s*k\.?\s*Timotejovi|(?:II\.?\s*Timoteusn|2\.?\s*Timoteusn)ak|(?:II\.?\s*Timóteu|2\.?\s*Timóteu)snak|(?:(?:II\.?\s*Timoteush|2\.?\s*Timoteush)o|(?:II\.?\s*Timóteu|2\.?\s*Timóteu)sho|II\.?\s*Timotheos)z|티모테오(?:에게\s*보낸\s*둘째\s*서간|2서)|ad\s*Timotheum\s*II|(?:دو(?:م(?:(?:\s*تیِمُتھِیُ|\s*تِیمُتھِیُ|-?تِیمُتھِیُ|(?:\s*تیمِتھُ|۔تیمتھ)ی)|تیموت(?:ئاؤ|ی[ؤو]))|تیموت(?:ئاؤ|ی[ؤو]))|(?:2\.?|۲)\s*تیِمُتھِیُ|(?:2\.?|۲)\s*تِیمُتھِیُ|(?:2\.|۲)-?تِیمُتھِیُ|2-?تِیمُتھِیُ|(?:(?:2\.?|۲)\s*تیمِتھُ|(?:2\.?۔|۲۔)تیمتھ)ی|[2۲]تیموتئاؤ|[2۲]تیموتی[ؤو])س|D(?:ru(?:ga\s*Timoteju|h(?:[aá]|[yý])\s*Tim)|ovomT(?:im(?:oteo)?|īm))|And(?:en\s*Tim(?:oteus)?|re\s*Tim(?:oteus)?)|2(?:(?:(?:(?:\s*(?:ਤਿਮੋਥਿਉਸ\s*ਨੂੰ|t(?:imatʰtʰ[aā]l[aā]|īmatʰtʰ[aā]l[aā])|த(?:ிமொ|ீமோ)த்தேயு|तीमथ्थाला|T(?:imoty|m)|ทธ)|\.\s*(?:T(?:imot(?:h(?:e(?:osz|um|e)|y)|e(?:ut|i)|y)|m)|त(?:ीमु(?:ाथै|थि)युस|िम(?:ोथीलाई|ुथियुस))|timotʰ[iī]l[aā][iī]|ทิโมธี)|\s*Timoth(?:e(?:osz|um|e)|y)|\s*तीमुाथैयुस|\s*timotʰil[aā][iī]|\s*timotʰīl[aā][iī]|e\.?\s*Timothee|\s*तीमुथियुस|\s*तिम(?:ोथीलाई|ुथियुस)|\s*Timote(?:ut|i)|Timothy|\s*ทิโมธี|티모)|تیمت)|tīmt)|\s*تیموتاؤ)|(?:II\.?\s*Timotejo|2\s*k\.?\s*Timoteo|2\.?\s*Timotejo)vi|(?:II\.?\s*Timóth|2\.?\s*Timóth)eosz|2(?:-?(?:е\.?\s*к\s*Тимофе|я(?:\.\s*(?:к\s*Тимоф|Тим(?:ет|оф))е|\s*(?:к\s*Тимоф|Тим(?:ет|оф))е)|е(?:\.\s*Тимоф[еі]|\s*Тимоф[еі])|е\.?\s*Тимете)|[ея](?:\.\s*(?:к\s*Тимоф|Тим(?:ет|оф))е|\s*(?:к\s*Тимоф|Тим(?:ет|оф))е)|\.?\s*к\s*Тимофе|\.?\s*Тимоф[еі]|\.?\s*Тимете)ю|II(?:\.\s*(?:T(?:i(?:m(?:(?:ot(?:h(?:e(?:u[ms]|e)|y)|ei|y)|óteo)|ôthê)|-?mô-?thê)|m)|Тимоте(?:ју|[ий]))|\s*(?:T(?:i(?:m(?:(?:ot(?:h(?:e(?:u[ms]|e)|y)|ei|y)|óteo)|ôthê)|-?mô-?thê)|m)|Тимоте(?:ју|[ий])))|(?:II\.?\s*Timoteov|2\.?\s*Timoteov)i|2nd\.?\s*T(?:himothy|imoth?y|himoty|omothy|m)|(?:2(?:-?е\.?\s*Ти­|\.?\s*Ти­)|II\.?\s*Ти­)мофія|Pili\s*Timotheo|II(?:\.\s*(?:Ti(?:m(?:ot(?:e(?:us|o)?|h(?:eo)?))?)?|Тим(?:отеј)?)|\s*(?:Ti(?:m(?:ot(?:e(?:us|o)?|h(?:eo)?))?)?|Тим(?:отеј)?))|II\.?\s*Timoteju|2\.?\s*Timotheus|(?:II\.?\s*Timóteu|2\.?\s*Timóteu)s|(?:II\.?\s*Th|2\.?\s*Th)imothy|Timotheum\s*II|2\.?\s*Timoteju|2nd\.?\s*Ti(?:m(?:oth)?)?|2\.?\s*Тимоте(?:ју|[ий])|[2۲]تیموتائ(?:وس[هی]|س)|(?:II\.?\s*Th|2\.?\s*Th)imoty|(?:II\.?\s*To|2(?:\.?\s*To|ndTi))mothy|Timotheo\s*II|II\.?\s*Тимофію|2\.?\s*ତୀମଥିଙ୍କ|2\.?\s*Timoteo|2\.?\s*Тимотеј|[2۲]تیموتائوس|Tweede\s*Tim|2\.?\s*Timóteo|2\.?\s*Timôthê|Β['ʹʹ΄’]\s*Τιμ[οό]θεο|[2۲]تیموتئوسه|[2۲]تیموتاؤسی|テモテ(?:ヘの第二の手紙|への(?:後の書|手紙[Ⅱ二])|\s*2|後書)|[2۲]تیموتئوس|[2۲]تیموتاؤس|Втор[ао]\s*Тим|۲(?:\s*تیموتاؤ|تیمت|tīmt)|2Timoteos|2Timoteo|Pili\s*Tim|[2۲]تیموتاؤ|dovvomtī|۲(?:\s*تیم(?:وت?)?|ت(?:ی(?:م(?:وت?)?)?)?|tīm?)|(?:《提(?:摩(?:太后书|斐後)|[后後])|提(?:摩(?:太后书|斐後)|[后後]))》|《?提摩太後書》|《?弟茂德後書》|Β['ʹʹ΄’]\s*Τιμ?|《提(?:摩(?:太后书|斐後)|[后後])|《?提摩太後書|《?弟茂德後書|Ⅱ\s*テモテへ|提(?:摩(?:太后书|斐後)|[后後])|디모데[2후]서|2\s*طيم|二テモテ|딤후))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Tim"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:او(?:ل\s*ت(?:يموتيو|یموتاؤ)س\s*رسول|ّل\s*ت(?:(?:يموتيوسی|یموتاؤس)|يموتيوس))|1\.?\s*Ti-?mô-?thê)|(?:1-?(?:ше|а)\.\s*(?:послання\s*(?:св\.?\s*апостола\s*Павла\s*до\s*Ти­мофія|апостола\s*Павла\s*до\s*Тимофія|до\s*Тимотея|до\s*Тимофія|Тимофію)|Ти(?:­мофія|мо(?:те[ий]|фію)))|П(?:ерш[ае]\s*(?:послання\s*(?:св\.?\s*апостола\s*Павла\s*до\s*Ти­мофія|апостола\s*Павла\s*до\s*Тимофія|до\s*Тимотея|до\s*Тимофія|Тимофію)|Ти(?:­мофія|мо(?:те[ий]|фію)))|ърво\s*послание\s*на\s*св(?:\.\s*ап\.?\s*Павла\s*до\s*Тимот|\s*ап\.?\s*Павла\s*до\s*Тимот)ея|рв(?:а\s*(?:писмо\s*од\s*апостол\s*Павле\s*до\s*Тимотеј|(?:посланица\s*)?Тимотеју)|о\s*(?:писмо\s*од\s*апостол\s*Павле\s*до\s*)?Тимотеј)|ърв(?:о\s*(?:послание\s*към\s*)?Тимот|а\s*Тимот)е[ий])|1-?е\.?\s*послання\s*(?:св\.?\s*апостола\s*Павла\s*до\s*Ти­мофія|апостола\s*Павла\s*до\s*Тимофія|до\s*Тимотея|до\s*Тимофія|Тимофію)|1-?(?:ше|а)\s*(?:послання\s*(?:св\.?\s*апостола\s*Павла\s*до\s*Ти­мофія|апостола\s*Павла\s*до\s*Тимофія|до\s*Тимотея|до\s*Тимофія|Тимофію)|Ти(?:­мофія|мо(?:те[ий]|фію)))|(?:1\.?\s*посланн|I\.?\s*посланн)я\s*(?:св\.?\s*апостола\s*Павла\s*до\s*Ти­мофія|апостола\s*Павла\s*до\s*Тимофія|до\s*Тимотея|до\s*Тимофія|Тимофію)|(?:P(?:er[sš]e\s*poslannja\s*apostola\s*Pavla\s*do\s*Tymofij|ierwsz[aey]\s*(?:List\s*(?:[sś]w\.?\s*Pawła\s*do\s*Tymoteusz|do\s*Tymoteusz)|Tymoteusz)|rva\s*Timoteju\s*Poslanic)|(?:1\.?\s*L|I\.?\s*L)ist\s*(?:[sś]w\.?\s*Pawła\s*do\s*Tymoteusz|do\s*Tymoteusz)|(?:1\.?\s*Timotej|I\.?\s*Timotej)u\s*Poslanic|(?:1\.?\s*Ty|I\.?\s*Ty)moteusz)a|(?:T(?:im(?:ott[eē]yuvukku\s*E[lḻ]utiya\s*Mutal[aā]vatu\s*Nirupa|ōtt[eē]yuvukku\s*E[lḻ]utiya\s*Mutal[aā]vatu\s*Nirupa)|īm[oō]tt[eē]yuvukku\s*E[lḻ]utiya\s*Mutal[aā]vatu\s*Nirupa)|1\.?\s*Tí|I\.?\s*Tí)m|ت(?:ِیمُتھِیُس\s*کے\s*نام\s*(?:پولُس\s*رسول\s*)?کا\s*پہلا\s*خط|یمتھیس\s*کے\s*نام\s*کا\s*پہلا\s*خط|يموثاوس\s*الأولى)|த(?:ீமோத்தேயுவுக்கு\s*எழுதிய\s*முதலா(?:வது\s*நிருப|ம்\s*கடித)ம்|ிம[ொோ]த்தேயுவுக்கு\s*எழுதிய\s*முதல்\s*திருமுகம்)|(?:(?:رسالة\s*بولس\s*الرسول\s*الأولى\s*إلى\s*تيموثا|الرسالة\s*الأولى\s*إلى\s*تيموثا|(?:(?:(?:(?:اول|[1۱])\s*تیموتا|[1۱]تیموتی)|اولتیموتی)|یکتیموتی)ئ|اول\s*تیمُوتا)و|اولين\s*(?:نامه\s*به\s*)?تيموتيو|او(?:ل\s*ت(?:یموتاؤ|يموتيو)س\s*مقد|ّل(?:\s*تِیمُتھِیُ|-?تِیمُتھِیُ|(?:\s*تیمِتھُ|۔تیمتھ)ی))|(?:1\.|[1۱])\s*تِیمُتھِیُ|(?:1\.|۱)-?تِیمُتھِیُ|1-?تِیمُتھِیُ|(?:1\.\s*تیمِتھُ|(?:[1۱]\s*تیمِتھُ|(?:1\.?۔|۱۔)تیمتھ))ی|اولتیموتی[ؤو]|یکتیموتی[ؤو]|[1۱]تیموتی[ؤو])س|(?:1\.?\s*пи|I\.?\s*пи)смо\s*од\s*апостол\s*Павле\s*до\s*Тимотеј|(?:P(?:aulus(?:(?:'\s*Første|'\s*1\.?)\s*Brev\s*til\s*Timotheu|’\s*(?:Første\s*Brev\s*til\s*Timoth|(?:(?:første\s*brev\s*til\s*Timot|1\s*Brev\s*til\s*Timoth)|1\.\s*Brev\s*til\s*Timoth))eu)|rvn[ií]\s*Timoteu)|Eerste\s*Timot(?:he[uü]|e[uü])|(?:1(?:\.\s*T(?:eemuathaiy|imoti)|\s*Teemuathaiy|\s*Timoti|Timothe)|AvvalT(?:imothae|īmutā)|YekTimothae|I\.?\s*Timoti|1Timothae|Timoteo)u|AvvalTimot(?:haio|eo?u|h(?:ao|e[ou])|ai?o)|Erste\s*Timotheu|1e\.\s*Timot(?:he[uü]|e[uü])|1(?:\.\s*Timoth?eü|\s*(?:(?:timotʰiu|Timoteü)|Timotheü))|I(?:\.\s*Timoth?eü|\s*Timoth?eü)|YekTimot(?:hao|eo?u)|YekTimothe[ou]|(?:1\.?\s*Timotey|I\.?\s*Timotey|YekTimota|1Timothai)o|1e\s*Timot(?:he[uü]|e[uü])|1Timoteo?u|1Timothao|1Timotai?o)s|(?:Ensimm[aä]inen\s*(?:Kirje\s*Timoteuksell|Timoteu(?:skirj|ksell))|(?:1\.?\s*Ki|I\.?\s*Ki)rje\s*Timoteuksell|(?:1\.?\s*Timoteusk|I\.?\s*Timoteusk)irj|(?:1\.?\s*Timoteuk|I\.?\s*Timoteuk)sell|1\.?\s*Timothé|I\.?\s*Timothé)e|P(?:avlova\s*prva\s*poslanica\s*Timoteju|r(?:va\s*poslanica\s*Timoteju|(?:v(?:n[ií]\s*list\s*Timotej?ovi|[aá]\s*kniha\s*Timotej?ovi|n[ií]\s*(?:list\s*Timete|Timotej)ovi|[yý]\s*(?:list\s*Timotej?ovi|Timotej?ovi)|(?:n[ií]\s*Timoteo|a\s*Timotej?o)vi|á\s*Timotej?ovi|n[ií]\s*Tm)|em(?:i(?:er(?:e(?:s\s*Timoth[eé]e|\s*Timoth[eé]e)|(?:s\s*Timoth[eé]e|\s*Timoth[eé]e))|ère(?:s\s*Timoth[eé]e|\s*Timoth[eé]e))|ye\s*Timote))))|F(?:yrra\s*(?:br[eé]f\s*P[aá]ls\s*til\s*T[ií]m[oó]teusar|T[ií]m[oó]teusarbr[eé]f)|[oö]rsta\s*Timot(?:heo|eu)sbrevet|ørste\s*Timoth?eusbrev|irst\s*T(?:himothy|imoth?y|himoty|omothy|m))|t(?:īm(?:utʰiyus\s*ke\s*nām\s*kā\s*pahlā\s*ḫaṭ|atʰtʰ[aā]l[aā]\s*pahile\s*patra)|imotʰius\s*nū̃\s*pahilī\s*pattrī|imatʰtʰ[aā]l[aā]\s*pahile\s*patra|imotʰ(?:il[aā][iī]\s*pahilo|īl[aā][iī]\s*pahilo)\s*patra)|אגרת\s*פולוס\s*הראשונה\s*אל-?טימותיוס|Waraka\s*wa\s*Kwanza\s*kwa\s*Timotheo|तिमोथीलाई(?:र्\s*पावलको)?\s*पहिलो\s*पत्र|Barua\s*ya\s*Kwanza\s*kwa\s*Timotheo|אגרת\s*פולוס\s*הראשונה\s*אל-?טימות|(?:رساله\s*اول\s*پولُس\s*به|(?:(?:(?:نامه\s*الهام‌شد|اولین\s*نام)ه\s*به|(?:کتاب\s*مقدس|پ(?:یام\s*اول|ندهای)))|نامه\s*پولُس\s*به))\s*تیموتاؤس|पौलाचे\s*तीमथ्याला\s*पहिले\s*पत्र|ה(?:איגרת\s*הראשונה\s*אל\s*טימותי|ראשונה\s*אל\s*טימותיא)וס|F(?:yrra\s*br[eé]f\s*P[aá]ls\s*til\s*T[ií]m[oó]t|ørste\s*Tim(?:oteus)?|irst\s*Ti(?:m(?:oth)?)?)|ਤਿਮੋਥਿਉਸ\s*ਨੂੰ\s*ਪਹਿਲੀ\s*ਪੱਤ੍ਰੀ|ତୀମଥିଙ୍କ\s*ପ୍ରତି\s*ପ୍ରଥମ\s*ପତ୍ର|E(?:pistula\s*I\s*ad\s*Timotheum|ls[oő]\s*Tim[oó]t(?:eus(?:nak|hoz)|heosz))|Epistula\s*ad\s*Timotheum\s*I|او(?:ل\s*ت(?:یموتاؤس(?:(?:(?:‌(?:نامه‌(?:هات|ش)ان|های‌شان)|ی(?:‌های‌ش)?ان)|\s*نبی)|ی‌نامه‌ا?ی)|يموتيوس‌نامه‌ا?ی)|ل\s*تیموتاؤس‌نامه‌گ?ی‌ها|ل\s*ت(?:یموتاؤسی‌نامه‌ه|يموتيوس‌(?:نامه‌)?ه)ا|(?:َل\s*تیموتاؤس(?:ی‌|-?)|ل\s*ت(?:یموتاؤسی?-?|يموتيوس(?:ی[-‌]|-?)))ها|ُل\s*تیموتاؤسی‌ها)|(?:(?:(?:(?:Prim(?:a\s*lettera\s*a|ero|o)|1(?:\.\s*Ka(?:ng|y)|\s*Ka(?:ng|y)|(?:\.[oº]|[°º])\.))\s*Timo|(?:(?:(?:Primeir[ao]\s*Tim[oó]|1[ao]\.\s*Tim[oó]|1[ao]\s*Tim[oó])|Prima\s*Timo)|(?:Primer\s*|1(?:\.[oº]|[°º])\s*)Timo))|I\.?\s*Kay\s*Timo)t|Una(?:ng\s*(?:Kay\s*)?Timot|\s*(?:Kay\s*)?Timot))eo|کتاب\s*مقدس\s*تيموتيوس\s*اول|او(?:ل(?:\s*ت(?:یم(?:(?:و(?:ت(?:ا(?:ؤ(?:س(?:‌(?:نامه‌هات?|ها)|ی‌ها|ی)?)?)?)?)?)?|وتاؤسی‌نامه)|يموتيو(?:س(?:‌نامه|ی)?)?)|تی)|َل\s*ت(?:یموتاؤسی?|يموتيو)|ُل\s*تیموتاؤس|ّل)|(?:1\.?\s*послани|I\.?\s*послани)ца\s*Тимотеју|پولُس\s*به\s*ت(?:يموتيو|یموتاؤ)س\s*اول|(?:(?:یادداش|آیا)ت|کتاب)\s*تیموتاؤس\s*اول|درس‌های\s*ت(?:يموتيو|یموتاؤ)س\s*اول|तीमथ्थाला\s*पहिले\s*पत्र|הראשונה\s*אל\s*טימותיוס|1\.?\s*Timotheosbrevet|(?:1\.?\s*l|I\.?\s*l)ist\s*Timotej?ovi|رساله\s*اول\s*ت(?:يموتيو|یموتاؤ)س|فرمان\s*اول\s*ت(?:يموتيو|یموتاؤ)س|موعظه\s*اول\s*ت(?:يموتيو|یموتاؤ)س|1(?:\.\s*Timoteusbreve|\s*(?:Timoteusbreve|[ei]\.?\s*Timoteu))t|(?:1\.?\s*l|I\.?\s*l)ist\s*Timeteovi|نامه\s*اول\s*ت(?:يموتيو|یموتاؤ)س|کتاب\s*اول\s*ت(?:يموتيو|یموتاؤ)س|پیام\s*ت(?:يموتيو|یموتاؤ)س\s*اول|Timot(?:eyos\s*Kowaad|h(?:e[ou]s|y))|1\.?\s*Timotheusbrev|1\s*T(?:im(?:ott[eē]yuvukk|ōtt[eē]yuvukk)|īm[oō]tt[eē]yuvukk)u|Προς\s*Τιμ[οό]θεον\s*Α['ʹʹ΄’]|1(?:(?:\.\s*(?:Ti(?:m(?:ot(?:e(?:us(?:brev)?)?|h(?:eo)?))?)?|त(?:िमोथी|ीम)|Тим)|\s*Timote(?:us(?:brev)?)?|\s*Timoth(?:eo)?|\s*(?:த(?:ீமோத்|ிமொ)|Tim?|तीम)|\s*तिमोथी|\s*Тим|Tim)|\.?\s*Timoteo)|1\s*k\.\s*Timotej?ovi|a(?:vval\s*tīmutā['’]ūs|d\s*Timotheum\s*I)|티모테오(?:에게\s*보낸\s*첫째\s*서간|1서)|Kwanza\s*Timotheo|1(?:\s*(?:ਤਿਮੋਥਿਉਸ\s*ਨੂੰ|t(?:imatʰtʰ[aā]l[aā]|īmatʰtʰ[aā]l[aā])|த(?:ிமொ|ீமோ)த்தேயு|तीमथ्[थय]ाला|T(?:imoty|m)|طيم|ทธ)|\.\s*(?:T(?:imot(?:h(?:e(?:osz|um|e)|y)|e(?:ut|i)|y)|m)|त(?:ीमु(?:ाथै|थि)युस|िम(?:ोथीलाई|ुथियुस))|timotʰ[iī]l[aā][iī]|ทิโมธี)|\s*Timoth(?:e(?:osz|um|e)|y)|\s*तीमुाथैयुस|\s*timotʰil[aā][iī]|\s*timotʰīl[aā][iī]|\s*तीमुथियुस|\s*तिम(?:ोथीलाई|ुथियुस)|\s*Timote(?:ut|i)|Timothy|\s*ทิโมธี|티모)|(?:1\.?\s*Timoteusn|I\.?\s*Timoteusn)ak|(?:1\.?\s*Timóteu|I\.?\s*Timóteu)snak|(?:(?:1\.?\s*Timoteush|I\.?\s*Timoteush)o|(?:1\.?\s*Timóteu|I\.?\s*Timóteu)sho|I\.?\s*Timotheos)z|(?:AvvalstTi|1\.?\s*To|I\.?\s*To|1stTi)mothy|1\s*k\s*Timotej?ovi|1(?:(?:ere?|re)|ère)\.\s*Timoth[eé]e|1(?:-?(?:е\.?\s*к\s*Тимофе|я(?:\.\s*(?:к\s*Тимоф|Тим(?:ет|оф))е|\s*(?:к\s*Тимоф|Тим(?:ет|оф))е)|е(?:\.\s*Тимоф[еі]|\s*Тимоф[еі])|е\.?\s*Тимете)|[ея](?:\.\s*(?:к\s*Тимоф|Тим(?:ет|оф))е|\s*(?:к\s*Тимоф|Тим(?:ет|оф))е)|\.?\s*к\s*Тимофе|\.?\s*Тимоф[еі]|\.?\s*Тимете)ю|(?:اوَل\s*تيموتيو|[1۱]تیموتاؤ)سی|اوُل\s*تيموتيوسی|ପ୍ରଥମ\s*ତୀମଥିଙ୍କ|E(?:ls[oő]\s*Tim(?:[oó]teus)?|erste\s*Tim)|P(?:rv(?:a\s*Timoteju|n[ií]\s*Tim)|ierwsz[aey]\s*Tym)|(?:اوَل\s*تيموتيو|[1۱]تیموتاؤ)س|اوُل\s*تيموتيوس|AvvalTimot(?:eos|hy)|(?:1\.?\s*Timóth|I\.?\s*Timóth)eosz|1st\.\s*T(?:himothy|imoth?y|himoty|omothy|m)|(?:1\.?\s*Timotej|I\.?\s*Timotej)ovi|1(?:(?:ere?|re)|ère)\s*Timoth[eé]e|(?:1(?:-?е\.?\s*Ти­|\.?\s*Ти­)|I\.?\s*Ти­)мофія|اولتیموت(?:ا(?:ئ(?:وس[هی]|س)|ؤسی)|ئوسه)|ﺍﻻﻭﻝ\s*ﺗﻴﻤﻮﺛﺎﻭﺱ|AvvalT(?:im(?:oteo)?|īm)|1\.?\s*Timotheus|П(?:рва\s*Тимотеј|ърв[ао]\s*Тим)|اولتیموت(?:ا(?:ئو|ؤ)س|ئوس)|I(?:\.\s*(?:T(?:i(?:m(?:(?:ot(?:h(?:e(?:u[ms]|e)|y)|ei|y)|óteo)|ôthê)|-?mô-?thê)|m)|Тимоте[ий])|\s*(?:T(?:i(?:m(?:(?:ot(?:h(?:e(?:u[ms]|e)|y)|ei|y)|óteo)|ôthê)|-?mô-?thê)|m)|Тимоте[ий]))|1st\s*T(?:himothy|imoth?y|himoty|omothy|m)|(?:1\.?\s*Timoteov|I\.?\s*Timoteov)i|1-?е\.?\s*Тимоте[ий]|یکتیموت(?:ا(?:ئ(?:وس[هی]|س)|ؤسی)|ئوسه)|(?:(?:اول|[1۱])|یک)تیموتئاؤس|اول\s*تیمُتاؤس|I(?:\.\s*(?:Ti(?:m(?:ot(?:e(?:us|o)?|h(?:eo)?))?)?|Тим)|\s*(?:Ti(?:m(?:ot(?:e(?:us|o)?|h(?:eo)?))?)?|Тим))|(?:1\.?\s*Timóteu|I\.?\s*Timóteu)s|1st\.\s*Ti(?:m(?:oth)?)?|(?:1\.?\s*Timotej|I\.?\s*Timotej)u|یکتیموت(?:ا(?:ئو|ؤ)س|ئوس)|YekTimot(?:eos|hy)|(?:1\.?\s*Th|I\.?\s*Th)imothy|Timotheum\s*I|(?:1\.?\s*Тимотеј|I\.?\s*Тимотеј)у|[1۱]تیموتائ(?:وس[هی]|س)|1\.?\s*ତୀମଥିଙ୍କ|1st\s*Ti(?:m(?:oth)?)?|Kwanza\s*Tim|1\.?\s*Тимотеј|I\.?\s*Тимотеј|[1۱]تیموتائوس|1\.?\s*Timóteo|1\.?\s*Timôthê|1\.?\s*Тимоте[ий]|(?:1\.?\s*Th|I\.?\s*Th)imoty|Timotheo\s*I|Α['ʹʹ΄’]\s*Τιμ[οό]θεο|テモテ(?:ヘの第一の手紙|への(?:前の書|手紙[Ⅰ一])|\s*1|前書)|I\.?\s*Тимофію|[1۱]تیموتئوسه|[1۱]تیموتئوس|1Timoteos|1Timoteo|[1۱]تیموتاؤ|1e\.\s*Tim|(?:《提(?:摩(?:太前[书書]|斐前)|前)|提(?:摩(?:太前[书書]|斐前)|前))》|《?弟茂德前書》|avvaltī|1تی(?:م(?:وت?)?)?|۱(?:تی(?:م(?:وت?)?)?|tīm?)|Timoth|YekTim|1e\s*Tim|(?:1\.?\s*Ty|I\.?\s*Ty)m|Α['ʹʹ΄’]\s*Τιμ?|《提(?:摩(?:太前[书書]|斐前)|前)|《?弟茂德前書|Ⅰ\s*テモテへ|提(?:摩(?:太前[书書]|斐前)|前)|1tīmt|1تیمت|۱(?:tīmt|تیمت)|디모데[1전]서|1tīm?|一テモテ|딤전))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Deut"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))(Deut-?ieh|(?:(?:Ks(?:i[eę]g[ai]\s*Powt(?:[oó]rzonego)?\s*Pra|\.\s*Powt(?:[oó]rzonego)?\s*Pra|\s*Powt(?:[oó]rzonego)?\s*Pra)w|(?:Pi[aą]ta\s*K|5\.?\s*K)s(?:i[eę]g[ai]\s*Moj[zż]eszow|\.\s*Moj[zż]eszow|\s*Moj[zż]eszow)|V(?:iides\s*Mooseksen\s*kirj|\.\s*(?:Ks(?:i[eę]g[ai]\s*Moj[zż]eszow|\.\s*Moj[zż]eszow|\s*Moj[zż]eszow)|kniha\s*Moj[zž][ií][sš]ov|Moj[zż]eszow|Mojz[ií][sš]ov|Mojž[ií][sš]ov)|\s*Ks(?:i[eę]g[ai]\s*Moj[zż]eszow|\.\s*Moj[zż]eszow|\s*Moj[zż]eszow)|\.?\s*Mooseksen\s*kirj|\s*kniha\s*Moj[zž][ií][sš]ov|\s*Moj[zż]eszow|\s*Mojz[ií][sš]ov|\s*Mojž[ií][sš]ov)|(?:Piata\s*(?:kniha\s*Moj[zž]i|Moj[zž]i)|5\s*k(?:\.\s*Moj[zž]i|\s*Moj[zž]i)|5\.\s*Mojz[ií]|5\s*Mojz[ií])[sš]ov|Kumbukumbu\s*la\s*Sheri|(?:P(?:at[aá]\s*k|át[aá]\s*k)|5\.\s*k)niha\s*Moj[zž][ií][sš]ov|Dezy[eè]m\s*liv\s*Lalwa\s*|5\.\s*Mooseksen\s*kirj|5\s*kniha\s*Moj[zž][ií][sš]ov|5\s*Mooseksen\s*kirj|(?:(?:(?:Piata|5)\s*Mojz|(?:Pi(?:ata\s*Mojż|ąta\s*Moj[zż])|5\s*Mojż))e|5\.\s*Moj[zż]e)szow|P(?:at[aá]\s*M|át[aá]\s*M)oj[zž][ií][sš]ov|5\.?\s*Mojž[ií][sš]ov|Te?sn-?h)a|Kitabu\s*cha\s*Tano\s*cha\s*Musa|Sharciga\s*Kunoqoshadiisa|P(?:hục\s*(?:truyền\s*luật\s*lệ\s*ký|Truyền\s*Luật\s*Lệ)|ovtorennja\s*Zakonu|nz)|Kumbukumbu\s*la\s*Torati|M(?:[aá]sodik\s*t[oö]rv[eé]nyk[oö]nyv|[oó]zes\s*V|T[oö]rv)|П(?:ет(?:та\s*книга\s*Мој|а\s*книга\s*Мои)сеева|['’]ята\s*книга\s*Мо[ий]сеева|о(?:вт(?:(?:орення|\.?)\s*Закону|орени\s*закони)|н(?:овљени\s*закони|з))|ета\s*Мојсијева)|(?:M[oó]zes\s*[oö]t[oö]dik\s*k[oö]nyv|D(?:eutéronom|t-?i)|Tesn-?i)e|(?:P(?:angandharing\s*Tore|w)|Andharaning\s*Tor[eè])t|Li(?:ber\s*Deuteronomii|gji\s*i\s*(?:P[eë]rt[eë]rir[eë]|përtërirë)|P)|vyavastʰ[aā]ko\s*pustak|(?:Vyavasthaavivara|Ponovljeni\s*zako|Ulanga)n|व्य(?:वस्था(?:को\s*पुस्तक|\s*विवरण|विवरण)|्वस्थाविवरन|ावस्था)|เฉลย(?:​ธรรม​|ธรรม)บัญญัติ|V(?:iides\s*Mooseksen|\.?\s*Mooseksen|\.\s*M(?:o(?:j[zż]|s)|ós)|\s*M(?:o(?:j(?:z?|ż)|s)|ós))|F(?:[uü]nfte\s*(?:Buch\s*)?Mose|emte\s*Mosebo(?:ken|g)|immta\s*b[oó]k\s*M[oó]se)|ت(?:ث(?:ن(?:ي(?:ة\s*الإشتراع|يه)|ی(?:ه[اهی]|[او])|ه)|ـ)|(?:ثن(?:(?:ي(?:ي-?|-?ی|ی)|يـی|ی‌?ی|ـی|ئ)|ـيي)|سن(?:يي|ئ))ه|(?:ثنی-?|سنیـ)یه|صنیـیه)|(?:Fimmta\s*M[oó]seb[oó]|5\.?\s*Mosebó|(?:5\.?\s*Móse|V(?:\.\s*M[oó]se|\s*M[oó]se))b[oó])k|ଦ୍ୱିତୀୟ\s*ବିବରଣୀ|Femte\s*Mos(?:ebok)?|ଦ୍ୱିତୀୟ\s*ବିବରଣ|D(?:euteron(?:om(?:i(?:y[ao]|[ao])|ya|ul|[ae])|ómio)|e?yuteronomyo|iyuteronomyo|(?:(?:(?:euteronôm|eut(?:e?|o)ronm)|euto?ronom)|ueteronom)io|euto?ronomy|eet(?:[eo]rono?my|rono?my)|u(?:eterono?my|etorono?my|ut(?:[eo]rono?my|rono?my)|etrono?my)|eut(?:e?|o)ronmy|trnmy|tn)|De(?:uteron[oó]miu|te[rw]on[oò]|warie)m|Δευτερον[οό]μιον|Δε(?:υτ(?:ερ(?:ον[οό]μιο)?)?)?|5\.\s*Mooseksen|Второзакон(?:ие|ня)|V(?:ijfde|\.?)\s*Mozes|(?:(?:5\.\s*М|V\.?\s*М)|5\s*М)ојсијева|5\.?\s*Mosebo(?:ken|g)|5\.?\s*Buch\s*Mose|இணைச்\s*சட்டம்|bivastʰā\s*sār|D(?:e(?:u(?:t(?:eronom(?:i|y)?)?)?|t)?|uet|t)|P(?:hục(?:\s*Truyền)?|iata\s*Mojz)|5\s*Mooseksen|vyavastʰ[aā]ko|Đệ\s*nhị\s*luật|سفر\s*التثنية|Kum(?:b(?:ukumbu)?)?|Pi(?:ata\s*Mojż|ąta\s*Moj[zż])|5\.?\s*Mosebok|व्यवस्था(?:को)?|5\s*Моисеева|ت(?:ثني-?ها-?ه|(?:ثني(?:ه(?:ا-?|‌)|-?-?)|سنیه‌)ه|صنیه-?ه|ثن(?:(?:يـ|ی‌)|ـ)ه)ا|ਬਿਵਸਥਾ\s*ਸਾਰ|П(?:ета\s*Мојс|овт)|T(?:(?:es(?:sniy|ni?y)|sn-?i)eh|essnie|es(?:n(?:i[ae]|a)|s(?:ny|i[ey]))h|asnieh)|משנה\s*תורה|Вт(?:ор(?:озак)?)?|Up[aā]kamam|5\.\s*Mozes|istis̱nā|ا(?:ِستِثنا|ستثناء)|تَثنِيَة|5(?:\.\s*Mo(?:se?)?|\s*(?:(?:M(?:o(?:os)?|oz|óz)?|М)|Mose?))|ت(?:ثني-?ها|ث(?:ن(?:یه?|ي)?)?|سنیه|صنیه)|5\.\s*Moj[zż]|(?:5\.\s*М|V\.?\s*М)ојс|tsniyeh|5(?:\s*M[oó]ze|Mó)s|உபாகமம்|التثنية|5\s*Mojz|5\s*Mojż|5\.\s*Mós|Sharci|5\s*Мојс|استثنا|ਬਿਵਸਥਾ|anuw[aā]d|अनुवाद|ବିବରଣି|T(?:es(?:sn?|n)|sn)|5\s*Moj|5\s*Mós|《申(?:命[紀記记]》|》)|דברים|《申(?:命[紀記记])?|5\s*Mz|申命[紀記记]》|tsn?|申命[紀記记]|உபா|신명기|ฉธบ|Ul|申命?|신명?|申》|இச))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Titus"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:П(?:ослан(?:(?:ня\s*(?:св\.?\s*апостола\s*Павла\s*до\s*Тита|апостола\s*Павла\s*до\s*Тита)|ие\s*на\s*св\.?\s*ап\.\s*Павла\s*до\s*Тита|ие\s*на\s*св\.?\s*ап\s*Павла\s*до\s*Тита|\s*ня\s*до\s*Тита|и(?:е\s*к|ца)\s*Титу)|ие\s*към\s*Тит)|исмо\s*од\s*апостол\s*Павле\s*до\s*Тит)|P(?:oslan(?:nja\s*apostola\s*Pavla\s*do\s*Tyta|ica\s*Titu)|a(?:ulus(?:'\s*Brev\s*til\s*Titus|’\s*[Bb]rev\s*til\s*Titus)|vlova\s*poslanica\s*Titu))|ط(?:ِطُس\s*کے\s*نام\s*(?:پولس\s*رسُول\s*)?کا\s*خط|طس\s*کے\s*نام\s*کا\s*خط)|தீத்து(?:(?:வுக்கு\s*எழுதிய\s*திருமுக|வுக்கு\s*எழுதிய\s*(?:நிருப|கடித))|க்கு\s*எழுதிய\s*திருமுக)ம்|T(?:ittuvukku\s*E[lḻ]utiya\s*Nirupa|īttuvukku\s*E[lḻ]utiya\s*Nirupa)m|رسالة\s*بولس\s*الرسول\s*إلى\s*تيطس|(?:List\s*(?:[sś]w\.?\s*Pawła\s*do\s*Tytus|do\s*Tytus)|t(?:itasl[aā][iī]\s*patr|īt(?:asl[aā][iī]\s*patr|al[aā]\s*patr|āl[aā]\s*patr)|ital[aā]\s*patr|itāl[aā]\s*patr))a|Br(?:ef\s*P[aá]ls\s*til\s*T[ií]tusar|éf\s*P[aá]ls\s*til\s*T[ií]tusar)|(?:(?:(?:(?:کتاب\s*پیام‌های|رساله|نامه|پیام)|کتاب)|سخنان)\s*تايتو|(?:(?:(?:کتاب\s*پیام‌های|رساله|نامه|پیام)|کتاب)|سخنان)\s*تيتو|حکایت\s*تايتو|تیط[وُ]|طيط)س|אגרת\s*פולוס\s*אל-?טיטוס|ṭiṭus\s*ke\s*nām\s*kā\s*ḫaṭ|तीतसलाई\s*पावलको\s*पत्र|ତୀତସଙ୍କ\s*ପ୍ରତି\s*ପତ୍ର|पौलाचे\s*तीताला\s*पत्र|ت(?:ا(?:يتوس‌نامه‌(?:(?:هات|ش)ان|گان|ای)|ی(?:‌توس(?:‌نامه|ی)|توس‌نامه))|(?:ا(?:يتوس(?:(?:‌نامه‌گ?ی‌|-?)|ي[-‌])|ی(?:توسی[-‌]|‌توس-?))|يتوس(?:(?:‌نامه‌گی‌|(?:‌نامه‌ی‌|-?))|ي[-‌]))ها|يتو(?:(?:(?:(?:س‌نامه‌هات|[شص])|س‌نامه‌ای)|س‌نامه‌شان)|س‌نامه‌گان)|(?:ا(?:ی‌?توس‌ه|يتوس‌ه)|يتوس‌ه)ا|ی(?:تو(?:[ثشص](?:[-‌]ها|[هی])|س[هی])|طس))|Brevet\s*till\s*Titus|Epistula\s*ad\s*Titum|tītus\s*nū̃\s*pattrī|Kirje\s*Titukselle|Brevet\s*til\s*Titus|ਤੀਤੁਸ\s*ਨੂੰ\s*ਪੱਤ੍ਰੀ|الرسالة\s*إلى\s*تيطس|ت(?:ا(?:ي(?:(?:توس(?:‌نامه(?:‌(?:هات?|ی))?)?)?|توسي)|ی(?:توسی?|‌توس))|ي(?:(?:(?:ت(?:وس(?:‌نامه(?:‌ها)?)?)?)?|توس‌نامه‌ی)|توسي)|یت(?:و(?:س|[ثشص])?)?)|Waraka\s*kwa\s*Tito|האיגרת\s*אל\s*טיטוס|Lettera\s*a\s*Tito|Barua\s*kwa\s*Tito|T(?:itusarbr[eé]fið|í(?:tusarbr[eé]fið|ch)|it(?:u(?:s(?:brevet|z?hoz)|m)|it|[eô])|a(?:y(?:tū|ṭu)sian|itūṣ)|itusian|ytusa|t)|तीतसलाई\s*पत्र|T(?:itusarbr[eé]f|ít(?:usarbr[eé]f)?|ittuvukku|īttuvukku|i(?:t(?:u(?:sz?)?|i|o)?|it)|ayṭus|yt(?:us)?)|List\s*T[ií]tovi|तीताला\s*पत्र|티토(?:에게\s*보낸\s*서간|서)|Titukselle|Προς\s*Τ[ίι]τον|ਤੀਤੁਸ(?:\s*ਨੂੰ)?|Ka(?:ng|y)\s*Tito|t(?:it(?:a(?:sl[aā][iī]|l[aā])|āl[aā])|īt(?:asl[aā][iī]|al[aā]|āl[aā]|us))|テ(?:トス(?:への(?:て[かが]み|書)|への手紙|ヘの手紙|書)|ィトに達する書)|ad\s*Titum|אל\s*טיטוס|तीत(?:स(?:लाई)?|ाला)|ତୀତସଙ୍କ|T(?:a(?:it(?:o[ou]|u)|yt(?:o[ou]|u))|i(?:t(?:oo|ū)|ito)|ītū)s|До\s*Тита|தீத்(?:து)?|Titovi|Títovi|T(?:yto|īṭ)us|Teetus|Tāitus|К\s*Титу|ط(?:ِطُس|طس|ي)|ท(?:ิตัส|ต)|《?弟鐸書》|《?提(?:多[书書]|特書)》|तीतुस|テトスへ?|《?弟鐸書|《?提(?:多[书書]|特書)|Τ(?:[ίι]το|τ)|Тит[ау]|ﺗﻴﻄﺲ|Τ[ίι]τ|Тит|《?多》|디도서|티토|《?多|딛))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Heb"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:П(?:ослан(?:и(?:е\s*(?:на\s*св(?:\.\s*ап\.?\s*Павла\s*до\s*Евреите|\s*ап\.?\s*Павла\s*до\s*Евреите)|к(?:ъм\s*евреите|\s*Евреям))|ца\s*Јеврејима)|\s*ня\s*до\s*Євре[ії]в|ня\s*до\s*євре[ії]в)|исмо\s*до\s*Евреите)|ع(?:بر(?:انیوں\s*کے\s*نام\s*پولس\s*رسول\s*کا\s*خط|(?:انیوں\s*کے\s*نام\s*کا\s*خط|(?:انی(?:ان(?:ات|[تدزسـهڈی])|ونه)|ی)))|ِبرانیوں\s*کے\s*نام\s*کا\s*خط)|எபிர(?:(?:ேயருக்கு\s*எழுதிய\s*(?:திருமுக|கடித)ம|ேயர)|ெயருக்கு\s*எழுதிய\s*நிருபம)்|(?:Epireyarukku\s*E[lḻ]utiya\s*Nirupa|Hebrej[ouů]|Zid[ouů]|Žid[ouů])m|P(?:avlova\s*poslanica\s*Hebrejima|oslan(?:nja\s*do\s*jevre[iï]v|ica\s*Hebrejima))|ʿibrāniyōṅ\s*ke\s*nām\s*kā\s*ḫaṭ|हिब्रूहरूको\s*निम्ति\s*पत्र|(?:hibr[uū]har[uū]ko\s*nimti\s*patr|Waraka\s*kwa\s*Waebrani|B(?:arua\s*kwa\s*Waebrani|r[eé]fið\s*til\s*Hebre)|ibr[iī]\s*lok[aā][mṃ]s\s*patr|Cibraaniyad|Waebrani)a|ال(?:رسالة\s*إلى\s*ال)?عبرانيين|L(?:ist\s*(?:do\s*(?:Hebrajczyk[oó]w|[ZŻ]yd[oó]w)|Hebrej[ouů]m|[ZŽ]id[uů]m)|ettera\s*agli\s*Ebrei|ayang\s*Ibrani)|(?:Epistula\s*)?ad\s*Hebraeos|(?:Brevet\s*til\s*(?:hebre|Hebræ)ern|He(?:prealaiskirj|br(?:e(?:njv|ern)|æern)))e|Kirje\s*he[bp]realaisille|Z(?:sid[oó]khoz\s*[ií]rt\s*lev[eé]l|d)|ibrānīāṃ\s*nū̃\s*pattrī|ਇਬਰਾਨੀਆਂ\s*ਨੂੰ\s*ਪੱਤ੍ਰੀ|हिब्रू(?:हरूको\s*निम्ति)?|hibr[uū]har[uū]ko\s*nimti|इब्री\s*लोकांस\s*पत्र|הא(?:יגרת\s*אל[\s*-]העברים|גרת\s*אל-?העברים)|Mga\s*(?:Hebr(?:ohanon|eo)|Ebreo)|Heprealaisille|H(?:eb(?:r(?:[eæ]erbrevet|éerbrevet|e(?:abr[eé]fið|(?:(?:o?|w)|e)s|u[sx])|aeer|aer|äer|rs|ws|s)|er?s|(?:ro|e[eo])s|o(?:[eor])?s)|ê-?bơ-?rơ|e[ew]brews|w(?:[ew])?brews|ébreux|brews)|히브리(?:인들에게\s*보낸\s*서간|서)|Προς\s*Εβρα[ίι]ους|E(?:pireyarukku|b(?:r(?:a(?:an(?:ian)?|n(?:iya)?)|e(?:ean)?)?)?|vr)|इब्री\s*लोकांस|ਇਬਰਾਨੀਆਂ\s*ਨੂੰ|Hebrajczyk[oó]w|ibr[iī]\s*lok[aā][mṃ]s|Heber\s*lev[eé]l|Héber\s*lev[eé]l|(?:Ibra(?:aniya|ni)a|(?:Ebr(?:(?:a(?:an(?:iya|y)|n(?:i(?:yy|e)|ee))|eeani)|iani)|Hebra(?:niy|ani)|Ibraany)a|Abraan(?:(?:iya|y)a|i[ao])|Ebra(?:ni(?:y(?:aa|[ou])|[ou])|ani(?:yu|[eo]))|Hebr(?:ania|ee[eë])|Ebraniaa|ebrāniā)n|Ibraaaniyon|Hebreohanon|Ebr(?:a(?:anians|niyan)|ei)|Ibr(?:aaniya)?n|(?:Ibraanian|H(?:e[ew]breww|w(?:[ew])?breww|eb(?:r(?:e(?:ww|r)|aeo|r[eorw]|we)|e(?:r[eorw]|w[erw])|(?:ro|e[eo])[eor]|o[eor][eor]|w(?:er|re))|breww))s|इब्रान(?:ियों|ी)|Zsid(?:[oó]k(?:hoz)?)?|ع(?:ب(?:ر(?:انی(?:انا?|و[نں])?)?)?|ِبرانیوں)|Hebrejima|عبران(?:ی(?:ائ|[آهی])|يا)ن|ヘ[フブ]ライ人への手紙|אל\s*העברים|Јеврејима|До\s*євре[ії]в|ibrānīāṃ|Ebranian|ヘ[フブ]ル人への手紙|へ[フブ]ル人への手紙|Εβρα[ίι]ους|К\s*Евреям|इब्र(?:ानि|ी)|(?:Do\s*Thá|Evre)i|ヘ[フブ](?:ル(?:人への)?書|ライ書)|Евреите|H(?:e(?:b(?:r(?:e[ow])?)?|pr)?|é(?:br?)?|br|ê)|Ibr(?:ani)?|ebr(?:ānī|i)|Євре[ії]в|(?:《?希伯(?:來[书書]|来书)|《[來来]|[來来])》|《?耶烏雷爾》|Евреям|Євр(?:е[ії])?|Евр(?:еи)?|எபி(?:ரே)?|ヘ[フブ](?:ル人へ|ライ)|《?希伯(?:來[书書]|来书)|《?耶烏雷爾|ฮ(?:ีบรู|บ)|(?:Zyd[oó]|Żyd[oó])w|ଏବ୍ରୀ|Cib|ebr|Zid|Žid|Zyd|Żyd|Εβρ?|Јев|히브?|《[來来]|Žd|Ἑβ|[來来]))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Phil"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:П(?:исмо\s*од\s*апостол\s*Павле\s*до\s*христијаните\s*во\s*Филипи|ослан(?:ня\s*(?:св(?:\.\s*апостола\s*Павла\s*до\s*филип['’]ян|\s*апостола\s*Павла\s*до\s*филип['’]ян)|апостола\s*Павла\s*до\s*филип['’]ян|до\s*(?:Філіп['’]ян|филип['’]ян))|и(?:е\s*к(?:ъм\s*филипяните|\s*Филиппи[ий]цам)|ца\s*Филипљанима))|ослание\s*на\s*св(?:\.\s*ап\.?\s*Павла\s*до\s*Филипян|\s*ап\.?\s*Павла\s*до\s*Филипян)и)|(?:Poslannja\s*apostola\s*Pavla\s*do\s*fylyp['’]j|Fīlīpi)an|ف(?:ِل(?:ِپ(?:ّیُوں\s*کے\s*نام\s*پو\s*لس\s*رسُول|ِّیوں\s*کے\s*نام)\s*کا\s*خط|پّیوں)|(?:يليپيان‌نامه‌گی‌|يل(?:يپيان‌نامه‌ی|یپيون‌نامه)‌|يل(?:یپي(?:(?:ان|ه)|ون)-?|يپيان-?))ها|یل(?:یپ(?:ي(?:ان(?:‌نامه‌گ?ی‌|ي[-‌]|-?)ها|ان(?:(?:‌نامه‌(?:هات|ای)|ی)|‌ها)|ون[-‌]ها|ه[-‌]ها)|ی(?:[او]ن[نه]|ها))|پ?‌نامه)|لپیوں\s*کے\s*نام\s*کا\s*خط|يل(?:يپيان|یپيه)‌نامه‌ای|يل(?:یپي(?:ه‌(?:نامه‌)?ه|ان‌ه|ون‌ه)|يپيان‌ه)ا|يلیپي(?:ه‌نامه‌ی|وني)|يلیپيان‌نامه|يل[يی]پياني[-‌]ها|يليپيون[-‌]ها|ل‌نامه)|பிலிப்பியர(?:ுக்கு\s*எழுதிய\s*(?:திருமுக|(?:நிருப|கடித))ம்|்)|رسالة\s*بولس\s*الرسول\s*إلى\s*أهل\s*فيلبي|(?:Pilippiyarukku\s*E[lḻ]utiya\s*Nirupa|Filipano)m|(?:P(?:avlova\s*p)?oslanica\s*Filipljanim|Filipljanim)a|א(?:גרת\s*פולוס\s*השליח\s*אל-?|ל\s*)הפיליפיים|אגרת\s*פולוס\s*השליח\s*אל-?הפיליפי|(?:Paulus(?:'\s*Brev\s*til\s*Filippern|’\s*(?:Brev\s*til\s*F|brev\s*til\s*f)ilippern)|Kirje\s*filippil[aä]isill|Filip(?:(?:p(?:il[aä]iskirj|ern)|ian[eë]v)|pensern)|Filippil[aä]isill)e|List\s*(?:[sś]w\.?\s*Pawła\s*do\s*Filipian|do\s*Filipian|Filip(?:anom|sk[yý]m))|B(?:r[eé]f\s*P[aá]ls\s*til\s*Filipp[ií]manna|arua\s*kwa\s*Wafilipi)|फिलिप्पीहरूलाई\s*पावलको\s*पत्र|Br[eé]f\s*P[aá]ls\s*til\s*Filipp[ií]mann|ଫିଲି‌ପ୍‌ପୀୟଙ୍କ\s*ପ୍ରତି\s*ପତ୍ର|पौलाचे\s*फिलिप्पैकरांस\s*पत्र|f(?:ilipp(?:iyōṅ\s*ke\s*nām\s*kā\s*ḫaṭ|īāṃ\s*nū̃\s*pattrī)|īlīppī)|Epistula\s*ad\s*Philippenses|Sulat\s*sa\s*mga\s*(?:Filipense|Pilip(?:ense|yano))|(?:کتاب\s*پیام‌های|(?:رسال|نام)ه|پیام)\s*ف(?:يلي|یلی)پيان|pʰilipp(?:aikar[aā][mṃ]s\s*patra|[iī]har[uū]l[aā][iī]\s*patra)|الرسالة\s*إلى\s*أهل\s*فيلبي|ਫ਼ਿਲਿੱਪੀਆਂ\s*ਨੂੰ\s*ਪੱਤ੍ਰੀ|(?:Lettera\s*ai\s*)?Filippesi|(?:Layang\s*Paulus\s*F|Waf)ilipi|Waraka\s*kwa\s*Wafilipi|ف(?:يليپيان‌نامه‌(?:هات|گ)ا|یل(?:یپ(?:يان‌نامه‌گا|ی[او]نا)|پیا))ن|फिलिप्पीहरूलाई\s*पत्र|האיגרת\s*אל\s*הפיליפים|फिलिप्पैकरांस\s*पत्र|ف(?:يليپيان‌نامه‌هات|ي(?:ل(?:يپيان(?:‌نامه(?:‌ها)?)?|یپي(?:ه(?:‌نامه)?|ان|ون)))?|یل(?:یپ(?:ي(?:ان(?:‌نامه(?:‌(?:ها|ی))?)?|ون|ه)|ی(?:[او]ن|ه))|پی?)?|يل(?:يپيان‌نامه‌ی|یپيون‌نامه)|ِلِپّیُوں|يل[يی]پياني|يليپيون|ل(?:پیوں|یپ|‌ن)?)|P(?:h(?:i(?:l(?:ip(?:p(?:ibeliekhez|er)|es)|(?:ipppia|ip(?:pe|i)a|pia)ns|l(?:(?:ip(?:pian|ai?n|ian)|(?:ipp?ea|pp?ia)n)|lipian)s|ip(?:pian|(?:p[ai]n|ai?n))s|ppians|ípphê|pan)|-?líp)|lpp|p)|ilipi)|(?:Mga\s*Taga(?:-?(?:\s*[FP]ilipo|Filipo)|\s*[FP]ilipo)|Filip(?:iya|yu)nian|P(?:h(?:il(?:l(?:ip(?:pi?ai|aia|i(?:a[ai]|ea))|p(?:ie|a))|ippia[ai]|ippaia|ip(?:p?ie|ea)|ipaia|pai)n|il(?:l(?:ip(?:(?:pi[ei]|ii)|ppi)|l(?:ip[ip]i|pp?i))|ipp?ii|ppii|pppi|pe)an|il(?:ippain|lip(?:ie?n|p[ai]n)|ip[ei]n|pin)|lipp?ian)|ilipo)|Taga(?:-?(?:\s*[FP]ilipo|Filipo)|\s*[FP]ilipo)|Filip(?:(?:ense|o)|yan))s|ف(?:يليپيان‌نامه‌ش|یلیپ(?:يان‌نامه‌ش|ی[او]نی)|لیپی)ان|Προς\s*Φιλιππησ[ίι]ους|pʰilipp(?:aikar[aā][mṃ]s|[iī]har[uū]l[aā][iī])|필리피(?:\s*신자들에게\s*보낸\s*서간|서)|ad\s*Philippenses|P(?:ilippiyarukku|h(?:i(?:l(?:(?:ipppia|ip(?:pe|i)a|pia)n|l(?:i(?:p(?:pian|ai?n|ian)|p?)|(?:ipp?ea|pp?ia)n|lipian)|ip(?:pian|(?:p[ai]n|ai?n))|ppian|i(?:p(?:i|p)?)?|pp?)?)?|l(?:ipp?|p)))|फिलिप्प(?:ी(?:हरूलाई)?|ैकरांस|ि)|ਫ਼ਿਲਿੱਪੀਆਂ\s*ਨੂੰ|ଫିଲି‌ପ୍‌ପୀୟଙ୍କ|F(?:(?:(?:ili(?:p(?:p(?:erbrevet|ibr[eé]fið|íbr[eé]fið)|en(?:s[oó]w|i)|ians)|boy)|l?p)|ilippiekhez)|lippiekhez)|حکایت\s*فيليپيان|سخنان\s*ف(?:يلي|یلی)پيان|Mga\s*Filipense|Mga\s*Pilip(?:ense|yano)|کتاب\s*ف(?:يلي|یلی)پيان|К\s*Филиппи[ий]цам|Philippenses|Φιλιππησ[ίι]ους|フィリ[ヒピ](?:の信徒への手紙|人への手紙|書)|Filipensk[yý]m|(?:F(?:ilip(?:(?:p(?:enze|ia)|iy[ou]|y[eo])|paiyo)|īlīpī(?:yo|ā))|Philipiu|Fīlīpp[iī]ā|fīlīppiā)n|אל\s*הפיליפים|फिलिप्(?:पियों|‍पी)|До\s*филип['’]ян|Филипљанима|Филиппи[ий]цам|Филип(?:ја|я)ните|رسالة\s*فيلبي|F(?:ilip(?:iya|yu)n|(?:ili(?:p(?:i(?:an)?|pi)?)?|l))|Фил(?:ип(?:јани|['’]ян|яни))?|f(?:ilippīāṃ|īlīp)|Ф(?:илип['’]яни|лп)|Filipsk[yý]m|[ヒピ]リ[ヒピ]人への手紙|ฟ(?:ีลิปปี|ป)|[ヒピ]リ[ヒピ](?:人への)?書|பிலி(?:ப்)?|(?:《腓立比[书書]|腓立比[书書]|《?肥利批)》|《?斐理伯書》|ﻓﻴﻠﻴﺒﻲ|[ヒピ]リ[ヒピ]人へ|《腓立比[书書]|《?斐理伯書|フィリ[ヒピ]|腓立比[书書]|《?肥利批|빌립보서|《腓》|Φι|《腓|필리|腓》|빌|腓))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Dan"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:Книга\s*(?:на\s*пророк\s*Даниила?|пророка\s*Дани[иії]ла)|தானியேல(?:ின்\s*புத்தகம)?்|Prophetia\s*Danielis|ଦାନିୟେଲଙ୍କ\s*ପୁସ୍ତକ|d(?:ān(?:iyalko\s*pustak|īl)|aniyalko\s*pustak)|दान(?:िय(?:लको\s*पुस्तक|्ये?ल)|ीएल्र)|Danielin\s*kirja|Ks(?:i[eę]g[ai]\s*Danie|\.?\s*Danie)la|Liv\s*Dany[eè]l\s*la|D(?:an(?:i(?:el(?:s\s*Bog|[ae])|ya(?:[ei]lh|l))|ya(?:[ei]lh|l))|[ln])|Daniels\s*bok|سفر\s*دانيال|d(?:ān(?:iyalko|ī?)|aniyalko)|دان(?:یا(?:ئل(?:له|[هی])|ل(?:له|ی))|ي(?:ا(?:ئل(?:له|[هی])|ل(?:له|ی))|ئل(?:له|ی)|لی|یل)|یئلله|یئ?لی|ییل)|(?:D(?:a(?:an(?:iyy|ye)|ní)|hani|áni)e|Dan(?:i(?:yah|(?:ye|[aèë]))|y(?:ah|[eièï]))|d(?:ān(?:ī(?:ʾī|e)|i[eā])|an[iī]e))l|D(?:a(?:n(?:iel(?:in?)?|iya[ei]l|ya[ei]l)?|an)?|án)|दान(?:ि(?:यल(?:को)?)?|ीएल)|ଦାନିୟେଲଙ|Đa-?ni-?ên|Ða-?ni-?ên|دان(?:ی(?:(?:[\s*‌]ای|اي)|یا)|ي(?:اي|یا))ل|دا(?:ن(?:یائ?ل|ي(?:ائ?ل|ئل)|یئل|یل?)?)?|T[aā][nṉ]iy[eē]l|ด(?:าเนีย|น)ล|Đa(?:-?niê|nie)n|Дани[иії]ла?|Δ(?:ανι[ήη]λ|ν)|Д(?:анило|ан(?:и[ея]|аи)л|они[её]л)|(?:《但以理[书書]|但以理[书書])》|ਦਾਨੀਏਲ|Д(?:ан(?:ил)?|он)|《但以理[书書]|《?達尼爾》|דניאל|[タダ]ニエル書|但以理[书書]|《?達尼爾|தானி|[タダ]ニエル|다니엘서|Δαν?|다니엘?|《但》|Đa|《但|但》|但|단))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Jude"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))(Judas(?:'\s*B|\s*b)rev|(?:(?:List\s*powszechny\s*[SŚ]wi[eę]tego\s*Iudasa\s*Apostoł|Judina\s*poslanic|Lettera\s*di\s*Giud|yah(?:ūd(?:ā(?:ce[mṃ]\s*patr|ko\s*patr)|a(?:ce[mṃ]\s*patr|ko\s*patr))|ud[aā](?:ce[mṃ]\s*patr|ko\s*patr))|Barua\s*ya\s*Yud|Yehoozd|Giu[dđ])a|С(?:оборне\s*послання\s*(?:св\.?\s*апостола\s*Юди|Юди)|ъборно\s*послание\s*на\s*св(?:\.\s*ап\.?\s*Иуда|\s*ап\.?\s*Иуда))|Hið\s*almenna\s*br[eé]f\s*J[uú]dasar|П(?:ослание\s*на|исмо\s*од)\s*апостол\s*Јуда|Poslan(?:ica\s*Jude\s*apostola|nja\s*apostola\s*Judy)|Послання\s*апостола\s*Юди|Y(?:u(?:t[aā]\s*E[lḻ]utiya\s*Nirupam|das)|ūt[aā]\s*E[lḻ]utiya\s*Nirupam|ah(?:oodah|uda[hi])|a(?:huda|ahud)ah|eh(?:udaa?h|ood(?:a[ahi]|eh)))|யூதா\s*(?:எழுதிய\s*(?:நிருப|கடித)ம்|திருமுகம்)|y(?:ahūdā(?:h\s*(?:kā\s*ʿām\s*ḫaṭ|dī\s*pattrī)|n)|ūdā)|(?:رسال(?:ى\s*القديس|ة)\s*يهوذ|یهو(?:دا‌نامه‌گی‌ه|ذا(?:‌(?:نامه‌گ?ی‌ه|ه)|(?:(?:ی[-‌]|-?))?ه))|يهودا(?:‌نامه‌ی‌|(?:ی[-‌]|-?))ه|فرمان\s*یهود|يهودا‌?ه)ا|ی(?:ہ(?:ُوداہ\s*کا\s*عام\s*خط|ود(?:اہ\s*کا\s*عام\s*خط|(?:ا(?:ءه|[ته])|[آةهىی])))|ه(?:و(?:ذا‌نامه‌(?:هات|شان|گان|ای)|د(?:ا[ته]|[آةنهىی]))|ذ)|هو(?:د?‌نام|داء)ه)|ਯਹੂਦਾਹ\s*ਦੀ\s*ਪੱਤ੍ਰੀ|(?:Посланица\s*)?Јудина|(?:Juudaksen\s*kirj|Yahoodaa-?y|Giu-?đ)e|Послание\s*на\s*Юда|يهودا‌نامه‌هات|يهودا‌نامه‌[شگ]ان|Epistula\s*Iudae|ଯିହୂଦାଙ୍କ\s*ପତ୍ର|يهودا‌نامه‌ها|ی(?:هو(?:(?:ذ(?:ا(?:‌نامه(?:‌(?:ها|ی))?|ی)?)?|دا?)?|(?:د?‌نام|داء))|ہ(?:ُوداہ|ودا(?:ء?|ہ)))|J(?:ud(?:as\s*epistel|ova|[ey])|udasarbr[eé]fið|úd(?:asarbr[eé]fið|ov\s*List)|udasbrevet|udov\s*List|de|id)|يهودا‌نامه‌ای|यहूदा(?:चें|को)\s*पत्र|List\s*[sś]w\.\s*Judy|Послание\s*Иуды|درس‌های\s*یهو[دذ]ا|Послання\s*(?:Іу|Ю)ди|يهودا‌نامه‌ی|Layang\s*Yudas|List\s*[sś]w\s*Judy|پندهای\s*یهو[دذ]ا|J(?:u(?:dasarbr[eé]f|(?:ud(?:aksen)?|d(?:ina|as?|ov)))|úd(?:as(?:arbr[eé]f)?|ov)?)|يهو(?:دا(?:ی\s*مقدس|\s*(?:رسول|مقدس))|ذای\s*مقدس)|Jud(?:as’\s*[Bb]re|[uů])v|אי?גרת\s*יהודה|(?:رساله|موعظه|پیام|کتاب|نامه)\s*یهو[دذ]ا|يه(?:و(?:دا(?:‌نامه|ی)?|ذا)?)?|Ј(?:аковљевог|уд[ае]|д)|List\s*Jud(?:[uů]v|y)|y(?:ah(?:ū(?:(?:dāce[mṃ]|(?:dāko|(?:dāh?)?))|da(?:ce[mṃ]|ko))|ud[aā](?:ce[mṃ]|ko))|ūd)|ଯିହୂଦାଙ୍କ|San\s*Judas|Y(?:ah(?:oodaa?|uda)|a(?:huda|ahud)a|eh(?:udaa?|ooda)|u(?:(?:da?|ud)|t[aā])|ūt[aā])|यहूदा(?:चें|को)?|ユ[タダ](?:からの手紙|の(?:手紙|書))|ਯਹੂਦਾਹ|(?:Y(?:uuda|d)|J(?:udá|údá|da))s|유다(?:\s*서간|서)|Iudae|Hudas|(?:《(?:犹大书|猶[大達]書)|犹大书|猶[大達]書)》|《?伊屋達》|Ιο[υύ]δα|יהודה|Iuda|《(?:犹大书|猶[大達]書)|《?伊屋達|யூதா|Иуд[аы]|ย(?:ูดา|ด)|Иуд|犹大书|猶[大達]書|Юда|Іуд|《[犹猶]》|᾿Ιδ|유다?|Юд|《[犹猶]|ユ[タダ]|Gd|犹》|猶》|犹|猶))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["2Macc"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Se(?:cond(?:o\s*(?:libro\s*dei\s*)?Maccabei|\s*Mac(?:c(?:cabbbe|abee?s)|c(?:ca|ab)bbe[es]|c(?:ca|ab)be(?:e[es]|s)|ab(?:b(?:be(?:e[es]|s)|ee?s)|ee?s))|a\s*Maccabei)|gund(?:o\s*Mac(?:(?:cab(?:bee?os|ee?os)|abbee?os|abee?os)|abeus)|a\s*Macabeus)|cond\s*Mac(?:cabeee|abb?eee)s)|(?:Drug(?:a\s*(?:knjiga\s*o\s*Makabejcim|Ks(?:i[eę]g[ai]\s*Machabejsk|\.?\s*Machabejsk))|i\s*Ks(?:i[eę]g[ai]\s*Machabejsk|\.?\s*Machabejsk))|(?:II\.?\s*K|2\.?\s*K)s(?:i[eę]g[ai]\s*Machabejsk|\.?\s*Machabejsk))a|Втор(?:а(?:(?:я\s*книга\s*Маккаве[ий]ская|\s*книга\s*на\s*Макавеите)|\s*Макавеи)|о\s*Макавеи)|Kitabu\s*cha\s*Wamakabayo\s*II|Druh(?:[aá]\s*kniha\s*Ma(?:ch|k)abejcov|[yý]\s*(?:list\s*Ma(?:ch|k)abejcov|Ma(?:chabejcov|kabej(?:sk[aá]|cov)))|[aá]\s*Machabejcov|[aá]\s*Makabejsk[aá]|[aá]\s*Makabejcov)|T(?:oinen\s*makkabilaiskirja|weede\s*Makkabee[eë]n)|(?:Втора\s*книга\s*Макаве[ий]с|(?:II\.?\s*Макавеј|2\.?\s*Макавеј)с)ка|(?:I(?:kalawang\s*Mg|I\.?\s*Mg)a\s*Macabe|2\.?\s*Mga\s*Macabe)o|Liber\s*II\s*Maccabaeorum|(?:Liber\s*Maccabaeorum|Ma(?:chabaeorum|kkabeusok))\s*II|(?:Andra\s*Mackab[eé]erboke|2(?:\.\s*Mackab[eé]erboke|(?:\s*Mackab[eé]erboke|(?:\.\s*Makkabee[eë]|\s*Makkabee[eë]))))n|(?:II\.?\s*m|2\.\s*m)akkabilaiskirja|2-?(?:ге|а)\.\s*(?:книга\s*Макаве[ії]в|Макаве[ії]в)|Друг(?:а\s*книга\s*Макаве[ії]в|е\s*(?:книга\s*Макаве[ії]в|Макаве[ії]в)|а\s*Мака(?:веј(?:ск)?|бејац)а|а\s*Макаве[ії]в)|(?:Deuxi[eè]me(?:s\s*Maccab[eé]e|\s*Maccab[eé]e)|2(?:(?:eme|de?)|ème)\.\s*Maccab[eé]e|2(?:(?:eme|de?)|ème)\s*Maccab[eé]e|(?:II\.?\s*Maccabé|2\.?\s*Maccabé)e|2e\.?\s*Maccab[eé]e|II\.?\s*Macabeu|2o\.\s*Macabeu|2\.?\s*Macabeu|2o\s*Macabeu)s|(?:M[aá]sodik\s*Makkabeuso|(?:Andre\s*Makkabeer|2\.?\s*Makkabeer)bo|(?:II\.?\s*Makkabeu|2\.?\s*Makkabeu)so|Pili\s*Ma)k|(?:2(?:-?е\.?\s*к|\.?\s*к)|II\.?\s*к)нига\s*Макаве[ії]в|2-?(?:ге|а)\s*(?:книга\s*Макаве[ії]в|Макаве[ії]в)|سفر\s*المكابين\s*الثاني|Se(?:gundo\s*Mac(?:cab(?:bee?o|ee?o)|abbee?o|abee?o)|cond\s*Mac(?:(?:c(?:ca|ab)bbe|c(?:ca|ab)bee?|ab(?:b(?:bee?|ee?)|ee?)|cabee?|cc?)?|(?:cabeee|abb?eee)))|Anden\s*Makkabæerbog|Ikalawang\s*Macabeos|2\s*makkabilaiskirja|Ikalawang\s*Macabeo|[OÖ]nnur\s*Makkabeab[oó]k|2\s*k\.\s*Ma(?:ch|k)abejcov|2(?:\.[oº]|º)\.?\s*Maccab(?:bee?os|ee?os)|Zweite\s*Makkab[aä]er|(?:II(?:\.\s*Mach?aba|\s*Mach?aba)|(?:2\.\s*Macha|(?:2\.?\s*Maca|2\s*Macha))ba)eorum|2(?:\.[oº]|º)\.?\s*Maccab(?:bee?o|ee?o)|Pili\s*Wamakabayo|(?:II\.?\s*Machabe|2\.?\s*Machabe)jcov|2\s*k\s*Ma(?:ch|k)abejcov|2\.?\s*Makkabæerbog|2nd\.?\s*Mac(?:c(?:cabbbe|abee?s)|c(?:ca|ab)bbe[es]|c(?:ca|ab)be(?:e[es]|s)|ab(?:b(?:be(?:e[es]|s)|ee?s)|ee?s))|(?:II(?:\.\s*Mac(?:cab(?:(?:bee?o|eo)|ee[eo])|ab(?:be(?:e[eo]|o)|e(?:e[eo]|o)))|\s*Mac(?:cab(?:(?:bee?o|eo)|ee[eo])|ab(?:be(?:e[eo]|o)|e(?:e[eo]|o))))|2nd\.?\s*Mac(?:cabeee|abb?eee)|2\.?\s*Maccab(?:bee?o|eo)|2\.?\s*Maccabee[eo]|2\.?\s*Macab(?:be(?:e[eo]|o)|e(?:e[eo]|o)))s|2(?:\.[oº]|º)\.?\s*Macab(?:bee?os|ee?os)|2o\.\s*Mac(?:cab(?:bee?os|ee?os)|abbee?os|abee?os)|المكابين\s*الثاني|2nd\.?\s*Mac(?:c(?:ca|ab)bbe|c(?:ca|ab)bee?|ab(?:b(?:bee?|ee?)|ee?)|cabee?|cc?)?|II(?:\.\s*Mac(?:cab(?:(?:bee?o|eo)|ee[eo])|ab(?:be(?:e[eo]|o)|e(?:e[eo]|o)))|\s*Mac(?:cab(?:(?:bee?o|eo)|ee[eo])|ab(?:be(?:e[eo]|o)|e(?:e[eo]|o))))|2nd\.?\s*Mac(?:cabeee|abb?eee)|2(?:\.[oº]|º)\.?\s*Macab(?:bee?o|ee?o)|2o\.\s*Mac(?:cab(?:bee?o|ee?o)|abbee?o|abee?o)|II(?:\.\s*(?:Mac(?:cab(?:(?:be(?:e[es]|s)|e[is])|ees)|ab(?:bee?s|e(?:es|[is])))|Макавеи)|\s*(?:Mac(?:cab(?:(?:be(?:e[es]|s)|e[is])|ees)|ab(?:bee?s|e(?:es|[is])))|Макавеи))|(?:II\.?\s*W|2\.?\s*W)amakabayo|(?:II\.?\s*Makabej|2\.?\s*Makabej)sk[aá]|(?:II\.?\s*Makabej|2\.?\s*Makabej)cov|(?:II\.?\s*Maccc|2\.?\s*Maccc)abbbe|(?:(?:II\.?\s*Maccc|2\.?\s*Maccc)abb|(?:II\.?\s*Maccabbb|2\.?\s*Maccabbb))e[es]|(?:II\.?\s*Maccc|2\.?\s*Maccc)abe(?:e[es]|s)|(?:II\.?\s*Macabbb|2\.?\s*Macabbb)e(?:e[es]|s)|2o\s*Mac(?:cab(?:bee?os|ee?os)|abbee?os|abee?os)|II\.?\s*Makkabee[eë]n|2e\.?\s*Makkabee[eë]n|(?:II\.?\s*Макаб|2\.?\s*Макаб)ејаца|(?:2(?:(?:(?:-?е\.?\s*Макк|\.\s*Макк)|\s*Макк)авее|(?:-?я|[ея])\.?\s*Маккавее)|II(?:\.\s*Макаве[ії]|\s*Макаве[ії])|2\.?\s*Макаве[ії])в|II(?:\.\s*Ma(?:c(?:c(?:ab(?:bee?|e))?|cabee|ab(?:bee?|ee?))?|k(?:abe|k)?)|\s*Ma(?:c(?:c(?:ab(?:bee?|e))?|cabee|ab(?:bee?|ee?))?|k(?:abe|k)?))|(?:(?:II\.?\s*Maccc|2\.?\s*Maccc)abb|(?:II\.?\s*Maccabbb|2\.?\s*Maccabbb))e|(?:II\.?\s*Maccc|2\.?\s*Maccc)abee?|(?:II\.?\s*Macabbb|2\.?\s*Macabbb)ee?|2\.?\s*Maccab(?:bee?o|eo)|2o\s*Mac(?:cab(?:bee?o|ee?o)|abbee?o|abee?o)|2\.?\s*Maccab(?:be(?:e[es]|s)|e[is])|Β['ʹʹ΄’]\s*Μακκαβα[ίι]ων|Wamakabayo\s*II|Μακκαβα[ίι]ων\s*Β['ʹʹ΄’]|2-?е\.?\s*Макаве[ії]в|2\.?\s*Macc(?:ab(?:bee?|e))?|2\.?\s*Maccabee[eo]|2\.?\s*Macab(?:be(?:e[eo]|o)|e(?:e[eo]|o))|2\.?\s*Maccabees|2\.?\s*Macab(?:bee?s|e(?:es|[is]))|2°\.\s*Maccabei|2a\.\s*Macabeus|2(?:\.\s*Makkab[aä]|\s*Makkab[aä])er|ספר\s*מקבים\s*ב['’]|(?:II\.?\s*Макавеј|2\.?\s*Макавеј)а|2\.?\s*Maccabee|2\.?\s*Macab(?:bee?|ee?)|M[aá]sodik\s*Mak|2(?:\s*(?:மக்கபேயர்|المكابيين|Mc[bh]|Мк|مك)|\.\s*มัคคาบี|\s*มัคคาบี|Macc|마카)|2°\s*Maccabei|2a\s*Macabeus|חשמונאים\s*ב['’]|And(?:en|re)\s*Makk|Tweede\s*Mak|2\.?\s*Макавеи|2\.?\s*Makabe|Druh(?:[aá]|[yý])\s*Mak|II\.?\s*Maccc|2\.?\s*Maccc|마카베오(?:기\s*하권|하)|2(?:\.\s*Ma(?:kk?|c)|\s*(?:(?:M(?:a(?:c(?:h|k)?)?|c)?|makk|Макк?|மக்)|Makk?))|2e\.?\s*Mak|Β['ʹʹ΄’]\s*Μακκ|מקבים\s*ב|マカ(?:[ヒビ]ー第二書|[ハバ]イ(?:\s*2|記[2下]|下))|《瑪加伯下》|《瑪加伯下|瑪加伯下》|瑪加伯下))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["3Macc"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:(?:Tr(?:e[cć]a\s*knjiga\s*o\s*Makabejcim|zeci(?:a\s*Ks(?:i[eę]g[ai]\s*Machabejsk|\.?\s*Machabejsk)|\s*Ks(?:i[eę]g[ai]\s*Machabejsk|\.?\s*Machabejsk)))|(?:III\.?\s*K|3\.?\s*K)s(?:i[eę]g[ai]\s*Machabejsk|\.?\s*Machabejsk))a|K(?:itabu\s*cha\s*Wamakabayo\s*III|olmas\s*makkabilaiskirja)|Тре(?:т(?:ья\s*книга\s*Маккаве[ий]ская|о\s*(?:книга\s*на\s*Макавеите|Макавеи)|[яє]\s*(?:книга\s*Макаве[ії]в|Макаве[ії]в)|а\s*Макавеи)|та\s*книга\s*Макаве[ий]ска|ћ(?:ом\s*Мака(?:веј(?:ск)?|бејац)а|а\s*Мака(?:веј(?:ск)?|бејац)а))|T(?:re(?:t(?:(?:ia\s*(?:kniha\s*)?Mac|i\s*Mac)|í\s*Mac)habejcov|dje\s*Makkabæerbog)|er(?:z(?:o\s*(?:libro\s*dei\s*)?Maccabei|a\s*Maccabei)|ce(?:r(?:o\s*Mac(?:cab(?:bee?os|ee?os)|ab(?:bee?os|ee?os))|\s*Mac(?:cab(?:bee?os|ee?os)|ab(?:bee?os|ee?os)))|ir[ao]\s*Macabeus))|roisi[eè]me(?:s\s*Maccab[eé]e|\s*Maccab[eé]e)s|hird\s*Mac(?:c(?:cabbbe|abee?s)|c(?:ca|ab)bbe[es]|c(?:ca|ab)be(?:e[es]|s)|ab(?:b(?:be(?:e[es]|s)|ee?s)|ee?s))|ret[ií]\s*Makabejsk[aá]|řet[ií]\s*Makabejsk[aá]|hird\s*Mac(?:cabeee|abb?eee)s|atu\s*Wamakabayo)|Liber\s*III\s*Maccabaeorum|(?:Liber\s*Maccabaeorum|Ma(?:chabaeorum|kkabeusok))\s*III|(?:Tredje\s*Mackab[eé]erboke|3(?:e\.?\s*Mack|\.\s*Mack)ab[eé]erboke|3(?:\s*Mackab[eé]erboke|(?:\.\s*Makkabee[eë]|\s*Makkabee[eë])))n|(?:III\.?\s*m|3\.\s*m)akkabilaiskirja|(?:I(?:katlong\s*Mg|II\.?\s*Mg)a\s*Macabe|3\.?\s*Mga\s*Macabe)o|(?:Harmadik\s*Makkabeuso|(?:Tredje\s*Makkabeer|3\.?\s*Makkabeer)bo|(?:III\.?\s*Makkabeu|3\.?\s*Makkabeu)so|Tatu\s*Ma)k|3-?(?:тє|а)\.\s*(?:книга\s*Макаве[ії]в|Макаве[ії]в)|(?:3(?:-?е\.?\s*к|\.?\s*к)|III\.?\s*к)нига\s*Макаве[ії]в|3-?(?:тє|а)\s*(?:книга\s*Макаве[ії]в|Макаве[ії]в)|T(?:ercer(?:o\s*Mac(?:cab(?:bee?o|ee?o)|ab(?:bee?o|ee?o))|\s*Mac(?:cab(?:bee?o|ee?o)|ab(?:bee?o|ee?o)))|hird\s*Mac(?:c(?:ca|ab)bbe|c(?:ca|ab)bee?|ab(?:b(?:bee?|ee?)|ee?)|cabee?|cc?)?|hird\s*Mac(?:cabeee|abb?eee)|redje\s*Makk|ret[ií]\s*Mak|řet[ií]\s*Mak)|Þriðja\s*Makkabeab[oó]k|3\s*makkabilaiskirja|(?:Ikatlong\s*Macabe|3o\.?\s*Macabee)os|(?:III(?:\.\s*Mach?aba|\s*Mach?aba)|(?:3\.\s*Macha|(?:3\.?\s*Maca|3\s*Macha))ba)eorum|(?:Ikatlong\s*Macabe|3o\.?\s*Macabee)o|(?:III\.?\s*Machabe|3\.?\s*Machabe)jcov|3\s*k\.?\s*Machabejcov|(?:III(?:\.\s*Mac(?:cab(?:(?:bee?o|eo)|ee[eo])|ab(?:be(?:e[eo]|o)|e(?:e[eo]|o)))|\s*Mac(?:cab(?:(?:bee?o|eo)|ee[eo])|ab(?:be(?:e[eo]|o)|e(?:e[eo]|o))))|3rd\.\s*Mac(?:cabeee|abb?eee)|3\.?\s*Maccab(?:bee?o|eo)|3rd\s*Mac(?:cabeee|abb?eee)|3\.?\s*Maccabee[eo]|3\.?\s*Macab(?:be(?:e[eo]|o)|e(?:e[eo]|o))|3o\.?\s*Macabeo)s|3(?:\.[oº]|º)\.\s*Mac(?:cab(?:bee?os|ee?os)|ab(?:bee?os|ee?os))|D(?:erde\s*Makkabee[eë]n|ritte\s*Makkab[aä]er)|III(?:\.\s*Mac(?:cab(?:(?:bee?o|eo)|ee[eo])|ab(?:be(?:e[eo]|o)|e(?:e[eo]|o)))|\s*Mac(?:cab(?:(?:bee?o|eo)|ee[eo])|ab(?:be(?:e[eo]|o)|e(?:e[eo]|o))))|3(?:\.[oº]|º)\.\s*Mac(?:cab(?:bee?o|ee?o)|ab(?:bee?o|ee?o))|III(?:\.\s*(?:Mac(?:cab(?:(?:be(?:e[es]|s)|e[is])|ees)|ab(?:bee?s|e(?:es|[is])))|Макавеи)|\s*(?:Mac(?:cab(?:(?:be(?:e[es]|s)|e[is])|ees)|ab(?:bee?s|e(?:es|[is])))|Макавеи))|(?:III\.?\s*W|3\.?\s*W)amakabayo|(?:III\.?\s*Maccc|3\.?\s*Maccc)abbbe|(?:(?:III\.?\s*Maccc|3\.?\s*Maccc)abb|(?:III\.?\s*Maccabbb|3\.?\s*Maccabbb))e[es]|(?:III\.?\s*Maccc|3\.?\s*Maccc)abe(?:e[es]|s)|(?:III\.?\s*Macabbb|3\.?\s*Macabbb)e(?:e[es]|s)|3rd\.\s*Mac(?:c(?:cabbbe|abee?s)|c(?:ca|ab)bbe[es]|c(?:ca|ab)be(?:e[es]|s)|ab(?:b(?:be(?:e[es]|s)|ee?s)|ee?s))|3\.?\s*Makkabæerbog|(?:III\.?\s*Makabej|3\.?\s*Makabej)sk[aá]|3o\.?\s*Maccab(?:bee?os|ee?os)|3(?:\.[oº]|º)\s*Mac(?:cab(?:bee?os|ee?os)|ab(?:bee?os|ee?os))|(?:3[eè]me\.\s*Maccab[eé]e|(?:III\.?\s*Maccabé|3\.?\s*Maccabé)e|3[eè]me\s*Maccab[eé]e|III\.?\s*Macabeu|3e\.?\s*Maccab[eé]e|3o\.?\s*Macabeu|3\.?\s*Macabeu)s|III\.?\s*Makkabee[eë]n|(?:III\.?\s*Макавеј|3\.?\s*Макавеј)ска|(?:III\.?\s*Макаб|3\.?\s*Макаб)ејаца|المكابين\s*الثالث|III(?:\.\s*Ma(?:c(?:c(?:ab(?:bee?|e))?|cabee|ab(?:bee?|ee?))?|k(?:abe|k)?)|\s*Ma(?:c(?:c(?:ab(?:bee?|e))?|cabee|ab(?:bee?|ee?))?|k(?:abe|k)?))|(?:(?:III\.?\s*Maccc|3\.?\s*Maccc)abb|(?:III\.?\s*Maccabbb|3\.?\s*Maccabbb))e|(?:III\.?\s*Maccc|3\.?\s*Maccc)abee?|(?:III\.?\s*Macabbb|3\.?\s*Macabbb)ee?|3rd\.\s*Mac(?:c(?:ca|ab)bbe|c(?:ca|ab)bee?|ab(?:b(?:bee?|ee?)|ee?)|cabee?|cc?)?|3rd\.\s*Mac(?:cabeee|abb?eee)|3o\.?\s*Maccab(?:bee?o|ee?o)|3(?:\.[oº]|º)\s*Mac(?:cab(?:bee?o|ee?o)|ab(?:bee?o|ee?o))|3rd\s*Mac(?:c(?:cabbbe|abee?s)|c(?:ca|ab)bbe[es]|c(?:ca|ab)be(?:e[es]|s)|ab(?:b(?:be(?:e[es]|s)|ee?s)|ee?s))|3o\.?\s*Macabbee?os|3e\.?\s*Makkabee[eë]n|Wamakabayo\s*III|(?:3(?:(?:(?:-?е\.?\s*Макк|\.\s*Макк)|\s*Макк)авее|(?:-?я|[ея])\.?\s*Маккавее)|III(?:\.\s*Макаве[ії]|\s*Макаве[ії])|3\.?\s*Макаве[ії])в|3rd\s*Mac(?:c(?:ca|ab)bbe|c(?:ca|ab)bee?|ab(?:b(?:bee?|ee?)|ee?)|cabee?|cc?)?|3\.?\s*Maccab(?:bee?o|eo)|3rd\s*Mac(?:cabeee|abb?eee)|3o\.?\s*Macabbee?o|3\.?\s*Maccab(?:be(?:e[es]|s)|e[is])|Γ['ʹʹ΄’]\s*Μακκαβα[ίι]ων|Μακκαβα[ίι]ων\s*Γ['ʹʹ΄’]|3-?е\.?\s*Макаве[ії]в|(?:III\.?\s*Макавеј|3\.?\s*Макавеј)а|3\.?\s*Macc(?:ab(?:bee?|e))?|3\.?\s*Maccabee[eo]|3\.?\s*Macab(?:be(?:e[eo]|o)|e(?:e[eo]|o))|Harmadik\s*Mak|3\.?\s*Maccabees|3\.?\s*Macab(?:bee?s|e(?:es|[is]))|3a\.\s*Macabeus|3°\.\s*Maccabei|3(?:\.\s*Makkab[aä]|\s*Makkab[aä])er|ספר\s*מקבים\s*ג['’]|3\.?\s*Maccabee|3\.?\s*Macab(?:bee?|ee?)|3o\.?\s*Macabeo|3(?:\s*(?:(?:மக்கபேயர்|Mc[bh]|Мк)|มัคคาบี)|\.\s*มัคคาบี|마카)|3a\s*Macabeus|3°\s*Maccabei|חשמונאים\s*ג['’]|III\.?\s*Maccc|3\.?\s*Макавеи|3\.?\s*Makabe|Derde\s*Mak|3\.?\s*Maccc|3(?:\.\s*Ma(?:kk?|c)|\s*(?:(?:M(?:ac(?:h|k)?|c)?|makk|Макк?|மக்)|Makk?))|3e\.?\s*Mak|Γ['ʹʹ΄’]\s*Μακκ|《3Macc》|מקבים\s*ג|マカ(?:[ヒビ]ー第三書|[ハバ]イ[\s*記]3)|마카베오\s*3서|《3Macc|3Macc》|3Macc))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["4Macc"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:Четв(?:ърт(?:а\s*(?:книга\s*на\s*Макавеите|Макавеи)|о\s*Макавеи)|ерта\s*(?:книга\s*Макаве[ії]в|Макаве[ії]в)|рта\s*Мака(?:веј(?:ск)?|бејац)а)|Czwarta\s*Ks(?:i[eę]g[ai]\s*Machabejska|\.?\s*Machabejska)|Qua(?:rt(?:o\s*(?:libro\s*dei\s*)?Maccabei|a\s*Maccabei)|tri[eè]me(?:s\s*Maccab[eé]es|\s*Maccab[eé]es)|rt[ao]\s*Macabeus)|[SŠ]tvrt[aá]\s*(?:kniha\s*)?Machabejcov|Kitabu\s*cha\s*Wamakabayo\s*IV|(?:Nelj[aä]s\s*makkabilaiskirj|(?:(?:IV\.?\s*m|4\.\s*m)|4\s*m)akkabilaiskirj)a|(?:IV\.?\s*K|4\.?\s*K)s(?:i[eę]g[ai]\s*Machabejska|\.?\s*Machabejska)|(?:Fj[aä]rde\s*Mackab[eé]erboke|4(?:\.\s*Mackab[eé]erboke|(?:\s*Mackab[eé]erboke|(?:\.\s*Makkabee[eë]|\s*Makkabee[eë]))))n|Liber\s*IV\s*Maccabaeorum|(?:Liber\s*Maccabaeorum|Ma(?:chabaeorum|kkabeusok))\s*IV|(?:I(?:kaapat\s*Mg|V\.?\s*Mg)a\s*Macabe|4\.?\s*Mga\s*Macabe)o|F(?:j(?:erde\s*Makkab(?:æerbog|eerbok)|[oó]rða\s*Makkabeab[oó]k)|ourth\s*Mac(?:c(?:cabbbe|abe(?:ee?s|s))|c(?:ca|ab)bbe[es]|c(?:ca|ab)be(?:e[es]|s)|ab(?:b(?:e(?:ee?s|s)|be(?:e[es]|s))|e(?:ee?s|s))))|(?:Cuarto\s*Mac(?:cab(?:bee?o|ee?o)|ab(?:bee?o|ee?o))|(?:Ikaapat\s*Macabe|4o\.?\s*Macabee)o|4(?:\.[oº]|º)\.\s*Mac(?:cab(?:bee?o|ee?o)|ab(?:bee?o|ee?o))|IV(?:\.\s*Mac(?:cab(?:(?:bee?o|eo)|ee[eo])|ab(?:be(?:e[eo]|o)|e(?:e[eo]|o)))|\s*Mac(?:cab(?:(?:bee?o|eo)|ee[eo])|ab(?:be(?:e[eo]|o)|e(?:e[eo]|o))))|4o\.?\s*Maccab(?:bee?o|ee?o)|4(?:\.[oº]|º)\s*Mac(?:cab(?:bee?o|ee?o)|ab(?:bee?o|ee?o))|4\.?\s*Maccab(?:bee?o|eo)|4o\.?\s*Macabbee?o|4\.?\s*Maccabee[eo]|4\.?\s*Macab(?:be(?:e[eo]|o)|e(?:e[eo]|o))|4o\.?\s*Macabeo)s|(?:IV\.?\s*к|4\.?\s*к)нига\s*Макаве[ії]в|Cuarto\s*Mac(?:cab(?:bee?o|ee?o)|ab(?:bee?o|ee?o))|Vier(?:de\s*Makkabee[eë]n|te\s*Makkab[aä]er)|Ctvrt[aá]\s*Makabejsk[aá]|Čtvrt[aá]\s*Makabejsk[aá]|F(?:ourth\s*Mac(?:cabe(?:ee?)?|c(?:ca|ab)bbe|c(?:ca|ab)bee?|ab(?:b(?:e(?:ee?)?|bee?)|e(?:ee?)?)|cc?)?|jerde\s*Makk)|4\s*k\.\s*Machabejcov|(?:IV(?:\.\s*Mach?aba|\s*Mach?aba)|(?:4\.\s*Macha|(?:4\.?\s*Maca|4\s*Macha))ba)eorum|(?:Ikaapat\s*Macabe|4o\.?\s*Macabee)o|4(?:\.[oº]|º)\.\s*Mac(?:cab(?:bee?o|ee?o)|ab(?:bee?o|ee?o))|4th\.\s*Mac(?:c(?:cabbbe|abe(?:ee?s|s))|c(?:ca|ab)bbe[es]|c(?:ca|ab)be(?:e[es]|s)|ab(?:b(?:e(?:ee?s|s)|be(?:e[es]|s))|e(?:ee?s|s)))|4\.?\s*Makkabæerbog|(?:(?:IV\.?\s*Makkabeus|4\.?\s*Makkabeus)o|4\.?\s*Makkabeerbo|Nne\s*Ma)k|4(?:e(?:me)?|ème)\.\s*Maccab[eé]es|(?:IV\.?\s*Machabe|4\.?\s*Machabe)jcov|4\s*k\s*Machabejcov|المكابين\s*الرابع|IV(?:\.\s*Mac(?:cab(?:(?:bee?o|eo)|ee[eo])|ab(?:be(?:e[eo]|o)|e(?:e[eo]|o)))|\s*Mac(?:cab(?:(?:bee?o|eo)|ee[eo])|ab(?:be(?:e[eo]|o)|e(?:e[eo]|o))))|4o\.?\s*Maccab(?:bee?o|ee?o)|4(?:\.[oº]|º)\s*Mac(?:cab(?:bee?o|ee?o)|ab(?:bee?o|ee?o))|4th\.\s*Mac(?:cabe(?:ee?)?|c(?:ca|ab)bbe|c(?:ca|ab)bee?|ab(?:b(?:e(?:ee?)?|bee?)|e(?:ee?)?)|cc?)?|IV(?:\.\s*(?:Mac(?:cab(?:(?:be(?:e[es]|s)|e[is])|ees)|ab(?:bee?s|e(?:es|[is])))|Макавеи)|\s*(?:Mac(?:cab(?:(?:be(?:e[es]|s)|e[is])|ees)|ab(?:bee?s|e(?:es|[is])))|Макавеи))|(?:IV\.?\s*W|4\.?\s*W)amakabayo|Nne\s*Wamakabayo|(?:IV\.?\s*Maccc|4\.?\s*Maccc)abbbe|(?:(?:IV\.?\s*Maccc|4\.?\s*Maccc)abb|(?:IV\.?\s*Maccabbb|4\.?\s*Maccabbb))e[es]|(?:IV\.?\s*Maccc|4\.?\s*Maccc)abe(?:e[es]|s)|(?:IV\.?\s*Macabbb|4\.?\s*Macabbb)e(?:e[es]|s)|4th\s*Mac(?:c(?:cabbbe|abe(?:ee?s|s))|c(?:ca|ab)bbe[es]|c(?:ca|ab)be(?:e[es]|s)|ab(?:b(?:e(?:ee?s|s)|be(?:e[es]|s))|e(?:ee?s|s)))|IV\.?\s*Makkabee[eë]n|(?:IV\.?\s*Makabej|4\.?\s*Makabej)sk[aá]|4(?:e(?:me)?|ème)\s*Maccab[eé]es|(?:IV\.?\s*Макавеј|4\.?\s*Макавеј)ска|(?:IV\.?\s*Макаб|4\.?\s*Макаб)ејаца|(?:4(?:-?[ея]\.?\s*Маккавее|[ея]\.?\s*Маккавее|\.?\s*Маккавее)|IV(?:\.\s*Макаве[ії]|\s*Макаве[ії])|4\.?\s*Макаве[ії])в|IV(?:\.\s*Ma(?:c(?:c(?:ab(?:bee?|e))?|cabee|ab(?:bee?|ee?))?|k(?:abe|k)?)|\s*Ma(?:c(?:c(?:ab(?:bee?|e))?|cabee|ab(?:bee?|ee?))?|k(?:abe|k)?))|4\.?\s*Maccab(?:bee?o|eo)|4o\.?\s*Macabbee?o|(?:(?:IV\.?\s*Maccc|4\.?\s*Maccc)abb|(?:IV\.?\s*Maccabbb|4\.?\s*Maccabbb))e|(?:IV\.?\s*Maccc|4\.?\s*Maccc)abee?|(?:IV\.?\s*Macabbb|4\.?\s*Macabbb)ee?|4th\s*Mac(?:cabe(?:ee?)?|c(?:ca|ab)bbe|c(?:ca|ab)bee?|ab(?:b(?:e(?:ee?)?|bee?)|e(?:ee?)?)|cc?)?|4\.?\s*Maccab(?:be(?:e[es]|s)|e[is])|Δ['ʹʹ΄’]\s*Μακκαβα[ίι]ων|(?:IV\.?\s*Maccabé|4\.?\s*Maccabé)es|Wamakabayo\s*IV|Μακκαβα[ίι]ων\s*Δ['ʹʹ΄’]|4\.?\s*Macc(?:ab(?:bee?|e))?|4\.?\s*Maccabee[eo]|4\.?\s*Macab(?:be(?:e[eo]|o)|e(?:e[eo]|o))|4\.?\s*Maccabees|4\.?\s*Macab(?:bee?s|e(?:es|[is]))|4(?:\.\s*Makkab[aä]|\s*Makkab[aä])er|4°\.\s*Maccabei|(?:4o\.?\s*Macabeu|IV\.?\s*Macabeu|4a\.?\s*Macabeu|4\.?\s*Macabeu)s|ספר\s*מקבים\s*ד['’]|(?:IV\.?\s*Макавеј|4\.?\s*Макавеј)а|4\.?\s*Maccabee|4\.?\s*Macab(?:bee?|ee?)|4o\.?\s*Macabeo|4(?:\s*(?:(?:மக்கபேயர்|Mc[bh]|Мк)|มัคคาบี)|\.\s*มัคคาบี|마카)|4°\s*Maccabei|חשמונאים\s*ד['’]|Vierde\s*Mak|Ctvrt[aá]\s*Mak|Čtvrt[aá]\s*Mak|4\.?\s*Макавеи|4\.?\s*Makabe|IV\.?\s*Maccc|4\.?\s*Maccc|4(?:\.\s*Ma(?:kk?|c)|\s*(?:(?:M(?:ac(?:h|k)?|c)?|makk|Макк?|மக்)|Makk?))|Δ['ʹʹ΄’]\s*Μακκ|《4Macc》|מקבים\s*ד|マカ(?:[ヒビ]ー第四書|[ハバ]イ[\s*記]4)|마카베오\s*4서|《4Macc|4Macc》|4Macc))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["1Macc"],
        testament: "a",
        regexp: /(?:^|(?<=[^\p{L}\p{N}])(?<!\d:(?=\d)))((?:(?:Ensimm[aä]inen\s*makkabilaiskirj|(?:(?:1\.\s*m|I\.?\s*m)|1\s*m)akkabilaiskirj)a|P(?:ierwsz[aey]\s*Ks(?:i[eę]g[ai]\s*Machabejska|\.?\s*Machabejska)|r(?:va\s*knjiga\s*o\s*Makabejcima|(?:im(?:o\s*(?:libro\s*dei\s*)?Maccabei|a\s*Maccabei)|v(?:[aá]\s*kniha\s*Machabejcov|[yý]\s*(?:list\s*)?Machabejcov|n[ií]\s*Makabejsk[aá]|[aá]\s*Machabejcov|[aá]\s*Makabejcov)|emi(?:er(?:e(?:s\s*Maccab[eé]es|\s*Maccab[eé]es)|(?:s\s*Maccab[eé]es|\s*Maccab[eé]es))|ère(?:s\s*Maccab[eé]es|\s*Maccab[eé]es))|imeir[ao]\s*Macabeus)))|П(?:ер(?:вая\s*книга\s*Маккаве[ий]ская|ш[ае]\s*(?:книга\s*Макаве[ії]в|Макаве[ії]в))|ърв(?:а\s*(?:книга\s*(?:на\s*Макавеите|Макаве[ий]ска)|Макавеи)|о\s*Макавеи)|(?:рва\s*Мака(?:бејац|веј)|рва\s*Макавејск)а)|(?:(?:Kitabu\s*cha\s*)?Wamakabayo|Makkabeusok)\s*I|F(?:[oö]rsta\s*Mackab[eé]erboken|ørste\s*Makkabæerbog|irst\s*Mac(?:c(?:cabbbe|abee?s)|c(?:ca|ab)bbe[es]|c(?:ca|ab)be(?:e[es]|s)|ab(?:b(?:be(?:e[es]|s)|ee?s)|ee?s)))|(?:1\.?\s*K|I\.?\s*K)s(?:i[eę]g[ai]\s*Machabejska|\.?\s*Machabejska)|Liber\s*(?:I\s*Maccabaeorum|Maccabaeorum\s*I)|1-?(?:ше|а)\.\s*(?:книга\s*Макаве[ії]в|Макаве[ії]в)|(?:F(?:ørste\s*Makkabeerbo|yrsta\s*Makkabeab[oó])|(?:(?:Els[oő]\s*Makkabeus|(?:1\.?\s*Makkabeu|I\.?\s*Makkabeu)s)|1\.?\s*Makkabeerb)o)k|(?:Primer(?:o\s*Mac(?:cabb?ee|abb?ee)|\s*Mac(?:cabb?ee|abb?ee))|1(?:\.[oº]|º)\.\s*Mac(?:cabb?ee|abb?ee)|1o\.?\s*Maccabb?ee|1(?:\.[oº]|º)\s*Mac(?:cabb?ee|abb?ee)|1o\.?\s*Macabbee|1o\.?\s*Macabee)os|(?:1(?:-?е\.?\s*к|\.?\s*к)|I\.?\s*к)нига\s*Макаве[ії]в|1-?(?:ше|а)\s*(?:книга\s*Макаве[ії]в|Макаве[ії]в)|(?:Primer(?:o\s*Mac(?:cabb?ee|abb?ee)|\s*Mac(?:cabb?ee|abb?ee))|1(?:\.[oº]|º)\.\s*Mac(?:cabb?ee|abb?ee)|1o\.?\s*Maccabb?ee|1(?:\.[oº]|º)\s*Mac(?:cabb?ee|abb?ee)|1o\.?\s*Macabbee|1o\.?\s*Macabee)o|(?:Primer(?:o\s*Mac(?:cabb?eo|abb?eo)|\s*Mac(?:cabb?eo|abb?eo))|First\s*Mac(?:cabeee|abb?eee)|1st\.\s*Mac(?:cabeee|abb?eee)|1(?:\.[oº]|º)\.\s*Mac(?:cabb?eo|abb?eo)|1\.?\s*Maccab(?:bee?o|eo)|I(?:\.\s*Mac(?:cab(?:(?:bee?o|eo)|ee[eo])|ab(?:be(?:e[eo]|o)|e(?:e[eo]|o)))|\s*Mac(?:cab(?:(?:bee?o|eo)|ee[eo])|ab(?:be(?:e[eo]|o)|e(?:e[eo]|o))))|1st\s*Mac(?:cabeee|abb?eee)|1o\.?\s*Maccabb?eo|1(?:\.[oº]|º)\s*Mac(?:cabb?eo|abb?eo)|1\.?\s*Maccabee[eo]|1\.?\s*Macab(?:be(?:e[eo]|o)|e(?:e[eo]|o))|1o\.?\s*Macabbeo|1o\.?\s*Macabeo)s|سفر\s*المكابين\s*الأول|Primer(?:o\s*Mac(?:cabb?eo|abb?eo)|\s*Mac(?:cabb?eo|abb?eo))|(?:Eerste\s*Makkabee[eë]|1e\.\s*Makkabee[eë]|1(?:\.\s*Makkabee[eë]|\s*Makkabee[eë])|I\.?\s*Makkabee[eë]|1e\s*Makkabee[eë])n|1\.\s*Mackab[eé]erboken|(?:Kwanza\s*W|(?:1\.?\s*W|I\.?\s*W))amakabayo|Una(?:ng\s*M(?:ga\s*Macabeo|acabeos)|\s*M(?:ga\s*Macabeo|acabeos))|1\s*Mackab[eé]erboken|1\s*k\.\s*Machabejcov|F(?:irst\s*Mac(?:c(?:ca|ab)bbe|c(?:ca|ab)bee?|ab(?:b(?:bee?|ee?)|ee?)|cabee?|cc?)?|ørste\s*Makk)|First\s*Mac(?:cabeee|abb?eee)|Erste\s*Makkab[aä]er|1st\.\s*Mac(?:c(?:cabbbe|abee?s)|c(?:ca|ab)bbe[es]|c(?:ca|ab)be(?:e[es]|s)|ab(?:b(?:be(?:e[es]|s)|ee?s)|ee?s))|1\.?\s*Makkabæerbog|1\s*k\s*Machabejcov|1(?:(?:ere?|re)|ère)\.\s*Maccab[eé]es|(?:(?:1\.\s*Macha|(?:1\.?\s*Maca|1\s*Macha))ba|I(?:\.\s*Mach?aba|\s*Mach?aba))eorum|1st\.\s*Mac(?:c(?:ca|ab)bbe|c(?:ca|ab)bee?|ab(?:b(?:bee?|ee?)|ee?)|cabee?|cc?)?|1st\.\s*Mac(?:cabeee|abb?eee)|1(?:\.[oº]|º)\.\s*Mac(?:cabb?eo|abb?eo)|1st\s*Mac(?:c(?:cabbbe|abee?s)|c(?:ca|ab)bbe[es]|c(?:ca|ab)be(?:e[es]|s)|ab(?:b(?:be(?:e[es]|s)|ee?s)|ee?s))|(?:1\.?\s*Machabe|I\.?\s*Machabe)jcov|1(?:(?:ere?|re)|ère)\s*Maccab[eé]es|(?:1\.?\s*Mg|I\.?\s*Mg)a\s*Macabeo|Machabaeorum\s*I|(?:1(?:(?:(?:-?е\.?\s*Макк|\.\s*Макк)|\s*Макк)авее|(?:-?я|[ея])\.?\s*Маккавее)|1\.?\s*Макаве[ії]|I(?:\.\s*Макаве[ії]|\s*Макаве[ії]))в|المكابين\s*الأول|1st\s*Mac(?:c(?:ca|ab)bbe|c(?:ca|ab)bee?|ab(?:b(?:bee?|ee?)|ee?)|cabee?|cc?)?|1\.?\s*Maccab(?:bee?o|eo)|I(?:\.\s*Mac(?:cab(?:(?:bee?o|eo)|ee[eo])|ab(?:be(?:e[eo]|o)|e(?:e[eo]|o)))|\s*Mac(?:cab(?:(?:bee?o|eo)|ee[eo])|ab(?:be(?:e[eo]|o)|e(?:e[eo]|o))))|1st\s*Mac(?:cabeee|abb?eee)|1o\.?\s*Maccabb?eo|1(?:\.[oº]|º)\s*Mac(?:cabb?eo|abb?eo)|Una(?:ng)?\s*Macabeo|1\.?\s*Maccab(?:be(?:e[es]|s)|e[is])|I(?:\.\s*(?:Mac(?:cab(?:(?:be(?:e[es]|s)|e[is])|ees)|ab(?:bee?s|e(?:es|[is])))|Макавеи)|\s*(?:Mac(?:cab(?:(?:be(?:e[es]|s)|e[is])|ees)|ab(?:bee?s|e(?:es|[is])))|Макавеи))|(?:1\.?\s*Maccc|I\.?\s*Maccc)abbbe|(?:(?:1\.?\s*Maccc|I\.?\s*Maccc)abb|(?:1\.?\s*Maccabbb|I\.?\s*Maccabbb))e[es]|(?:1\.?\s*Maccc|I\.?\s*Maccc)abe(?:e[es]|s)|(?:1\.?\s*Macabbb|I\.?\s*Macabbb)e(?:e[es]|s)|(?:1\.?\s*Makabej|I\.?\s*Makabej)sk[aá]|Α['ʹʹ΄’]\s*Μακκαβα[ίι]ων|Μακκαβα[ίι]ων\s*Α['ʹʹ΄’]|(?:1\.?\s*Макаб|I\.?\s*Макаб)ејаца|(?:1\.?\s*Макавеј|I\.?\s*Макавеј)ска|1-?е\.?\s*Макаве[ії]в|1\.?\s*Macc(?:ab(?:bee?|e))?|I(?:\.\s*Ma(?:c(?:c(?:ab(?:bee?|e))?|cabee|ab(?:bee?|ee?))?|k(?:abe|k)?)|\s*Ma(?:c(?:c(?:ab(?:bee?|e))?|cabee|ab(?:bee?|ee?))?|k(?:abe|k)?))|(?:(?:1\.?\s*Maccc|I\.?\s*Maccc)abb|(?:1\.?\s*Maccabbb|I\.?\s*Maccabbb))e|(?:1\.?\s*Maccc|I\.?\s*Maccc)abee?|(?:1\.?\s*Macabbb|I\.?\s*Macabbb)ee?|1\.?\s*Maccabee[eo]|1\.?\s*Macab(?:be(?:e[eo]|o)|e(?:e[eo]|o))|1o\.?\s*Macabbeo|1\.?\s*Maccabees|1\.?\s*Macab(?:bee?s|e(?:es|[is]))|1(?:\.\s*Makkab[aä]|\s*Makkab[aä])er|1°\.\s*Maccabei|(?:1o\.?\s*Macabeu|1a\.\s*Macabeu|1\.?\s*Macabeu|I\.?\s*Macabeu|1a\s*Macabeu)s|(?:1\.?\s*Maccabé|I\.?\s*Maccabé|Maccabe)es|ספר\s*מקבים\s*א['’]|1\.?\s*Maccabee|1\.?\s*Macab(?:bee?|ee?)|1o\.?\s*Macabeo|1(?:\s*(?:மக்கபேயர்|المكابيين|Mc[bh]|Мк|مك)|\.\s*มัคคาบี|\s*มัคคาบี|Macc|마카)|1°\s*Maccabei|חשמונאים\s*א['’]|(?:1\.?\s*Макавеј|I\.?\s*Макавеј)а|E(?:erste\s*Mak|ls[oő]\s*Mak)|1\.?\s*Макавеи|Kwanza\s*Mak|1\.?\s*Makabe|Prvn[ií]\s*Mak|1\.?\s*Maccc|I\.?\s*Maccc|마카베오(?:기\s*상권|상)|1(?:\.\s*Ma(?:kk?|c)|\s*(?:(?:M(?:a(?:c(?:h|k)?)?|c)?|makk|Макк?|மக்)|Makk?))|1e\.\s*Mak|Α['ʹʹ΄’]\s*Μακκ|מקבים\s*א|マカ(?:[ヒビ]ー第一書|[ハバ]イ(?:\s*1|記[1上]|上))|1e\s*Mak|《瑪加伯上》|《瑪加伯上|瑪加伯上》|瑪加伯上))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Judg"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))(Thủ\s*lãnh|(?:ந(?:ியாயாதிபதிகள(?:ின்\s*புத்தக|்\s*ஆகம)ம்|ீதி(?:த்\s*தலைவர்|பதி)கள்)|ବିଗ୍ଭରକର୍ତ୍ତାମାନଙ୍କ\s*ବିବରଣ|n(?:y[aā]yakartt[aā]har[uū]ko\s*pustak|iāīāṃ\s*dī\s*potʰī)|Книга\s*(?:на\s*(?:израелеви\s*судии|съдиите)|С(?:уд(?:е[ий]\s*Израилевых|дів)|ъдии\s*Израилеви))|न्याय(?:कर्त(?:्त)?ाहरूको\s*पुस्तक|िय(?:\s*का\s*विर्तान्त|ों))|n(?:y[aā]yakartt[aā]har[uū]ko|iāīāṃ)|न्यायकर्त(?:्ताहरूको|ा)|(?:Tuomarien\s*kirj|Xaakinnad|Sudcovi)a|K(?:n(?:jiga\s*o\s*Sucima|yha\s*Suddiv)|s(?:i[eę]g[ai]\s*S[eę]dzi[oó]w|\.\s*S[eę]dzi[oó]w|\s*S[eę]dzi[oó]w)|\.?\s*sudcov)|N(?:iy[aā]y[aā]tipatika[lḷ]|yayiyon)|С(?:ъдии\s*Израилев|удь)и|ਨਿਆਂ?ਈਆਂ\s*ਦੀ\s*ਪੋਥੀ|ந(?:ியா(?:யாதிபதிகள்)?|ீத)|(?:M(?:(?:ga\s*M)?aghuh|ga\s*H)uko|Hakim-?haki|Para\s*Haki|H(?:uko|k))m|Li(?:ber\s*Iudicum|v\s*Ch[eè]f\s*yo)|(?:Dommernes\s*bo|B(?:ír[aá]|ir[aá]))k|Các\s*(?:quan\s*xét|Thủ\s*lãnh)|Книга\s*Суде[ий]|J(?:udecatorii|dgs|gs|ij|[cz])|(?:D(?:om(?:(?:merbog|arbok)e|arab[oó]ki)|ómarab[oó]ki|a(?:(?:v(?:aran|r)|voor)a|w(?:oo|a)ra))|Thẩm\s*phá|Quan\s*á)n|ผู้วินิจฉัย|J(?:u(?:decatori|ec|dg|[ií]z|e|g)|d?g)|(?:Judecător|Giudic|Suc)i|سفر\s*القضاة|D(?:om(?:(?:mer(?:nes?)?)?|arab[oó]k)|óm(?:arab[oó]k)?|avaran)|Tuom(?:arien)?|R(?:ichteren|echters)|Gjyqtar[eë]t|R(?:icht(?:ere?)?|echt)|Davarane|داو(?:[او]ر(?:انه|ن)|ر(?:ان[نه]|اان|ران|ن))|Hak\.?-?hak|داو(?:[او]ران|ر(?:ان)?)?|Waamuzi|S[eę]dzi[oó]w|Iudicum|S(?:ud(?:cov)?|[eę]dz|d)|S(?:oudc[uů]|d[cz])|Κριτ(?:α[ίι]|[έε]ς)|Ju(?:(?:ec|dg|g)|[ií]z)es|Суд(?:и(?:ј[ае]|и)|е[ий])|שופטים|शास्ते|القضاة|Суддів|С(?:ъд(?:ии)?|уд)|ق(?:ُضاۃ|ضا[ةہۃ])|[sŝ][aā]ste|(?:《士(?:师记|師記)|士(?:師記|师记))》|《?民長紀》|qużāh|Quan|Waam|Xaak|Κρ(?:ιτ)?|《士(?:师记|師記)|《?民長紀|Gjy|H[au]k|Iud|Bír|士(?:師記|师记)|Amu|Gdc|Thủ|《士》|판관기|วนฉ|사사기|士師?|قض|《士|판관|士》|삿))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Mark"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:(?:Mabuting\s*Balita\s*ayon\s*kay\s*(?:San\s*Mar[ck]|Mar[ck])o|E(?:(?:(?:banghelyo\s*ayon\s*kay\s*Marc|banghelyo\s*ni\s*(?:San\s*Mar[ck]|Mar[ck]))|vangelio\s*de\s*Marc)|l\s*Evangelio\s*de\s*Marc)o|S(?:ulat\s*ni\s*S)?an\s*Marco|M(?:ar(?:cou|koo|q(?:ou|uo))|rco))s|The\s*Gospel\s*(?:according\s*to\s*(?:S(?:aint\s*M(?:ar|r?)k|t(?:\.\s*M(?:ar|r?)k|\s*M(?:ar|r?)k))|M(?:ar|r?)k)|of\s*(?:S(?:aint\s*M(?:ar|r?)k|t(?:\.\s*M(?:ar|r?)k|\s*M(?:ar|r?)k))|M(?:ar|r?)k))|The\s*Gospel\s*(?:according\s*to\s*(?:S(?:aint\s*Ma?r|t(?:\.\s*Ma?r|\s*Ma?r))|Ma?r)|of\s*(?:S(?:aint\s*Ma?r|t(?:\.\s*Ma?r|\s*Ma?r))|Ma?r))|m(?:ark[aā]ne\s*lihilele\s*[sŝ]ubʰavartam[aā]n|ār(?:k[aā]ne\s*lihilele\s*[sŝ]ubʰavartam[aā]n|qūsi)|ar(?:k(?:(?:usle\s*lekʰeko\s*susm[aā]c[aā]r|ūsle\s*lekʰeko\s*susm[aā]c[aā]r)|us\s*dī\s*ĩjīl)|qus\s*kī\s*injīl))|Gospel\s*(?:according\s*to\s*(?:S(?:aint\s*M(?:ar|r?)k|t(?:\.\s*M(?:ar|r?)k|\s*M(?:ar|r?)k))|M(?:ar|r?)k)|of\s*(?:S(?:aint\s*M(?:ar|r?)k|t(?:\.\s*M(?:ar|r?)k|\s*M(?:ar|r?)k))|M(?:ar|r?)k))|Gospel\s*(?:according\s*to\s*(?:S(?:aint\s*Ma?r|t(?:\.\s*Ma?r|\s*Ma?r))|Ma?r)|of\s*(?:S(?:aint\s*Ma?r|t(?:\.\s*Ma?r|\s*Ma?r))|Ma?r))|Evankeliumi\s*Markuksen\s*mukaan|म(?:ार्काने\s*लिहिलेले\s*शुभवर्तमान|र्कू(?:स(?:ले\s*लेखे)?को\s*सुसमाचार|श))|Evangelium\s*secundum\s*Marcum|E(?:w(?:angelia\s*w(?:edług\s*[sś]w\.|g\s*[sś]w\.)|\.)|van(?:gelium\s*podle|jelium\s*Pod[lľ]a))\s*Marka|Ewangelia\s*w(?:edług\s*[sś]w\s*|g\s*[sś]w\s*)Marka|Evangelie\s*volgens\s*Mar[ck]us|От\s*Марка\s*свето\s*Евангелие|Евангелие(?:то\s*според\s*Марко|\s*(?:според\s*Марко|от\s*Марк[ао]))|Evangeliet\s*etter\s*Markus|மாற்கு\s*(?:எழுதிய\s*(?:சுவிசேஷம்|நற்செய்தி)|நற்செய்தி)|Євангелі[яє]\s*від\s*(?:св\.?\s*Марка|Марка)|M(?:arkuksen\s*evankeliumi|arku\s*Na[rṛ]ceyti|aṛku\s*Na[rṛ]ceyti|ā[rṛ]ku\s*Na[rṛ]ceyti|a(?:r(?:c(?:oose|us)e|q(?:o(?:ose|s)e|uss)|k(?:uss|os|a)|cos)|k)|arek|á(?:ccô|rk)|rk|[ck])|ମାର୍କ\s*ଲିଖିତ\s*ସୁସମାଗ୍ଭର|Jevan(?:helije\s*vid\s*Marka|đelje\s*po\s*Marku)|Vangelo\s*di\s*(?:San\s*)?Marco|พระวรสารนักบุญมาร์ค|Mark(?:ovo|us)\s*evangelium|Evan[ðđ]elje\s*po\s*Marku|הבשורה\s*על[\s*-]פי\s*מרקוס|Јеванђеље\s*по\s*Марку|Mark[uú]sarguðspjall|Ungjilli\s*i\s*Markut|Еванђеље\s*по\s*Марку|Markusevangeliet|Injili\s*ya\s*Marko|Ewangelia\s*Marka|م(?:ر(?:ق(?:ُس\s*کی\s*انجیل|س\s*کی\s*انجیل|سی|ص)|(?:قو|ک)س)|َرق(?:ُسه|و[سص]|سه|ص))|ਮਰਕੁਸ\s*ਦੀ\s*ਇੰਜੀਲ|Injil\s*Markus|Κατ[άα]\s*Μ[άα]ρκον|Saint\s*M(?:ar|r?)k|إنجيل\s*مرقس|M(?:ar(?:k(?:u(?:ksen|s)?|o)?|c(?:oose|us)|c(?:o(?:os)?|u)?|q(?:oo?s|us))?|aṛku|ā[rṛ]ku|rc?|ác)|Saint\s*Ma?r|マルコ(?:による福音書|[の傳]福音書|福音書|[伝書])|Від\s*Марка|m(?:ark(?:us(?:le)?|ūsle)|ark[aā]ne|ār(?:k[aā]ne|qūs?))|От\s*Марка|म(?:र्कूस(?:ले)?|ार्क(?:ाने)?)|St\.\s*M(?:ar|r?)k|Ew\s*Marka|St\.\s*Ma?r|마(?:르코\s*|가)복음서|Marakus|《?馬(?:爾谷|可)福音》|St\s*M(?:ar|r?)k|م(?:َر(?:قُو|[كک]ُ)|ر(?:ق(?:ُو|ّ)|ك))س|م(?:َرقُ?س|ر(?:ق(?:ُس|س)?|قو|ک)?)|Ew\s*Mar|마(?:르(?:코\s*복음)?|가(?:복음)?)|மாற்(?:கு)?|《?馬(?:爾谷|可)福音|St\s*Ma?r|Μ(?:[άα]ρκος|ρ)|ม(?:าระโ)?ก|《?马可福音》|मर्?कुस|र्मकू?स|《?马可福音|ਮਰਕੁਸ|ମାର୍କ|М(?:арк[oао]|[кр])|(?:《?瑪爾克|《?可)》|מרקוס|Μ[άα]ρκ|Марк|《?瑪爾克|マルコ|《?可|막))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Jas"],
        testament: "n",
        regexp: /(?:^|(?<=[^\p{L}]))((?:(?:List\s*(?:powszechny\s*[SŚ]wi[eę]tego\s*Iakuba\s*Apostoł|[sś]w\.?\s*Jakub)|Jakovljeva\s*poslanic|y(?:akob[aā]ce[mṃ]\s*patr|āk(?:ob[aā]ce[mṃ]\s*patr|[uū]bko\s*patr)|ak[uū]bko\s*patr))a|С(?:оборне\s*послання\s*(?:св\.?\s*апостола\s*Я|Я)кова|ъборно\s*послание\s*на\s*св(?:\.\s*ап\.?\s*Иакова|\s*ап\.?\s*Иакова))|யாக(?:(?:்கோபு\s*(?:எழுதிய\s*)?திருமுக|்கோபு\s*எழுதிய\s*(?:நிருப|கடித))|ப்பர்\s*திருமுக)ம்|Poslannja\s*apostola\s*Jakova|П(?:ослание\s*на\s*(?:апостол\s*Ја|Я)|исмо\s*од\s*апостол\s*Ја)ков|Y(?:akk[oō]pu\s*E[lḻ]utiya\s*Nirupam|ākk[oō]pu\s*E[lḻ]utiya\s*Nirupam|a(?:aqoob(?:ey|i)|q(?:o(?:ob(?:e[ehy]|i)|ub)|ub(?:e[eh]|i))|(?:cquu|k(?:oo|u))b|kobo)|k)|Hið\s*almenna\s*br[eé]f\s*Jakobs|Послання\s*(?:апостола\s*)?Якова|(?:Посланица\s*Јаковље|Јаковље|(?:Јаков|Иак)о)ва|(?:Lettera\s*di\s*Giacom|(?:Sant|T)iag|Giacom)o|رسالة\s*(?:القديس\s*)?يعقوب|y(?:a(?:ʿqūb\s*kā\s*ʿām\s*ḫaṭ|['’]qūbi)|ākūb\s*dī\s*pattrī)|یعق(?:و(?:ب\s*کا\s*عا\s*م\s*خط|(?:ب\s*کا\s*عام\s*خط|(?:ب(?:ا[ءت]|ته|[ئهىی])|پ[هی])))|ُوب\s*کا\s*عام\s*خط)|Waraka\s*wa\s*Yakobo|Epistula\s*Iacobi|ਯਾਕੂਬ\s*ਦੀ\s*ਪੱਤ੍ਰੀ|Barua\s*ya\s*Yakobo|Послание\s*Иакова|J(?:a(?:k(?:ob(?:(?:s(?:\s*epistel|br[eé]fið)|usbrief|it)|sbrevet)|ub(?:ov\s*List|a))|akobin\s*kirje|s)|(?:ame|m)s|k)|याक(?:ोबाचें|ूबको)\s*पत्र|(?:Layang\s*Yakobu|Jac?que|Yakobu)s|ଯାକୁବଙ୍କ\s*ପତ୍ର|List\s*Jakub(?:[uů]v|a)|Jak(?:obs\s*[Bb]re|ub[uů])v|J(?:a(?:k(?:o(?:vljeva|b(?:us|i|s)?)|ub(?:ov)?)?|ak(?:obin)?|cq?|m)?|ame|m)|אי?גרת\s*יעקב|y(?:akob[aā]ce[mṃ]|āk(?:ob[aā]ce[mṃ]|[uū]bko|ūb)|ak[uū]bko|a['’]qūb?)|याक(?:ोब(?:ाचें)?|ूब(?:को)?)|யாக்(?:கோபு)?|ଯାକୁବଙ୍କ|ヤコ[フブ](?:からの手紙|の手紙|の?書)|Y(?:a(?:(?:aqoob|q(?:oo|u)b|cq?|k)|kk[oō]pu)|ākk[oō]pu)|G(?:ia(?:côbê|-?cơ)|[cm])|(?:Yaaqu|Iaco)bi|Ιακ[ωώ]βου|(?:Yaaqu|Iaco)b|یعق(?:و(?:ب(?:ا|ت)?|پ)?|ُوب)?|야고보(?:\s*서간|서)|(?:《雅各(?:伯書|[书書])|雅各(?:伯書|[书書]))》|Jacobo|Јак(?:ов)?|《雅各(?:伯書|[书書])|ਯਾਕੂਬ|Jakab|Iacov|Як(?:ова|уб)|ย(?:ากอบ|[กบ])|《?亞适烏》|يعقوب|S(?:ant?|t)|Як(?:ов)?|雅各(?:伯書|[书書])|《?亞适烏|יעקב|Iac|Иак|ヤコ[フブ]|Stg|《雅》|᾿Ια|يع|《雅|야고|Tg|雅》|雅|약))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Amos"],
        testament: "o",
        regexp: /(?:^|(?<=[^\p{L}]))((?:ଆମୋଷ\s*ଭବିଷ୍ୟ‌ଦ୍‌ବକ୍ତାଙ୍କ\s*ପୁସ୍ତକ|Книга\s*(?:на\s*пророк\s*Амоса?|пророка\s*Амоса)|(?:Aamoksen\s*kirj|Ks(?:i[eę]g[ai]\s*Amos|\.?\s*Amos))a|Prophetia\s*Amos|आमोसको\s*पुस्तक|Liv\s*Am[oò]s\s*la|A(?:m(?:(?:os(?:['’]\s*(?:Bog|bok)|[aeiz])|ós|s)|oose)|amo(?:oo?se|use|s[es])|-?mốt)|عام(?:و(?:و(?:س(?:س(?:یی|[هہ])|ی[ہی]|[ـهہ])|و(?:س(?:سس|یی|[هہ])|وسہ))|س(?:(?:سیی|(?:س[سه]|یہ|[ـهہ]))|ییہ))|س)|سفر\s*عاموس|A(?:am(?:o(?:ksen|oo?s|s))?|m(?:os?|ó)?)|عا(?:م(?:و(?:و(?:وس(?:س|ی)?|س(?:س|ی)?)|س(?:سی|(?:س|ی)?)))?)?|Caamoos|《?阿摩司[书書]》|(?:A(?:m(?:o(?:oo|u)|[òō])|amoe)|ʿāmō|Ámó|āmo|Ām[oō])s|عامُوس|《?阿摩司[书書]|Ámosz|āmūsī|ஆமோஸ்|อ(?:าโ)?มส|アモス(?:しょ|書)|(?:《?亞毛斯|《?摩)》|Амоса?|Ám(?:os)?|ām(?:ūs)?|Caam|आमोस|ଆମୋଷ|《?亞毛斯|Αμ[ωώ]ς|아모스서|עמוס|अमोस|ਆਮੋਸ|amos|아모스?|ஆமோ|アモス|Αμ|Ам|《?摩|Ἀμ|암))(?:(?=[\d\s.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-–—])|$)/giu
      },
      {
        osis: ["Tob"],
        testament: "a",
